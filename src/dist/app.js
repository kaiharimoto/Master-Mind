...
`)+`
`+m);let R=E+p+a,S=E+m+o,M=tg(s,s.VERTEX_SHADER,R),b=tg(s,s.FRAGMENT_SHADER,S);s.attachShader(_,M),s.attachShader(_,b),n.index0AttributeName!==void 0?s.bindAttribLocation(_,0,n.index0AttributeName):n.hasPositionAttribute===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function C(A){if(t.debug.checkShaderErrors){let P=s.getProgramInfoLog(_)||"",B=s.getShaderInfoLog(M)||"",X=s.getShaderInfoLog(b)||"",U=P.trim(),G=B.trim(),V=X.trim(),$=!0,Z=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if($=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(s,_,M,b);else{let te=ig(s,M,"vertex"),re=ig(s,b,"fragment");Be("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
Program Info Log: `+U+`
`+te+`
`+re)}else U!==""?De("WebGLProgram: Program Info Log:",U):(G===""||V==="")&&(Z=!1);Z&&(A.diagnostics={runnable:$,programLog:U,vertexShader:{log:G,prefix:p},fragmentShader:{log:V,prefix:m}})}s.deleteShader(M),s.deleteShader(b),v=new ea(s,_),w=uM(s,_)}let v;this.getUniforms=function(){return v===void 0&&C(this),v};let w;this.getAttributes=function(){return w===void 0&&C(this),w};let I=n.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return I===!1&&(I=s.getProgramParameter(_,tM)),I},this.destroy=function(){i.releaseStatesOfProgram(this),s.deleteProgram(_),this.program=void 0},this.type=n.shaderType,this.name=n.shaderName,this.id=nM++,this.cacheKey=e,this.usedTimes=1,this.program=_,this.vertexShader=M,this.fragmentShader=b,this}var TM=0,Cd=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e,n,i){let s=this._getShaderCacheForMaterial(e);return s.has(n)===!1&&(s.add(n),n.usedTimes++),s.has(i)===!1&&(s.add(i),i.usedTimes++),this}remove(e){let n=this.materialCache.get(e);for(let i of n)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderStage(e){return this._getShaderStage(e.vertexShader)}getFragmentShaderStage(e){return this._getShaderStage(e.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){let n=this.materialCache,i=n.get(e);return i===void 0&&(i=new Set,n.set(e,i)),i}_getShaderStage(e){let n=this.shaderCache,i=n.get(e);return i===void 0&&(i=new Rd(e),n.set(e,i)),i}},Rd=class{constructor(e){this.id=TM++,this.code=e,this.usedTimes=0}};function CM(t){return t===Ns||t===oo||t===lo}function RM(t,e,n,i,s,r){let a=new za,o=new Cd,l=new Set,c=[],u=new Map,d=i.logarithmicDepthBuffer,h=i.precision,f={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function g(v){return l.add(v),v===0?"uv":`uv${v}`}function _(v,w,I,A,P,B){let X=A.fog,U=P.geometry,G=v.isMeshStandardMaterial||v.isMeshLambertMaterial||v.isMeshPhongMaterial?A.environment:null,V=v.isMeshStandardMaterial||v.isMeshLambertMaterial&&!v.envMap||v.isMeshPhongMaterial&&!v.envMap,$=e.get(v.envMap||G,V),Z=$&&$.mapping===to?$.image.height:null,te=f[v.type];v.precision!==null&&(h=i.getMaxPrecision(v.precision),h!==v.precision&&De("WebGLProgram.getParameters:",v.precision,"not supported, using",h,"instead."));let re=U.morphAttributes.position||U.morphAttributes.normal||U.morphAttributes.color,pe=re!==void 0?re.length:0,Xe=0;U.morphAttributes.position!==void 0&&(Xe=1),U.morphAttributes.normal!==void 0&&(Xe=2),U.morphAttributes.color!==void 0&&(Xe=3);let rt,Ze,K,ne;if(te){let Se=Fi[te];rt=Se.vertexShader,Ze=Se.fragmentShader}else{rt=v.vertexShader,Ze=v.fragmentShader;let Se=o.getVertexShaderStage(v),Bt=o.getFragmentShaderStage(v);o.update(v,Se,Bt),K=Se.id,ne=Bt.id}let ee=t.getRenderTarget(),Ue=t.state.buffers.depth.getReversed(),ze=P.isInstancedMesh===!0,Fe=P.isBatchedMesh===!0,Ct=!!v.map,Ye=!!v.matcap,pt=!!$,at=!!v.aoMap,Je=!!v.lightMap,Lt=!!v.bumpMap&&v.wireframe===!1,Rt=!!v.normalMap,Nt=!!v.displacementMap,Gt=!!v.emissiveMap,It=!!v.metalnessMap,Ot=!!v.roughnessMap,F=v.anisotropy>0,wn=v.clearcoat>0,gt=v.dispersion>0,T=v.iridescence>0,x=v.sheen>0,O=v.transmission>0,H=F&&!!v.anisotropyMap,q=wn&&!!v.clearcoatMap,ie=wn&&!!v.clearcoatNormalMap,oe=wn&&!!v.clearcoatRoughnessMap,Y=T&&!!v.iridescenceMap,J=T&&!!v.iridescenceThicknessMap,le=x&&!!v.sheenColorMap,Te=x&&!!v.sheenRoughnessMap,ue=!!v.specularMap,ce=!!v.specularColorMap,Ne=!!v.specularIntensityMap,Oe=O&&!!v.transmissionMap,Ge=O&&!!v.thicknessMap,L=!!v.gradientMap,ae=!!v.alphaMap,j=v.alphaTest>0,he=!!v.alphaHash,ge=!!v.extensions,Q=ui;v.toneMapped&&(ee===null||ee.isXRRenderTarget===!0)&&(Q=t.toneMapping);let Ae={shaderID:te,shaderType:v.type,shaderName:v.name,vertexShader:rt,fragmentShader:Ze,defines:v.defines,customVertexShaderID:K,customFragmentShaderID:ne,isRawShaderMaterial:v.isRawShaderMaterial===!0,glslVersion:v.glslVersion,precision:h,batching:Fe,batchingColor:Fe&&P._colorsTexture!==null,instancing:ze,instancingColor:ze&&P.instanceColor!==null,instancingMorph:ze&&P.morphTexture!==null,outputColorSpace:ee===null?t.outputColorSpace:ee.isXRRenderTarget===!0?ee.texture.colorSpace:je.workingColorSpace,alphaToCoverage:!!v.alphaToCoverage,map:Ct,matcap:Ye,envMap:pt,envMapMode:pt&&$.mapping,envMapCubeUVHeight:Z,aoMap:at,lightMap:Je,bumpMap:Lt,normalMap:Rt,displacementMap:Nt,emissiveMap:Gt,normalMapObjectSpace:Rt&&v.normalMapType===Im,normalMapTangentSpace:Rt&&v.normalMapType===hd,packedNormalMap:Rt&&v.normalMapType===hd&&CM(v.normalMap.format),metalnessMap:It,roughnessMap:Ot,anisotropy:F,anisotropyMap:H,clearcoat:wn,clearcoatMap:q,clearcoatNormalMap:ie,clearcoatRoughnessMap:oe,dispersion:gt,iridescence:T,iridescenceMap:Y,iridescenceThicknessMap:J,sheen:x,sheenColorMap:le,sheenRoughnessMap:Te,specularMap:ue,specularColorMap:ce,specularIntensityMap:Ne,transmission:O,transmissionMap:Oe,thicknessMap:Ge,gradientMap:L,opaque:v.transparent===!1&&v.blending===Jn&&v.alphaToCoverage===!1,alphaMap:ae,alphaTest:j,alphaHash:he,combine:v.combine,mapUv:Ct&&g(v.map.channel),aoMapUv:at&&g(v.aoMap.channel),lightMapUv:Je&&g(v.lightMap.channel),bumpMapUv:Lt&&g(v.bumpMap.channel),normalMapUv:Rt&&g(v.normalMap.channel),displacementMapUv:Nt&&g(v.displacementMap.channel),emissiveMapUv:Gt&&g(v.emissiveMap.channel),metalnessMapUv:It&&g(v.metalnessMap.channel),roughnessMapUv:Ot&&g(v.roughnessMap.channel),anisotropyMapUv:H&&g(v.anisotropyMap.channel),clearcoatMapUv:q&&g(v.clearcoatMap.channel),clearcoatNormalMapUv:ie&&g(v.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:oe&&g(v.clearcoatRoughnessMap.channel),iridescenceMapUv:Y&&g(v.iridescenceMap.channel),iridescenceThicknessMapUv:J&&g(v.iridescenceThicknessMap.channel),sheenColorMapUv:le&&g(v.sheenColorMap.channel),sheenRoughnessMapUv:Te&&g(v.sheenRoughnessMap.channel),specularMapUv:ue&&g(v.specularMap.channel),specularColorMapUv:ce&&g(v.specularColorMap.channel),specularIntensityMapUv:Ne&&g(v.specularIntensityMap.channel),transmissionMapUv:Oe&&g(v.transmissionMap.channel),thicknessMapUv:Ge&&g(v.thicknessMap.channel),alphaMapUv:ae&&g(v.alphaMap.channel),vertexTangents:!!U.attributes.tangent&&(Rt||F),vertexNormals:!!U.attributes.normal,vertexColors:v.vertexColors,vertexAlphas:v.vertexColors===!0&&!!U.attributes.color&&U.attributes.color.itemSize===4,pointsUvs:P.isPoints===!0&&!!U.attributes.uv&&(Ct||ae),fog:!!X,useFog:v.fog===!0,fogExp2:!!X&&X.isFogExp2,flatShading:v.wireframe===!1&&(v.flatShading===!0||U.attributes.normal===void 0&&Rt===!1&&(v.isMeshLambertMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isMeshPhysicalMaterial)),sizeAttenuation:v.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:Ue,skinning:P.isSkinnedMesh===!0,hasPositionAttribute:U.attributes.position!==void 0,morphTargets:U.morphAttributes.position!==void 0,morphNormals:U.morphAttributes.normal!==void 0,morphColors:U.morphAttributes.color!==void 0,morphTargetsCount:pe,morphTextureStride:Xe,numDirLights:w.directional.length,numPointLights:w.point.length,numSpotLights:w.spot.length,numSpotLightMaps:w.spotLightMap.length,numRectAreaLights:w.rectArea.length,numHemiLights:w.hemi.length,numDirLightShadows:w.directionalShadowMap.length,numPointLightShadows:w.pointShadowMap.length,numSpotLightShadows:w.spotShadowMap.length,numSpotLightShadowsWithMaps:w.numSpotLightShadowsWithMaps,numLightProbes:w.numLightProbes,numLightProbeGrids:B.length,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:v.dithering,shadowMapEnabled:t.shadowMap.enabled&&I.length>0,shadowMapType:t.shadowMap.type,toneMapping:Q,decodeVideoTexture:Ct&&v.map.isVideoTexture===!0&&je.getTransfer(v.map.colorSpace)===mt,decodeVideoTextureEmissive:Gt&&v.emissiveMap.isVideoTexture===!0&&je.getTransfer(v.emissiveMap.colorSpace)===mt,premultipliedAlpha:v.premultipliedAlpha,doubleSided:v.side===Ri,flipSided:v.side===bn,useDepthPacking:v.depthPacking>=0,depthPacking:v.depthPacking||0,index0AttributeName:v.index0AttributeName,extensionClipCullDistance:ge&&v.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ge&&v.extensions.multiDraw===!0||Fe)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:v.customProgramCacheKey()};return Ae.vertexUv1s=l.has(1),Ae.vertexUv2s=l.has(2),Ae.vertexUv3s=l.has(3),l.clear(),Ae}function p(v){let w=[];if(v.shaderID?w.push(v.shaderID):(w.push(v.customVertexShaderID),w.push(v.customFragmentShaderID)),v.defines!==void 0)for(let I in v.defines)w.push(I),w.push(v.defines[I]);return v.isRawShaderMaterial===!1&&(m(w,v),E(w,v),w.push(t.outputColorSpace)),w.push(v.customProgramCacheKey),w.join()}function m(v,w){v.push(w.precision),v.push(w.outputColorSpace),v.push(w.envMapMode),v.push(w.envMapCubeUVHeight),v.push(w.mapUv),v.push(w.alphaMapUv),v.push(w.lightMapUv),v.push(w.aoMapUv),v.push(w.bumpMapUv),v.push(w.normalMapUv),v.push(w.displacementMapUv),v.push(w.emissiveMapUv),v.push(w.metalnessMapUv),v.push(w.roughnessMapUv),v.push(w.anisotropyMapUv),v.push(w.clearcoatMapUv),v.push(w.clearcoatNormalMapUv),v.push(w.clearcoatRoughnessMapUv),v.push(w.iridescenceMapUv),v.push(w.iridescenceThicknessMapUv),v.push(w.sheenColorMapUv),v.push(w.sheenRoughnessMapUv),v.push(w.specularMapUv),v.push(w.specularColorMapUv),v.push(w.specularIntensityMapUv),v.push(w.transmissionMapUv),v.push(w.thicknessMapUv),v.push(w.combine),v.push(w.fogExp2),v.push(w.sizeAttenuation),v.push(w.morphTargetsCount),v.push(w.morphAttributeCount),v.push(w.numDirLights),v.push(w.numPointLights),v.push(w.numSpotLights),v.push(w.numSpotLightMaps),v.push(w.numHemiLights),v.push(w.numRectAreaLights),v.push(w.numDirLightShadows),v.push(w.numPointLightShadows),v.push(w.numSpotLightShadows),v.push(w.numSpotLightShadowsWithMaps),v.push(w.numLightProbes),v.push(w.shadowMapType),v.push(w.toneMapping),v.push(w.numClippingPlanes),v.push(w.numClipIntersection),v.push(w.depthPacking)}function E(v,w){a.disableAll(),w.instancing&&a.enable(0),w.instancingColor&&a.enable(1),w.instancingMorph&&a.enable(2),w.matcap&&a.enable(3),w.envMap&&a.enable(4),w.normalMapObjectSpace&&a.enable(5),w.normalMapTangentSpace&&a.enable(6),w.clearcoat&&a.enable(7),w.iridescence&&a.enable(8),w.alphaTest&&a.enable(9),w.vertexColors&&a.enable(10),w.vertexAlphas&&a.enable(11),w.vertexUv1s&&a.enable(12),w.vertexUv2s&&a.enable(13),w.vertexUv3s&&a.enable(14),w.vertexTangents&&a.enable(15),w.anisotropy&&a.enable(16),w.alphaHash&&a.enable(17),w.batching&&a.enable(18),w.dispersion&&a.enable(19),w.batchingColor&&a.enable(20),w.gradientMap&&a.enable(21),w.packedNormalMap&&a.enable(22),w.vertexNormals&&a.enable(23),v.push(a.mask),a.disableAll(),w.fog&&a.enable(0),w.useFog&&a.enable(1),w.flatShading&&a.enable(2),w.logarithmicDepthBuffer&&a.enable(3),w.reversedDepthBuffer&&a.enable(4),w.skinning&&a.enable(5),w.morphTargets&&a.enable(6),w.morphNormals&&a.enable(7),w.morphColors&&a.enable(8),w.premultipliedAlpha&&a.enable(9),w.shadowMapEnabled&&a.enable(10),w.doubleSided&&a.enable(11),w.flipSided&&a.enable(12),w.useDepthPacking&&a.enable(13),w.dithering&&a.enable(14),w.transmission&&a.enable(15),w.sheen&&a.enable(16),w.opaque&&a.enable(17),w.pointsUvs&&a.enable(18),w.decodeVideoTexture&&a.enable(19),w.decodeVideoTextureEmissive&&a.enable(20),w.alphaToCoverage&&a.enable(21),w.numLightProbeGrids>0&&a.enable(22),w.hasPositionAttribute&&a.enable(23),v.push(a.mask)}function R(v){let w=f[v.type],I;if(w){let A=Fi[w];I=Hm.clone(A.uniforms)}else I=v.uniforms;return I}function S(v,w){let I=u.get(w);return I!==void 0?++I.usedTimes:(I=new AM(t,w,v,s),c.push(I),u.set(w,I)),I}function M(v){if(--v.usedTimes===0){let w=c.indexOf(v);c[w]=c[c.length-1],c.pop(),u.delete(v.cacheKey),v.destroy()}}function b(v){o.remove(v)}function C(){o.dispose()}return{getParameters:_,getProgramCacheKey:p,getUniforms:R,acquireProgram:S,releaseProgram:M,releaseShaderCache:b,programs:c,dispose:C}}function IM(){let t=new WeakMap;function e(a){return t.has(a)}function n(a){let o=t.get(a);return o===void 0&&(o={},t.set(a,o)),o}function i(a){t.delete(a)}function s(a,o,l){t.get(a)[o]=l}function r(){t=new WeakMap}return{has:e,get:n,remove:i,update:s,dispose:r}}function PM(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.material.id!==e.material.id?t.material.id-e.material.id:t.materialVariant!==e.materialVariant?t.materialVariant-e.materialVariant:t.z!==e.z?t.z-e.z:t.id-e.id}function lg(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.z!==e.z?e.z-t.z:t.id-e.id}function cg(){let t=[],e=0,n=[],i=[],s=[];function r(){e=0,n.length=0,i.length=0,s.length=0}function a(h){let f=0;return h.isInstancedMesh&&(f+=2),h.isSkinnedMesh&&(f+=1),f}function o(h,f,g,_,p,m){let E=t[e];return E===void 0?(E={id:h.id,object:h,geometry:f,material:g,materialVariant:a(h),groupOrder:_,renderOrder:h.renderOrder,z:p,group:m},t[e]=E):(E.id=h.id,E.object=h,E.geometry=f,E.material=g,E.materialVariant=a(h),E.groupOrder=_,E.renderOrder=h.renderOrder,E.z=p,E.group=m),e++,E}function l(h,f,g,_,p,m){let E=o(h,f,g,_,p,m);g.transmission>0?i.push(E):g.transparent===!0?s.push(E):n.push(E)}function c(h,f,g,_,p,m){let E=o(h,f,g,_,p,m);g.transmission>0?i.unshift(E):g.transparent===!0?s.unshift(E):n.unshift(E)}function u(h,f,g){n.length>1&&n.sort(h||PM),i.length>1&&i.sort(f||lg),s.length>1&&s.sort(f||lg),g&&(n.reverse(),i.reverse(),s.reverse())}function d(){for(let h=e,f=t.length;h<f;h++){let g=t[h];if(g.id===null)break;g.id=null,g.object=null,g.geometry=null,g.material=null,g.group=null}}return{opaque:n,transmissive:i,transparent:s,init:r,push:l,unshift:c,finish:d,sort:u}}function LM(){let t=new WeakMap;function e(i,s){let r=t.get(i),a;return r===void 0?(a=new cg,t.set(i,[a])):s>=r.length?(a=new cg,r.push(a)):a=r[s],a}function n(){t=new WeakMap}return{get:e,dispose:n}}function NM(){let t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={direction:new N,color:new Ve};break;case"SpotLight":n={position:new N,direction:new N,color:new Ve,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":n={position:new N,color:new Ve,distance:0,decay:0};break;case"HemisphereLight":n={direction:new N,skyColor:new Ve,groundColor:new Ve};break;case"RectAreaLight":n={color:new Ve,position:new N,halfWidth:new N,halfHeight:new N};break}return t[e.id]=n,n}}}function FM(){let t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Qe};break;case"SpotLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Qe};break;case"PointLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Qe,shadowCameraNear:1,shadowCameraFar:1e3};break}return t[e.id]=n,n}}}var DM=0;function UM(t,e){return(e.castShadow?2:0)-(t.castShadow?2:0)+(e.map?1:0)-(t.map?1:0)}function OM(t){let e=new NM,n=FM(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new N);let s=new N,r=new zt,a=new zt;function o(c){let u=0,d=0,h=0;for(let w=0;w<9;w++)i.probe[w].set(0,0,0);let f=0,g=0,_=0,p=0,m=0,E=0,R=0,S=0,M=0,b=0,C=0;c.sort(UM);for(let w=0,I=c.length;w<I;w++){let A=c[w],P=A.color,B=A.intensity,X=A.distance,U=null;if(A.shadow&&A.shadow.map&&(A.shadow.map.texture.format===Ns?U=A.shadow.map.texture:U=A.shadow.map.depthTexture||A.shadow.map.texture),A.isAmbientLight)u+=P.r*B,d+=P.g*B,h+=P.b*B;else if(A.isLightProbe){for(let G=0;G<9;G++)i.probe[G].addScaledVector(A.sh.coefficients[G],B);C++}else if(A.isDirectionalLight){let G=e.get(A);if(G.color.copy(A.color).multiplyScalar(A.intensity),A.castShadow){let V=A.shadow,$=n.get(A);$.shadowIntensity=V.intensity,$.shadowBias=V.bias,$.shadowNormalBias=V.normalBias,$.shadowRadius=V.radius,$.shadowMapSize=V.mapSize,i.directionalShadow[f]=$,i.directionalShadowMap[f]=U,i.directionalShadowMatrix[f]=A.shadow.matrix,E++}i.directional[f]=G,f++}else if(A.isSpotLight){let G=e.get(A);G.position.setFromMatrixPosition(A.matrixWorld),G.color.copy(P).multiplyScalar(B),G.distance=X,G.coneCos=Math.cos(A.angle),G.penumbraCos=Math.cos(A.angle*(1-A.penumbra)),G.decay=A.decay,i.spot[_]=G;let V=A.shadow;if(A.map&&(i.spotLightMap[M]=A.map,M++,V.updateMatrices(A),A.castShadow&&b++),i.spotLightMatrix[_]=V.matrix,A.castShadow){let $=n.get(A);$.shadowIntensity=V.intensity,$.shadowBias=V.bias,$.shadowNormalBias=V.normalBias,$.shadowRadius=V.radius,$.shadowMapSize=V.mapSize,i.spotShadow[_]=$,i.spotShadowMap[_]=U,S++}_++}else if(A.isRectAreaLight){let G=e.get(A);G.color.copy(P).multiplyScalar(B),G.halfWidth.set(A.width*.5,0,0),G.halfHeight.set(0,A.height*.5,0),i.rectArea[p]=G,p++}else if(A.isPointLight){let G=e.get(A);if(G.color.copy(A.color).multiplyScalar(A.intensity),G.distance=A.distance,G.decay=A.decay,A.castShadow){let V=A.shadow,$=n.get(A);$.shadowIntensity=V.intensity,$.shadowBias=V.bias,$.shadowNormalBias=V.normalBias,$.shadowRadius=V.radius,$.shadowMapSize=V.mapSize,$.shadowCameraNear=V.camera.near,$.shadowCameraFar=V.camera.far,i.pointShadow[g]=$,i.pointShadowMap[g]=U,i.pointShadowMatrix[g]=A.shadow.matrix,R++}i.point[g]=G,g++}else if(A.isHemisphereLight){let G=e.get(A);G.skyColor.copy(A.color).multiplyScalar(B),G.groundColor.copy(A.groundColor).multiplyScalar(B),i.hemi[m]=G,m++}}p>0&&(t.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=de.LTC_FLOAT_1,i.rectAreaLTC2=de.LTC_FLOAT_2):(i.rectAreaLTC1=de.LTC_HALF_1,i.rectAreaLTC2=de.LTC_HALF_2)),i.ambient[0]=u,i.ambient[1]=d,i.ambient[2]=h;let v=i.hash;(v.directionalLength!==f||v.pointLength!==g||v.spotLength!==_||v.rectAreaLength!==p||v.hemiLength!==m||v.numDirectionalShadows!==E||v.numPointShadows!==R||v.numSpotShadows!==S||v.numSpotMaps!==M||v.numLightProbes!==C)&&(i.directional.length=f,i.spot.length=_,i.rectArea.length=p,i.point.length=g,i.hemi.length=m,i.directionalShadow.length=E,i.directionalShadowMap.length=E,i.pointShadow.length=R,i.pointShadowMap.length=R,i.spotShadow.length=S,i.spotShadowMap.length=S,i.directionalShadowMatrix.length=E,i.pointShadowMatrix.length=R,i.spotLightMatrix.length=S+M-b,i.spotLightMap.length=M,i.numSpotLightShadowsWithMaps=b,i.numLightProbes=C,v.directionalLength=f,v.pointLength=g,v.spotLength=_,v.rectAreaLength=p,v.hemiLength=m,v.numDirectionalShadows=E,v.numPointShadows=R,v.numSpotShadows=S,v.numSpotMaps=M,v.numLightProbes=C,i.version=DM++)}function l(c,u){let d=0,h=0,f=0,g=0,_=0,p=u.matrixWorldInverse;for(let m=0,E=c.length;m<E;m++){let R=c[m];if(R.isDirectionalLight){let S=i.directional[d];S.direction.setFromMatrixPosition(R.matrixWorld),s.setFromMatrixPosition(R.target.matrixWorld),S.direction.sub(s),S.direction.transformDirection(p),d++}else if(R.isSpotLight){let S=i.spot[f];S.position.setFromMatrixPosition(R.matrixWorld),S.position.applyMatrix4(p),S.direction.setFromMatrixPosition(R.matrixWorld),s.setFromMatrixPosition(R.target.matrixWorld),S.direction.sub(s),S.direction.transformDirection(p),f++}else if(R.isRectAreaLight){let S=i.rectArea[g];S.position.setFromMatrixPosition(R.matrixWorld),S.position.applyMatrix4(p),a.identity(),r.copy(R.matrixWorld),r.premultiply(p),a.extractRotation(r),S.halfWidth.set(R.width*.5,0,0),S.halfHeight.set(0,R.height*.5,0),S.halfWidth.applyMatrix4(a),S.halfHeight.applyMatrix4(a),g++}else if(R.isPointLight){let S=i.point[h];S.position.setFromMatrixPosition(R.matrixWorld),S.position.applyMatrix4(p),h++}else if(R.isHemisphereLight){let S=i.hemi[_];S.direction.setFromMatrixPosition(R.matrixWorld),S.direction.transformDirection(p),_++}}}return{setup:o,setupView:l,state:i}}function hg(t){let e=new OM(t),n=[],i=[],s=[];function r(h){d.camera=h,n.length=0,i.length=0,s.length=0}function a(h){n.push(h)}function o(h){i.push(h)}function l(h){s.push(h)}function c(){e.setup(n)}function u(h){e.setupView(n,h)}let d={lightsArray:n,shadowsArray:i,lightProbeGridArray:s,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:r,state:d,setupLights:c,setupLightsView:u,pushLight:a,pushShadow:o,pushLightProbeGrid:l}}function BM(t){let e=new WeakMap;function n(s,r=0){let a=e.get(s),o;return a===void 0?(o=new hg(t),e.set(s,[o])):r>=a.length?(o=new hg(t),a.push(o)):o=a[r],o}function i(){e=new WeakMap}return{get:n,dispose:i}}var kM=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,VM=[new N(1,0,0),new N(-1,0,0),new N(0,1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1)],HM=[new N(0,-1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1),new N(0,-1,0),new N(0,-1,0)],ug=new zt,uo=new N,Md=new N;function GM(t,e,n){let i=new $a,s=new Qe,r=new Qe,a=new Ft,o=new kl,l=new zl,c={},u=n.maxTextureSize,d={[Qi]:bn,[bn]:Qi,[Ri]:Ri},h=new tn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Qe},radius:{value:4}},vertexShader:kM,fragmentShader:zM}),f=h.clone();f.defines.HORIZONTAL_PASS=1;let g=new Tn;g.setAttribute("position",new ln(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let _=new hn(g,h),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=eo;let m=this.type;this.render=function(b,C,v){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||b.length===0)return;this.type===om&&(De("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=eo);let w=t.getRenderTarget(),I=t.getActiveCubeFace(),A=t.getActiveMipmapLevel(),P=t.state;P.setBlending(Ii),P.buffers.depth.getReversed()===!0?P.buffers.color.setClear(0,0,0,0):P.buffers.color.setClear(1,1,1,1),P.buffers.depth.setTest(!0),P.setScissorTest(!1);let B=m!==this.type;B&&C.traverse(function(X){X.material&&(Array.isArray(X.material)?X.material.forEach(U=>U.needsUpdate=!0):X.material.needsUpdate=!0)});for(let X=0,U=b.length;X<U;X++){let G=b[X],V=G.shadow;if(V===void 0){De("WebGLShadowMap:",G,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);let $=V.getFrameExtents();s.multiply($),r.copy(V.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/$.x),s.x=r.x*$.x,V.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/$.y),s.y=r.y*$.y,V.mapSize.y=r.y));let Z=t.state.buffers.depth.getReversed();if(V.camera._reversedDepth=Z,V.map===null||B===!0){if(V.map!==null&&(V.map.depthTexture!==null&&(V.map.depthTexture.dispose(),V.map.depthTexture=null),V.map.dispose()),this.type===Zr){if(G.isPointLight){De("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}V.map=new zn(s.x,s.y,{format:Ns,type:Li,minFilter:en,magFilter:en,generateMipmaps:!1}),V.map.texture.name=G.name+".shadowMap",V.map.depthTexture=new es(s.x,s.y,fi),V.map.depthTexture.name=G.name+".shadowMapDepth",V.map.depthTexture.format=Ei,V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=cn,V.map.depthTexture.magFilter=cn}else G.isPointLight?(V.map=new Gc(s.x),V.map.depthTexture=new Ol(s.x,di)):(V.map=new zn(s.x,s.y),V.map.depthTexture=new es(s.x,s.y,di)),V.map.depthTexture.name=G.name+".shadowMap",V.map.depthTexture.format=Ei,this.type===eo?(V.map.depthTexture.compareFunction=Z?kc:Bc,V.map.depthTexture.minFilter=en,V.map.depthTexture.magFilter=en):(V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=cn,V.map.depthTexture.magFilter=cn);V.camera.updateProjectionMatrix()}let te=V.map.isWebGLCubeRenderTarget?6:1;for(let re=0;re<te;re++){if(V.map.isWebGLCubeRenderTarget)t.setRenderTarget(V.map,re),t.clear();else{re===0&&(t.setRenderTarget(V.map),t.clear());let pe=V.getViewport(re);a.set(r.x*pe.x,r.y*pe.y,r.x*pe.z,r.y*pe.w),P.viewport(a)}if(G.isPointLight){let pe=V.camera,Xe=V.matrix,rt=G.distance||pe.far;rt!==pe.far&&(pe.far=rt,pe.updateProjectionMatrix()),uo.setFromMatrixPosition(G.matrixWorld),pe.position.copy(uo),Md.copy(pe.position),Md.add(VM[re]),pe.up.copy(HM[re]),pe.lookAt(Md),pe.updateMatrixWorld(),Xe.makeTranslation(-uo.x,-uo.y,-uo.z),ug.multiplyMatrices(pe.projectionMatrix,pe.matrixWorldInverse),V._frustum.setFromProjectionMatrix(ug,pe.coordinateSystem,pe.reversedDepth)}else V.updateMatrices(G);i=V.getFrustum(),S(C,v,V.camera,G,this.type)}V.isPointLightShadow!==!0&&this.type===Zr&&E(V,v),V.needsUpdate=!1}m=this.type,p.needsUpdate=!1,t.setRenderTarget(w,I,A)};function E(b,C){let v=e.update(_);h.defines.VSM_SAMPLES!==b.blurSamples&&(h.defines.VSM_SAMPLES=b.blurSamples,f.defines.VSM_SAMPLES=b.blurSamples,h.needsUpdate=!0,f.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new zn(s.x,s.y,{format:Ns,type:Li})),h.uniforms.shadow_pass.value=b.map.depthTexture,h.uniforms.resolution.value=b.mapSize,h.uniforms.radius.value=b.radius,t.setRenderTarget(b.mapPass),t.clear(),t.renderBufferDirect(C,null,v,h,_,null),f.uniforms.shadow_pass.value=b.mapPass.texture,f.uniforms.resolution.value=b.mapSize,f.uniforms.radius.value=b.radius,t.setRenderTarget(b.map),t.clear(),t.renderBufferDirect(C,null,v,f,_,null)}function R(b,C,v,w){let I=null,A=v.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(A!==void 0)I=A;else if(I=v.isPointLight===!0?l:o,t.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){let P=I.uuid,B=C.uuid,X=c[P];X===void 0&&(X={},c[P]=X);let U=X[B];U===void 0&&(U=I.clone(),X[B]=U,C.addEventListener("dispose",M)),I=U}if(I.visible=C.visible,I.wireframe=C.wireframe,w===Zr?I.side=C.shadowSide!==null?C.shadowSide:C.side:I.side=C.shadowSide!==null?C.shadowSide:d[C.side],I.alphaMap=C.alphaMap,I.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,I.map=C.map,I.clipShadows=C.clipShadows,I.clippingPlanes=C.clippingPlanes,I.clipIntersection=C.clipIntersection,I.displacementMap=C.displacementMap,I.displacementScale=C.displacementScale,I.displacementBias=C.displacementBias,I.wireframeLinewidth=C.wireframeLinewidth,I.linewidth=C.linewidth,v.isPointLight===!0&&I.isMeshDistanceMaterial===!0){let P=t.properties.get(I);P.light=v}return I}function S(b,C,v,w,I){if(b.visible===!1)return;if(b.layers.test(C.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&I===Zr)&&(!b.frustumCulled||i.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,b.matrixWorld);let B=e.update(b),X=b.material;if(Array.isArray(X)){let U=B.groups;for(let G=0,V=U.length;G<V;G++){let $=U[G],Z=X[$.materialIndex];if(Z&&Z.visible){let te=R(b,Z,w,I);b.onBeforeShadow(t,b,C,v,B,te,$),t.renderBufferDirect(v,null,B,te,b,$),b.onAfterShadow(t,b,C,v,B,te,$)}}}else if(X.visible){let U=R(b,X,w,I);b.onBeforeShadow(t,b,C,v,B,U,null),t.renderBufferDirect(v,null,B,U,b,null),b.onAfterShadow(t,b,C,v,B,U,null)}}let P=b.children;for(let B=0,X=P.length;B<X;B++)S(P[B],C,v,w,I)}function M(b){b.target.removeEventListener("dispose",M);for(let v in c){let w=c[v],I=b.target.uuid;I in w&&(w[I].dispose(),delete w[I])}}}function WM(t,e){function n(){let L=!1,ae=new Ft,j=null,he=new Ft(0,0,0,0);return{setMask:function(ge){j!==ge&&!L&&(t.colorMask(ge,ge,ge,ge),j=ge)},setLocked:function(ge){L=ge},setClear:function(ge,Q,Ae,Se,Bt){Bt===!0&&(ge*=Se,Q*=Se,Ae*=Se),ae.set(ge,Q,Ae,Se),he.equals(ae)===!1&&(t.clearColor(ge,Q,Ae,Se),he.copy(ae))},reset:function(){L=!1,j=null,he.set(-1,0,0,0)}}}function i(){let L=!1,ae=!1,j=null,he=null,ge=null;return{setReversed:function(Q){if(ae!==Q){let Ae=e.get("EXT_clip_control");Q?Ae.clipControlEXT(Ae.LOWER_LEFT_EXT,Ae.ZERO_TO_ONE_EXT):Ae.clipControlEXT(Ae.LOWER_LEFT_EXT,Ae.NEGATIVE_ONE_TO_ONE_EXT),ae=Q;let Se=ge;ge=null,this.setClear(Se)}},getReversed:function(){return ae},setTest:function(Q){Q?ee(t.DEPTH_TEST):Ue(t.DEPTH_TEST)},setMask:function(Q){j!==Q&&!L&&(t.depthMask(Q),j=Q)},setFunc:function(Q){if(ae&&(Q=zm[Q]),he!==Q){switch(Q){case vl:t.depthFunc(t.NEVER);break;case _l:t.depthFunc(t.ALWAYS);break;case yl:t.depthFunc(t.LESS);break;case er:t.depthFunc(t.LEQUAL);break;case bl:t.depthFunc(t.EQUAL);break;case Ml:t.depthFunc(t.GEQUAL);break;case Sl:t.depthFunc(t.GREATER);break;case wl:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}he=Q}},setLocked:function(Q){L=Q},setClear:function(Q){ge!==Q&&(ge=Q,ae&&(Q=1-Q),t.clearDepth(Q))},reset:function(){L=!1,j=null,he=null,ge=null,ae=!1}}}function s(){let L=!1,ae=null,j=null,he=null,ge=null,Q=null,Ae=null,Se=null,Bt=null;return{setTest:function(bt){L||(bt?ee(t.STENCIL_TEST):Ue(t.STENCIL_TEST))},setMask:function(bt){ae!==bt&&!L&&(t.stencilMask(bt),ae=bt)},setFunc:function(bt,_i,yi){(j!==bt||he!==_i||ge!==yi)&&(t.stencilFunc(bt,_i,yi),j=bt,he=_i,ge=yi)},setOp:function(bt,_i,yi){(Q!==bt||Ae!==_i||Se!==yi)&&(t.stencilOp(bt,_i,yi),Q=bt,Ae=_i,Se=yi)},setLocked:function(bt){L=bt},setClear:function(bt){Bt!==bt&&(t.clearStencil(bt),Bt=bt)},reset:function(){L=!1,ae=null,j=null,he=null,ge=null,Q=null,Ae=null,Se=null,Bt=null}}}let r=new n,a=new i,o=new s,l=new WeakMap,c=new WeakMap,u={},d={},h={},f=new WeakMap,g=[],_=null,p=!1,m=null,E=null,R=null,S=null,M=null,b=null,C=null,v=new Ve(0,0,0),w=0,I=!1,A=null,P=null,B=null,X=null,U=null,G=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS),V=!1,$=0,Z=t.getParameter(t.VERSION);Z.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(Z)[1]),V=$>=1):Z.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),V=$>=2);let te=null,re={},pe=t.getParameter(t.SCISSOR_BOX),Xe=t.getParameter(t.VIEWPORT),rt=new Ft().fromArray(pe),Ze=new Ft().fromArray(Xe);function K(L,ae,j,he){let ge=new Uint8Array(4),Q=t.createTexture();t.bindTexture(L,Q),t.texParameteri(L,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(L,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Ae=0;Ae<j;Ae++)L===t.TEXTURE_3D||L===t.TEXTURE_2D_ARRAY?t.texImage3D(ae,0,t.RGBA,1,1,he,0,t.RGBA,t.UNSIGNED_BYTE,ge):t.texImage2D(ae+Ae,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,ge);return Q}let ne={};ne[t.TEXTURE_2D]=K(t.TEXTURE_2D,t.TEXTURE_2D,1),ne[t.TEXTURE_CUBE_MAP]=K(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),ne[t.TEXTURE_2D_ARRAY]=K(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),ne[t.TEXTURE_3D]=K(t.TEXTURE_3D,t.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ee(t.DEPTH_TEST),a.setFunc(er),Lt(!1),Rt(Wu),ee(t.CULL_FACE),at(Ii);function ee(L){u[L]!==!0&&(t.enable(L),u[L]=!0)}function Ue(L){u[L]!==!1&&(t.disable(L),u[L]=!1)}function ze(L,ae){return h[L]!==ae?(t.bindFramebuffer(L,ae),h[L]=ae,L===t.DRAW_FRAMEBUFFER&&(h[t.FRAMEBUFFER]=ae),L===t.FRAMEBUFFER&&(h[t.DRAW_FRAMEBUFFER]=ae),!0):!1}function Fe(L,ae){let j=g,he=!1;if(L){j=f.get(ae),j===void 0&&(j=[],f.set(ae,j));let ge=L.textures;if(j.length!==ge.length||j[0]!==t.COLOR_ATTACHMENT0){for(let Q=0,Ae=ge.length;Q<Ae;Q++)j[Q]=t.COLOR_ATTACHMENT0+Q;j.length=ge.length,he=!0}}else j[0]!==t.BACK&&(j[0]=t.BACK,he=!0);he&&t.drawBuffers(j)}function Ct(L){return _!==L?(t.useProgram(L),_=L,!0):!1}let Ye={[ws]:t.FUNC_ADD,[cm]:t.FUNC_SUBTRACT,[hm]:t.FUNC_REVERSE_SUBTRACT};Ye[um]=t.MIN,Ye[dm]=t.MAX;let pt={[fm]:t.ZERO,[pm]:t.ONE,[mm]:t.SRC_COLOR,[gl]:t.SRC_ALPHA,[bm]:t.SRC_ALPHA_SATURATE,[_m]:t.DST_COLOR,[xm]:t.DST_ALPHA,[gm]:t.ONE_MINUS_SRC_COLOR,[xl]:t.ONE_MINUS_SRC_ALPHA,[ym]:t.ONE_MINUS_DST_COLOR,[vm]:t.ONE_MINUS_DST_ALPHA,[Mm]:t.CONSTANT_COLOR,[Sm]:t.ONE_MINUS_CONSTANT_COLOR,[wm]:t.CONSTANT_ALPHA,[Em]:t.ONE_MINUS_CONSTANT_ALPHA};function at(L,ae,j,he,ge,Q,Ae,Se,Bt,bt){if(L===Ii){p===!0&&(Ue(t.BLEND),p=!1);return}if(p===!1&&(ee(t.BLEND),p=!0),L!==lm){if(L!==m||bt!==I){if((E!==ws||M!==ws)&&(t.blendEquation(t.FUNC_ADD),E=ws,M=ws),bt)switch(L){case Jn:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Xu:t.blendFunc(t.ONE,t.ONE);break;case $u:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case qu:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:Be("WebGLState: Invalid blending: ",L);break}else switch(L){case Jn:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Xu:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case $u:Be("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case qu:Be("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Be("WebGLState: Invalid blending: ",L);break}R=null,S=null,b=null,C=null,v.set(0,0,0),w=0,m=L,I=bt}return}ge=ge||ae,Q=Q||j,Ae=Ae||he,(ae!==E||ge!==M)&&(t.blendEquationSeparate(Ye[ae],Ye[ge]),E=ae,M=ge),(j!==R||he!==S||Q!==b||Ae!==C)&&(t.blendFuncSeparate(pt[j],pt[he],pt[Q],pt[Ae]),R=j,S=he,b=Q,C=Ae),(Se.equals(v)===!1||Bt!==w)&&(t.blendColor(Se.r,Se.g,Se.b,Bt),v.copy(Se),w=Bt),m=L,I=!1}function Je(L,ae){L.side===Ri?Ue(t.CULL_FACE):ee(t.CULL_FACE);let j=L.side===bn;ae&&(j=!j),Lt(j),L.blending===Jn&&L.transparent===!1?at(Ii):at(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),a.setFunc(L.depthFunc),a.setTest(L.depthTest),a.setMask(L.depthWrite),r.setMask(L.colorWrite);let he=L.stencilWrite;o.setTest(he),he&&(o.setMask(L.stencilWriteMask),o.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),o.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),Gt(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?ee(t.SAMPLE_ALPHA_TO_COVERAGE):Ue(t.SAMPLE_ALPHA_TO_COVERAGE)}function Lt(L){A!==L&&(L?t.frontFace(t.CW):t.frontFace(t.CCW),A=L)}function Rt(L){L!==rm?(ee(t.CULL_FACE),L!==P&&(L===Wu?t.cullFace(t.BACK):L===am?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):Ue(t.CULL_FACE),P=L}function Nt(L){L!==B&&(V&&t.lineWidth(L),B=L)}function Gt(L,ae,j){L?(ee(t.POLYGON_OFFSET_FILL),(X!==ae||U!==j)&&(X=ae,U=j,a.getReversed()&&(ae=-ae),t.polygonOffset(ae,j))):Ue(t.POLYGON_OFFSET_FILL)}function It(L){L?ee(t.SCISSOR_TEST):Ue(t.SCISSOR_TEST)}function Ot(L){L===void 0&&(L=t.TEXTURE0+G-1),te!==L&&(t.activeTexture(L),te=L)}function F(L,ae,j){j===void 0&&(te===null?j=t.TEXTURE0+G-1:j=te);let he=re[j];he===void 0&&(he={type:void 0,texture:void 0},re[j]=he),(he.type!==L||he.texture!==ae)&&(te!==j&&(t.activeTexture(j),te=j),t.bindTexture(L,ae||ne[L]),he.type=L,he.texture=ae)}function wn(){let L=re[te];L!==void 0&&L.type!==void 0&&(t.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function gt(){try{t.compressedTexImage2D(...arguments)}catch(L){Be("WebGLState:",L)}}function T(){try{t.compressedTexImage3D(...arguments)}catch(L){Be("WebGLState:",L)}}function x(){try{t.texSubImage2D(...arguments)}catch(L){Be("WebGLState:",L)}}function O(){try{t.texSubImage3D(...arguments)}catch(L){Be("WebGLState:",L)}}function H(){try{t.compressedTexSubImage2D(...arguments)}catch(L){Be("WebGLState:",L)}}function q(){try{t.compressedTexSubImage3D(...arguments)}catch(L){Be("WebGLState:",L)}}function ie(){try{t.texStorage2D(...arguments)}catch(L){Be("WebGLState:",L)}}function oe(){try{t.texStorage3D(...arguments)}catch(L){Be("WebGLState:",L)}}function Y(){try{t.texImage2D(...arguments)}catch(L){Be("WebGLState:",L)}}function J(){try{t.texImage3D(...arguments)}catch(L){Be("WebGLState:",L)}}function le(L){return d[L]!==void 0?d[L]:t.getParameter(L)}function Te(L,ae){d[L]!==ae&&(t.pixelStorei(L,ae),d[L]=ae)}function ue(L){rt.equals(L)===!1&&(t.scissor(L.x,L.y,L.z,L.w),rt.copy(L))}function ce(L){Ze.equals(L)===!1&&(t.viewport(L.x,L.y,L.z,L.w),Ze.copy(L))}function Ne(L,ae){let j=c.get(ae);j===void 0&&(j=new WeakMap,c.set(ae,j));let he=j.get(L);he===void 0&&(he=t.getUniformBlockIndex(ae,L.name),j.set(L,he))}function Oe(L,ae){let he=c.get(ae).get(L);l.get(ae)!==he&&(t.uniformBlockBinding(ae,he,L.__bindingPointIndex),l.set(ae,he))}function Ge(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),a.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),u={},d={},te=null,re={},h={},f=new WeakMap,g=[],_=null,p=!1,m=null,E=null,R=null,S=null,M=null,b=null,C=null,v=new Ve(0,0,0),w=0,I=!1,A=null,P=null,B=null,X=null,U=null,rt.set(0,0,t.canvas.width,t.canvas.height),Ze.set(0,0,t.canvas.width,t.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:ee,disable:Ue,bindFramebuffer:ze,drawBuffers:Fe,useProgram:Ct,setBlending:at,setMaterial:Je,setFlipSided:Lt,setCullFace:Rt,setLineWidth:Nt,setPolygonOffset:Gt,setScissorTest:It,activeTexture:Ot,bindTexture:F,unbindTexture:wn,compressedTexImage2D:gt,compressedTexImage3D:T,texImage2D:Y,texImage3D:J,pixelStorei:Te,getParameter:le,updateUBOMapping:Ne,uniformBlockBinding:Oe,texStorage2D:ie,texStorage3D:oe,texSubImage2D:x,texSubImage3D:O,compressedTexSubImage2D:H,compressedTexSubImage3D:q,scissor:ue,viewport:ce,reset:Ge}}function XM(t,e,n,i,s,r,a){let o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Qe,u=new WeakMap,d=new Set,h,f=new WeakMap,g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(T,x){return g?new OffscreenCanvas(T,x):Wr("canvas")}function p(T,x,O){let H=1,q=gt(T);if((q.width>O||q.height>O)&&(H=O/Math.max(q.width,q.height)),H<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){let ie=Math.floor(H*q.width),oe=Math.floor(H*q.height);h===void 0&&(h=_(ie,oe));let Y=x?_(ie,oe):h;return Y.width=ie,Y.height=oe,Y.getContext("2d").drawImage(T,0,0,ie,oe),De("WebGLRenderer: Texture has been resized from ("+q.width+"x"+q.height+") to ("+ie+"x"+oe+")."),Y}else return"data"in T&&De("WebGLRenderer: Image in DataTexture is too big ("+q.width+"x"+q.height+")."),T;return T}function m(T){return T.generateMipmaps}function E(T){t.generateMipmap(T)}function R(T){return T.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?t.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function S(T,x,O,H,q,ie=!1){if(T!==null){if(t[T]!==void 0)return t[T];De("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let oe;H&&(oe=e.get("EXT_texture_norm16"),oe||De("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Y=x;if(x===t.RED&&(O===t.FLOAT&&(Y=t.R32F),O===t.HALF_FLOAT&&(Y=t.R16F),O===t.UNSIGNED_BYTE&&(Y=t.R8),O===t.UNSIGNED_SHORT&&oe&&(Y=oe.R16_EXT),O===t.SHORT&&oe&&(Y=oe.R16_SNORM_EXT)),x===t.RED_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.R8UI),O===t.UNSIGNED_SHORT&&(Y=t.R16UI),O===t.UNSIGNED_INT&&(Y=t.R32UI),O===t.BYTE&&(Y=t.R8I),O===t.SHORT&&(Y=t.R16I),O===t.INT&&(Y=t.R32I)),x===t.RG&&(O===t.FLOAT&&(Y=t.RG32F),O===t.HALF_FLOAT&&(Y=t.RG16F),O===t.UNSIGNED_BYTE&&(Y=t.RG8),O===t.UNSIGNED_SHORT&&oe&&(Y=oe.RG16_EXT),O===t.SHORT&&oe&&(Y=oe.RG16_SNORM_EXT)),x===t.RG_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.RG8UI),O===t.UNSIGNED_SHORT&&(Y=t.RG16UI),O===t.UNSIGNED_INT&&(Y=t.RG32UI),O===t.BYTE&&(Y=t.RG8I),O===t.SHORT&&(Y=t.RG16I),O===t.INT&&(Y=t.RG32I)),x===t.RGB_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.RGB8UI),O===t.UNSIGNED_SHORT&&(Y=t.RGB16UI),O===t.UNSIGNED_INT&&(Y=t.RGB32UI),O===t.BYTE&&(Y=t.RGB8I),O===t.SHORT&&(Y=t.RGB16I),O===t.INT&&(Y=t.RGB32I)),x===t.RGBA_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.RGBA8UI),O===t.UNSIGNED_SHORT&&(Y=t.RGBA16UI),O===t.UNSIGNED_INT&&(Y=t.RGBA32UI),O===t.BYTE&&(Y=t.RGBA8I),O===t.SHORT&&(Y=t.RGBA16I),O===t.INT&&(Y=t.RGBA32I)),x===t.RGB&&(O===t.UNSIGNED_SHORT&&oe&&(Y=oe.RGB16_EXT),O===t.SHORT&&oe&&(Y=oe.RGB16_SNORM_EXT),O===t.UNSIGNED_INT_5_9_9_9_REV&&(Y=t.RGB9_E5),O===t.UNSIGNED_INT_10F_11F_11F_REV&&(Y=t.R11F_G11F_B10F)),x===t.RGBA){let J=ie?Oa:je.getTransfer(q);O===t.FLOAT&&(Y=t.RGBA32F),O===t.HALF_FLOAT&&(Y=t.RGBA16F),O===t.UNSIGNED_BYTE&&(Y=J===mt?t.SRGB8_ALPHA8:t.RGBA8),O===t.UNSIGNED_SHORT&&oe&&(Y=oe.RGBA16_EXT),O===t.SHORT&&oe&&(Y=oe.RGBA16_SNORM_EXT),O===t.UNSIGNED_SHORT_4_4_4_4&&(Y=t.RGBA4),O===t.UNSIGNED_SHORT_5_5_5_1&&(Y=t.RGB5_A1)}return(Y===t.R16F||Y===t.R32F||Y===t.RG16F||Y===t.RG32F||Y===t.RGBA16F||Y===t.RGBA32F)&&e.get("EXT_color_buffer_float"),Y}function M(T,x){let O;return T?x===null||x===di||x===Jr?O=t.DEPTH24_STENCIL8:x===fi?O=t.DEPTH32F_STENCIL8:x===jr&&(O=t.DEPTH24_STENCIL8,De("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===di||x===Jr?O=t.DEPTH_COMPONENT24:x===fi?O=t.DEPTH_COMPONENT32F:x===jr&&(O=t.DEPTH_COMPONENT16),O}function b(T,x){return m(T)===!0||T.isFramebufferTexture&&T.minFilter!==cn&&T.minFilter!==en?Math.log2(Math.max(x.width,x.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?x.mipmaps.length:1}function C(T){let x=T.target;x.removeEventListener("dispose",C),w(x),x.isVideoTexture&&u.delete(x),x.isHTMLTexture&&d.delete(x)}function v(T){let x=T.target;x.removeEventListener("dispose",v),A(x)}function w(T){let x=i.get(T);if(x.__webglInit===void 0)return;let O=T.source,H=f.get(O);if(H){let q=H[x.__cacheKey];q.usedTimes--,q.usedTimes===0&&I(T),Object.keys(H).length===0&&f.delete(O)}i.remove(T)}function I(T){let x=i.get(T);t.deleteTexture(x.__webglTexture);let O=T.source,H=f.get(O);delete H[x.__cacheKey],a.memory.textures--}function A(T){let x=i.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),i.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let H=0;H<6;H++){if(Array.isArray(x.__webglFramebuffer[H]))for(let q=0;q<x.__webglFramebuffer[H].length;q++)t.deleteFramebuffer(x.__webglFramebuffer[H][q]);else t.deleteFramebuffer(x.__webglFramebuffer[H]);x.__webglDepthbuffer&&t.deleteRenderbuffer(x.__webglDepthbuffer[H])}else{if(Array.isArray(x.__webglFramebuffer))for(let H=0;H<x.__webglFramebuffer.length;H++)t.deleteFramebuffer(x.__webglFramebuffer[H]);else t.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&t.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&t.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let H=0;H<x.__webglColorRenderbuffer.length;H++)x.__webglColorRenderbuffer[H]&&t.deleteRenderbuffer(x.__webglColorRenderbuffer[H]);x.__webglDepthRenderbuffer&&t.deleteRenderbuffer(x.__webglDepthRenderbuffer)}let O=T.textures;for(let H=0,q=O.length;H<q;H++){let ie=i.get(O[H]);ie.__webglTexture&&(t.deleteTexture(ie.__webglTexture),a.memory.textures--),i.remove(O[H])}i.remove(T)}let P=0;function B(){P=0}function X(){return P}function U(T){P=T}function G(){let T=P;return T>=s.maxTextures&&De("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+s.maxTextures),P+=1,T}function V(T){let x=[];return x.push(T.wrapS),x.push(T.wrapT),x.push(T.wrapR||0),x.push(T.magFilter),x.push(T.minFilter),x.push(T.anisotropy),x.push(T.internalFormat),x.push(T.format),x.push(T.type),x.push(T.generateMipmaps),x.push(T.premultiplyAlpha),x.push(T.flipY),x.push(T.unpackAlignment),x.push(T.colorSpace),x.join()}function $(T,x){let O=i.get(T);if(T.isVideoTexture&&F(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&O.__version!==T.version){let H=T.image;if(H===null)De("WebGLRenderer: Texture marked for update but no image data found.");else if(H.complete===!1)De("WebGLRenderer: Texture marked for update but image is incomplete");else{Ue(O,T,x);return}}else T.isExternalTexture&&(O.__webglTexture=T.sourceTexture?T.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,O.__webglTexture,t.TEXTURE0+x)}function Z(T,x){let O=i.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&O.__version!==T.version){Ue(O,T,x);return}else T.isExternalTexture&&(O.__webglTexture=T.sourceTexture?T.sourceTexture:null);n.bindTexture(t.TEXTURE_2D_ARRAY,O.__webglTexture,t.TEXTURE0+x)}function te(T,x){let O=i.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&O.__version!==T.version){Ue(O,T,x);return}n.bindTexture(t.TEXTURE_3D,O.__webglTexture,t.TEXTURE0+x)}function re(T,x){let O=i.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&O.__version!==T.version){ze(O,T,x);return}n.bindTexture(t.TEXTURE_CUBE_MAP,O.__webglTexture,t.TEXTURE0+x)}let pe={[El]:t.REPEAT,[wi]:t.CLAMP_TO_EDGE,[Al]:t.MIRRORED_REPEAT},Xe={[cn]:t.NEAREST,[Cm]:t.NEAREST_MIPMAP_NEAREST,[no]:t.NEAREST_MIPMAP_LINEAR,[en]:t.LINEAR,[tc]:t.LINEAR_MIPMAP_NEAREST,[Pi]:t.LINEAR_MIPMAP_LINEAR},rt={[Pm]:t.NEVER,[Um]:t.ALWAYS,[Lm]:t.LESS,[Bc]:t.LEQUAL,[Nm]:t.EQUAL,[kc]:t.GEQUAL,[Fm]:t.GREATER,[Dm]:t.NOTEQUAL};function Ze(T,x){if(x.type===fi&&e.has("OES_texture_float_linear")===!1&&(x.magFilter===en||x.magFilter===tc||x.magFilter===no||x.magFilter===Pi||x.minFilter===en||x.minFilter===tc||x.minFilter===no||x.minFilter===Pi)&&De("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(T,t.TEXTURE_WRAP_S,pe[x.wrapS]),t.texParameteri(T,t.TEXTURE_WRAP_T,pe[x.wrapT]),(T===t.TEXTURE_3D||T===t.TEXTURE_2D_ARRAY)&&t.texParameteri(T,t.TEXTURE_WRAP_R,pe[x.wrapR]),t.texParameteri(T,t.TEXTURE_MAG_FILTER,Xe[x.magFilter]),t.texParameteri(T,t.TEXTURE_MIN_FILTER,Xe[x.minFilter]),x.compareFunction&&(t.texParameteri(T,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(T,t.TEXTURE_COMPARE_FUNC,rt[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===cn||x.minFilter!==no&&x.minFilter!==Pi||x.type===fi&&e.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||i.get(x).__currentAnisotropy){let O=e.get("EXT_texture_filter_anisotropic");t.texParameterf(T,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,s.getMaxAnisotropy())),i.get(x).__currentAnisotropy=x.anisotropy}}}function K(T,x){let O=!1;T.__webglInit===void 0&&(T.__webglInit=!0,x.addEventListener("dispose",C));let H=x.source,q=f.get(H);q===void 0&&(q={},f.set(H,q));let ie=V(x);if(ie!==T.__cacheKey){q[ie]===void 0&&(q[ie]={texture:t.createTexture(),usedTimes:0},a.memory.textures++,O=!0),q[ie].usedTimes++;let oe=q[T.__cacheKey];oe!==void 0&&(q[T.__cacheKey].usedTimes--,oe.usedTimes===0&&I(x)),T.__cacheKey=ie,T.__webglTexture=q[ie].texture}return O}function ne(T,x,O){return Math.floor(Math.floor(T/O)/x)}function ee(T,x,O,H){let ie=T.updateRanges;if(ie.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,x.width,x.height,O,H,x.data);else{ie.sort((Te,ue)=>Te.start-ue.start);let oe=0;for(let Te=1;Te<ie.length;Te++){let ue=ie[oe],ce=ie[Te],Ne=ue.start+ue.count,Oe=ne(ce.start,x.width,4),Ge=ne(ue.start,x.width,4);ce.start<=Ne+1&&Oe===Ge&&ne(ce.start+ce.count-1,x.width,4)===Oe?ue.count=Math.max(ue.count,ce.start+ce.count-ue.start):(++oe,ie[oe]=ce)}ie.length=oe+1;let Y=n.getParameter(t.UNPACK_ROW_LENGTH),J=n.getParameter(t.UNPACK_SKIP_PIXELS),le=n.getParameter(t.UNPACK_SKIP_ROWS);n.pixelStorei(t.UNPACK_ROW_LENGTH,x.width);for(let Te=0,ue=ie.length;Te<ue;Te++){let ce=ie[Te],Ne=Math.floor(ce.start/4),Oe=Math.ceil(ce.count/4),Ge=Ne%x.width,L=Math.floor(Ne/x.width),ae=Oe,j=1;n.pixelStorei(t.UNPACK_SKIP_PIXELS,Ge),n.pixelStorei(t.UNPACK_SKIP_ROWS,L),n.texSubImage2D(t.TEXTURE_2D,0,Ge,L,ae,j,O,H,x.data)}T.clearUpdateRanges(),n.pixelStorei(t.UNPACK_ROW_LENGTH,Y),n.pixelStorei(t.UNPACK_SKIP_PIXELS,J),n.pixelStorei(t.UNPACK_SKIP_ROWS,le)}}function Ue(T,x,O){let H=t.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(H=t.TEXTURE_2D_ARRAY),x.isData3DTexture&&(H=t.TEXTURE_3D);let q=K(T,x),ie=x.source;n.bindTexture(H,T.__webglTexture,t.TEXTURE0+O);let oe=i.get(ie);if(ie.version!==oe.__version||q===!0){if(n.activeTexture(t.TEXTURE0+O),(typeof ImageBitmap<"u"&&x.image instanceof ImageBitmap)===!1){let j=je.getPrimaries(je.workingColorSpace),he=x.colorSpace===pi?null:je.getPrimaries(x.colorSpace),ge=x.colorSpace===pi||j===he?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,ge)}n.pixelStorei(t.UNPACK_ALIGNMENT,x.unpackAlignment);let J=p(x.image,!1,s.maxTextureSize);J=wn(x,J);let le=r.convert(x.format,x.colorSpace),Te=r.convert(x.type),ue=S(x.internalFormat,le,Te,x.normalized,x.colorSpace,x.isVideoTexture);Ze(H,x);let ce,Ne=x.mipmaps,Oe=x.isVideoTexture!==!0,Ge=oe.__version===void 0||q===!0,L=ie.dataReady,ae=b(x,J);if(x.isDepthTexture)ue=M(x.format===Ls,x.type),Ge&&(Oe?n.texStorage2D(t.TEXTURE_2D,1,ue,J.width,J.height):n.texImage2D(t.TEXTURE_2D,0,ue,J.width,J.height,0,le,Te,null));else if(x.isDataTexture)if(Ne.length>0){Oe&&Ge&&n.texStorage2D(t.TEXTURE_2D,ae,ue,Ne[0].width,Ne[0].height);for(let j=0,he=Ne.length;j<he;j++)ce=Ne[j],Oe?L&&n.texSubImage2D(t.TEXTURE_2D,j,0,0,ce.width,ce.height,le,Te,ce.data):n.texImage2D(t.TEXTURE_2D,j,ue,ce.width,ce.height,0,le,Te,ce.data);x.generateMipmaps=!1}else Oe?(Ge&&n.texStorage2D(t.TEXTURE_2D,ae,ue,J.width,J.height),L&&ee(x,J,le,Te)):n.texImage2D(t.TEXTURE_2D,0,ue,J.width,J.height,0,le,Te,J.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){Oe&&Ge&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ae,ue,Ne[0].width,Ne[0].height,J.depth);for(let j=0,he=Ne.length;j<he;j++)if(ce=Ne[j],x.format!==Qn)if(le!==null)if(Oe){if(L)if(x.layerUpdates.size>0){let ge=gd(ce.width,ce.height,x.format,x.type);for(let Q of x.layerUpdates){let Ae=ce.data.subarray(Q*ge/ce.data.BYTES_PER_ELEMENT,(Q+1)*ge/ce.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,j,0,0,Q,ce.width,ce.height,1,le,Ae)}x.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,j,0,0,0,ce.width,ce.height,J.depth,le,ce.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,j,ue,ce.width,ce.height,J.depth,0,ce.data,0,0);else De("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Oe?L&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,j,0,0,0,ce.width,ce.height,J.depth,le,Te,ce.data):n.texImage3D(t.TEXTURE_2D_ARRAY,j,ue,ce.width,ce.height,J.depth,0,le,Te,ce.data)}else{Oe&&Ge&&n.texStorage2D(t.TEXTURE_2D,ae,ue,Ne[0].width,Ne[0].height);for(let j=0,he=Ne.length;j<he;j++)ce=Ne[j],x.format!==Qn?le!==null?Oe?L&&n.compressedTexSubImage2D(t.TEXTURE_2D,j,0,0,ce.width,ce.height,le,ce.data):n.compressedTexImage2D(t.TEXTURE_2D,j,ue,ce.width,ce.height,0,ce.data):De("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Oe?L&&n.texSubImage2D(t.TEXTURE_2D,j,0,0,ce.width,ce.height,le,Te,ce.data):n.texImage2D(t.TEXTURE_2D,j,ue,ce.width,ce.height,0,le,Te,ce.data)}else if(x.isDataArrayTexture)if(Oe){if(Ge&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ae,ue,J.width,J.height,J.depth),L)if(x.layerUpdates.size>0){let j=gd(J.width,J.height,x.format,x.type);for(let he of x.layerUpdates){let ge=J.data.subarray(he*j/J.data.BYTES_PER_ELEMENT,(he+1)*j/J.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,he,J.width,J.height,1,le,Te,ge)}x.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,le,Te,J.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,ue,J.width,J.height,J.depth,0,le,Te,J.data);else if(x.isData3DTexture)Oe?(Ge&&n.texStorage3D(t.TEXTURE_3D,ae,ue,J.width,J.height,J.depth),L&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,le,Te,J.data)):n.texImage3D(t.TEXTURE_3D,0,ue,J.width,J.height,J.depth,0,le,Te,J.data);else if(x.isFramebufferTexture){if(Ge)if(Oe)n.texStorage2D(t.TEXTURE_2D,ae,ue,J.width,J.height);else{let j=J.width,he=J.height;for(let ge=0;ge<ae;ge++)n.texImage2D(t.TEXTURE_2D,ge,ue,j,he,0,le,Te,null),j>>=1,he>>=1}}else if(x.isHTMLTexture){if("texElementImage2D"in t){let j=t.canvas;if(j.hasAttribute("layoutsubtree")||j.setAttribute("layoutsubtree","true"),J.parentNode!==j){j.appendChild(J),d.add(x),j.onpaint=he=>{let ge=he.changedElements;for(let Q of d)ge.includes(Q.image)&&(Q.needsUpdate=!0)},j.requestPaint();return}if(t.texElementImage2D.length===3)t.texElementImage2D(t.TEXTURE_2D,t.RGBA8,J);else{let ge=t.RGBA,Q=t.RGBA,Ae=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,0,ge,Q,Ae,J)}t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(Ne.length>0){if(Oe&&Ge){let j=gt(Ne[0]);n.texStorage2D(t.TEXTURE_2D,ae,ue,j.width,j.height)}for(let j=0,he=Ne.length;j<he;j++)ce=Ne[j],Oe?L&&n.texSubImage2D(t.TEXTURE_2D,j,0,0,le,Te,ce):n.texImage2D(t.TEXTURE_2D,j,ue,le,Te,ce);x.generateMipmaps=!1}else if(Oe){if(Ge){let j=gt(J);n.texStorage2D(t.TEXTURE_2D,ae,ue,j.width,j.height)}L&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,le,Te,J)}else n.texImage2D(t.TEXTURE_2D,0,ue,le,Te,J);m(x)&&E(H),oe.__version=ie.version,x.onUpdate&&x.onUpdate(x)}T.__version=x.version}function ze(T,x,O){if(x.image.length!==6)return;let H=K(T,x),q=x.source;n.bindTexture(t.TEXTURE_CUBE_MAP,T.__webglTexture,t.TEXTURE0+O);let ie=i.get(q);if(q.version!==ie.__version||H===!0){n.activeTexture(t.TEXTURE0+O);let oe=je.getPrimaries(je.workingColorSpace),Y=x.colorSpace===pi?null:je.getPrimaries(x.colorSpace),J=x.colorSpace===pi||oe===Y?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(t.UNPACK_ALIGNMENT,x.unpackAlignment),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,J);let le=x.isCompressedTexture||x.image[0].isCompressedTexture,Te=x.image[0]&&x.image[0].isDataTexture,ue=[];for(let Q=0;Q<6;Q++)!le&&!Te?ue[Q]=p(x.image[Q],!0,s.maxCubemapSize):ue[Q]=Te?x.image[Q].image:x.image[Q],ue[Q]=wn(x,ue[Q]);let ce=ue[0],Ne=r.convert(x.format,x.colorSpace),Oe=r.convert(x.type),Ge=S(x.internalFormat,Ne,Oe,x.normalized,x.colorSpace),L=x.isVideoTexture!==!0,ae=ie.__version===void 0||H===!0,j=q.dataReady,he=b(x,ce);Ze(t.TEXTURE_CUBE_MAP,x);let ge;if(le){L&&ae&&n.texStorage2D(t.TEXTURE_CUBE_MAP,he,Ge,ce.width,ce.height);for(let Q=0;Q<6;Q++){ge=ue[Q].mipmaps;for(let Ae=0;Ae<ge.length;Ae++){let Se=ge[Ae];x.format!==Qn?Ne!==null?L?j&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Ae,0,0,Se.width,Se.height,Ne,Se.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Ae,Ge,Se.width,Se.height,0,Se.data):De("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?j&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Ae,0,0,Se.width,Se.height,Ne,Oe,Se.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Ae,Ge,Se.width,Se.height,0,Ne,Oe,Se.data)}}}else{if(ge=x.mipmaps,L&&ae){ge.length>0&&he++;let Q=gt(ue[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,he,Ge,Q.width,Q.height)}for(let Q=0;Q<6;Q++)if(Te){L?j&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,ue[Q].width,ue[Q].height,Ne,Oe,ue[Q].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ge,ue[Q].width,ue[Q].height,0,Ne,Oe,ue[Q].data);for(let Ae=0;Ae<ge.length;Ae++){let Bt=ge[Ae].image[Q].image;L?j&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Ae+1,0,0,Bt.width,Bt.height,Ne,Oe,Bt.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Ae+1,Ge,Bt.width,Bt.height,0,Ne,Oe,Bt.data)}}else{L?j&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,Ne,Oe,ue[Q]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ge,Ne,Oe,ue[Q]);for(let Ae=0;Ae<ge.length;Ae++){let Se=ge[Ae];L?j&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Ae+1,0,0,Ne,Oe,Se.image[Q]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,Ae+1,Ge,Ne,Oe,Se.image[Q])}}}m(x)&&E(t.TEXTURE_CUBE_MAP),ie.__version=q.version,x.onUpdate&&x.onUpdate(x)}T.__version=x.version}function Fe(T,x,O,H,q,ie){let oe=r.convert(O.format,O.colorSpace),Y=r.convert(O.type),J=S(O.internalFormat,oe,Y,O.normalized,O.colorSpace),le=i.get(x),Te=i.get(O);if(Te.__renderTarget=x,!le.__hasExternalTextures){let ue=Math.max(1,x.width>>ie),ce=Math.max(1,x.height>>ie);q===t.TEXTURE_3D||q===t.TEXTURE_2D_ARRAY?n.texImage3D(q,ie,J,ue,ce,x.depth,0,oe,Y,null):n.texImage2D(q,ie,J,ue,ce,0,oe,Y,null)}n.bindFramebuffer(t.FRAMEBUFFER,T),Ot(x)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,H,q,Te.__webglTexture,0,It(x)):(q===t.TEXTURE_2D||q>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&q<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,H,q,Te.__webglTexture,ie),n.bindFramebuffer(t.FRAMEBUFFER,null)}function Ct(T,x,O){if(t.bindRenderbuffer(t.RENDERBUFFER,T),x.depthBuffer){let H=x.depthTexture,q=H&&H.isDepthTexture?H.type:null,ie=M(x.stencilBuffer,q),oe=x.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;Ot(x)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,It(x),ie,x.width,x.height):O?t.renderbufferStorageMultisample(t.RENDERBUFFER,It(x),ie,x.width,x.height):t.renderbufferStorage(t.RENDERBUFFER,ie,x.width,x.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,oe,t.RENDERBUFFER,T)}else{let H=x.textures;for(let q=0;q<H.length;q++){let ie=H[q],oe=r.convert(ie.format,ie.colorSpace),Y=r.convert(ie.type),J=S(ie.internalFormat,oe,Y,ie.normalized,ie.colorSpace);Ot(x)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,It(x),J,x.width,x.height):O?t.renderbufferStorageMultisample(t.RENDERBUFFER,It(x),J,x.width,x.height):t.renderbufferStorage(t.RENDERBUFFER,J,x.width,x.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Ye(T,x,O){let H=x.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(t.FRAMEBUFFER,T),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let q=i.get(x.depthTexture);if(q.__renderTarget=x,(!q.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),H){if(q.__webglInit===void 0&&(q.__webglInit=!0,x.depthTexture.addEventListener("dispose",C)),q.__webglTexture===void 0){q.__webglTexture=t.createTexture(),n.bindTexture(t.TEXTURE_CUBE_MAP,q.__webglTexture),Ze(t.TEXTURE_CUBE_MAP,x.depthTexture);let le=r.convert(x.depthTexture.format),Te=r.convert(x.depthTexture.type),ue;x.depthTexture.format===Ei?ue=t.DEPTH_COMPONENT24:x.depthTexture.format===Ls&&(ue=t.DEPTH24_STENCIL8);for(let ce=0;ce<6;ce++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,ue,x.width,x.height,0,le,Te,null)}}else $(x.depthTexture,0);let ie=q.__webglTexture,oe=It(x),Y=H?t.TEXTURE_CUBE_MAP_POSITIVE_X+O:t.TEXTURE_2D,J=x.depthTexture.format===Ls?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(x.depthTexture.format===Ei)Ot(x)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,J,Y,ie,0,oe):t.framebufferTexture2D(t.FRAMEBUFFER,J,Y,ie,0);else if(x.depthTexture.format===Ls)Ot(x)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,J,Y,ie,0,oe):t.framebufferTexture2D(t.FRAMEBUFFER,J,Y,ie,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function pt(T){let x=i.get(T),O=T.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==T.depthTexture){let H=T.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),H){let q=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,H.removeEventListener("dispose",q)};H.addEventListener("dispose",q),x.__depthDisposeCallback=q}x.__boundDepthTexture=H}if(T.depthTexture&&!x.__autoAllocateDepthBuffer)if(O)for(let H=0;H<6;H++)Ye(x.__webglFramebuffer[H],T,H);else{let H=T.texture.mipmaps;H&&H.length>0?Ye(x.__webglFramebuffer[0],T,0):Ye(x.__webglFramebuffer,T,0)}else if(O){x.__webglDepthbuffer=[];for(let H=0;H<6;H++)if(n.bindFramebuffer(t.FRAMEBUFFER,x.__webglFramebuffer[H]),x.__webglDepthbuffer[H]===void 0)x.__webglDepthbuffer[H]=t.createRenderbuffer(),Ct(x.__webglDepthbuffer[H],T,!1);else{let q=T.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ie=x.__webglDepthbuffer[H];t.bindRenderbuffer(t.RENDERBUFFER,ie),t.framebufferRenderbuffer(t.FRAMEBUFFER,q,t.RENDERBUFFER,ie)}}else{let H=T.texture.mipmaps;if(H&&H.length>0?n.bindFramebuffer(t.FRAMEBUFFER,x.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=t.createRenderbuffer(),Ct(x.__webglDepthbuffer,T,!1);else{let q=T.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ie=x.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,ie),t.framebufferRenderbuffer(t.FRAMEBUFFER,q,t.RENDERBUFFER,ie)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function at(T,x,O){let H=i.get(T);x!==void 0&&Fe(H.__webglFramebuffer,T,T.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),O!==void 0&&pt(T)}function Je(T){let x=T.texture,O=i.get(T),H=i.get(x);T.addEventListener("dispose",v);let q=T.textures,ie=T.isWebGLCubeRenderTarget===!0,oe=q.length>1;if(oe||(H.__webglTexture===void 0&&(H.__webglTexture=t.createTexture()),H.__version=x.version,a.memory.textures++),ie){O.__webglFramebuffer=[];for(let Y=0;Y<6;Y++)if(x.mipmaps&&x.mipmaps.length>0){O.__webglFramebuffer[Y]=[];for(let J=0;J<x.mipmaps.length;J++)O.__webglFramebuffer[Y][J]=t.createFramebuffer()}else O.__webglFramebuffer[Y]=t.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){O.__webglFramebuffer=[];for(let Y=0;Y<x.mipmaps.length;Y++)O.__webglFramebuffer[Y]=t.createFramebuffer()}else O.__webglFramebuffer=t.createFramebuffer();if(oe)for(let Y=0,J=q.length;Y<J;Y++){let le=i.get(q[Y]);le.__webglTexture===void 0&&(le.__webglTexture=t.createTexture(),a.memory.textures++)}if(T.samples>0&&Ot(T)===!1){O.__webglMultisampledFramebuffer=t.createFramebuffer(),O.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let Y=0;Y<q.length;Y++){let J=q[Y];O.__webglColorRenderbuffer[Y]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,O.__webglColorRenderbuffer[Y]);let le=r.convert(J.format,J.colorSpace),Te=r.convert(J.type),ue=S(J.internalFormat,le,Te,J.normalized,J.colorSpace,T.isXRRenderTarget===!0),ce=It(T);t.renderbufferStorageMultisample(t.RENDERBUFFER,ce,ue,T.width,T.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Y,t.RENDERBUFFER,O.__webglColorRenderbuffer[Y])}t.bindRenderbuffer(t.RENDERBUFFER,null),T.depthBuffer&&(O.__webglDepthRenderbuffer=t.createRenderbuffer(),Ct(O.__webglDepthRenderbuffer,T,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(ie){n.bindTexture(t.TEXTURE_CUBE_MAP,H.__webglTexture),Ze(t.TEXTURE_CUBE_MAP,x);for(let Y=0;Y<6;Y++)if(x.mipmaps&&x.mipmaps.length>0)for(let J=0;J<x.mipmaps.length;J++)Fe(O.__webglFramebuffer[Y][J],T,x,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Y,J);else Fe(O.__webglFramebuffer[Y],T,x,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0);m(x)&&E(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(oe){for(let Y=0,J=q.length;Y<J;Y++){let le=q[Y],Te=i.get(le),ue=t.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ue=T.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(ue,Te.__webglTexture),Ze(ue,le),Fe(O.__webglFramebuffer,T,le,t.COLOR_ATTACHMENT0+Y,ue,0),m(le)&&E(ue)}n.unbindTexture()}else{let Y=t.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(Y=T.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(Y,H.__webglTexture),Ze(Y,x),x.mipmaps&&x.mipmaps.length>0)for(let J=0;J<x.mipmaps.length;J++)Fe(O.__webglFramebuffer[J],T,x,t.COLOR_ATTACHMENT0,Y,J);else Fe(O.__webglFramebuffer,T,x,t.COLOR_ATTACHMENT0,Y,0);m(x)&&E(Y),n.unbindTexture()}T.depthBuffer&&pt(T)}function Lt(T){let x=T.textures;for(let O=0,H=x.length;O<H;O++){let q=x[O];if(m(q)){let ie=R(T),oe=i.get(q).__webglTexture;n.bindTexture(ie,oe),E(ie),n.unbindTexture()}}}let Rt=[],Nt=[];function Gt(T){if(T.samples>0){if(Ot(T)===!1){let x=T.textures,O=T.width,H=T.height,q=t.COLOR_BUFFER_BIT,ie=T.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,oe=i.get(T),Y=x.length>1;if(Y)for(let le=0;le<x.length;le++)n.bindFramebuffer(t.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+le,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,oe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+le,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,oe.__webglMultisampledFramebuffer);let J=T.texture.mipmaps;J&&J.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,oe.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,oe.__webglFramebuffer);for(let le=0;le<x.length;le++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(q|=t.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(q|=t.STENCIL_BUFFER_BIT)),Y){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,oe.__webglColorRenderbuffer[le]);let Te=i.get(x[le]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Te,0)}t.blitFramebuffer(0,0,O,H,0,0,O,H,q,t.NEAREST),l===!0&&(Rt.length=0,Nt.length=0,Rt.push(t.COLOR_ATTACHMENT0+le),T.depthBuffer&&T.resolveDepthBuffer===!1&&(Rt.push(ie),Nt.push(ie),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,Nt)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,Rt))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),Y)for(let le=0;le<x.length;le++){n.bindFramebuffer(t.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+le,t.RENDERBUFFER,oe.__webglColorRenderbuffer[le]);let Te=i.get(x[le]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,oe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+le,t.TEXTURE_2D,Te,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,oe.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){let x=T.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[x])}}}function It(T){return Math.min(s.maxSamples,T.samples)}function Ot(T){let x=i.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function F(T){let x=a.render.frame;u.get(T)!==x&&(u.set(T,x),T.update())}function wn(T,x){let O=T.colorSpace,H=T.format,q=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||O!==tr&&O!==pi&&(je.getTransfer(O)===mt?(H!==Qn||q!==Gn)&&De("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Be("WebGLTextures: Unsupported texture color space:",O)),x}function gt(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=G,this.resetTextureUnits=B,this.getTextureUnits=X,this.setTextureUnits=U,this.setTexture2D=$,this.setTexture2DArray=Z,this.setTexture3D=te,this.setTextureCube=re,this.rebindTextures=at,this.setupRenderTarget=Je,this.updateRenderTargetMipmap=Lt,this.updateMultisampleRenderTarget=Gt,this.setupDepthRenderbuffer=pt,this.setupFrameBufferTexture=Fe,this.useMultisampledRTT=Ot,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function $M(t,e){function n(i,s=pi){let r,a=je.getTransfer(s);if(i===Gn)return t.UNSIGNED_BYTE;if(i===ic)return t.UNSIGNED_SHORT_4_4_4_4;if(i===sc)return t.UNSIGNED_SHORT_5_5_5_1;if(i===rd)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===ad)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===id)return t.BYTE;if(i===sd)return t.SHORT;if(i===jr)return t.UNSIGNED_SHORT;if(i===nc)return t.INT;if(i===di)return t.UNSIGNED_INT;if(i===fi)return t.FLOAT;if(i===Li)return t.HALF_FLOAT;if(i===od)return t.ALPHA;if(i===ld)return t.RGB;if(i===Qn)return t.RGBA;if(i===Ei)return t.DEPTH_COMPONENT;if(i===Ls)return t.DEPTH_STENCIL;if(i===cd)return t.RED;if(i===rc)return t.RED_INTEGER;if(i===Ns)return t.RG;if(i===ac)return t.RG_INTEGER;if(i===oc)return t.RGBA_INTEGER;if(i===io||i===so||i===ro||i===ao)if(a===mt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===io)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===so)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===ro)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===ao)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===io)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===so)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===ro)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===ao)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===lc||i===cc||i===hc||i===uc)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===lc)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===cc)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===hc)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===uc)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===dc||i===fc||i===pc||i===mc||i===gc||i===oo||i===xc)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(i===dc||i===fc)return a===mt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===pc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(i===mc)return r.COMPRESSED_R11_EAC;if(i===gc)return r.COMPRESSED_SIGNED_R11_EAC;if(i===oo)return r.COMPRESSED_RG11_EAC;if(i===xc)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===vc||i===_c||i===yc||i===bc||i===Mc||i===Sc||i===wc||i===Ec||i===Ac||i===Tc||i===Cc||i===Rc||i===Ic||i===Pc)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(i===vc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===_c)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===yc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===bc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Mc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Sc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===wc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Ec)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Ac)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Tc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Cc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Rc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Ic)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Pc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Lc||i===Nc||i===Fc)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(i===Lc)return a===mt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Nc)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Fc)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Dc||i===Uc||i===lo||i===Oc)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(i===Dc)return r.COMPRESSED_RED_RGTC1_EXT;if(i===Uc)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===lo)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Oc)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Jr?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}var qM=`
void main() {
...
}`,Id=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n){if(this.texture===null){let i=new Ka(e.texture);(e.depthNear!==n.depthNear||e.depthFar!==n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){let n=e.cameras[0].viewport,i=new tn({vertexShader:qM,fragmentShader:YM,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new hn(new Ci(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Pd=class extends Ai{constructor(e,n){super();let i=this,s=null,r=1,a=null,o="local-floor",l=1,c=null,u=null,d=null,h=null,f=null,g=null,_=typeof XRWebGLBinding<"u",p=new Id,m={},E=n.getContextAttributes(),R=null,S=null,M=[],b=[],C=new Qe,v=null,w=new xn;w.viewport=new Ft;let I=new xn;I.viewport=new Ft;let A=[w,I],P=new Jl,B=null,X=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let ne=M[K];return ne===void 0&&(ne=new qr,M[K]=ne),ne.getTargetRaySpace()},this.getControllerGrip=function(K){let ne=M[K];return ne===void 0&&(ne=new qr,M[K]=ne),ne.getGripSpace()},this.getHand=function(K){let ne=M[K];return ne===void 0&&(ne=new qr,M[K]=ne),ne.getHandSpace()};function U(K){let ne=b.indexOf(K.inputSource);if(ne===-1)return;let ee=M[ne];ee!==void 0&&(ee.update(K.inputSource,K.frame,c||a),ee.dispatchEvent({type:K.type,data:K.inputSource}))}function G(){s.removeEventListener("select",U),s.removeEventListener("selectstart",U),s.removeEventListener("selectend",U),s.removeEventListener("squeeze",U),s.removeEventListener("squeezestart",U),s.removeEventListener("squeezeend",U),s.removeEventListener("end",G),s.removeEventListener("inputsourceschange",V);for(let K=0;K<M.length;K++){let ne=b[K];ne!==null&&(b[K]=null,M[K].disconnect(ne))}B=null,X=null,p.reset();for(let K in m)delete m[K];e.setRenderTarget(R),f=null,h=null,d=null,s=null,S=null,Ze.stop(),i.isPresenting=!1,e.setPixelRatio(v),e.setSize(C.width,C.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){r=K,i.isPresenting===!0&&De("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){o=K,i.isPresenting===!0&&De("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(K){c=K},this.getBaseLayer=function(){return h!==null?h:f},this.getBinding=function(){return d===null&&_&&(d=new XRWebGLBinding(s,n)),d},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(K){if(s=K,s!==null){if(R=e.getRenderTarget(),s.addEventListener("select",U),s.addEventListener("selectstart",U),s.addEventListener("selectend",U),s.addEventListener("squeeze",U),s.addEventListener("squeezestart",U),s.addEventListener("squeezeend",U),s.addEventListener("end",G),s.addEventListener("inputsourceschange",V),E.xrCompatible!==!0&&await n.makeXRCompatible(),v=e.getPixelRatio(),e.getSize(C),_&&"createProjectionLayer"in XRWebGLBinding.prototype){let ee=null,Ue=null,ze=null;E.depth&&(ze=E.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,ee=E.stencil?Ls:Ei,Ue=E.stencil?Jr:di);let Fe={colorFormat:n.RGBA8,depthFormat:ze,scaleFactor:r};d=this.getBinding(),h=d.createProjectionLayer(Fe),s.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),S=new zn(h.textureWidth,h.textureHeight,{format:Qn,type:Gn,depthTexture:new es(h.textureWidth,h.textureHeight,Ue,void 0,void 0,void 0,void 0,void 0,void 0,ee),stencilBuffer:E.stencil,colorSpace:e.outputColorSpace,samples:E.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{let ee={antialias:E.antialias,alpha:!0,depth:E.depth,stencil:E.stencil,framebufferScaleFactor:r};f=new XRWebGLLayer(s,n,ee),s.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),S=new zn(f.framebufferWidth,f.framebufferHeight,{format:Qn,type:Gn,colorSpace:e.outputColorSpace,stencilBuffer:E.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),Ze.setContext(s),Ze.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return p.getDepthTexture()};function V(K){for(let ne=0;ne<K.removed.length;ne++){let ee=K.removed[ne],Ue=b.indexOf(ee);Ue>=0&&(b[Ue]=null,M[Ue].disconnect(ee))}for(let ne=0;ne<K.added.length;ne++){let ee=K.added[ne],Ue=b.indexOf(ee);if(Ue===-1){for(let Fe=0;Fe<M.length;Fe++)if(Fe>=b.length){b.push(ee),Ue=Fe;break}else if(b[Fe]===null){b[Fe]=ee,Ue=Fe;break}if(Ue===-1)break}let ze=M[Ue];ze&&ze.connect(ee)}}let $=new N,Z=new N;function te(K,ne,ee){$.setFromMatrixPosition(ne.matrixWorld),Z.setFromMatrixPosition(ee.matrixWorld);let Ue=$.distanceTo(Z),ze=ne.projectionMatrix.elements,Fe=ee.projectionMatrix.elements,Ct=ze[14]/(ze[10]-1),Ye=ze[14]/(ze[10]+1),pt=(ze[9]+1)/ze[5],at=(ze[9]-1)/ze[5],Je=(ze[8]-1)/ze[0],Lt=(Fe[8]+1)/Fe[0],Rt=Ct*Je,Nt=Ct*Lt,Gt=Ue/(-Je+Lt),It=Gt*-Je;if(ne.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(It),K.translateZ(Gt),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),ze[10]===-1)K.projectionMatrix.copy(ne.projectionMatrix),K.projectionMatrixInverse.copy(ne.projectionMatrixInverse);else{let Ot=Ct+Gt,F=Ye+Gt,wn=Rt-It,gt=Nt+(Ue-It),T=pt*Ye/F*Ot,x=at*Ye/F*Ot;K.projectionMatrix.makePerspective(wn,gt,T,x,Ot,F),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function re(K,ne){ne===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(ne.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(s===null)return;let ne=K.near,ee=K.far;p.texture!==null&&(p.depthNear>0&&(ne=p.depthNear),p.depthFar>0&&(ee=p.depthFar)),P.near=I.near=w.near=ne,P.far=I.far=w.far=ee,(B!==P.near||X!==P.far)&&(s.updateRenderState({depthNear:P.near,depthFar:P.far}),B=P.near,X=P.far),P.layers.mask=K.layers.mask|6,w.layers.mask=P.layers.mask&-5,I.layers.mask=P.layers.mask&-3;let Ue=K.parent,ze=P.cameras;re(P,Ue);for(let Fe=0;Fe<ze.length;Fe++)re(ze[Fe],Ue);ze.length===2?te(P,w,I):P.projectionMatrix.copy(w.projectionMatrix),pe(K,P,Ue)};function pe(K,ne,ee){ee===null?K.matrix.copy(ne.matrixWorld):(K.matrix.copy(ee.matrixWorld),K.matrix.invert(),K.matrix.multiply(ne.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(ne.projectionMatrix),K.projectionMatrixInverse.copy(ne.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=Cl*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return P},this.getFoveation=function(){if(!(h===null&&f===null))return l},this.setFoveation=function(K){l=K,h!==null&&(h.fixedFoveation=K),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=K)},this.hasDepthSensing=function(){return p.texture!==null},this.getDepthSensingMesh=function(){return p.getMesh(P)},this.getCameraTexture=function(K){return m[K]};let Xe=null;function rt(K,ne){if(u=ne.getViewerPose(c||a),g=ne,u!==null){let ee=u.views;f!==null&&(e.setRenderTargetFramebuffer(S,f.framebuffer),e.setRenderTarget(S));let Ue=!1;ee.length!==P.cameras.length&&(P.cameras.length=0,Ue=!0);for(let Ye=0;Ye<ee.length;Ye++){let pt=ee[Ye],at=null;if(f!==null)at=f.getViewport(pt);else{let Lt=d.getViewSubImage(h,pt);at=Lt.viewport,Ye===0&&(e.setRenderTargetTextures(S,Lt.colorTexture,Lt.depthStencilTexture),e.setRenderTarget(S))}let Je=A[Ye];Je===void 0&&(Je=new xn,Je.layers.enable(Ye),Je.viewport=new Ft,A[Ye]=Je),Je.matrix.fromArray(pt.transform.matrix),Je.matrix.decompose(Je.position,Je.quaternion,Je.scale),Je.projectionMatrix.fromArray(pt.projectionMatrix),Je.projectionMatrixInverse.copy(Je.projectionMatrix).invert(),Je.viewport.set(at.x,at.y,at.width,at.height),Ye===0&&(P.matrix.copy(Je.matrix),P.matrix.decompose(P.position,P.quaternion,P.scale)),Ue===!0&&P.cameras.push(Je)}let ze=s.enabledFeatures;if(ze&&ze.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&_){d=i.getBinding();let Ye=d.getDepthInformation(ee[0]);Ye&&Ye.isValid&&Ye.texture&&p.init(Ye,s.renderState)}if(ze&&ze.includes("camera-access")&&_){e.state.unbindTexture(),d=i.getBinding();for(let Ye=0;Ye<ee.length;Ye++){let pt=ee[Ye].camera;if(pt){let at=m[pt];at||(at=new Ka,m[pt]=at);let Je=d.getCameraImage(pt);at.sourceTexture=Je}}}}for(let ee=0;ee<M.length;ee++){let Ue=b[ee],ze=M[ee];Ue!==null&&ze!==void 0&&ze.update(Ue,ne,c||a)}Xe&&Xe(K,ne),ne.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:ne}),g=null}let Ze=new dg;Ze.setAnimationLoop(rt),this.setAnimationLoop=function(K){Xe=K},this.dispose=function(){}}},KM=new zt,vg=new ke;vg.set(-1,0,0,0,1,0,0,0,1);function ZM(t,e){function n(p,m){p.matrixAutoUpdate===!0&&p.updateMatrix(),m.value.copy(p.matrix)}function i(p,m){m.color.getRGB(p.fogColor.value,fd(t)),m.isFog?(p.fogNear.value=m.near,p.fogFar.value=m.far):m.isFogExp2&&(p.fogDensity.value=m.density)}function s(p,m,E,R,S){m.isNodeMaterial?m.uniformsNeedUpdate=!1:m.isMeshBasicMaterial?r(p,m):m.isMeshLambertMaterial?(r(p,m),m.envMap&&(p.envMapIntensity.value=m.envMapIntensity)):m.isMeshToonMaterial?(r(p,m),d(p,m)):m.isMeshPhongMaterial?(r(p,m),u(p,m),m.envMap&&(p.envMapIntensity.value=m.envMapIntensity)):m.isMeshStandardMaterial?(r(p,m),h(p,m),m.isMeshPhysicalMaterial&&f(p,m,S)):m.isMeshMatcapMaterial?(r(p,m),g(p,m)):m.isMeshDepthMaterial?r(p,m):m.isMeshDistanceMaterial?(r(p,m),_(p,m)):m.isMeshNormalMaterial?r(p,m):m.isLineBasicMaterial?(a(p,m),m.isLineDashedMaterial&&o(p,m)):m.isPointsMaterial?l(p,m,E,R):m.isSpriteMaterial?c(p,m):m.isShadowMaterial?(p.color.value.copy(m.color),p.opacity.value=m.opacity):m.isShaderMaterial&&(m.uniformsNeedUpdate=!1)}function r(p,m){p.opacity.value=m.opacity,m.color&&p.diffuse.value.copy(m.color),m.emissive&&p.emissive.value.copy(m.emissive).multiplyScalar(m.emissiveIntensity),m.map&&(p.map.value=m.map,n(m.map,p.mapTransform)),m.alphaMap&&(p.alphaMap.value=m.alphaMap,n(m.alphaMap,p.alphaMapTransform)),m.bumpMap&&(p.bumpMap.value=m.bumpMap,n(m.bumpMap,p.bumpMapTransform),p.bumpScale.value=m.bumpScale,m.side===bn&&(p.bumpScale.value*=-1)),m.normalMap&&(p.normalMap.value=m.normalMap,n(m.normalMap,p.normalMapTransform),p.normalScale.value.copy(m.normalScale),m.side===bn&&p.normalScale.value.negate()),m.displacementMap&&(p.displacementMap.value=m.displacementMap,n(m.displacementMap,p.displacementMapTransform),p.displacementScale.value=m.displacementScale,p.displacementBias.value=m.displacementBias),m.emissiveMap&&(p.emissiveMap.value=m.emissiveMap,n(m.emissiveMap,p.emissiveMapTransform)),m.specularMap&&(p.specularMap.value=m.specularMap,n(m.specularMap,p.specularMapTransform)),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest);let E=e.get(m),R=E.envMap,S=E.envMapRotation;R&&(p.envMap.value=R,p.envMapRotation.value.setFromMatrix4(KM.makeRotationFromEuler(S)).transpose(),R.isCubeTexture&&R.isRenderTargetTexture===!1&&p.envMapRotation.value.premultiply(vg),p.reflectivity.value=m.reflectivity,p.ior.value=m.ior,p.refractionRatio.value=m.refractionRatio),m.lightMap&&(p.lightMap.value=m.lightMap,p.lightMapIntensity.value=m.lightMapIntensity,n(m.lightMap,p.lightMapTransform)),m.aoMap&&(p.aoMap.value=m.aoMap,p.aoMapIntensity.value=m.aoMapIntensity,n(m.aoMap,p.aoMapTransform))}function a(p,m){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,m.map&&(p.map.value=m.map,n(m.map,p.mapTransform))}function o(p,m){p.dashSize.value=m.dashSize,p.totalSize.value=m.dashSize+m.gapSize,p.scale.value=m.scale}function l(p,m,E,R){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,p.size.value=m.size*E,p.scale.value=R*.5,m.map&&(p.map.value=m.map,n(m.map,p.uvTransform)),m.alphaMap&&(p.alphaMap.value=m.alphaMap,n(m.alphaMap,p.alphaMapTransform)),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest)}function c(p,m){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,p.rotation.value=m.rotation,m.map&&(p.map.value=m.map,n(m.map,p.mapTransform)),m.alphaMap&&(p.alphaMap.value=m.alphaMap,n(m.alphaMap,p.alphaMapTransform)),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest)}function u(p,m){p.specular.value.copy(m.specular),p.shininess.value=Math.max(m.shininess,1e-4)}function d(p,m){m.gradientMap&&(p.gradientMap.value=m.gradientMap)}function h(p,m){p.metalness.value=m.metalness,m.metalnessMap&&(p.metalnessMap.value=m.metalnessMap,n(m.metalnessMap,p.metalnessMapTransform)),p.roughness.value=m.roughness,m.roughnessMap&&(p.roughnessMap.value=m.roughnessMap,n(m.roughnessMap,p.roughnessMapTransform)),m.envMap&&(p.envMapIntensity.value=m.envMapIntensity)}function f(p,m,E){p.ior.value=m.ior,m.sheen>0&&(p.sheenColor.value.copy(m.sheenColor).multiplyScalar(m.sheen),p.sheenRoughness.value=m.sheenRoughness,m.sheenColorMap&&(p.sheenColorMap.value=m.sheenColorMap,n(m.sheenColorMap,p.sheenColorMapTransform)),m.sheenRoughnessMap&&(p.sheenRoughnessMap.value=m.sheenRoughnessMap,n(m.sheenRoughnessMap,p.sheenRoughnessMapTransform))),m.clearcoat>0&&(p.clearcoat.value=m.clearcoat,p.clearcoatRoughness.value=m.clearcoatRoughness,m.clearcoatMap&&(p.clearcoatMap.value=m.clearcoatMap,n(m.clearcoatMap,p.clearcoatMapTransform)),m.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=m.clearcoatRoughnessMap,n(m.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),m.clearcoatNormalMap&&(p.clearcoatNormalMap.value=m.clearcoatNormalMap,n(m.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(m.clearcoatNormalScale),m.side===bn&&p.clearcoatNormalScale.value.negate())),m.dispersion>0&&(p.dispersion.value=m.dispersion),m.iridescence>0&&(p.iridescence.value=m.iridescence,p.iridescenceIOR.value=m.iridescenceIOR,p.iridescenceThicknessMinimum.value=m.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=m.iridescenceThicknessRange[1],m.iridescenceMap&&(p.iridescenceMap.value=m.iridescenceMap,n(m.iridescenceMap,p.iridescenceMapTransform)),m.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=m.iridescenceThicknessMap,n(m.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),m.transmission>0&&(p.transmission.value=m.transmission,p.transmissionSamplerMap.value=E.texture,p.transmissionSamplerSize.value.set(E.width,E.height),m.transmissionMap&&(p.transmissionMap.value=m.transmissionMap,n(m.transmissionMap,p.transmissionMapTransform)),p.thickness.value=m.thickness,m.thicknessMap&&(p.thicknessMap.value=m.thicknessMap,n(m.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=m.attenuationDistance,p.attenuationColor.value.copy(m.attenuationColor)),m.anisotropy>0&&(p.anisotropyVector.value.set(m.anisotropy*Math.cos(m.anisotropyRotation),m.anisotropy*Math.sin(m.anisotropyRotation)),m.anisotropyMap&&(p.anisotropyMap.value=m.anisotropyMap,n(m.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=m.specularIntensity,p.specularColor.value.copy(m.specularColor),m.specularColorMap&&(p.specularColorMap.value=m.specularColorMap,n(m.specularColorMap,p.specularColorMapTransform)),m.specularIntensityMap&&(p.specularIntensityMap.value=m.specularIntensityMap,n(m.specularIntensityMap,p.specularIntensityMapTransform))}function g(p,m){m.matcap&&(p.matcap.value=m.matcap)}function _(p,m){let E=e.get(m).light;p.referencePosition.value.setFromMatrixPosition(E.matrixWorld),p.nearDistance.value=E.shadow.camera.near,p.farDistance.value=E.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function jM(t,e,n,i){let s={},r={},a=[],o=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(S,M){let b=M.program;i.uniformBlockBinding(S,b)}function c(S,M){let b=s[S.id];b===void 0&&(p(S),b=u(S),s[S.id]=b,S.addEventListener("dispose",E));let C=M.program;i.updateUBOMapping(S,C);let v=e.render.frame;r[S.id]!==v&&(h(S),r[S.id]=v)}function u(S){let M=d();S.__bindingPointIndex=M;let b=t.createBuffer(),C=S.__size,v=S.usage;return t.bindBuffer(t.UNIFORM_BUFFER,b),t.bufferData(t.UNIFORM_BUFFER,C,v),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,M,b),b}function d(){for(let S=0;S<o;S++)if(a.indexOf(S)===-1)return a.push(S),S;return Be("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(S){let M=s[S.id],b=S.uniforms,C=S.__cache;t.bindBuffer(t.UNIFORM_BUFFER,M);for(let v=0,w=b.length;v<w;v++){let I=b[v];if(Array.isArray(I))for(let A=0,P=I.length;A<P;A++)f(I[A],v,A,C);else f(I,v,0,C)}t.bindBuffer(t.UNIFORM_BUFFER,null)}function f(S,M,b,C){if(_(S,M,b,C)===!0){let v=S.__offset,w=S.value;if(Array.isArray(w)){let I=0;for(let A=0;A<w.length;A++){let P=w[A],B=m(P);g(P,S.__data,I),typeof P!="number"&&typeof P!="boolean"&&!P.isMatrix3&&!ArrayBuffer.isView(P)&&(I+=B.storage/Float32Array.BYTES_PER_ELEMENT)}}else g(w,S.__data,0);t.bufferSubData(t.UNIFORM_BUFFER,v,S.__data)}}function g(S,M,b){typeof S=="number"||typeof S=="boolean"?M[0]=S:S.isMatrix3?(M[0]=S.elements[0],M[1]=S.elements[1],M[2]=S.elements[2],M[3]=0,M[4]=S.elements[3],M[5]=S.elements[4],M[6]=S.elements[5],M[7]=0,M[8]=S.elements[6],M[9]=S.elements[7],M[10]=S.elements[8],M[11]=0):ArrayBuffer.isView(S)?M.set(new S.constructor(S.buffer,S.byteOffset,M.length)):S.toArray(M,b)}function _(S,M,b,C){let v=S.value,w=M+"_"+b;if(C[w]===void 0)return typeof v=="number"||typeof v=="boolean"?C[w]=v:ArrayBuffer.isView(v)?C[w]=v.slice():C[w]=v.clone(),!0;{let I=C[w];if(typeof v=="number"||typeof v=="boolean"){if(I!==v)return C[w]=v,!0}else{if(ArrayBuffer.isView(v))return!0;if(I.equals(v)===!1)return I.copy(v),!0}}return!1}function p(S){let M=S.uniforms,b=0,C=16;for(let w=0,I=M.length;w<I;w++){let A=Array.isArray(M[w])?M[w]:[M[w]];for(let P=0,B=A.length;P<B;P++){let X=A[P],U=Array.isArray(X.value)?X.value:[X.value];for(let G=0,V=U.length;G<V;G++){let $=U[G],Z=m($),te=b%C,re=te%Z.boundary,pe=te+re;b+=re,pe!==0&&C-pe<Z.storage&&(b+=C-pe),X.__data=new Float32Array(Z.storage/Float32Array.BYTES_PER_ELEMENT),X.__offset=b,b+=Z.storage}}}let v=b%C;return v>0&&(b+=C-v),S.__size=b,S.__cache={},this}function m(S){let M={boundary:0,storage:0};return typeof S=="number"||typeof S=="boolean"?(M.boundary=4,M.storage=4):S.isVector2?(M.boundary=8,M.storage=8):S.isVector3||S.isColor?(M.boundary=16,M.storage=12):S.isVector4?(M.boundary=16,M.storage=16):S.isMatrix3?(M.boundary=48,M.storage=48):S.isMatrix4?(M.boundary=64,M.storage=64):S.isTexture?De("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(S)?(M.boundary=16,M.storage=S.byteLength):De("WebGLRenderer: Unsupported uniform value type.",S),M}function E(S){let M=S.target;M.removeEventListener("dispose",E);let b=a.indexOf(M.__bindingPointIndex);a.splice(b,1),t.deleteBuffer(s[M.id]),delete s[M.id],delete r[M.id]}function R(){for(let S in s)t.deleteBuffer(s[S]);a=[],s={},r={}}return{bind:l,update:c,dispose:R}}var JM=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Ni=null;function QM(){return Ni===null&&(Ni=new Ll(JM,16,16,Ns,Li),Ni.name="DFG_LUT",Ni.minFilter=en,Ni.magFilter=en,Ni.wrapS=wi,Ni.wrapT=wi,Ni.generateMipmaps=!1,Ni.needsUpdate=!0),Ni}var Wc=class{constructor(e={}){let{canvas:n=Om(),context:i=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:h=!1,outputBufferType:f=Gn}=e;this.isWebGLRenderer=!0;let g;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=i.getContextAttributes().alpha}else g=a;let _=f,p=new Set([oc,ac,rc]),m=new Set([Gn,di,jr,Jr,ic,sc]),E=new Uint32Array(4),R=new Int32Array(4),S=new N,M=null,b=null,C=[],v=[],w=null;this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=ui,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let I=this,A=!1,P=null,B=null,X=null,U=null;this._outputColorSpace=kn;let G=0,V=0,$=null,Z=-1,te=null,re=new Ft,pe=new Ft,Xe=null,rt=new Ve(0),Ze=0,K=n.width,ne=n.height,ee=1,Ue=null,ze=null,Fe=new Ft(0,0,K,ne),Ct=new Ft(0,0,K,ne),Ye=!1,pt=new $a,at=!1,Je=!1,Lt=new zt,Rt=new N,Nt=new Ft,Gt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},It=!1;function Ot(){return $===null?ee:1}let F=i;function wn(y,D){return n.getContext(y,D)}try{let y={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:d};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${"185"}`),n.addEventListener("webglcontextlost",Bt,!1),n.addEventListener("webglcontextrestored",bt,!1),n.addEventListener("webglcontextcreationerror",_i,!1),F===null){let D="webgl2";if(F=wn(D,y),F===null)throw wn(D)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(y){throw Be("WebGLRenderer: "+y.message),y}let gt,T,x,O,H,q,ie,oe,Y,J,le,Te,ue,ce,Ne,Oe,Ge,L,ae,j,he,ge,Q;function Ae(){gt=new a2(F),gt.init(),he=new $M(F,gt),T=new Jb(F,gt,e,he),x=new WM(F,gt),T.reversedDepthBuffer&&h&&x.buffers.depth.setReversed(!0),B=F.createFramebuffer(),X=F.createFramebuffer(),U=F.createFramebuffer(),O=new c2(F),H=new IM,q=new XM(F,gt,x,H,T,he,O),ie=new r2(I),oe=new f_(F),ge=new Zb(F,oe),Y=new o2(F,oe,O,ge),J=new u2(F,Y,oe,ge,O),L=new h2(F,T,q),Ne=new Qb(H),le=new RM(I,ie,gt,T,ge,Ne),Te=new ZM(I,H),ue=new LM,ce=new BM(gt),Ge=new Kb(I,ie,x,J,g,l),Oe=new GM(I,J,T),Q=new jM(F,O,T,x),ae=new jb(F,gt,O),j=new l2(F,gt,O),O.programs=le.programs,I.capabilities=T,I.extensions=gt,I.properties=H,I.renderLists=ue,I.shadowMap=Oe,I.state=x,I.info=O}Ae(),_!==Gn&&(w=new f2(_,n.width,n.height,o,s,r));let Se=new Pd(I,F);this.xr=Se,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){let y=gt.get("WEBGL_lose_context");y&&y.loseContext()},this.forceContextRestore=function(){let y=gt.get("WEBGL_lose_context");y&&y.restoreContext()},this.getPixelRatio=function(){return ee},this.setPixelRatio=function(y){y!==void 0&&(ee=y,this.setSize(K,ne,!1))},this.getSize=function(y){return y.set(K,ne)},this.setSize=function(y,D,W=!0){if(Se.isPresenting){De("WebGLRenderer: Can't change size while VR device is presenting.");return}K=y,ne=D,n.width=Math.floor(y*ee),n.height=Math.floor(D*ee),W===!0&&(n.style.width=y+"px",n.style.height=D+"px"),w!==null&&w.setSize(n.width,n.height),this.setViewport(0,0,y,D)},this.getDrawingBufferSize=function(y){return y.set(K*ee,ne*ee).floor()},this.setDrawingBufferSize=function(y,D,W){K=y,ne=D,ee=W,n.width=Math.floor(y*W),n.height=Math.floor(D*W),this.setViewport(0,0,y,D)},this.setEffects=function(y){if(_===Gn){Be("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(y){for(let D=0;D<y.length;D++)if(y[D].isOutputPass===!0){De("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}w.setEffects(y||[])},this.getCurrentViewport=function(y){return y.copy(re)},this.getViewport=function(y){return y.copy(Fe)},this.setViewport=function(y,D,W,k){y.isVector4?Fe.set(y.x,y.y,y.z,y.w):Fe.set(y,D,W,k),x.viewport(re.copy(Fe).multiplyScalar(ee).round())},this.getScissor=function(y){return y.copy(Ct)},this.setScissor=function(y,D,W,k){y.isVector4?Ct.set(y.x,y.y,y.z,y.w):Ct.set(y,D,W,k),x.scissor(pe.copy(Ct).multiplyScalar(ee).round())},this.getScissorTest=function(){return Ye},this.setScissorTest=function(y){x.setScissorTest(Ye=y)},this.setOpaqueSort=function(y){Ue=y},this.setTransparentSort=function(y){ze=y},this.getClearColor=function(y){return y.copy(Ge.getClearColor())},this.setClearColor=function(){Ge.setClearColor(...arguments)},this.getClearAlpha=function(){return Ge.getClearAlpha()},this.setClearAlpha=function(){Ge.setClearAlpha(...arguments)},this.clear=function(y=!0,D=!0,W=!0){let k=0;if(y){let z=!1;if($!==null){let me=$.texture.format;z=p.has(me)}if(z){let me=$.texture.type,ye=m.has(me),fe=Ge.getClearColor(),Ee=Ge.getClearAlpha(),Ce=fe.r,We=fe.g,Ke=fe.b;ye?(E[0]=Ce,E[1]=We,E[2]=Ke,E[3]=Ee,F.clearBufferuiv(F.COLOR,0,E)):(R[0]=Ce,R[1]=We,R[2]=Ke,R[3]=Ee,F.clearBufferiv(F.COLOR,0,R))}else k|=F.COLOR_BUFFER_BIT}D&&(k|=F.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),W&&(k|=F.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),k!==0&&F.clear(k)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(y){y.setRenderer(this),P=y},this.dispose=function(){n.removeEventListener("webglcontextlost",Bt,!1),n.removeEventListener("webglcontextrestored",bt,!1),n.removeEventListener("webglcontextcreationerror",_i,!1),Ge.dispose(),ue.dispose(),ce.dispose(),H.dispose(),ie.dispose(),J.dispose(),ge.dispose(),Q.dispose(),le.dispose(),Se.dispose(),Se.removeEventListener("sessionstart",Cp),Se.removeEventListener("sessionend",Rp),$s.stop()};function Bt(y){y.preventDefault(),dd("WebGLRenderer: Context Lost."),A=!0}function bt(){dd("WebGLRenderer: Context Restored."),A=!1;let y=O.autoReset,D=Oe.enabled,W=Oe.autoUpdate,k=Oe.needsUpdate,z=Oe.type;Ae(),O.autoReset=y,Oe.enabled=D,Oe.autoUpdate=W,Oe.needsUpdate=k,Oe.type=z}function _i(y){Be("WebGLRenderer: A WebGL context could not be created. Reason: ",y.statusMessage)}function yi(y){let D=y.target;D.removeEventListener("dispose",yi),A1(D)}function A1(y){T1(y),H.remove(y)}function T1(y){let D=H.get(y).programs;D!==void 0&&(D.forEach(function(W){le.releaseProgram(W)}),y.isShaderMaterial&&le.releaseShaderCache(y))}this.renderBufferDirect=function(y,D,W,k,z,me){D===null&&(D=Gt);let ye=z.isMesh&&z.matrixWorld.determinantAffine()<0,fe=I1(y,D,W,k,z);x.setMaterial(k,ye);let Ee=W.index,Ce=1;if(k.wireframe===!0){if(Ee=Y.getWireframeAttribute(W),Ee===void 0)return;Ce=2}let We=W.drawRange,Ke=W.attributes.position,Ie=We.start*Ce,vt=(We.start+We.count)*Ce;me!==null&&(Ie=Math.max(Ie,me.start*Ce),vt=Math.min(vt,(me.start+me.count)*Ce)),Ee!==null?(Ie=Math.max(Ie,0),vt=Math.min(vt,Ee.count)):Ke!=null&&(Ie=Math.max(Ie,0),vt=Math.min(vt,Ke.count));let Wt=vt-Ie;if(Wt<0||Wt===1/0)return;ge.setup(z,k,fe,W,Ee);let kt,_t=ae;if(Ee!==null&&(kt=oe.get(Ee),_t=j,_t.setIndex(kt)),z.isMesh)k.wireframe===!0?(x.setLineWidth(k.wireframeLinewidth*Ot()),_t.setMode(F.LINES)):_t.setMode(F.TRIANGLES);else if(z.isLine){let pn=k.linewidth;pn===void 0&&(pn=1),x.setLineWidth(pn*Ot()),z.isLineSegments?_t.setMode(F.LINES):z.isLineLoop?_t.setMode(F.LINE_LOOP):_t.setMode(F.LINE_STRIP)}else z.isPoints?_t.setMode(F.POINTS):z.isSprite&&_t.setMode(F.TRIANGLES);if(z.isBatchedMesh)if(gt.get("WEBGL_multi_draw"))_t.renderMultiDraw(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount);else{let pn=z._multiDrawStarts,_e=z._multiDrawCounts,Un=z._multiDrawCount,ot=Ee?oe.get(Ee).bytesPerElement:1,Zn=H.get(k).currentProgram.getUniforms();for(let bi=0;bi<Un;bi++)Zn.setValue(F,"_gl_DrawID",bi),_t.render(pn[bi]/ot,_e[bi])}else if(z.isInstancedMesh)_t.renderInstances(Ie,Wt,z.count);else if(W.isInstancedBufferGeometry){let pn=W._maxInstanceCount!==void 0?W._maxInstanceCount:1/0,_e=Math.min(W.instanceCount,pn);_t.renderInstances(Ie,Wt,_e)}else _t.render(Ie,Wt)};function Tp(y,D,W){y.transparent===!0&&y.side===Ri&&y.forceSinglePass===!1?(y.side=bn,y.needsUpdate=!0,Xo(y,D,W),y.side=Qi,y.needsUpdate=!0,Xo(y,D,W),y.side=Ri):Xo(y,D,W)}this.compile=function(y,D,W=null){W===null&&(W=y),b=ce.get(W),b.init(D),v.push(b),W.traverseVisible(function(z){z.isLight&&z.layers.test(D.layers)&&(b.pushLight(z),z.castShadow&&b.pushShadow(z))}),y!==W&&y.traverseVisible(function(z){z.isLight&&z.layers.test(D.layers)&&(b.pushLight(z),z.castShadow&&b.pushShadow(z))}),b.setupLights();let k=new Set;return y.traverse(function(z){if(!(z.isMesh||z.isPoints||z.isLine||z.isSprite))return;let me=z.material;if(me)if(Array.isArray(me))for(let ye=0;ye<me.length;ye++){let fe=me[ye];Tp(fe,W,z),k.add(fe)}else Tp(me,W,z),k.add(me)}),b=v.pop(),k},this.compileAsync=function(y,D,W=null){let k=this.compile(y,D,W);return new Promise(z=>{function me(){if(k.forEach(function(ye){H.get(ye).currentProgram.isReady()&&k.delete(ye)}),k.size===0){z(y);return}setTimeout(me,10)}gt.get("KHR_parallel_shader_compile")!==null?me():setTimeout(me,10)})};let hu=null;function C1(y){hu&&hu(y)}function Cp(){$s.stop()}function Rp(){$s.start()}let $s=new dg;$s.setAnimationLoop(C1),typeof self<"u"&&$s.setContext(self),this.setAnimationLoop=function(y){hu=y,Se.setAnimationLoop(y),y===null?$s.stop():$s.start()},Se.addEventListener("sessionstart",Cp),Se.addEventListener("sessionend",Rp),this.render=function(y,D){if(D!==void 0&&D.isCamera!==!0){Be("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(A===!0)return;P!==null&&P.renderStart(y,D);let W=Se.enabled===!0&&Se.isPresenting===!0,k=w!==null&&($===null||W)&&w.begin(I,$);if(y.matrixWorldAutoUpdate===!0&&y.updateMatrixWorld(),D.parent===null&&D.matrixWorldAutoUpdate===!0&&D.updateMatrixWorld(),Se.enabled===!0&&Se.isPresenting===!0&&(w===null||w.isCompositing()===!1)&&(Se.cameraAutoUpdate===!0&&Se.updateCamera(D),D=Se.getCamera()),y.isScene===!0&&y.onBeforeRender(I,y,D,$),b=ce.get(y,v.length),b.init(D),b.state.textureUnits=q.getTextureUnits(),v.push(b),Lt.multiplyMatrices(D.projectionMatrix,D.matrixWorldInverse),pt.setFromProjectionMatrix(Lt,hi,D.reversedDepth),Je=this.localClippingEnabled,at=Ne.init(this.clippingPlanes,Je),M=ue.get(y,C.length),M.init(),C.push(M),Se.enabled===!0&&Se.isPresenting===!0){let ye=I.xr.getDepthSensingMesh();ye!==null&&uu(ye,D,-1/0,I.sortObjects)}uu(y,D,0,I.sortObjects),M.finish(),I.sortObjects===!0&&M.sort(Ue,ze,D.reversedDepth),It=Se.enabled===!1||Se.isPresenting===!1||Se.hasDepthSensing()===!1,It&&Ge.addToRenderList(M,y),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),at===!0&&Ne.beginShadows();let z=b.state.shadowsArray;if(Oe.render(z,y,D),at===!0&&Ne.endShadows(),(k&&w.hasRenderPass())===!1){let ye=M.opaque,fe=M.transmissive;if(b.setupLights(),D.isArrayCamera){let Ee=D.cameras;if(fe.length>0)for(let Ce=0,We=Ee.length;Ce<We;Ce++){let Ke=Ee[Ce];Pp(ye,fe,y,Ke)}It&&Ge.render(y);for(let Ce=0,We=Ee.length;Ce<We;Ce++){let Ke=Ee[Ce];Ip(M,y,Ke,Ke.viewport)}}else fe.length>0&&Pp(ye,fe,y,D),It&&Ge.render(y),Ip(M,y,D)}$!==null&&V===0&&(q.updateMultisampleRenderTarget($),q.updateRenderTargetMipmap($)),k&&w.end(I),y.isScene===!0&&y.onAfterRender(I,y,D),ge.resetDefaultState(),Z=-1,te=null,v.pop(),v.length>0?(b=v[v.length-1],q.setTextureUnits(b.state.textureUnits),at===!0&&Ne.setGlobalState(I.clippingPlanes,b.state.camera)):b=null,C.pop(),C.length>0?M=C[C.length-1]:M=null,P!==null&&P.renderEnd()};function uu(y,D,W,k){if(y.visible===!1)return;if(y.layers.test(D.layers)){if(y.isGroup)W=y.renderOrder;else if(y.isLOD)y.autoUpdate===!0&&y.update(D);else if(y.isLightProbeGrid)b.pushLightProbeGrid(y);else if(y.isLight)b.pushLight(y),y.castShadow&&b.pushShadow(y);else if(y.isSprite){if(!y.frustumCulled||pt.intersectsSprite(y)){k&&Nt.setFromMatrixPosition(y.matrixWorld).applyMatrix4(Lt);let ye=J.update(y),fe=y.material;fe.visible&&M.push(y,ye,fe,W,Nt.z,null)}}else if((y.isMesh||y.isLine||y.isPoints)&&(!y.frustumCulled||pt.intersectsObject(y))){let ye=J.update(y),fe=y.material;if(k&&(y.boundingSphere!==void 0?(y.boundingSphere===null&&y.computeBoundingSphere(),Nt.copy(y.boundingSphere.center)):(ye.boundingSphere===null&&ye.computeBoundingSphere(),Nt.copy(ye.boundingSphere.center)),Nt.applyMatrix4(y.matrixWorld).applyMatrix4(Lt)),Array.isArray(fe)){let Ee=ye.groups;for(let Ce=0,We=Ee.length;Ce<We;Ce++){let Ke=Ee[Ce],Ie=fe[Ke.materialIndex];Ie&&Ie.visible&&M.push(y,ye,Ie,W,Nt.z,Ke)}}else fe.visible&&M.push(y,ye,fe,W,Nt.z,null)}}let me=y.children;for(let ye=0,fe=me.length;ye<fe;ye++)uu(me[ye],D,W,k)}function Ip(y,D,W,k){let{opaque:z,transmissive:me,transparent:ye}=y;b.setupLightsView(W),at===!0&&Ne.setGlobalState(I.clippingPlanes,W),k&&x.viewport(re.copy(k)),z.length>0&&Wo(z,D,W),me.length>0&&Wo(me,D,W),ye.length>0&&Wo(ye,D,W),x.buffers.depth.setTest(!0),x.buffers.depth.setMask(!0),x.buffers.color.setMask(!0),x.setPolygonOffset(!1)}function Pp(y,D,W,k){if((W.isScene===!0?W.overrideMaterial:null)!==null)return;if(b.state.transmissionRenderTarget[k.id]===void 0){let Ie=gt.has("EXT_color_buffer_half_float")||gt.has("EXT_color_buffer_float");b.state.transmissionRenderTarget[k.id]=new zn(1,1,{generateMipmaps:!0,type:Ie?Li:Gn,minFilter:Pi,samples:Math.max(4,T.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:je.workingColorSpace})}let me=b.state.transmissionRenderTarget[k.id],ye=k.viewport||re;me.setSize(ye.z*I.transmissionResolutionScale,ye.w*I.transmissionResolutionScale);let fe=I.getRenderTarget(),Ee=I.getActiveCubeFace(),Ce=I.getActiveMipmapLevel();I.setRenderTarget(me),I.getClearColor(rt),Ze=I.getClearAlpha(),Ze<1&&I.setClearColor(16777215,.5),I.clear(),It&&Ge.render(W);let We=I.toneMapping;I.toneMapping=ui;let Ke=k.viewport;if(k.viewport!==void 0&&(k.viewport=void 0),b.setupLightsView(k),at===!0&&Ne.setGlobalState(I.clippingPlanes,k),Wo(y,W,k),q.updateMultisampleRenderTarget(me),q.updateRenderTargetMipmap(me),gt.has("WEBGL_multisampled_render_to_texture")===!1){let Ie=!1;for(let vt=0,Wt=D.length;vt<Wt;vt++){let kt=D[vt],{object:_t,geometry:pn,material:_e,group:Un}=kt;if(_e.side===Ri&&_t.layers.test(k.layers)){let ot=_e.side;_e.side=bn,_e.needsUpdate=!0,Lp(_t,W,k,pn,_e,Un),_e.side=ot,_e.needsUpdate=!0,Ie=!0}}Ie===!0&&(q.updateMultisampleRenderTarget(me),q.updateRenderTargetMipmap(me))}I.setRenderTarget(fe,Ee,Ce),I.setClearColor(rt,Ze),Ke!==void 0&&(k.viewport=Ke),I.toneMapping=We}function Wo(y,D,W){let k=D.isScene===!0?D.overrideMaterial:null;for(let z=0,me=y.length;z<me;z++){let ye=y[z],{object:fe,geometry:Ee,group:Ce}=ye,We=ye.material;We.allowOverride===!0&&k!==null&&(We=k),fe.layers.test(W.layers)&&Lp(fe,D,W,Ee,We,Ce)}}function Lp(y,D,W,k,z,me){y.onBeforeRender(I,D,W,k,z,me),y.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,y.matrixWorld),y.normalMatrix.getNormalMatrix(y.modelViewMatrix),z.onBeforeRender(I,D,W,k,y,me),z.transparent===!0&&z.side===Ri&&z.forceSinglePass===!1?(z.side=bn,z.needsUpdate=!0,I.renderBufferDirect(W,D,k,z,y,me),z.side=Qi,z.needsUpdate=!0,I.renderBufferDirect(W,D,k,z,y,me),z.side=Ri):I.renderBufferDirect(W,D,k,z,y,me),y.onAfterRender(I,D,W,k,z,me)}function Xo(y,D,W){D.isScene!==!0&&(D=Gt);let k=H.get(y),z=b.state.lights,me=b.state.shadowsArray,ye=z.state.version,fe=le.getParameters(y,z.state,me,D,W,b.state.lightProbeGridArray),Ee=le.getProgramCacheKey(fe),Ce=k.programs;k.environment=y.isMeshStandardMaterial||y.isMeshLambertMaterial||y.isMeshPhongMaterial?D.environment:null,k.fog=D.fog;let We=y.isMeshStandardMaterial||y.isMeshLambertMaterial&&!y.envMap||y.isMeshPhongMaterial&&!y.envMap;k.envMap=ie.get(y.envMap||k.environment,We),k.envMapRotation=k.environment!==null&&y.envMap===null?D.environmentRotation:y.envMapRotation,Ce===void 0&&(y.addEventListener("dispose",yi),Ce=new Map,k.programs=Ce);let Ke=Ce.get(Ee);if(Ke!==void 0){if(k.currentProgram===Ke&&k.lightsStateVersion===ye)return Fp(y,fe),Ke}else fe.uniforms=le.getUniforms(y),P!==null&&y.isNodeMaterial&&P.build(y,W,fe),y.onBeforeCompile(fe,I),Ke=le.acquireProgram(fe,Ee),Ce.set(Ee,Ke),k.uniforms=fe.uniforms;let Ie=k.uniforms;return(!y.isShaderMaterial&&!y.isRawShaderMaterial||y.clipping===!0)&&(Ie.clippingPlanes=Ne.uniform),Fp(y,fe),k.needsLights=L1(y),k.lightsStateVersion=ye,k.needsLights&&(Ie.ambientLightColor.value=z.state.ambient,Ie.lightProbe.value=z.state.probe,Ie.directionalLights.value=z.state.directional,Ie.directionalLightShadows.value=z.state.directionalShadow,Ie.spotLights.value=z.state.spot,Ie.spotLightShadows.value=z.state.spotShadow,Ie.rectAreaLights.value=z.state.rectArea,Ie.ltc_1.value=z.state.rectAreaLTC1,Ie.ltc_2.value=z.state.rectAreaLTC2,Ie.pointLights.value=z.state.point,Ie.pointLightShadows.value=z.state.pointShadow,Ie.hemisphereLights.value=z.state.hemi,Ie.directionalShadowMatrix.value=z.state.directionalShadowMatrix,Ie.spotLightMatrix.value=z.state.spotLightMatrix,Ie.spotLightMap.value=z.state.spotLightMap,Ie.pointShadowMatrix.value=z.state.pointShadowMatrix),k.lightProbeGrid=b.state.lightProbeGridArray.length>0,k.currentProgram=Ke,k.uniformsList=null,Ke}function Np(y){if(y.uniformsList===null){let D=y.currentProgram.getUniforms();y.uniformsList=ea.seqWithValue(D.seq,y.uniforms)}return y.uniformsList}function Fp(y,D){let W=H.get(y);W.outputColorSpace=D.outputColorSpace,W.batching=D.batching,W.batchingColor=D.batchingColor,W.instancing=D.instancing,W.instancingColor=D.instancingColor,W.instancingMorph=D.instancingMorph,W.skinning=D.skinning,W.morphTargets=D.morphTargets,W.morphNormals=D.morphNormals,W.morphColors=D.morphColors,W.morphTargetsCount=D.morphTargetsCount,W.numClippingPlanes=D.numClippingPlanes,W.numIntersection=D.numClipIntersection,W.vertexAlphas=D.vertexAlphas,W.vertexTangents=D.vertexTangents,W.toneMapping=D.toneMapping}function R1(y,D){if(y.length===0)return null;if(y.length===1)return y[0].texture!==null?y[0]:null;S.setFromMatrixPosition(D.matrixWorld);for(let W=0,k=y.length;W<k;W++){let z=y[W];if(z.texture!==null&&z.boundingBox.containsPoint(S))return z}return null}function I1(y,D,W,k,z){D.isScene!==!0&&(D=Gt),q.resetTextureUnits();let me=D.fog,ye=k.isMeshStandardMaterial||k.isMeshLambertMaterial||k.isMeshPhongMaterial?D.environment:null,fe=$===null?I.outputColorSpace:$.isXRRenderTarget===!0?$.texture.colorSpace:je.workingColorSpace,Ee=k.isMeshStandardMaterial||k.isMeshLambertMaterial&&!k.envMap||k.isMeshPhongMaterial&&!k.envMap,Ce=ie.get(k.envMap||ye,Ee),We=k.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,Ke=!!W.attributes.tangent&&(!!k.normalMap||k.anisotropy>0),Ie=!!W.morphAttributes.position,vt=!!W.morphAttributes.normal,Wt=!!W.morphAttributes.color,kt=ui;k.toneMapped&&($===null||$.isXRRenderTarget===!0)&&(kt=I.toneMapping);let _t=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,pn=_t!==void 0?_t.length:0,_e=H.get(k),Un=b.state.lights;if(at===!0&&(Je===!0||y!==te)){let Mt=y===te&&k.id===Z;Ne.setState(k,y,Mt)}let ot=!1;k.version===_e.__version?(_e.needsLights&&_e.lightsStateVersion!==Un.state.version||_e.outputColorSpace!==fe||z.isBatchedMesh&&_e.batching===!1||!z.isBatchedMesh&&_e.batching===!0||z.isBatchedMesh&&_e.batchingColor===!0&&z.colorTexture===null||z.isBatchedMesh&&_e.batchingColor===!1&&z.colorTexture!==null||z.isInstancedMesh&&_e.instancing===!1||!z.isInstancedMesh&&_e.instancing===!0||z.isSkinnedMesh&&_e.skinning===!1||!z.isSkinnedMesh&&_e.skinning===!0||z.isInstancedMesh&&_e.instancingColor===!0&&z.instanceColor===null||z.isInstancedMesh&&_e.instancingColor===!1&&z.instanceColor!==null||z.isInstancedMesh&&_e.instancingMorph===!0&&z.morphTexture===null||z.isInstancedMesh&&_e.instancingMorph===!1&&z.morphTexture!==null||_e.envMap!==Ce||k.fog===!0&&_e.fog!==me||_e.numClippingPlanes!==void 0&&(_e.numClippingPlanes!==Ne.numPlanes||_e.numIntersection!==Ne.numIntersection)||_e.vertexAlphas!==We||_e.vertexTangents!==Ke||_e.morphTargets!==Ie||_e.morphNormals!==vt||_e.morphColors!==Wt||_e.toneMapping!==kt||_e.morphTargetsCount!==pn||!!_e.lightProbeGrid!=b.state.lightProbeGridArray.length>0)&&(ot=!0):(ot=!0,_e.__version=k.version);let Zn=_e.currentProgram;ot===!0&&(Zn=Xo(k,D,z),P&&k.isNodeMaterial&&P.onUpdateProgram(k,Zn,_e));let bi=!1,ps=!1,Cr=!1,yt=Zn.getUniforms(),Xt=_e.uniforms;if(x.useProgram(Zn.program)&&(bi=!0,ps=!0,Cr=!0),k.id!==Z&&(Z=k.id,ps=!0),_e.needsLights){let Mt=R1(b.state.lightProbeGridArray,z);_e.lightProbeGrid!==Mt&&(_e.lightProbeGrid=Mt,ps=!0)}if(bi||te!==y){x.buffers.depth.getReversed()&&y.reversedDepth!==!0&&(y._reversedDepth=!0,y.updateProjectionMatrix()),yt.setValue(F,"projectionMatrix",y.projectionMatrix),yt.setValue(F,"viewMatrix",y.matrixWorldInverse);let gs=yt.map.cameraPosition;gs!==void 0&&gs.setValue(F,Rt.setFromMatrixPosition(y.matrixWorld)),T.logarithmicDepthBuffer&&yt.setValue(F,"logDepthBufFC",2/(Math.log(y.far+1)/Math.LN2)),(k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshLambertMaterial||k.isMeshBasicMaterial||k.isMeshStandardMaterial||k.isShaderMaterial)&&yt.setValue(F,"isOrthographic",y.isOrthographicCamera===!0),te!==y&&(te=y,ps=!0,Cr=!0)}if(_e.needsLights&&(Un.state.directionalShadowMap.length>0&&yt.setValue(F,"directionalShadowMap",Un.state.directionalShadowMap,q),Un.state.spotShadowMap.length>0&&yt.setValue(F,"spotShadowMap",Un.state.spotShadowMap,q),Un.state.pointShadowMap.length>0&&yt.setValue(F,"pointShadowMap",Un.state.pointShadowMap,q)),z.isSkinnedMesh){yt.setOptional(F,z,"bindMatrix"),yt.setOptional(F,z,"bindMatrixInverse");let Mt=z.skeleton;Mt&&(Mt.boneTexture===null&&Mt.computeBoneTexture(),yt.setValue(F,"boneTexture",Mt.boneTexture,q))}z.isBatchedMesh&&(yt.setOptional(F,z,"batchingTexture"),yt.setValue(F,"batchingTexture",z._matricesTexture,q),yt.setOptional(F,z,"batchingIdTexture"),yt.setValue(F,"batchingIdTexture",z._indirectTexture,q),yt.setOptional(F,z,"batchingColorTexture"),z._colorsTexture!==null&&yt.setValue(F,"batchingColorTexture",z._colorsTexture,q));let ms=W.morphAttributes;if((ms.position!==void 0||ms.normal!==void 0||ms.color!==void 0)&&L.update(z,W,Zn),(ps||_e.receiveShadow!==z.receiveShadow)&&(_e.receiveShadow=z.receiveShadow,yt.setValue(F,"receiveShadow",z.receiveShadow)),(k.isMeshStandardMaterial||k.isMeshLambertMaterial||k.isMeshPhongMaterial)&&k.envMap===null&&D.environment!==null&&(Xt.envMapIntensity.value=D.environmentIntensity),Xt.dfgLUT!==void 0&&(Xt.dfgLUT.value=QM()),ps){if(yt.setValue(F,"toneMappingExposure",I.toneMappingExposure),_e.needsLights&&P1(Xt,Cr),me&&k.fog===!0&&Te.refreshFogUniforms(Xt,me),Te.refreshMaterialUniforms(Xt,k,ee,ne,b.state.transmissionRenderTarget[y.id]),_e.needsLights&&_e.lightProbeGrid){let Mt=_e.lightProbeGrid;Xt.probesSH.value=Mt.texture,Xt.probesMin.value.copy(Mt.boundingBox.min),Xt.probesMax.value.copy(Mt.boundingBox.max),Xt.probesResolution.value.copy(Mt.resolution)}ea.upload(F,Np(_e),Xt,q)}if(k.isShaderMaterial&&k.uniformsNeedUpdate===!0&&(ea.upload(F,Np(_e),Xt,q),k.uniformsNeedUpdate=!1),k.isSpriteMaterial&&yt.setValue(F,"center",z.center),yt.setValue(F,"modelViewMatrix",z.modelViewMatrix),yt.setValue(F,"normalMatrix",z.normalMatrix),yt.setValue(F,"modelMatrix",z.matrixWorld),k.uniformsGroups!==void 0){let Mt=k.uniformsGroups;for(let gs=0,Rr=Mt.length;gs<Rr;gs++){let Dp=Mt[gs];Q.update(Dp,Zn),Q.bind(Dp,Zn)}}return Zn}function P1(y,D){y.ambientLightColor.needsUpdate=D,y.lightProbe.needsUpdate=D,y.directionalLights.needsUpdate=D,y.directionalLightShadows.needsUpdate=D,y.pointLights.needsUpdate=D,y.pointLightShadows.needsUpdate=D,y.spotLights.needsUpdate=D,y.spotLightShadows.needsUpdate=D,y.rectAreaLights.needsUpdate=D,y.hemisphereLights.needsUpdate=D}function L1(y){return y.isMeshLambertMaterial||y.isMeshToonMaterial||y.isMeshPhongMaterial||y.isMeshStandardMaterial||y.isShadowMaterial||y.isShaderMaterial&&y.lights===!0}this.getActiveCubeFace=function(){return G},this.getActiveMipmapLevel=function(){return V},this.getRenderTarget=function(){return $},this.setRenderTargetTextures=function(y,D,W){let k=H.get(y);k.__autoAllocateDepthBuffer=y.resolveDepthBuffer===!1,k.__autoAllocateDepthBuffer===!1&&(k.__useRenderToTexture=!1),H.get(y.texture).__webglTexture=D,H.get(y.depthTexture).__webglTexture=k.__autoAllocateDepthBuffer?void 0:W,k.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(y,D){let W=H.get(y);W.__webglFramebuffer=D,W.__useDefaultFramebuffer=D===void 0},this.setRenderTarget=function(y,D=0,W=0){$=y,G=D,V=W;let k=null,z=!1,me=!1;if(y){let fe=H.get(y);if(fe.__useDefaultFramebuffer!==void 0){x.bindFramebuffer(F.FRAMEBUFFER,fe.__webglFramebuffer),re.copy(y.viewport),pe.copy(y.scissor),Xe=y.scissorTest,x.viewport(re),x.scissor(pe),x.setScissorTest(Xe),Z=-1;return}else if(fe.__webglFramebuffer===void 0)q.setupRenderTarget(y);else if(fe.__hasExternalTextures)q.rebindTextures(y,H.get(y.texture).__webglTexture,H.get(y.depthTexture).__webglTexture);else if(y.depthBuffer){let We=y.depthTexture;if(fe.__boundDepthTexture!==We){if(We!==null&&H.has(We)&&(y.width!==We.image.width||y.height!==We.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");q.setupDepthRenderbuffer(y)}}let Ee=y.texture;(Ee.isData3DTexture||Ee.isDataArrayTexture||Ee.isCompressedArrayTexture)&&(me=!0);let Ce=H.get(y).__webglFramebuffer;y.isWebGLCubeRenderTarget?(Array.isArray(Ce[D])?k=Ce[D][W]:k=Ce[D],z=!0):y.samples>0&&q.useMultisampledRTT(y)===!1?k=H.get(y).__webglMultisampledFramebuffer:Array.isArray(Ce)?k=Ce[W]:k=Ce,re.copy(y.viewport),pe.copy(y.scissor),Xe=y.scissorTest}else re.copy(Fe).multiplyScalar(ee).floor(),pe.copy(Ct).multiplyScalar(ee).floor(),Xe=Ye;if(W!==0&&(k=B),x.bindFramebuffer(F.FRAMEBUFFER,k)&&x.drawBuffers(y,k),x.viewport(re),x.scissor(pe),x.setScissorTest(Xe),z){let fe=H.get(y.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+D,fe.__webglTexture,W)}else if(me){let fe=D;for(let Ee=0;Ee<y.textures.length;Ee++){let Ce=H.get(y.textures[Ee]);F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0+Ee,Ce.__webglTexture,W,fe)}}else if(y!==null&&W!==0){let fe=H.get(y.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,fe.__webglTexture,W)}Z=-1},this.readRenderTargetPixels=function(y,D,W,k,z,me,ye,fe=0){if(!(y&&y.isWebGLRenderTarget)){Be("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ee=H.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&ye!==void 0&&(Ee=Ee[ye]),Ee){x.bindFramebuffer(F.FRAMEBUFFER,Ee);try{let Ce=y.textures[fe],We=Ce.format,Ke=Ce.type;if(y.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+fe),!T.textureFormatReadable(We)){Be("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!T.textureTypeReadable(Ke)){Be("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}D>=0&&D<=y.width-k&&W>=0&&W<=y.height-z&&F.readPixels(D,W,k,z,he.convert(We),he.convert(Ke),me)}finally{let Ce=$!==null?H.get($).__webglFramebuffer:null;x.bindFramebuffer(F.FRAMEBUFFER,Ce)}}},this.readRenderTargetPixelsAsync=async function(y,D,W,k,z,me,ye,fe=0){if(!(y&&y.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ee=H.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&ye!==void 0&&(Ee=Ee[ye]),Ee)if(D>=0&&D<=y.width-k&&W>=0&&W<=y.height-z){x.bindFramebuffer(F.FRAMEBUFFER,Ee);let Ce=y.textures[fe],We=Ce.format,Ke=Ce.type;if(y.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+fe),!T.textureFormatReadable(We))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!T.textureTypeReadable(Ke))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let Ie=F.createBuffer();F.bindBuffer(F.PIXEL_PACK_BUFFER,Ie),F.bufferData(F.PIXEL_PACK_BUFFER,me.byteLength,F.STREAM_READ),F.readPixels(D,W,k,z,he.convert(We),he.convert(Ke),0);let vt=$!==null?H.get($).__webglFramebuffer:null;x.bindFramebuffer(F.FRAMEBUFFER,vt);let Wt=F.fenceSync(F.SYNC_GPU_COMMANDS_COMPLETE,0);return F.flush(),await km(F,Wt,4),F.bindBuffer(F.PIXEL_PACK_BUFFER,Ie),F.getBufferSubData(F.PIXEL_PACK_BUFFER,0,me),F.deleteBuffer(Ie),F.deleteSync(Wt),me}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(y,D=null,W=0){let k=Math.pow(2,-W),z=Math.floor(y.image.width*k),me=Math.floor(y.image.height*k),ye=D!==null?D.x:0,fe=D!==null?D.y:0;q.setTexture2D(y,0),F.copyTexSubImage2D(F.TEXTURE_2D,W,0,0,ye,fe,z,me),x.unbindTexture()},this.copyTextureToTexture=function(y,D,W=null,k=null,z=0,me=0){let ye,fe,Ee,Ce,We,Ke,Ie,vt,Wt,kt=y.isCompressedTexture?y.mipmaps[me]:y.image;if(W!==null)ye=W.max.x-W.min.x,fe=W.max.y-W.min.y,Ee=W.isBox3?W.max.z-W.min.z:1,Ce=W.min.x,We=W.min.y,Ke=W.isBox3?W.min.z:0;else{let Xt=Math.pow(2,-z);ye=Math.floor(kt.width*Xt),fe=Math.floor(kt.height*Xt),y.isDataArrayTexture?Ee=kt.depth:y.isData3DTexture?Ee=Math.floor(kt.depth*Xt):Ee=1,Ce=0,We=0,Ke=0}k!==null?(Ie=k.x,vt=k.y,Wt=k.z):(Ie=0,vt=0,Wt=0);let _t=he.convert(D.format),pn=he.convert(D.type),_e;D.isData3DTexture?(q.setTexture3D(D,0),_e=F.TEXTURE_3D):D.isDataArrayTexture||D.isCompressedArrayTexture?(q.setTexture2DArray(D,0),_e=F.TEXTURE_2D_ARRAY):(q.setTexture2D(D,0),_e=F.TEXTURE_2D),x.activeTexture(F.TEXTURE0),x.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,D.flipY),x.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,D.premultiplyAlpha),x.pixelStorei(F.UNPACK_ALIGNMENT,D.unpackAlignment);let Un=x.getParameter(F.UNPACK_ROW_LENGTH),ot=x.getParameter(F.UNPACK_IMAGE_HEIGHT),Zn=x.getParameter(F.UNPACK_SKIP_PIXELS),bi=x.getParameter(F.UNPACK_SKIP_ROWS),ps=x.getParameter(F.UNPACK_SKIP_IMAGES);x.pixelStorei(F.UNPACK_ROW_LENGTH,kt.width),x.pixelStorei(F.UNPACK_IMAGE_HEIGHT,kt.height),x.pixelStorei(F.UNPACK_SKIP_PIXELS,Ce),x.pixelStorei(F.UNPACK_SKIP_ROWS,We),x.pixelStorei(F.UNPACK_SKIP_IMAGES,Ke);let Cr=y.isDataArrayTexture||y.isData3DTexture,yt=D.isDataArrayTexture||D.isData3DTexture;if(y.isDepthTexture){let Xt=H.get(y),ms=H.get(D),Mt=H.get(Xt.__renderTarget),gs=H.get(ms.__renderTarget);x.bindFramebuffer(F.READ_FRAMEBUFFER,Mt.__webglFramebuffer),x.bindFramebuffer(F.DRAW_FRAMEBUFFER,gs.__webglFramebuffer);for(let Rr=0;Rr<Ee;Rr++)Cr&&(F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,H.get(y).__webglTexture,z,Ke+Rr),F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,H.get(D).__webglTexture,me,Wt+Rr)),F.blitFramebuffer(Ce,We,ye,fe,Ie,vt,ye,fe,F.DEPTH_BUFFER_BIT,F.NEAREST);x.bindFramebuffer(F.READ_FRAMEBUFFER,null),x.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else if(z!==0||y.isRenderTargetTexture||H.has(y)){let Xt=H.get(y),ms=H.get(D);x.bindFramebuffer(F.READ_FRAMEBUFFER,X),x.bindFramebuffer(F.DRAW_FRAMEBUFFER,U);for(let Mt=0;Mt<Ee;Mt++)Cr?F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,Xt.__webglTexture,z,Ke+Mt):F.framebufferTexture2D(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,Xt.__webglTexture,z),yt?F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,ms.__webglTexture,me,Wt+Mt):F.framebufferTexture2D(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,ms.__webglTexture,me),z!==0?F.blitFramebuffer(Ce,We,ye,fe,Ie,vt,ye,fe,F.COLOR_BUFFER_BIT,F.NEAREST):yt?F.copyTexSubImage3D(_e,me,Ie,vt,Wt+Mt,Ce,We,ye,fe):F.copyTexSubImage2D(_e,me,Ie,vt,Ce,We,ye,fe);x.bindFramebuffer(F.READ_FRAMEBUFFER,null),x.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else yt?y.isDataTexture||y.isData3DTexture?F.texSubImage3D(_e,me,Ie,vt,Wt,ye,fe,Ee,_t,pn,kt.data):D.isCompressedArrayTexture?F.compressedTexSubImage3D(_e,me,Ie,vt,Wt,ye,fe,Ee,_t,kt.data):F.texSubImage3D(_e,me,Ie,vt,Wt,ye,fe,Ee,_t,pn,kt):y.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,me,Ie,vt,ye,fe,_t,pn,kt.data):y.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,me,Ie,vt,kt.width,kt.height,_t,kt.data):F.texSubImage2D(F.TEXTURE_2D,me,Ie,vt,ye,fe,_t,pn,kt);x.pixelStorei(F.UNPACK_ROW_LENGTH,Un),x.pixelStorei(F.UNPACK_IMAGE_HEIGHT,ot),x.pixelStorei(F.UNPACK_SKIP_PIXELS,Zn),x.pixelStorei(F.UNPACK_SKIP_ROWS,bi),x.pixelStorei(F.UNPACK_SKIP_IMAGES,ps),me===0&&D.generateMipmaps&&F.generateMipmap(_e),x.unbindTexture()},this.initRenderTarget=function(y){H.get(y).__webglFramebuffer===void 0&&q.setupRenderTarget(y)},this.initTexture=function(y){y.isCubeTexture?q.setTextureCube(y,0):y.isData3DTexture?q.setTexture3D(y,0):y.isDataArrayTexture||y.isCompressedArrayTexture?q.setTexture2DArray(y,0):q.setTexture2D(y,0),x.unbindTexture()},this.resetState=function(){G=0,V=0,$=null,x.reset(),ge.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return hi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let n=this.getContext();n.drawingBufferColorSpace=je._getDrawingBufferColorSpace(e),n.unpackColorSpace=je._getUnpackColorSpace()}};var na={amber:"#FFB020",coral:"#FF6B4A",magenta:"#E85C9A",violet:"#9B7BFF",azure:"#4FA8FF",teal:"#2FD0C0",lime:"#9BD648",bone:"#E8DCC8"},Ld=Object.keys(na),_g=["text","label","color","pos","placed","createdAt","lastTouchedAt"];function bg(t,e,n){return{id:t,name:e,createdAt:n,lastOpenedAt:n,nodes:{},links:{},holding:{origin:[0,-14,0],radius:5.2},clocks:{},removedLinks:{}}}function Nd(t,e){let n=!1,i=(s,r,a)=>{let o=t.clocks[s];if(o===void 0||r>o)return t.clocks[s]=r,t.clocks[s+"#a"]=yg(a),!0;if(r===o){let l=yg(a);if(l>(t.clocks[s+"#a"]??-1))return t.clocks[s+"#a"]=l,!0}return!1};switch(e.t){case"node.set":{let s=t.nodes[e.id],r=s??{id:e.id,text:"",label:"",color:"bone",pos:[0,0,0],placed:!1,createdAt:e.ts,lastTouchedAt:e.ts};for(let a of _g)a in e.fields&&i(`n:${e.id}:${a}`,e.ts,e.actor)&&(r[a]=e.fields[a],n=!0);return s||(t.nodes[e.id]=r,n=!0),s===void 0&&t.clocks[`n:${e.id}:#del`]!==void 0&&delete t.clocks[`n:${e.id}:#del`],n}case"node.del":{if(_g.some(r=>(t.clocks[`n:${e.id}:${r}`]??-1)>e.ts))return!1;if(t.nodes[e.id]){delete t.nodes[e.id];for(let r of Object.keys(t.links))(t.links[r].a===e.id||t.links[r].b===e.id)&&(t.removedLinks[r]=e.ts,delete t.links[r]);t.clocks[`n:${e.id}:#del`]=e.ts,n=!0}return n}case"link.add":return t.removedLinks[e.id]!==void 0&&t.removedLinks[e.id]>=e.ts?!1:(t.links[e.id]||(t.links[e.id]={id:e.id,a:e.a,b:e.b,createdAt:e.ts},delete t.removedLinks[e.id],t.clocks[`l:${e.id}`]=e.ts,n=!0),n);case"link.del":return(t.clocks[`l:${e.id}`]??-1)>e.ts?!1:(t.links[e.id]&&(delete t.links[e.id],t.removedLinks[e.id]=e.ts,n=!0),n);case"map.set":{for(let s of Object.keys(e.fields))i(`m:${s}`,e.ts,e.actor)&&(t[s]=e.fields[s],n=!0);return n}}}function yg(t){let e=2166136261;for(let n=0;n<t.length;n++)e^=t.charCodeAt(n),e=Math.imul(e,16777619);return e>>>0}function Cn(t){return Object.values(t.nodes).sort((e,n)=>e.id<n.id?-1:e.id>n.id?1:0)}function Mg(t){return Object.values(t.links).sort((e,n)=>e.id<n.id?-1:e.id>n.id?1:0)}function lr(t){return Cn(t).filter(e=>!e.placed)}function Fd(t,e){let n=new Set;for(let i of Object.values(t.links))i.a===e?n.add(i.b):i.b===e&&n.add(i.a);return n}function qc(t,e){let n=1/0,i=-1/0;for(let s of Object.values(t.nodes))s.createdAt<n&&(n=s.createdAt),s.createdAt>i&&(i=s.createdAt);return!isFinite(n)||i<=n?1:(e.createdAt-n)/(i-n)}function Sg(t,e,n){let i=new Map,s=e?Fd(t,e):new Set;for(let r of Object.values(t.nodes))i.set(r.id,r.id===e?"selected":n.has(r.id)?"searchHit":r.placed?s.has(r.id)?"connected":"plain":"unplaced");return i}function wg(t,e){let n=e.trim().toLowerCase();return n?Cn(t).map(i=>{let s=i.text.toLowerCase(),r=i.label.toLowerCase(),a=-1;return s===n?a=0:s.startsWith(n)?a=1:r===n?a=2:s.includes(n)?a=3:r.includes(n)&&(a=4),{n:i,score:a}}).filter(i=>i.score>=0).sort((i,s)=>i.score-s.score||(i.n.id<s.n.id?-1:1)).map(i=>({n:i.n,field:i.score===2||i.score===4?"label":"text"})):[]}var Eg=0;function Dd(t){Eg++;let e=Math.floor(Math.random()*16777215).toString(36);return`${t}${Date.now().toString(36)}${Eg.toString(36)}${e}`}var Yc=class t{doc;actor;lastTs=0;listeners=[];transport=null;constructor(e,n){this.doc=e,this.actor=n}static blank(e,n,i){return new t(bg(e,n,Date.now()),i)}lastChange=null;describe(e){if(e.t==="node.set"){let n=e.fields;return"pos"in n&&n.placed===!0?"placed a node":"pos"in n?"moved a node":"text"in n?"edited text":"color"in n?"changed a colour":"label"in n?"set a label":"edited a node"}return e.t==="link.add"?"connected two nodes":e.t==="link.del"?"removed a filament":e.t==="node.del"?"deleted a node":e.t}attach(e){this.transport=e,e.onRemote(n=>{this.lastTs=Math.max(this.lastTs,n.ts),Nd(this.doc,n)&&(this.lastChange={actor:n.actor,remote:n.actor!==this.actor,what:this.describe(n),at:n.ts},this.emit(n))})}detach(){this.transport=null}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(n=>n!==e)}}emit(e){for(let n of this.listeners)n(this.doc,e)}ts(){let e=Date.now();return this.lastTs=e>this.lastTs?e:this.lastTs+1,this.lastTs}commit(e){let n=e(this.ts());return Nd(this.doc,n)&&(this.lastChange={actor:n.actor,remote:!1,what:this.describe(n),at:n.ts},this.emit(n)),this.transport?.send(n),n}replaceDoc(e){this.doc=e,this.emit(null)}quickAdd(e,n="bone"){let i=Dd("n"),s=lr(this.doc).length,r=this.doc.holding,a=s*2.39996%(Math.PI*2),o=r.radius*(.34+.42*(s%5/5)),l=[r.origin[0]+o*Math.cos(a),r.origin[1]+(s%3-1)*r.radius*.26,r.origin[2]+o*Math.sin(a)],c=Date.now();return this.commit(u=>({t:"node.set",id:i,actor:this.actor,ts:u,fields:{text:e,label:"holding",color:n,pos:l,placed:!1,createdAt:c,lastTouchedAt:c}})),i}place(e,n,i){let s=this.doc.nodes[e];if(!s)return;let r=i!==void 0?i:s.label==="holding"?"":s.label;this.commit(a=>({t:"node.set",id:e,actor:this.actor,ts:a,fields:{pos:n,placed:!0,lastTouchedAt:Date.now(),label:r}}))}move(e,n){this.doc.nodes[e]&&this.commit(i=>({t:"node.set",id:e,actor:this.actor,ts:i,fields:{pos:n,lastTouchedAt:Date.now()}}))}moveCluster(e,n){for(let i of e){let s=this.doc.nodes[i];if(!s)continue;let r=[s.pos[0]+n[0],s.pos[1]+n[1],s.pos[2]+n[2]];this.commit(a=>({t:"node.set",id:i,actor:this.actor,ts:a,fields:{pos:r,lastTouchedAt:Date.now()}}))}}setText(e,n){this.commit(i=>({t:"node.set",id:e,actor:this.actor,ts:i,fields:{text:n,lastTouchedAt:Date.now()}}))}setColor(e,n){this.commit(i=>({t:"node.set",id:e,actor:this.actor,ts:i,fields:{color:n,lastTouchedAt:Date.now()}}))}setLabel(e,n){this.commit(i=>({t:"node.set",id:e,actor:this.actor,ts:i,fields:{label:n,lastTouchedAt:Date.now()}}))}remove(e){this.commit(n=>({t:"node.del",id:e,actor:this.actor,ts:n}))}connect(e,n){if(e===n||!this.doc.nodes[e]||!this.doc.nodes[n])return null;let[i,s]=e<n?[e,n]:[n,e],r=`l${i}_${s}`;return this.doc.links[r]||this.commit(a=>({t:"link.add",id:r,a:i,b:s,actor:this.actor,ts:a})),r}disconnect(e,n){let[i,s]=e<n?[e,n]:[n,e],r=`l${i}_${s}`;this.doc.links[r]&&this.commit(a=>({t:"link.del",id:r,actor:this.actor,ts:a}))}rename(e){this.commit(n=>({t:"map.set",actor:this.actor,ts:n,fields:{name:e}}))}touchOpened(){this.commit(e=>({t:"map.set",actor:this.actor,ts:e,fields:{lastOpenedAt:Date.now()}}))}holdingCount(){return lr(this.doc).length}neighboursOf(e){return Fd(this.doc,e)}node(e){return this.doc.nodes[e]}};var Kc=class{constructor(e,n,i){this.url=e;this.actor=n;this.account=i}url;actor;ws=null;queue=[];remoteFns=[];snapFns=[];origin={from:"live"};connId=null;serverPid=null;mapsFns=[];statusFns=[];status="offline";detail="not connected";account;connect(e){this.setStatus("connecting",`connecting to ${this.url}`);let n=new WebSocket(`${this.url}?map=${encodeURIComponent(e)}&actor=${encodeURIComponent(this.actor)}&account=${encodeURIComponent(this.account)}`);this.ws=n,n.onopen=()=>{this.setStatus("live",`live \xB7 ${this.account}`);for(let i of this.queue.splice(0))n.send(JSON.stringify({t:"op",op:i}))},n.onclose=()=>{this.status!=="error"&&this.setStatus("offline","disconnected")},n.onerror=()=>this.setStatus("error","connection failed"),n.onmessage=i=>{let s=JSON.parse(i.data);if(s.t==="op")for(let r of this.remoteFns)r(s.op);else if(s.t==="snapshot"){this.origin=s.origin??{from:"live"},s.conn!==void 0&&(this.connId=s.conn),s.serverPid!==void 0&&(this.serverPid=s.serverPid);for(let r of this.snapFns)r(s.doc,this.origin)}else if(s.t==="maps")for(let r of this.mapsFns)r(s.maps);else s.t==="error"&&this.setStatus("error",s.message)}}close(){this.ws?.close(),this.ws=null}send(e){this.ws&&this.ws.readyState===WebSocket.OPEN?this.ws.send(JSON.stringify({t:"op",op:e})):this.queue.push(e)}request(e){this.ws&&this.ws.readyState===WebSocket.OPEN&&this.ws.send(JSON.stringify(e))}onRemote(e){this.remoteFns.push(e)}onSnapshot(e){this.snapFns.push(e)}onMaps(e){this.mapsFns.push(e)}onStatus(e){this.statusFns.push(e),e(this.status,this.detail)}setStatus(e,n){this.status=e,this.detail=n;for(let i of this.statusFns)i(e,n)}};var Ig="#120E0B",eS="#8A7F76",tS="#D8CCC0",Qc="#EFE6D8",nS={plain:0,connected:1,unplaced:2,searchHit:3,selected:4},mo={plain:.5,connected:.72,unplaced:.86,searchHit:.95,selected:1},Ag=new Map;function zd(t){let e=na[t]??t,n=Ag.get(e);return n||(n=new Ve(e),Ag.set(e,n)),n}var Tg=(t,e,n)=>.2126*t+.7152*e+.0722*n;var Ud=t=>t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4),Od=t=>t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055;function iS(t,e,n){let i=Ud(t),s=Ud(e),r=Ud(n),a=Math.cbrt(.4122214708*i+.5363325363*s+.0514459929*r),o=Math.cbrt(.2119034982*i+.6806995451*s+.1073969566*r),l=Math.cbrt(.0883024619*i+.2817188376*s+.6299787005*r);return[.2104542553*a+.793617785*o-.0040720468*l,1.9779984951*a-2.428592205*o+.4505937099*l,.0259040371*a+.7827717662*o-.808675766*l]}function Bd(t,e,n){let i=(t+.3963377774*e+.2158037573*n)**3,s=(t-.1055613458*e-.0638541728*n)**3,r=(t-.0894841775*e-1.291485548*n)**3;return[Od(4.0767416621*i-3.3077115913*s+.2309699292*r),Od(-1.2684380046*i+2.6097574011*s-.3413193965*r),Od(-.0041960863*i-.7034186147*s+1.707614701*r)]}var kd={plain:.26,connected:.37,unplaced:.48,searchHit:.59,selected:.7},sS=.35,rS=.1,Cg=["plain","connected","unplaced","searchHit","selected"],go=Cg.map((t,e)=>{let n=kd[t],i=e===0?rS:kd[Cg[e-1]];return(n-sS*(n-i))/n}),Rg=new Map;function Pg(t,e){let n=`${t}|${e}`,i=Rg.get(n);if(!i){let s=zd(t),r=kd[e],[,a,o]=iS(s.r,s.g,s.b),l=h=>{let f=0,g=1.4;for(let _=0;_<28;_++){let p=(f+g)/2,E=Bd(p,a*h,o*h).map(R=>Math.min(1,Math.max(0,R)));Tg(E[0],E[1],E[2])<r?f=p:g=p}return(f+g)/2},c=0,u=1,d=null;for(let h=0;h<22;h++){let f=(c+u)/2,g=Bd(l(f),a*f,o*f);g.every(p=>p>=-.002&&p<=1.002)&&Math.abs(Tg(Math.min(1,Math.max(0,g[0])),Math.min(1,Math.max(0,g[1])),Math.min(1,Math.max(0,g[2])))-r)<.004?(d=g.map(p=>Math.min(1,Math.max(0,p))),c=f):u=f}d||(d=Bd(l(0),0,0).map(f=>Math.min(1,Math.max(0,f)))),i=new Ve(d[0],d[1],d[2]),Rg.set(n,i)}return i}var aS=`
precision highp float;
attribute vec3  iPos;
