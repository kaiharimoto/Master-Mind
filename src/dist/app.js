...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ii,depthTest:!1,depthWrite:!1})}function s2(t,e,n){let i=new Float32Array(or),s=new F(0,1,0);return new tn({name:"SphericalGaussianBlur",defines:{n:or,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${t}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Xc(),fragmentShader:`
...
`)}var aM={[Ku]:"Linear",[Zu]:"Reinhard",[ju]:"Cineon",[Ju]:"ACESFilmic",[ed]:"AgX",[td]:"Neutral",[Qu]:"Custom"};function oM(t,e){let n=aM[e];return n===void 0?(Ue("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+t+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}var Vc=new F;function lM(){je.getLuminanceCoefficients(Vc);let t=Vc.x.toFixed(4),e=Vc.y.toFixed(4),n=Vc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${t}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+m);let R=E+p+a,S=E+m+o,b=tg(s,s.VERTEX_SHADER,R),M=tg(s,s.FRAGMENT_SHADER,S);s.attachShader(v,b),s.attachShader(v,M),n.index0AttributeName!==void 0?s.bindAttribLocation(v,0,n.index0AttributeName):n.hasPositionAttribute===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function w(C){if(t.debug.checkShaderErrors){let P=s.getProgramInfoLog(v)||"",O=s.getShaderInfoLog(b)||"",B=s.getShaderInfoLog(M)||"",L=P.trim(),W=O.trim(),z=B.trim(),$=!0,Z=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if($=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(s,v,b,M);else{let ee=ig(s,b,"vertex"),re=ig(s,M,"fragment");Be("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
Program Info Log: `+L+`
`+ee+`
`+re)}else L!==""?Ue("WebGLProgram: Program Info Log:",L):(W===""||z==="")&&(Z=!1);Z&&(C.diagnostics={runnable:$,programLog:L,vertexShader:{log:W,prefix:p},fragmentShader:{log:z,prefix:m}})}s.deleteShader(b),s.deleteShader(M),_=new ea(s,v),A=uM(s,v)}let _;this.getUniforms=function(){return _===void 0&&w(this),_};let A;this.getAttributes=function(){return A===void 0&&w(this),A};let I=n.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return I===!1&&(I=s.getProgramParameter(v,tM)),I},this.destroy=function(){i.releaseStatesOfProgram(this),s.deleteProgram(v),this.program=void 0},this.type=n.shaderType,this.name=n.shaderName,this.id=nM++,this.cacheKey=e,this.usedTimes=1,this.program=v,this.vertexShader=b,this.fragmentShader=M,this}var TM=0,Cd=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e,n,i){let s=this._getShaderCacheForMaterial(e);return s.has(n)===!1&&(s.add(n),n.usedTimes++),s.has(i)===!1&&(s.add(i),i.usedTimes++),this}remove(e){let n=this.materialCache.get(e);for(let i of n)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderStage(e){return this._getShaderStage(e.vertexShader)}getFragmentShaderStage(e){return this._getShaderStage(e.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){let n=this.materialCache,i=n.get(e);return i===void 0&&(i=new Set,n.set(e,i)),i}_getShaderStage(e){let n=this.shaderCache,i=n.get(e);return i===void 0&&(i=new Rd(e),n.set(e,i)),i}},Rd=class{constructor(e){this.id=TM++,this.code=e,this.usedTimes=0}};function CM(t){return t===Ns||t===oo||t===lo}function RM(t,e,n,i,s,r){let a=new za,o=new Cd,l=new Set,c=[],u=new Map,d=i.logarithmicDepthBuffer,h=i.precision,f={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function g(_){return l.add(_),_===0?"uv":`uv${_}`}function v(_,A,I,C,P,O){let B=C.fog,L=P.geometry,W=_.isMeshStandardMaterial||_.isMeshLambertMaterial||_.isMeshPhongMaterial?C.environment:null,z=_.isMeshStandardMaterial||_.isMeshLambertMaterial&&!_.envMap||_.isMeshPhongMaterial&&!_.envMap,$=e.get(_.envMap||W,z),Z=$&&$.mapping===to?$.image.height:null,ee=f[_.type];_.precision!==null&&(h=i.getMaxPrecision(_.precision),h!==_.precision&&Ue("WebGLProgram.getParameters:",_.precision,"not supported, using",h,"instead."));let re=L.morphAttributes.position||L.morphAttributes.normal||L.morphAttributes.color,le=re!==void 0?re.length:0,Ke=0;L.morphAttributes.position!==void 0&&(Ke=1),L.morphAttributes.normal!==void 0&&(Ke=2),L.morphAttributes.color!==void 0&&(Ke=3);let tt,$e,q,ne;if(ee){let Se=Fi[ee];tt=Se.vertexShader,$e=Se.fragmentShader}else{tt=_.vertexShader,$e=_.fragmentShader;let Se=o.getVertexShaderStage(_),kt=o.getFragmentShaderStage(_);o.update(_,Se,kt),q=Se.id,ne=kt.id}let Q=t.getRenderTarget(),De=t.state.buffers.depth.getReversed(),ke=P.isInstancedMesh===!0,Ne=P.isBatchedMesh===!0,bt=!!_.map,Ge=!!_.matcap,pt=!!$,at=!!_.aoMap,Je=!!_.lightMap,Lt=!!_.bumpMap&&_.wireframe===!1,Rt=!!_.normalMap,Nt=!!_.displacementMap,Gt=!!_.emissiveMap,It=!!_.metalnessMap,Ot=!!_.roughnessMap,D=_.anisotropy>0,wn=_.clearcoat>0,gt=_.dispersion>0,T=_.iridescence>0,x=_.sheen>0,k=_.transmission>0,G=D&&!!_.anisotropyMap,Y=wn&&!!_.clearcoatMap,ie=wn&&!!_.clearcoatNormalMap,oe=wn&&!!_.clearcoatRoughnessMap,K=T&&!!_.iridescenceMap,J=T&&!!_.iridescenceThicknessMap,ce=x&&!!_.sheenColorMap,Te=x&&!!_.sheenRoughnessMap,de=!!_.specularMap,he=!!_.specularColorMap,Fe=!!_.specularIntensityMap,Oe=k&&!!_.transmissionMap,We=k&&!!_.thicknessMap,N=!!_.gradientMap,ae=!!_.alphaMap,j=_.alphaTest>0,ue=!!_.alphaHash,ge=!!_.extensions,te=ui;_.toneMapped&&(Q===null||Q.isXRRenderTarget===!0)&&(te=t.toneMapping);let Ae={shaderID:ee,shaderType:_.type,shaderName:_.name,vertexShader:tt,fragmentShader:$e,defines:_.defines,customVertexShaderID:q,customFragmentShaderID:ne,isRawShaderMaterial:_.isRawShaderMaterial===!0,glslVersion:_.glslVersion,precision:h,batching:Ne,batchingColor:Ne&&P._colorsTexture!==null,instancing:ke,instancingColor:ke&&P.instanceColor!==null,instancingMorph:ke&&P.morphTexture!==null,outputColorSpace:Q===null?t.outputColorSpace:Q.isXRRenderTarget===!0?Q.texture.colorSpace:je.workingColorSpace,alphaToCoverage:!!_.alphaToCoverage,map:bt,matcap:Ge,envMap:pt,envMapMode:pt&&$.mapping,envMapCubeUVHeight:Z,aoMap:at,lightMap:Je,bumpMap:Lt,normalMap:Rt,displacementMap:Nt,emissiveMap:Gt,normalMapObjectSpace:Rt&&_.normalMapType===Im,normalMapTangentSpace:Rt&&_.normalMapType===hd,packedNormalMap:Rt&&_.normalMapType===hd&&CM(_.normalMap.format),metalnessMap:It,roughnessMap:Ot,anisotropy:D,anisotropyMap:G,clearcoat:wn,clearcoatMap:Y,clearcoatNormalMap:ie,clearcoatRoughnessMap:oe,dispersion:gt,iridescence:T,iridescenceMap:K,iridescenceThicknessMap:J,sheen:x,sheenColorMap:ce,sheenRoughnessMap:Te,specularMap:de,specularColorMap:he,specularIntensityMap:Fe,transmission:k,transmissionMap:Oe,thicknessMap:We,gradientMap:N,opaque:_.transparent===!1&&_.blending===Jn&&_.alphaToCoverage===!1,alphaMap:ae,alphaTest:j,alphaHash:ue,combine:_.combine,mapUv:bt&&g(_.map.channel),aoMapUv:at&&g(_.aoMap.channel),lightMapUv:Je&&g(_.lightMap.channel),bumpMapUv:Lt&&g(_.bumpMap.channel),normalMapUv:Rt&&g(_.normalMap.channel),displacementMapUv:Nt&&g(_.displacementMap.channel),emissiveMapUv:Gt&&g(_.emissiveMap.channel),metalnessMapUv:It&&g(_.metalnessMap.channel),roughnessMapUv:Ot&&g(_.roughnessMap.channel),anisotropyMapUv:G&&g(_.anisotropyMap.channel),clearcoatMapUv:Y&&g(_.clearcoatMap.channel),clearcoatNormalMapUv:ie&&g(_.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:oe&&g(_.clearcoatRoughnessMap.channel),iridescenceMapUv:K&&g(_.iridescenceMap.channel),iridescenceThicknessMapUv:J&&g(_.iridescenceThicknessMap.channel),sheenColorMapUv:ce&&g(_.sheenColorMap.channel),sheenRoughnessMapUv:Te&&g(_.sheenRoughnessMap.channel),specularMapUv:de&&g(_.specularMap.channel),specularColorMapUv:he&&g(_.specularColorMap.channel),specularIntensityMapUv:Fe&&g(_.specularIntensityMap.channel),transmissionMapUv:Oe&&g(_.transmissionMap.channel),thicknessMapUv:We&&g(_.thicknessMap.channel),alphaMapUv:ae&&g(_.alphaMap.channel),vertexTangents:!!L.attributes.tangent&&(Rt||D),vertexNormals:!!L.attributes.normal,vertexColors:_.vertexColors,vertexAlphas:_.vertexColors===!0&&!!L.attributes.color&&L.attributes.color.itemSize===4,pointsUvs:P.isPoints===!0&&!!L.attributes.uv&&(bt||ae),fog:!!B,useFog:_.fog===!0,fogExp2:!!B&&B.isFogExp2,flatShading:_.wireframe===!1&&(_.flatShading===!0||L.attributes.normal===void 0&&Rt===!1&&(_.isMeshLambertMaterial||_.isMeshPhongMaterial||_.isMeshStandardMaterial||_.isMeshPhysicalMaterial)),sizeAttenuation:_.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:De,skinning:P.isSkinnedMesh===!0,hasPositionAttribute:L.attributes.position!==void 0,morphTargets:L.morphAttributes.position!==void 0,morphNormals:L.morphAttributes.normal!==void 0,morphColors:L.morphAttributes.color!==void 0,morphTargetsCount:le,morphTextureStride:Ke,numDirLights:A.directional.length,numPointLights:A.point.length,numSpotLights:A.spot.length,numSpotLightMaps:A.spotLightMap.length,numRectAreaLights:A.rectArea.length,numHemiLights:A.hemi.length,numDirLightShadows:A.directionalShadowMap.length,numPointLightShadows:A.pointShadowMap.length,numSpotLightShadows:A.spotShadowMap.length,numSpotLightShadowsWithMaps:A.numSpotLightShadowsWithMaps,numLightProbes:A.numLightProbes,numLightProbeGrids:O.length,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:_.dithering,shadowMapEnabled:t.shadowMap.enabled&&I.length>0,shadowMapType:t.shadowMap.type,toneMapping:te,decodeVideoTexture:bt&&_.map.isVideoTexture===!0&&je.getTransfer(_.map.colorSpace)===mt,decodeVideoTextureEmissive:Gt&&_.emissiveMap.isVideoTexture===!0&&je.getTransfer(_.emissiveMap.colorSpace)===mt,premultipliedAlpha:_.premultipliedAlpha,doubleSided:_.side===Ri,flipSided:_.side===bn,useDepthPacking:_.depthPacking>=0,depthPacking:_.depthPacking||0,index0AttributeName:_.index0AttributeName,extensionClipCullDistance:ge&&_.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ge&&_.extensions.multiDraw===!0||Ne)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:_.customProgramCacheKey()};return Ae.vertexUv1s=l.has(1),Ae.vertexUv2s=l.has(2),Ae.vertexUv3s=l.has(3),l.clear(),Ae}function p(_){let A=[];if(_.shaderID?A.push(_.shaderID):(A.push(_.customVertexShaderID),A.push(_.customFragmentShaderID)),_.defines!==void 0)for(let I in _.defines)A.push(I),A.push(_.defines[I]);return _.isRawShaderMaterial===!1&&(m(A,_),E(A,_),A.push(t.outputColorSpace)),A.push(_.customProgramCacheKey),A.join()}function m(_,A){_.push(A.precision),_.push(A.outputColorSpace),_.push(A.envMapMode),_.push(A.envMapCubeUVHeight),_.push(A.mapUv),_.push(A.alphaMapUv),_.push(A.lightMapUv),_.push(A.aoMapUv),_.push(A.bumpMapUv),_.push(A.normalMapUv),_.push(A.displacementMapUv),_.push(A.emissiveMapUv),_.push(A.metalnessMapUv),_.push(A.roughnessMapUv),_.push(A.anisotropyMapUv),_.push(A.clearcoatMapUv),_.push(A.clearcoatNormalMapUv),_.push(A.clearcoatRoughnessMapUv),_.push(A.iridescenceMapUv),_.push(A.iridescenceThicknessMapUv),_.push(A.sheenColorMapUv),_.push(A.sheenRoughnessMapUv),_.push(A.specularMapUv),_.push(A.specularColorMapUv),_.push(A.specularIntensityMapUv),_.push(A.transmissionMapUv),_.push(A.thicknessMapUv),_.push(A.combine),_.push(A.fogExp2),_.push(A.sizeAttenuation),_.push(A.morphTargetsCount),_.push(A.morphAttributeCount),_.push(A.numDirLights),_.push(A.numPointLights),_.push(A.numSpotLights),_.push(A.numSpotLightMaps),_.push(A.numHemiLights),_.push(A.numRectAreaLights),_.push(A.numDirLightShadows),_.push(A.numPointLightShadows),_.push(A.numSpotLightShadows),_.push(A.numSpotLightShadowsWithMaps),_.push(A.numLightProbes),_.push(A.shadowMapType),_.push(A.toneMapping),_.push(A.numClippingPlanes),_.push(A.numClipIntersection),_.push(A.depthPacking)}function E(_,A){a.disableAll(),A.instancing&&a.enable(0),A.instancingColor&&a.enable(1),A.instancingMorph&&a.enable(2),A.matcap&&a.enable(3),A.envMap&&a.enable(4),A.normalMapObjectSpace&&a.enable(5),A.normalMapTangentSpace&&a.enable(6),A.clearcoat&&a.enable(7),A.iridescence&&a.enable(8),A.alphaTest&&a.enable(9),A.vertexColors&&a.enable(10),A.vertexAlphas&&a.enable(11),A.vertexUv1s&&a.enable(12),A.vertexUv2s&&a.enable(13),A.vertexUv3s&&a.enable(14),A.vertexTangents&&a.enable(15),A.anisotropy&&a.enable(16),A.alphaHash&&a.enable(17),A.batching&&a.enable(18),A.dispersion&&a.enable(19),A.batchingColor&&a.enable(20),A.gradientMap&&a.enable(21),A.packedNormalMap&&a.enable(22),A.vertexNormals&&a.enable(23),_.push(a.mask),a.disableAll(),A.fog&&a.enable(0),A.useFog&&a.enable(1),A.flatShading&&a.enable(2),A.logarithmicDepthBuffer&&a.enable(3),A.reversedDepthBuffer&&a.enable(4),A.skinning&&a.enable(5),A.morphTargets&&a.enable(6),A.morphNormals&&a.enable(7),A.morphColors&&a.enable(8),A.premultipliedAlpha&&a.enable(9),A.shadowMapEnabled&&a.enable(10),A.doubleSided&&a.enable(11),A.flipSided&&a.enable(12),A.useDepthPacking&&a.enable(13),A.dithering&&a.enable(14),A.transmission&&a.enable(15),A.sheen&&a.enable(16),A.opaque&&a.enable(17),A.pointsUvs&&a.enable(18),A.decodeVideoTexture&&a.enable(19),A.decodeVideoTextureEmissive&&a.enable(20),A.alphaToCoverage&&a.enable(21),A.numLightProbeGrids>0&&a.enable(22),A.hasPositionAttribute&&a.enable(23),_.push(a.mask)}function R(_){let A=f[_.type],I;if(A){let C=Fi[A];I=Hm.clone(C.uniforms)}else I=_.uniforms;return I}function S(_,A){let I=u.get(A);return I!==void 0?++I.usedTimes:(I=new AM(t,A,_,s),c.push(I),u.set(A,I)),I}function b(_){if(--_.usedTimes===0){let A=c.indexOf(_);c[A]=c[c.length-1],c.pop(),u.delete(_.cacheKey),_.destroy()}}function M(_){o.remove(_)}function w(){o.dispose()}return{getParameters:v,getProgramCacheKey:p,getUniforms:R,acquireProgram:S,releaseProgram:b,releaseShaderCache:M,programs:c,dispose:w}}function IM(){let t=new WeakMap;function e(a){return t.has(a)}function n(a){let o=t.get(a);return o===void 0&&(o={},t.set(a,o)),o}function i(a){t.delete(a)}function s(a,o,l){t.get(a)[o]=l}function r(){t=new WeakMap}return{has:e,get:n,remove:i,update:s,dispose:r}}function PM(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.material.id!==e.material.id?t.material.id-e.material.id:t.materialVariant!==e.materialVariant?t.materialVariant-e.materialVariant:t.z!==e.z?t.z-e.z:t.id-e.id}function lg(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.z!==e.z?e.z-t.z:t.id-e.id}function cg(){let t=[],e=0,n=[],i=[],s=[];function r(){e=0,n.length=0,i.length=0,s.length=0}function a(h){let f=0;return h.isInstancedMesh&&(f+=2),h.isSkinnedMesh&&(f+=1),f}function o(h,f,g,v,p,m){let E=t[e];return E===void 0?(E={id:h.id,object:h,geometry:f,material:g,materialVariant:a(h),groupOrder:v,renderOrder:h.renderOrder,z:p,group:m},t[e]=E):(E.id=h.id,E.object=h,E.geometry=f,E.material=g,E.materialVariant=a(h),E.groupOrder=v,E.renderOrder=h.renderOrder,E.z=p,E.group=m),e++,E}function l(h,f,g,v,p,m){let E=o(h,f,g,v,p,m);g.transmission>0?i.push(E):g.transparent===!0?s.push(E):n.push(E)}function c(h,f,g,v,p,m){let E=o(h,f,g,v,p,m);g.transmission>0?i.unshift(E):g.transparent===!0?s.unshift(E):n.unshift(E)}function u(h,f,g){n.length>1&&n.sort(h||PM),i.length>1&&i.sort(f||lg),s.length>1&&s.sort(f||lg),g&&(n.reverse(),i.reverse(),s.reverse())}function d(){for(let h=e,f=t.length;h<f;h++){let g=t[h];if(g.id===null)break;g.id=null,g.object=null,g.geometry=null,g.material=null,g.group=null}}return{opaque:n,transmissive:i,transparent:s,init:r,push:l,unshift:c,finish:d,sort:u}}function LM(){let t=new WeakMap;function e(i,s){let r=t.get(i),a;return r===void 0?(a=new cg,t.set(i,[a])):s>=r.length?(a=new cg,r.push(a)):a=r[s],a}function n(){t=new WeakMap}return{get:e,dispose:n}}function NM(){let t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={direction:new F,color:new Ve};break;case"SpotLight":n={position:new F,direction:new F,color:new Ve,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":n={position:new F,color:new Ve,distance:0,decay:0};break;case"HemisphereLight":n={direction:new F,skyColor:new Ve,groundColor:new Ve};break;case"RectAreaLight":n={color:new Ve,position:new F,halfWidth:new F,halfHeight:new F};break}return t[e.id]=n,n}}}function FM(){let t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Qe};break;case"SpotLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Qe};break;case"PointLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Qe,shadowCameraNear:1,shadowCameraFar:1e3};break}return t[e.id]=n,n}}}var DM=0;function UM(t,e){return(e.castShadow?2:0)-(t.castShadow?2:0)+(e.map?1:0)-(t.map?1:0)}function OM(t){let e=new NM,n=FM(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new F);let s=new F,r=new zt,a=new zt;function o(c){let u=0,d=0,h=0;for(let A=0;A<9;A++)i.probe[A].set(0,0,0);let f=0,g=0,v=0,p=0,m=0,E=0,R=0,S=0,b=0,M=0,w=0;c.sort(UM);for(let A=0,I=c.length;A<I;A++){let C=c[A],P=C.color,O=C.intensity,B=C.distance,L=null;if(C.shadow&&C.shadow.map&&(C.shadow.map.texture.format===Ns?L=C.shadow.map.texture:L=C.shadow.map.depthTexture||C.shadow.map.texture),C.isAmbientLight)u+=P.r*O,d+=P.g*O,h+=P.b*O;else if(C.isLightProbe){for(let W=0;W<9;W++)i.probe[W].addScaledVector(C.sh.coefficients[W],O);w++}else if(C.isDirectionalLight){let W=e.get(C);if(W.color.copy(C.color).multiplyScalar(C.intensity),C.castShadow){let z=C.shadow,$=n.get(C);$.shadowIntensity=z.intensity,$.shadowBias=z.bias,$.shadowNormalBias=z.normalBias,$.shadowRadius=z.radius,$.shadowMapSize=z.mapSize,i.directionalShadow[f]=$,i.directionalShadowMap[f]=L,i.directionalShadowMatrix[f]=C.shadow.matrix,E++}i.directional[f]=W,f++}else if(C.isSpotLight){let W=e.get(C);W.position.setFromMatrixPosition(C.matrixWorld),W.color.copy(P).multiplyScalar(O),W.distance=B,W.coneCos=Math.cos(C.angle),W.penumbraCos=Math.cos(C.angle*(1-C.penumbra)),W.decay=C.decay,i.spot[v]=W;let z=C.shadow;if(C.map&&(i.spotLightMap[b]=C.map,b++,z.updateMatrices(C),C.castShadow&&M++),i.spotLightMatrix[v]=z.matrix,C.castShadow){let $=n.get(C);$.shadowIntensity=z.intensity,$.shadowBias=z.bias,$.shadowNormalBias=z.normalBias,$.shadowRadius=z.radius,$.shadowMapSize=z.mapSize,i.spotShadow[v]=$,i.spotShadowMap[v]=L,S++}v++}else if(C.isRectAreaLight){let W=e.get(C);W.color.copy(P).multiplyScalar(O),W.halfWidth.set(C.width*.5,0,0),W.halfHeight.set(0,C.height*.5,0),i.rectArea[p]=W,p++}else if(C.isPointLight){let W=e.get(C);if(W.color.copy(C.color).multiplyScalar(C.intensity),W.distance=C.distance,W.decay=C.decay,C.castShadow){let z=C.shadow,$=n.get(C);$.shadowIntensity=z.intensity,$.shadowBias=z.bias,$.shadowNormalBias=z.normalBias,$.shadowRadius=z.radius,$.shadowMapSize=z.mapSize,$.shadowCameraNear=z.camera.near,$.shadowCameraFar=z.camera.far,i.pointShadow[g]=$,i.pointShadowMap[g]=L,i.pointShadowMatrix[g]=C.shadow.matrix,R++}i.point[g]=W,g++}else if(C.isHemisphereLight){let W=e.get(C);W.skyColor.copy(C.color).multiplyScalar(O),W.groundColor.copy(C.groundColor).multiplyScalar(O),i.hemi[m]=W,m++}}p>0&&(t.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=fe.LTC_FLOAT_1,i.rectAreaLTC2=fe.LTC_FLOAT_2):(i.rectAreaLTC1=fe.LTC_HALF_1,i.rectAreaLTC2=fe.LTC_HALF_2)),i.ambient[0]=u,i.ambient[1]=d,i.ambient[2]=h;let _=i.hash;(_.directionalLength!==f||_.pointLength!==g||_.spotLength!==v||_.rectAreaLength!==p||_.hemiLength!==m||_.numDirectionalShadows!==E||_.numPointShadows!==R||_.numSpotShadows!==S||_.numSpotMaps!==b||_.numLightProbes!==w)&&(i.directional.length=f,i.spot.length=v,i.rectArea.length=p,i.point.length=g,i.hemi.length=m,i.directionalShadow.length=E,i.directionalShadowMap.length=E,i.pointShadow.length=R,i.pointShadowMap.length=R,i.spotShadow.length=S,i.spotShadowMap.length=S,i.directionalShadowMatrix.length=E,i.pointShadowMatrix.length=R,i.spotLightMatrix.length=S+b-M,i.spotLightMap.length=b,i.numSpotLightShadowsWithMaps=M,i.numLightProbes=w,_.directionalLength=f,_.pointLength=g,_.spotLength=v,_.rectAreaLength=p,_.hemiLength=m,_.numDirectionalShadows=E,_.numPointShadows=R,_.numSpotShadows=S,_.numSpotMaps=b,_.numLightProbes=w,i.version=DM++)}function l(c,u){let d=0,h=0,f=0,g=0,v=0,p=u.matrixWorldInverse;for(let m=0,E=c.length;m<E;m++){let R=c[m];if(R.isDirectionalLight){let S=i.directional[d];S.direction.setFromMatrixPosition(R.matrixWorld),s.setFromMatrixPosition(R.target.matrixWorld),S.direction.sub(s),S.direction.transformDirection(p),d++}else if(R.isSpotLight){let S=i.spot[f];S.position.setFromMatrixPosition(R.matrixWorld),S.position.applyMatrix4(p),S.direction.setFromMatrixPosition(R.matrixWorld),s.setFromMatrixPosition(R.target.matrixWorld),S.direction.sub(s),S.direction.transformDirection(p),f++}else if(R.isRectAreaLight){let S=i.rectArea[g];S.position.setFromMatrixPosition(R.matrixWorld),S.position.applyMatrix4(p),a.identity(),r.copy(R.matrixWorld),r.premultiply(p),a.extractRotation(r),S.halfWidth.set(R.width*.5,0,0),S.halfHeight.set(0,R.height*.5,0),S.halfWidth.applyMatrix4(a),S.halfHeight.applyMatrix4(a),g++}else if(R.isPointLight){let S=i.point[h];S.position.setFromMatrixPosition(R.matrixWorld),S.position.applyMatrix4(p),h++}else if(R.isHemisphereLight){let S=i.hemi[v];S.direction.setFromMatrixPosition(R.matrixWorld),S.direction.transformDirection(p),v++}}}return{setup:o,setupView:l,state:i}}function hg(t){let e=new OM(t),n=[],i=[],s=[];function r(h){d.camera=h,n.length=0,i.length=0,s.length=0}function a(h){n.push(h)}function o(h){i.push(h)}function l(h){s.push(h)}function c(){e.setup(n)}function u(h){e.setupView(n,h)}let d={lightsArray:n,shadowsArray:i,lightProbeGridArray:s,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:r,state:d,setupLights:c,setupLightsView:u,pushLight:a,pushShadow:o,pushLightProbeGrid:l}}function kM(t){let e=new WeakMap;function n(s,r=0){let a=e.get(s),o;return a===void 0?(o=new hg(t),e.set(s,[o])):r>=a.length?(o=new hg(t),a.push(o)):o=a[r],o}function i(){e=new WeakMap}return{get:n,dispose:i}}var BM=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,VM=[new F(1,0,0),new F(-1,0,0),new F(0,1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1)],HM=[new F(0,-1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1),new F(0,-1,0),new F(0,-1,0)],ug=new zt,uo=new F,Md=new F;function GM(t,e,n){let i=new $a,s=new Qe,r=new Qe,a=new Ft,o=new Bl,l=new zl,c={},u=n.maxTextureSize,d={[Qi]:bn,[bn]:Qi,[Ri]:Ri},h=new tn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Qe},radius:{value:4}},vertexShader:BM,fragmentShader:zM}),f=h.clone();f.defines.HORIZONTAL_PASS=1;let g=new Tn;g.setAttribute("position",new ln(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let v=new hn(g,h),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=eo;let m=this.type;this.render=function(M,w,_){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||M.length===0)return;this.type===om&&(Ue("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=eo);let A=t.getRenderTarget(),I=t.getActiveCubeFace(),C=t.getActiveMipmapLevel(),P=t.state;P.setBlending(Ii),P.buffers.depth.getReversed()===!0?P.buffers.color.setClear(0,0,0,0):P.buffers.color.setClear(1,1,1,1),P.buffers.depth.setTest(!0),P.setScissorTest(!1);let O=m!==this.type;O&&w.traverse(function(B){B.material&&(Array.isArray(B.material)?B.material.forEach(L=>L.needsUpdate=!0):B.material.needsUpdate=!0)});for(let B=0,L=M.length;B<L;B++){let W=M[B],z=W.shadow;if(z===void 0){Ue("WebGLShadowMap:",W,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;s.copy(z.mapSize);let $=z.getFrameExtents();s.multiply($),r.copy(z.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/$.x),s.x=r.x*$.x,z.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/$.y),s.y=r.y*$.y,z.mapSize.y=r.y));let Z=t.state.buffers.depth.getReversed();if(z.camera._reversedDepth=Z,z.map===null||O===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===Zr){if(W.isPointLight){Ue("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new zn(s.x,s.y,{format:Ns,type:Li,minFilter:en,magFilter:en,generateMipmaps:!1}),z.map.texture.name=W.name+".shadowMap",z.map.depthTexture=new es(s.x,s.y,fi),z.map.depthTexture.name=W.name+".shadowMapDepth",z.map.depthTexture.format=Ei,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=cn,z.map.depthTexture.magFilter=cn}else W.isPointLight?(z.map=new Gc(s.x),z.map.depthTexture=new Ol(s.x,di)):(z.map=new zn(s.x,s.y),z.map.depthTexture=new es(s.x,s.y,di)),z.map.depthTexture.name=W.name+".shadowMap",z.map.depthTexture.format=Ei,this.type===eo?(z.map.depthTexture.compareFunction=Z?Bc:kc,z.map.depthTexture.minFilter=en,z.map.depthTexture.magFilter=en):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=cn,z.map.depthTexture.magFilter=cn);z.camera.updateProjectionMatrix()}let ee=z.map.isWebGLCubeRenderTarget?6:1;for(let re=0;re<ee;re++){if(z.map.isWebGLCubeRenderTarget)t.setRenderTarget(z.map,re),t.clear();else{re===0&&(t.setRenderTarget(z.map),t.clear());let le=z.getViewport(re);a.set(r.x*le.x,r.y*le.y,r.x*le.z,r.y*le.w),P.viewport(a)}if(W.isPointLight){let le=z.camera,Ke=z.matrix,tt=W.distance||le.far;tt!==le.far&&(le.far=tt,le.updateProjectionMatrix()),uo.setFromMatrixPosition(W.matrixWorld),le.position.copy(uo),Md.copy(le.position),Md.add(VM[re]),le.up.copy(HM[re]),le.lookAt(Md),le.updateMatrixWorld(),Ke.makeTranslation(-uo.x,-uo.y,-uo.z),ug.multiplyMatrices(le.projectionMatrix,le.matrixWorldInverse),z._frustum.setFromProjectionMatrix(ug,le.coordinateSystem,le.reversedDepth)}else z.updateMatrices(W);i=z.getFrustum(),S(w,_,z.camera,W,this.type)}z.isPointLightShadow!==!0&&this.type===Zr&&E(z,_),z.needsUpdate=!1}m=this.type,p.needsUpdate=!1,t.setRenderTarget(A,I,C)};function E(M,w){let _=e.update(v);h.defines.VSM_SAMPLES!==M.blurSamples&&(h.defines.VSM_SAMPLES=M.blurSamples,f.defines.VSM_SAMPLES=M.blurSamples,h.needsUpdate=!0,f.needsUpdate=!0),M.mapPass===null&&(M.mapPass=new zn(s.x,s.y,{format:Ns,type:Li})),h.uniforms.shadow_pass.value=M.map.depthTexture,h.uniforms.resolution.value=M.mapSize,h.uniforms.radius.value=M.radius,t.setRenderTarget(M.mapPass),t.clear(),t.renderBufferDirect(w,null,_,h,v,null),f.uniforms.shadow_pass.value=M.mapPass.texture,f.uniforms.resolution.value=M.mapSize,f.uniforms.radius.value=M.radius,t.setRenderTarget(M.map),t.clear(),t.renderBufferDirect(w,null,_,f,v,null)}function R(M,w,_,A){let I=null,C=_.isPointLight===!0?M.customDistanceMaterial:M.customDepthMaterial;if(C!==void 0)I=C;else if(I=_.isPointLight===!0?l:o,t.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){let P=I.uuid,O=w.uuid,B=c[P];B===void 0&&(B={},c[P]=B);let L=B[O];L===void 0&&(L=I.clone(),B[O]=L,w.addEventListener("dispose",b)),I=L}if(I.visible=w.visible,I.wireframe=w.wireframe,A===Zr?I.side=w.shadowSide!==null?w.shadowSide:w.side:I.side=w.shadowSide!==null?w.shadowSide:d[w.side],I.alphaMap=w.alphaMap,I.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,I.map=w.map,I.clipShadows=w.clipShadows,I.clippingPlanes=w.clippingPlanes,I.clipIntersection=w.clipIntersection,I.displacementMap=w.displacementMap,I.displacementScale=w.displacementScale,I.displacementBias=w.displacementBias,I.wireframeLinewidth=w.wireframeLinewidth,I.linewidth=w.linewidth,_.isPointLight===!0&&I.isMeshDistanceMaterial===!0){let P=t.properties.get(I);P.light=_}return I}function S(M,w,_,A,I){if(M.visible===!1)return;if(M.layers.test(w.layers)&&(M.isMesh||M.isLine||M.isPoints)&&(M.castShadow||M.receiveShadow&&I===Zr)&&(!M.frustumCulled||i.intersectsObject(M))){M.modelViewMatrix.multiplyMatrices(_.matrixWorldInverse,M.matrixWorld);let O=e.update(M),B=M.material;if(Array.isArray(B)){let L=O.groups;for(let W=0,z=L.length;W<z;W++){let $=L[W],Z=B[$.materialIndex];if(Z&&Z.visible){let ee=R(M,Z,A,I);M.onBeforeShadow(t,M,w,_,O,ee,$),t.renderBufferDirect(_,null,O,ee,M,$),M.onAfterShadow(t,M,w,_,O,ee,$)}}}else if(B.visible){let L=R(M,B,A,I);M.onBeforeShadow(t,M,w,_,O,L,null),t.renderBufferDirect(_,null,O,L,M,null),M.onAfterShadow(t,M,w,_,O,L,null)}}let P=M.children;for(let O=0,B=P.length;O<B;O++)S(P[O],w,_,A,I)}function b(M){M.target.removeEventListener("dispose",b);for(let _ in c){let A=c[_],I=M.target.uuid;I in A&&(A[I].dispose(),delete A[I])}}}function WM(t,e){function n(){let N=!1,ae=new Ft,j=null,ue=new Ft(0,0,0,0);return{setMask:function(ge){j!==ge&&!N&&(t.colorMask(ge,ge,ge,ge),j=ge)},setLocked:function(ge){N=ge},setClear:function(ge,te,Ae,Se,kt){kt===!0&&(ge*=Se,te*=Se,Ae*=Se),ae.set(ge,te,Ae,Se),ue.equals(ae)===!1&&(t.clearColor(ge,te,Ae,Se),ue.copy(ae))},reset:function(){N=!1,j=null,ue.set(-1,0,0,0)}}}function i(){let N=!1,ae=!1,j=null,ue=null,ge=null;return{setReversed:function(te){if(ae!==te){let Ae=e.get("EXT_clip_control");te?Ae.clipControlEXT(Ae.LOWER_LEFT_EXT,Ae.ZERO_TO_ONE_EXT):Ae.clipControlEXT(Ae.LOWER_LEFT_EXT,Ae.NEGATIVE_ONE_TO_ONE_EXT),ae=te;let Se=ge;ge=null,this.setClear(Se)}},getReversed:function(){return ae},setTest:function(te){te?Q(t.DEPTH_TEST):De(t.DEPTH_TEST)},setMask:function(te){j!==te&&!N&&(t.depthMask(te),j=te)},setFunc:function(te){if(ae&&(te=zm[te]),ue!==te){switch(te){case vl:t.depthFunc(t.NEVER);break;case _l:t.depthFunc(t.ALWAYS);break;case yl:t.depthFunc(t.LESS);break;case er:t.depthFunc(t.LEQUAL);break;case bl:t.depthFunc(t.EQUAL);break;case Ml:t.depthFunc(t.GEQUAL);break;case Sl:t.depthFunc(t.GREATER);break;case wl:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}ue=te}},setLocked:function(te){N=te},setClear:function(te){ge!==te&&(ge=te,ae&&(te=1-te),t.clearDepth(te))},reset:function(){N=!1,j=null,ue=null,ge=null,ae=!1}}}function s(){let N=!1,ae=null,j=null,ue=null,ge=null,te=null,Ae=null,Se=null,kt=null;return{setTest:function(Mt){N||(Mt?Q(t.STENCIL_TEST):De(t.STENCIL_TEST))},setMask:function(Mt){ae!==Mt&&!N&&(t.stencilMask(Mt),ae=Mt)},setFunc:function(Mt,_i,yi){(j!==Mt||ue!==_i||ge!==yi)&&(t.stencilFunc(Mt,_i,yi),j=Mt,ue=_i,ge=yi)},setOp:function(Mt,_i,yi){(te!==Mt||Ae!==_i||Se!==yi)&&(t.stencilOp(Mt,_i,yi),te=Mt,Ae=_i,Se=yi)},setLocked:function(Mt){N=Mt},setClear:function(Mt){kt!==Mt&&(t.clearStencil(Mt),kt=Mt)},reset:function(){N=!1,ae=null,j=null,ue=null,ge=null,te=null,Ae=null,Se=null,kt=null}}}let r=new n,a=new i,o=new s,l=new WeakMap,c=new WeakMap,u={},d={},h={},f=new WeakMap,g=[],v=null,p=!1,m=null,E=null,R=null,S=null,b=null,M=null,w=null,_=new Ve(0,0,0),A=0,I=!1,C=null,P=null,O=null,B=null,L=null,W=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS),z=!1,$=0,Z=t.getParameter(t.VERSION);Z.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(Z)[1]),z=$>=1):Z.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),z=$>=2);let ee=null,re={},le=t.getParameter(t.SCISSOR_BOX),Ke=t.getParameter(t.VIEWPORT),tt=new Ft().fromArray(le),$e=new Ft().fromArray(Ke);function q(N,ae,j,ue){let ge=new Uint8Array(4),te=t.createTexture();t.bindTexture(N,te),t.texParameteri(N,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(N,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Ae=0;Ae<j;Ae++)N===t.TEXTURE_3D||N===t.TEXTURE_2D_ARRAY?t.texImage3D(ae,0,t.RGBA,1,1,ue,0,t.RGBA,t.UNSIGNED_BYTE,ge):t.texImage2D(ae+Ae,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,ge);return te}let ne={};ne[t.TEXTURE_2D]=q(t.TEXTURE_2D,t.TEXTURE_2D,1),ne[t.TEXTURE_CUBE_MAP]=q(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),ne[t.TEXTURE_2D_ARRAY]=q(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),ne[t.TEXTURE_3D]=q(t.TEXTURE_3D,t.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),Q(t.DEPTH_TEST),a.setFunc(er),Lt(!1),Rt(Wu),Q(t.CULL_FACE),at(Ii);function Q(N){u[N]!==!0&&(t.enable(N),u[N]=!0)}function De(N){u[N]!==!1&&(t.disable(N),u[N]=!1)}function ke(N,ae){return h[N]!==ae?(t.bindFramebuffer(N,ae),h[N]=ae,N===t.DRAW_FRAMEBUFFER&&(h[t.FRAMEBUFFER]=ae),N===t.FRAMEBUFFER&&(h[t.DRAW_FRAMEBUFFER]=ae),!0):!1}function Ne(N,ae){let j=g,ue=!1;if(N){j=f.get(ae),j===void 0&&(j=[],f.set(ae,j));let ge=N.textures;if(j.length!==ge.length||j[0]!==t.COLOR_ATTACHMENT0){for(let te=0,Ae=ge.length;te<Ae;te++)j[te]=t.COLOR_ATTACHMENT0+te;j.length=ge.length,ue=!0}}else j[0]!==t.BACK&&(j[0]=t.BACK,ue=!0);ue&&t.drawBuffers(j)}function bt(N){return v!==N?(t.useProgram(N),v=N,!0):!1}let Ge={[ws]:t.FUNC_ADD,[cm]:t.FUNC_SUBTRACT,[hm]:t.FUNC_REVERSE_SUBTRACT};Ge[um]=t.MIN,Ge[dm]=t.MAX;let pt={[fm]:t.ZERO,[pm]:t.ONE,[mm]:t.SRC_COLOR,[gl]:t.SRC_ALPHA,[bm]:t.SRC_ALPHA_SATURATE,[_m]:t.DST_COLOR,[xm]:t.DST_ALPHA,[gm]:t.ONE_MINUS_SRC_COLOR,[xl]:t.ONE_MINUS_SRC_ALPHA,[ym]:t.ONE_MINUS_DST_COLOR,[vm]:t.ONE_MINUS_DST_ALPHA,[Mm]:t.CONSTANT_COLOR,[Sm]:t.ONE_MINUS_CONSTANT_COLOR,[wm]:t.CONSTANT_ALPHA,[Em]:t.ONE_MINUS_CONSTANT_ALPHA};function at(N,ae,j,ue,ge,te,Ae,Se,kt,Mt){if(N===Ii){p===!0&&(De(t.BLEND),p=!1);return}if(p===!1&&(Q(t.BLEND),p=!0),N!==lm){if(N!==m||Mt!==I){if((E!==ws||b!==ws)&&(t.blendEquation(t.FUNC_ADD),E=ws,b=ws),Mt)switch(N){case Jn:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Xu:t.blendFunc(t.ONE,t.ONE);break;case $u:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case qu:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:Be("WebGLState: Invalid blending: ",N);break}else switch(N){case Jn:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Xu:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case $u:Be("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case qu:Be("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Be("WebGLState: Invalid blending: ",N);break}R=null,S=null,M=null,w=null,_.set(0,0,0),A=0,m=N,I=Mt}return}ge=ge||ae,te=te||j,Ae=Ae||ue,(ae!==E||ge!==b)&&(t.blendEquationSeparate(Ge[ae],Ge[ge]),E=ae,b=ge),(j!==R||ue!==S||te!==M||Ae!==w)&&(t.blendFuncSeparate(pt[j],pt[ue],pt[te],pt[Ae]),R=j,S=ue,M=te,w=Ae),(Se.equals(_)===!1||kt!==A)&&(t.blendColor(Se.r,Se.g,Se.b,kt),_.copy(Se),A=kt),m=N,I=!1}function Je(N,ae){N.side===Ri?De(t.CULL_FACE):Q(t.CULL_FACE);let j=N.side===bn;ae&&(j=!j),Lt(j),N.blending===Jn&&N.transparent===!1?at(Ii):at(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),a.setFunc(N.depthFunc),a.setTest(N.depthTest),a.setMask(N.depthWrite),r.setMask(N.colorWrite);let ue=N.stencilWrite;o.setTest(ue),ue&&(o.setMask(N.stencilWriteMask),o.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),o.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),Gt(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?Q(t.SAMPLE_ALPHA_TO_COVERAGE):De(t.SAMPLE_ALPHA_TO_COVERAGE)}function Lt(N){C!==N&&(N?t.frontFace(t.CW):t.frontFace(t.CCW),C=N)}function Rt(N){N!==rm?(Q(t.CULL_FACE),N!==P&&(N===Wu?t.cullFace(t.BACK):N===am?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):De(t.CULL_FACE),P=N}function Nt(N){N!==O&&(z&&t.lineWidth(N),O=N)}function Gt(N,ae,j){N?(Q(t.POLYGON_OFFSET_FILL),(B!==ae||L!==j)&&(B=ae,L=j,a.getReversed()&&(ae=-ae),t.polygonOffset(ae,j))):De(t.POLYGON_OFFSET_FILL)}function It(N){N?Q(t.SCISSOR_TEST):De(t.SCISSOR_TEST)}function Ot(N){N===void 0&&(N=t.TEXTURE0+W-1),ee!==N&&(t.activeTexture(N),ee=N)}function D(N,ae,j){j===void 0&&(ee===null?j=t.TEXTURE0+W-1:j=ee);let ue=re[j];ue===void 0&&(ue={type:void 0,texture:void 0},re[j]=ue),(ue.type!==N||ue.texture!==ae)&&(ee!==j&&(t.activeTexture(j),ee=j),t.bindTexture(N,ae||ne[N]),ue.type=N,ue.texture=ae)}function wn(){let N=re[ee];N!==void 0&&N.type!==void 0&&(t.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function gt(){try{t.compressedTexImage2D(...arguments)}catch(N){Be("WebGLState:",N)}}function T(){try{t.compressedTexImage3D(...arguments)}catch(N){Be("WebGLState:",N)}}function x(){try{t.texSubImage2D(...arguments)}catch(N){Be("WebGLState:",N)}}function k(){try{t.texSubImage3D(...arguments)}catch(N){Be("WebGLState:",N)}}function G(){try{t.compressedTexSubImage2D(...arguments)}catch(N){Be("WebGLState:",N)}}function Y(){try{t.compressedTexSubImage3D(...arguments)}catch(N){Be("WebGLState:",N)}}function ie(){try{t.texStorage2D(...arguments)}catch(N){Be("WebGLState:",N)}}function oe(){try{t.texStorage3D(...arguments)}catch(N){Be("WebGLState:",N)}}function K(){try{t.texImage2D(...arguments)}catch(N){Be("WebGLState:",N)}}function J(){try{t.texImage3D(...arguments)}catch(N){Be("WebGLState:",N)}}function ce(N){return d[N]!==void 0?d[N]:t.getParameter(N)}function Te(N,ae){d[N]!==ae&&(t.pixelStorei(N,ae),d[N]=ae)}function de(N){tt.equals(N)===!1&&(t.scissor(N.x,N.y,N.z,N.w),tt.copy(N))}function he(N){$e.equals(N)===!1&&(t.viewport(N.x,N.y,N.z,N.w),$e.copy(N))}function Fe(N,ae){let j=c.get(ae);j===void 0&&(j=new WeakMap,c.set(ae,j));let ue=j.get(N);ue===void 0&&(ue=t.getUniformBlockIndex(ae,N.name),j.set(N,ue))}function Oe(N,ae){let ue=c.get(ae).get(N);l.get(ae)!==ue&&(t.uniformBlockBinding(ae,ue,N.__bindingPointIndex),l.set(ae,ue))}function We(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),a.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),u={},d={},ee=null,re={},h={},f=new WeakMap,g=[],v=null,p=!1,m=null,E=null,R=null,S=null,b=null,M=null,w=null,_=new Ve(0,0,0),A=0,I=!1,C=null,P=null,O=null,B=null,L=null,tt.set(0,0,t.canvas.width,t.canvas.height),$e.set(0,0,t.canvas.width,t.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:Q,disable:De,bindFramebuffer:ke,drawBuffers:Ne,useProgram:bt,setBlending:at,setMaterial:Je,setFlipSided:Lt,setCullFace:Rt,setLineWidth:Nt,setPolygonOffset:Gt,setScissorTest:It,activeTexture:Ot,bindTexture:D,unbindTexture:wn,compressedTexImage2D:gt,compressedTexImage3D:T,texImage2D:K,texImage3D:J,pixelStorei:Te,getParameter:ce,updateUBOMapping:Fe,uniformBlockBinding:Oe,texStorage2D:ie,texStorage3D:oe,texSubImage2D:x,texSubImage3D:k,compressedTexSubImage2D:G,compressedTexSubImage3D:Y,scissor:de,viewport:he,reset:We}}function XM(t,e,n,i,s,r,a){let o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Qe,u=new WeakMap,d=new Set,h,f=new WeakMap,g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(T,x){return g?new OffscreenCanvas(T,x):Wr("canvas")}function p(T,x,k){let G=1,Y=gt(T);if((Y.width>k||Y.height>k)&&(G=k/Math.max(Y.width,Y.height)),G<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){let ie=Math.floor(G*Y.width),oe=Math.floor(G*Y.height);h===void 0&&(h=v(ie,oe));let K=x?v(ie,oe):h;return K.width=ie,K.height=oe,K.getContext("2d").drawImage(T,0,0,ie,oe),Ue("WebGLRenderer: Texture has been resized from ("+Y.width+"x"+Y.height+") to ("+ie+"x"+oe+")."),K}else return"data"in T&&Ue("WebGLRenderer: Image in DataTexture is too big ("+Y.width+"x"+Y.height+")."),T;return T}function m(T){return T.generateMipmaps}function E(T){t.generateMipmap(T)}function R(T){return T.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?t.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function S(T,x,k,G,Y,ie=!1){if(T!==null){if(t[T]!==void 0)return t[T];Ue("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let oe;G&&(oe=e.get("EXT_texture_norm16"),oe||Ue("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let K=x;if(x===t.RED&&(k===t.FLOAT&&(K=t.R32F),k===t.HALF_FLOAT&&(K=t.R16F),k===t.UNSIGNED_BYTE&&(K=t.R8),k===t.UNSIGNED_SHORT&&oe&&(K=oe.R16_EXT),k===t.SHORT&&oe&&(K=oe.R16_SNORM_EXT)),x===t.RED_INTEGER&&(k===t.UNSIGNED_BYTE&&(K=t.R8UI),k===t.UNSIGNED_SHORT&&(K=t.R16UI),k===t.UNSIGNED_INT&&(K=t.R32UI),k===t.BYTE&&(K=t.R8I),k===t.SHORT&&(K=t.R16I),k===t.INT&&(K=t.R32I)),x===t.RG&&(k===t.FLOAT&&(K=t.RG32F),k===t.HALF_FLOAT&&(K=t.RG16F),k===t.UNSIGNED_BYTE&&(K=t.RG8),k===t.UNSIGNED_SHORT&&oe&&(K=oe.RG16_EXT),k===t.SHORT&&oe&&(K=oe.RG16_SNORM_EXT)),x===t.RG_INTEGER&&(k===t.UNSIGNED_BYTE&&(K=t.RG8UI),k===t.UNSIGNED_SHORT&&(K=t.RG16UI),k===t.UNSIGNED_INT&&(K=t.RG32UI),k===t.BYTE&&(K=t.RG8I),k===t.SHORT&&(K=t.RG16I),k===t.INT&&(K=t.RG32I)),x===t.RGB_INTEGER&&(k===t.UNSIGNED_BYTE&&(K=t.RGB8UI),k===t.UNSIGNED_SHORT&&(K=t.RGB16UI),k===t.UNSIGNED_INT&&(K=t.RGB32UI),k===t.BYTE&&(K=t.RGB8I),k===t.SHORT&&(K=t.RGB16I),k===t.INT&&(K=t.RGB32I)),x===t.RGBA_INTEGER&&(k===t.UNSIGNED_BYTE&&(K=t.RGBA8UI),k===t.UNSIGNED_SHORT&&(K=t.RGBA16UI),k===t.UNSIGNED_INT&&(K=t.RGBA32UI),k===t.BYTE&&(K=t.RGBA8I),k===t.SHORT&&(K=t.RGBA16I),k===t.INT&&(K=t.RGBA32I)),x===t.RGB&&(k===t.UNSIGNED_SHORT&&oe&&(K=oe.RGB16_EXT),k===t.SHORT&&oe&&(K=oe.RGB16_SNORM_EXT),k===t.UNSIGNED_INT_5_9_9_9_REV&&(K=t.RGB9_E5),k===t.UNSIGNED_INT_10F_11F_11F_REV&&(K=t.R11F_G11F_B10F)),x===t.RGBA){let J=ie?Oa:je.getTransfer(Y);k===t.FLOAT&&(K=t.RGBA32F),k===t.HALF_FLOAT&&(K=t.RGBA16F),k===t.UNSIGNED_BYTE&&(K=J===mt?t.SRGB8_ALPHA8:t.RGBA8),k===t.UNSIGNED_SHORT&&oe&&(K=oe.RGBA16_EXT),k===t.SHORT&&oe&&(K=oe.RGBA16_SNORM_EXT),k===t.UNSIGNED_SHORT_4_4_4_4&&(K=t.RGBA4),k===t.UNSIGNED_SHORT_5_5_5_1&&(K=t.RGB5_A1)}return(K===t.R16F||K===t.R32F||K===t.RG16F||K===t.RG32F||K===t.RGBA16F||K===t.RGBA32F)&&e.get("EXT_color_buffer_float"),K}function b(T,x){let k;return T?x===null||x===di||x===Jr?k=t.DEPTH24_STENCIL8:x===fi?k=t.DEPTH32F_STENCIL8:x===jr&&(k=t.DEPTH24_STENCIL8,Ue("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===di||x===Jr?k=t.DEPTH_COMPONENT24:x===fi?k=t.DEPTH_COMPONENT32F:x===jr&&(k=t.DEPTH_COMPONENT16),k}function M(T,x){return m(T)===!0||T.isFramebufferTexture&&T.minFilter!==cn&&T.minFilter!==en?Math.log2(Math.max(x.width,x.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?x.mipmaps.length:1}function w(T){let x=T.target;x.removeEventListener("dispose",w),A(x),x.isVideoTexture&&u.delete(x),x.isHTMLTexture&&d.delete(x)}function _(T){let x=T.target;x.removeEventListener("dispose",_),C(x)}function A(T){let x=i.get(T);if(x.__webglInit===void 0)return;let k=T.source,G=f.get(k);if(G){let Y=G[x.__cacheKey];Y.usedTimes--,Y.usedTimes===0&&I(T),Object.keys(G).length===0&&f.delete(k)}i.remove(T)}function I(T){let x=i.get(T);t.deleteTexture(x.__webglTexture);let k=T.source,G=f.get(k);delete G[x.__cacheKey],a.memory.textures--}function C(T){let x=i.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),i.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let G=0;G<6;G++){if(Array.isArray(x.__webglFramebuffer[G]))for(let Y=0;Y<x.__webglFramebuffer[G].length;Y++)t.deleteFramebuffer(x.__webglFramebuffer[G][Y]);else t.deleteFramebuffer(x.__webglFramebuffer[G]);x.__webglDepthbuffer&&t.deleteRenderbuffer(x.__webglDepthbuffer[G])}else{if(Array.isArray(x.__webglFramebuffer))for(let G=0;G<x.__webglFramebuffer.length;G++)t.deleteFramebuffer(x.__webglFramebuffer[G]);else t.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&t.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&t.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let G=0;G<x.__webglColorRenderbuffer.length;G++)x.__webglColorRenderbuffer[G]&&t.deleteRenderbuffer(x.__webglColorRenderbuffer[G]);x.__webglDepthRenderbuffer&&t.deleteRenderbuffer(x.__webglDepthRenderbuffer)}let k=T.textures;for(let G=0,Y=k.length;G<Y;G++){let ie=i.get(k[G]);ie.__webglTexture&&(t.deleteTexture(ie.__webglTexture),a.memory.textures--),i.remove(k[G])}i.remove(T)}let P=0;function O(){P=0}function B(){return P}function L(T){P=T}function W(){let T=P;return T>=s.maxTextures&&Ue("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+s.maxTextures),P+=1,T}function z(T){let x=[];return x.push(T.wrapS),x.push(T.wrapT),x.push(T.wrapR||0),x.push(T.magFilter),x.push(T.minFilter),x.push(T.anisotropy),x.push(T.internalFormat),x.push(T.format),x.push(T.type),x.push(T.generateMipmaps),x.push(T.premultiplyAlpha),x.push(T.flipY),x.push(T.unpackAlignment),x.push(T.colorSpace),x.join()}function $(T,x){let k=i.get(T);if(T.isVideoTexture&&D(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&k.__version!==T.version){let G=T.image;if(G===null)Ue("WebGLRenderer: Texture marked for update but no image data found.");else if(G.complete===!1)Ue("WebGLRenderer: Texture marked for update but image is incomplete");else{De(k,T,x);return}}else T.isExternalTexture&&(k.__webglTexture=T.sourceTexture?T.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,k.__webglTexture,t.TEXTURE0+x)}function Z(T,x){let k=i.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&k.__version!==T.version){De(k,T,x);return}else T.isExternalTexture&&(k.__webglTexture=T.sourceTexture?T.sourceTexture:null);n.bindTexture(t.TEXTURE_2D_ARRAY,k.__webglTexture,t.TEXTURE0+x)}function ee(T,x){let k=i.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&k.__version!==T.version){De(k,T,x);return}n.bindTexture(t.TEXTURE_3D,k.__webglTexture,t.TEXTURE0+x)}function re(T,x){let k=i.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&k.__version!==T.version){ke(k,T,x);return}n.bindTexture(t.TEXTURE_CUBE_MAP,k.__webglTexture,t.TEXTURE0+x)}let le={[El]:t.REPEAT,[wi]:t.CLAMP_TO_EDGE,[Al]:t.MIRRORED_REPEAT},Ke={[cn]:t.NEAREST,[Cm]:t.NEAREST_MIPMAP_NEAREST,[no]:t.NEAREST_MIPMAP_LINEAR,[en]:t.LINEAR,[tc]:t.LINEAR_MIPMAP_NEAREST,[Pi]:t.LINEAR_MIPMAP_LINEAR},tt={[Pm]:t.NEVER,[Um]:t.ALWAYS,[Lm]:t.LESS,[kc]:t.LEQUAL,[Nm]:t.EQUAL,[Bc]:t.GEQUAL,[Fm]:t.GREATER,[Dm]:t.NOTEQUAL};function $e(T,x){if(x.type===fi&&e.has("OES_texture_float_linear")===!1&&(x.magFilter===en||x.magFilter===tc||x.magFilter===no||x.magFilter===Pi||x.minFilter===en||x.minFilter===tc||x.minFilter===no||x.minFilter===Pi)&&Ue("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(T,t.TEXTURE_WRAP_S,le[x.wrapS]),t.texParameteri(T,t.TEXTURE_WRAP_T,le[x.wrapT]),(T===t.TEXTURE_3D||T===t.TEXTURE_2D_ARRAY)&&t.texParameteri(T,t.TEXTURE_WRAP_R,le[x.wrapR]),t.texParameteri(T,t.TEXTURE_MAG_FILTER,Ke[x.magFilter]),t.texParameteri(T,t.TEXTURE_MIN_FILTER,Ke[x.minFilter]),x.compareFunction&&(t.texParameteri(T,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(T,t.TEXTURE_COMPARE_FUNC,tt[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===cn||x.minFilter!==no&&x.minFilter!==Pi||x.type===fi&&e.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||i.get(x).__currentAnisotropy){let k=e.get("EXT_texture_filter_anisotropic");t.texParameterf(T,k.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,s.getMaxAnisotropy())),i.get(x).__currentAnisotropy=x.anisotropy}}}function q(T,x){let k=!1;T.__webglInit===void 0&&(T.__webglInit=!0,x.addEventListener("dispose",w));let G=x.source,Y=f.get(G);Y===void 0&&(Y={},f.set(G,Y));let ie=z(x);if(ie!==T.__cacheKey){Y[ie]===void 0&&(Y[ie]={texture:t.createTexture(),usedTimes:0},a.memory.textures++,k=!0),Y[ie].usedTimes++;let oe=Y[T.__cacheKey];oe!==void 0&&(Y[T.__cacheKey].usedTimes--,oe.usedTimes===0&&I(x)),T.__cacheKey=ie,T.__webglTexture=Y[ie].texture}return k}function ne(T,x,k){return Math.floor(Math.floor(T/k)/x)}function Q(T,x,k,G){let ie=T.updateRanges;if(ie.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,x.width,x.height,k,G,x.data);else{ie.sort((Te,de)=>Te.start-de.start);let oe=0;for(let Te=1;Te<ie.length;Te++){let de=ie[oe],he=ie[Te],Fe=de.start+de.count,Oe=ne(he.start,x.width,4),We=ne(de.start,x.width,4);he.start<=Fe+1&&Oe===We&&ne(he.start+he.count-1,x.width,4)===Oe?de.count=Math.max(de.count,he.start+he.count-de.start):(++oe,ie[oe]=he)}ie.length=oe+1;let K=n.getParameter(t.UNPACK_ROW_LENGTH),J=n.getParameter(t.UNPACK_SKIP_PIXELS),ce=n.getParameter(t.UNPACK_SKIP_ROWS);n.pixelStorei(t.UNPACK_ROW_LENGTH,x.width);for(let Te=0,de=ie.length;Te<de;Te++){let he=ie[Te],Fe=Math.floor(he.start/4),Oe=Math.ceil(he.count/4),We=Fe%x.width,N=Math.floor(Fe/x.width),ae=Oe,j=1;n.pixelStorei(t.UNPACK_SKIP_PIXELS,We),n.pixelStorei(t.UNPACK_SKIP_ROWS,N),n.texSubImage2D(t.TEXTURE_2D,0,We,N,ae,j,k,G,x.data)}T.clearUpdateRanges(),n.pixelStorei(t.UNPACK_ROW_LENGTH,K),n.pixelStorei(t.UNPACK_SKIP_PIXELS,J),n.pixelStorei(t.UNPACK_SKIP_ROWS,ce)}}function De(T,x,k){let G=t.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(G=t.TEXTURE_2D_ARRAY),x.isData3DTexture&&(G=t.TEXTURE_3D);let Y=q(T,x),ie=x.source;n.bindTexture(G,T.__webglTexture,t.TEXTURE0+k);let oe=i.get(ie);if(ie.version!==oe.__version||Y===!0){if(n.activeTexture(t.TEXTURE0+k),(typeof ImageBitmap<"u"&&x.image instanceof ImageBitmap)===!1){let j=je.getPrimaries(je.workingColorSpace),ue=x.colorSpace===pi?null:je.getPrimaries(x.colorSpace),ge=x.colorSpace===pi||j===ue?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,ge)}n.pixelStorei(t.UNPACK_ALIGNMENT,x.unpackAlignment);let J=p(x.image,!1,s.maxTextureSize);J=wn(x,J);let ce=r.convert(x.format,x.colorSpace),Te=r.convert(x.type),de=S(x.internalFormat,ce,Te,x.normalized,x.colorSpace,x.isVideoTexture);$e(G,x);let he,Fe=x.mipmaps,Oe=x.isVideoTexture!==!0,We=oe.__version===void 0||Y===!0,N=ie.dataReady,ae=M(x,J);if(x.isDepthTexture)de=b(x.format===Ls,x.type),We&&(Oe?n.texStorage2D(t.TEXTURE_2D,1,de,J.width,J.height):n.texImage2D(t.TEXTURE_2D,0,de,J.width,J.height,0,ce,Te,null));else if(x.isDataTexture)if(Fe.length>0){Oe&&We&&n.texStorage2D(t.TEXTURE_2D,ae,de,Fe[0].width,Fe[0].height);for(let j=0,ue=Fe.length;j<ue;j++)he=Fe[j],Oe?N&&n.texSubImage2D(t.TEXTURE_2D,j,0,0,he.width,he.height,ce,Te,he.data):n.texImage2D(t.TEXTURE_2D,j,de,he.width,he.height,0,ce,Te,he.data);x.generateMipmaps=!1}else Oe?(We&&n.texStorage2D(t.TEXTURE_2D,ae,de,J.width,J.height),N&&Q(x,J,ce,Te)):n.texImage2D(t.TEXTURE_2D,0,de,J.width,J.height,0,ce,Te,J.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){Oe&&We&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ae,de,Fe[0].width,Fe[0].height,J.depth);for(let j=0,ue=Fe.length;j<ue;j++)if(he=Fe[j],x.format!==Qn)if(ce!==null)if(Oe){if(N)if(x.layerUpdates.size>0){let ge=gd(he.width,he.height,x.format,x.type);for(let te of x.layerUpdates){let Ae=he.data.subarray(te*ge/he.data.BYTES_PER_ELEMENT,(te+1)*ge/he.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,j,0,0,te,he.width,he.height,1,ce,Ae)}x.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,j,0,0,0,he.width,he.height,J.depth,ce,he.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,j,de,he.width,he.height,J.depth,0,he.data,0,0);else Ue("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Oe?N&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,j,0,0,0,he.width,he.height,J.depth,ce,Te,he.data):n.texImage3D(t.TEXTURE_2D_ARRAY,j,de,he.width,he.height,J.depth,0,ce,Te,he.data)}else{Oe&&We&&n.texStorage2D(t.TEXTURE_2D,ae,de,Fe[0].width,Fe[0].height);for(let j=0,ue=Fe.length;j<ue;j++)he=Fe[j],x.format!==Qn?ce!==null?Oe?N&&n.compressedTexSubImage2D(t.TEXTURE_2D,j,0,0,he.width,he.height,ce,he.data):n.compressedTexImage2D(t.TEXTURE_2D,j,de,he.width,he.height,0,he.data):Ue("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Oe?N&&n.texSubImage2D(t.TEXTURE_2D,j,0,0,he.width,he.height,ce,Te,he.data):n.texImage2D(t.TEXTURE_2D,j,de,he.width,he.height,0,ce,Te,he.data)}else if(x.isDataArrayTexture)if(Oe){if(We&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ae,de,J.width,J.height,J.depth),N)if(x.layerUpdates.size>0){let j=gd(J.width,J.height,x.format,x.type);for(let ue of x.layerUpdates){let ge=J.data.subarray(ue*j/J.data.BYTES_PER_ELEMENT,(ue+1)*j/J.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,ue,J.width,J.height,1,ce,Te,ge)}x.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,ce,Te,J.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,de,J.width,J.height,J.depth,0,ce,Te,J.data);else if(x.isData3DTexture)Oe?(We&&n.texStorage3D(t.TEXTURE_3D,ae,de,J.width,J.height,J.depth),N&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,ce,Te,J.data)):n.texImage3D(t.TEXTURE_3D,0,de,J.width,J.height,J.depth,0,ce,Te,J.data);else if(x.isFramebufferTexture){if(We)if(Oe)n.texStorage2D(t.TEXTURE_2D,ae,de,J.width,J.height);else{let j=J.width,ue=J.height;for(let ge=0;ge<ae;ge++)n.texImage2D(t.TEXTURE_2D,ge,de,j,ue,0,ce,Te,null),j>>=1,ue>>=1}}else if(x.isHTMLTexture){if("texElementImage2D"in t){let j=t.canvas;if(j.hasAttribute("layoutsubtree")||j.setAttribute("layoutsubtree","true"),J.parentNode!==j){j.appendChild(J),d.add(x),j.onpaint=ue=>{let ge=ue.changedElements;for(let te of d)ge.includes(te.image)&&(te.needsUpdate=!0)},j.requestPaint();return}if(t.texElementImage2D.length===3)t.texElementImage2D(t.TEXTURE_2D,t.RGBA8,J);else{let ge=t.RGBA,te=t.RGBA,Ae=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,0,ge,te,Ae,J)}t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(Fe.length>0){if(Oe&&We){let j=gt(Fe[0]);n.texStorage2D(t.TEXTURE_2D,ae,de,j.width,j.height)}for(let j=0,ue=Fe.length;j<ue;j++)he=Fe[j],Oe?N&&n.texSubImage2D(t.TEXTURE_2D,j,0,0,ce,Te,he):n.texImage2D(t.TEXTURE_2D,j,de,ce,Te,he);x.generateMipmaps=!1}else if(Oe){if(We){let j=gt(J);n.texStorage2D(t.TEXTURE_2D,ae,de,j.width,j.height)}N&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,ce,Te,J)}else n.texImage2D(t.TEXTURE_2D,0,de,ce,Te,J);m(x)&&E(G),oe.__version=ie.version,x.onUpdate&&x.onUpdate(x)}T.__version=x.version}function ke(T,x,k){if(x.image.length!==6)return;let G=q(T,x),Y=x.source;n.bindTexture(t.TEXTURE_CUBE_MAP,T.__webglTexture,t.TEXTURE0+k);let ie=i.get(Y);if(Y.version!==ie.__version||G===!0){n.activeTexture(t.TEXTURE0+k);let oe=je.getPrimaries(je.workingColorSpace),K=x.colorSpace===pi?null:je.getPrimaries(x.colorSpace),J=x.colorSpace===pi||oe===K?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(t.UNPACK_ALIGNMENT,x.unpackAlignment),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,J);let ce=x.isCompressedTexture||x.image[0].isCompressedTexture,Te=x.image[0]&&x.image[0].isDataTexture,de=[];for(let te=0;te<6;te++)!ce&&!Te?de[te]=p(x.image[te],!0,s.maxCubemapSize):de[te]=Te?x.image[te].image:x.image[te],de[te]=wn(x,de[te]);let he=de[0],Fe=r.convert(x.format,x.colorSpace),Oe=r.convert(x.type),We=S(x.internalFormat,Fe,Oe,x.normalized,x.colorSpace),N=x.isVideoTexture!==!0,ae=ie.__version===void 0||G===!0,j=Y.dataReady,ue=M(x,he);$e(t.TEXTURE_CUBE_MAP,x);let ge;if(ce){N&&ae&&n.texStorage2D(t.TEXTURE_CUBE_MAP,ue,We,he.width,he.height);for(let te=0;te<6;te++){ge=de[te].mipmaps;for(let Ae=0;Ae<ge.length;Ae++){let Se=ge[Ae];x.format!==Qn?Fe!==null?N?j&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ae,0,0,Se.width,Se.height,Fe,Se.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ae,We,Se.width,Se.height,0,Se.data):Ue("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?j&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ae,0,0,Se.width,Se.height,Fe,Oe,Se.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ae,We,Se.width,Se.height,0,Fe,Oe,Se.data)}}}else{if(ge=x.mipmaps,N&&ae){ge.length>0&&ue++;let te=gt(de[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,ue,We,te.width,te.height)}for(let te=0;te<6;te++)if(Te){N?j&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,de[te].width,de[te].height,Fe,Oe,de[te].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,We,de[te].width,de[te].height,0,Fe,Oe,de[te].data);for(let Ae=0;Ae<ge.length;Ae++){let kt=ge[Ae].image[te].image;N?j&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ae+1,0,0,kt.width,kt.height,Fe,Oe,kt.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ae+1,We,kt.width,kt.height,0,Fe,Oe,kt.data)}}else{N?j&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,Fe,Oe,de[te]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,We,Fe,Oe,de[te]);for(let Ae=0;Ae<ge.length;Ae++){let Se=ge[Ae];N?j&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ae+1,0,0,Fe,Oe,Se.image[te]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ae+1,We,Fe,Oe,Se.image[te])}}}m(x)&&E(t.TEXTURE_CUBE_MAP),ie.__version=Y.version,x.onUpdate&&x.onUpdate(x)}T.__version=x.version}function Ne(T,x,k,G,Y,ie){let oe=r.convert(k.format,k.colorSpace),K=r.convert(k.type),J=S(k.internalFormat,oe,K,k.normalized,k.colorSpace),ce=i.get(x),Te=i.get(k);if(Te.__renderTarget=x,!ce.__hasExternalTextures){let de=Math.max(1,x.width>>ie),he=Math.max(1,x.height>>ie);Y===t.TEXTURE_3D||Y===t.TEXTURE_2D_ARRAY?n.texImage3D(Y,ie,J,de,he,x.depth,0,oe,K,null):n.texImage2D(Y,ie,J,de,he,0,oe,K,null)}n.bindFramebuffer(t.FRAMEBUFFER,T),Ot(x)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,G,Y,Te.__webglTexture,0,It(x)):(Y===t.TEXTURE_2D||Y>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&Y<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,G,Y,Te.__webglTexture,ie),n.bindFramebuffer(t.FRAMEBUFFER,null)}function bt(T,x,k){if(t.bindRenderbuffer(t.RENDERBUFFER,T),x.depthBuffer){let G=x.depthTexture,Y=G&&G.isDepthTexture?G.type:null,ie=b(x.stencilBuffer,Y),oe=x.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;Ot(x)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,It(x),ie,x.width,x.height):k?t.renderbufferStorageMultisample(t.RENDERBUFFER,It(x),ie,x.width,x.height):t.renderbufferStorage(t.RENDERBUFFER,ie,x.width,x.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,oe,t.RENDERBUFFER,T)}else{let G=x.textures;for(let Y=0;Y<G.length;Y++){let ie=G[Y],oe=r.convert(ie.format,ie.colorSpace),K=r.convert(ie.type),J=S(ie.internalFormat,oe,K,ie.normalized,ie.colorSpace);Ot(x)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,It(x),J,x.width,x.height):k?t.renderbufferStorageMultisample(t.RENDERBUFFER,It(x),J,x.width,x.height):t.renderbufferStorage(t.RENDERBUFFER,J,x.width,x.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Ge(T,x,k){let G=x.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(t.FRAMEBUFFER,T),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let Y=i.get(x.depthTexture);if(Y.__renderTarget=x,(!Y.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),G){if(Y.__webglInit===void 0&&(Y.__webglInit=!0,x.depthTexture.addEventListener("dispose",w)),Y.__webglTexture===void 0){Y.__webglTexture=t.createTexture(),n.bindTexture(t.TEXTURE_CUBE_MAP,Y.__webglTexture),$e(t.TEXTURE_CUBE_MAP,x.depthTexture);let ce=r.convert(x.depthTexture.format),Te=r.convert(x.depthTexture.type),de;x.depthTexture.format===Ei?de=t.DEPTH_COMPONENT24:x.depthTexture.format===Ls&&(de=t.DEPTH24_STENCIL8);for(let he=0;he<6;he++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+he,0,de,x.width,x.height,0,ce,Te,null)}}else $(x.depthTexture,0);let ie=Y.__webglTexture,oe=It(x),K=G?t.TEXTURE_CUBE_MAP_POSITIVE_X+k:t.TEXTURE_2D,J=x.depthTexture.format===Ls?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(x.depthTexture.format===Ei)Ot(x)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,J,K,ie,0,oe):t.framebufferTexture2D(t.FRAMEBUFFER,J,K,ie,0);else if(x.depthTexture.format===Ls)Ot(x)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,J,K,ie,0,oe):t.framebufferTexture2D(t.FRAMEBUFFER,J,K,ie,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function pt(T){let x=i.get(T),k=T.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==T.depthTexture){let G=T.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),G){let Y=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,G.removeEventListener("dispose",Y)};G.addEventListener("dispose",Y),x.__depthDisposeCallback=Y}x.__boundDepthTexture=G}if(T.depthTexture&&!x.__autoAllocateDepthBuffer)if(k)for(let G=0;G<6;G++)Ge(x.__webglFramebuffer[G],T,G);else{let G=T.texture.mipmaps;G&&G.length>0?Ge(x.__webglFramebuffer[0],T,0):Ge(x.__webglFramebuffer,T,0)}else if(k){x.__webglDepthbuffer=[];for(let G=0;G<6;G++)if(n.bindFramebuffer(t.FRAMEBUFFER,x.__webglFramebuffer[G]),x.__webglDepthbuffer[G]===void 0)x.__webglDepthbuffer[G]=t.createRenderbuffer(),bt(x.__webglDepthbuffer[G],T,!1);else{let Y=T.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ie=x.__webglDepthbuffer[G];t.bindRenderbuffer(t.RENDERBUFFER,ie),t.framebufferRenderbuffer(t.FRAMEBUFFER,Y,t.RENDERBUFFER,ie)}}else{let G=T.texture.mipmaps;if(G&&G.length>0?n.bindFramebuffer(t.FRAMEBUFFER,x.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=t.createRenderbuffer(),bt(x.__webglDepthbuffer,T,!1);else{let Y=T.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ie=x.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,ie),t.framebufferRenderbuffer(t.FRAMEBUFFER,Y,t.RENDERBUFFER,ie)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function at(T,x,k){let G=i.get(T);x!==void 0&&Ne(G.__webglFramebuffer,T,T.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),k!==void 0&&pt(T)}function Je(T){let x=T.texture,k=i.get(T),G=i.get(x);T.addEventListener("dispose",_);let Y=T.textures,ie=T.isWebGLCubeRenderTarget===!0,oe=Y.length>1;if(oe||(G.__webglTexture===void 0&&(G.__webglTexture=t.createTexture()),G.__version=x.version,a.memory.textures++),ie){k.__webglFramebuffer=[];for(let K=0;K<6;K++)if(x.mipmaps&&x.mipmaps.length>0){k.__webglFramebuffer[K]=[];for(let J=0;J<x.mipmaps.length;J++)k.__webglFramebuffer[K][J]=t.createFramebuffer()}else k.__webglFramebuffer[K]=t.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){k.__webglFramebuffer=[];for(let K=0;K<x.mipmaps.length;K++)k.__webglFramebuffer[K]=t.createFramebuffer()}else k.__webglFramebuffer=t.createFramebuffer();if(oe)for(let K=0,J=Y.length;K<J;K++){let ce=i.get(Y[K]);ce.__webglTexture===void 0&&(ce.__webglTexture=t.createTexture(),a.memory.textures++)}if(T.samples>0&&Ot(T)===!1){k.__webglMultisampledFramebuffer=t.createFramebuffer(),k.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,k.__webglMultisampledFramebuffer);for(let K=0;K<Y.length;K++){let J=Y[K];k.__webglColorRenderbuffer[K]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,k.__webglColorRenderbuffer[K]);let ce=r.convert(J.format,J.colorSpace),Te=r.convert(J.type),de=S(J.internalFormat,ce,Te,J.normalized,J.colorSpace,T.isXRRenderTarget===!0),he=It(T);t.renderbufferStorageMultisample(t.RENDERBUFFER,he,de,T.width,T.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+K,t.RENDERBUFFER,k.__webglColorRenderbuffer[K])}t.bindRenderbuffer(t.RENDERBUFFER,null),T.depthBuffer&&(k.__webglDepthRenderbuffer=t.createRenderbuffer(),bt(k.__webglDepthRenderbuffer,T,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(ie){n.bindTexture(t.TEXTURE_CUBE_MAP,G.__webglTexture),$e(t.TEXTURE_CUBE_MAP,x);for(let K=0;K<6;K++)if(x.mipmaps&&x.mipmaps.length>0)for(let J=0;J<x.mipmaps.length;J++)Ne(k.__webglFramebuffer[K][J],T,x,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+K,J);else Ne(k.__webglFramebuffer[K],T,x,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+K,0);m(x)&&E(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(oe){for(let K=0,J=Y.length;K<J;K++){let ce=Y[K],Te=i.get(ce),de=t.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(de=T.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(de,Te.__webglTexture),$e(de,ce),Ne(k.__webglFramebuffer,T,ce,t.COLOR_ATTACHMENT0+K,de,0),m(ce)&&E(de)}n.unbindTexture()}else{let K=t.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(K=T.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(K,G.__webglTexture),$e(K,x),x.mipmaps&&x.mipmaps.length>0)for(let J=0;J<x.mipmaps.length;J++)Ne(k.__webglFramebuffer[J],T,x,t.COLOR_ATTACHMENT0,K,J);else Ne(k.__webglFramebuffer,T,x,t.COLOR_ATTACHMENT0,K,0);m(x)&&E(K),n.unbindTexture()}T.depthBuffer&&pt(T)}function Lt(T){let x=T.textures;for(let k=0,G=x.length;k<G;k++){let Y=x[k];if(m(Y)){let ie=R(T),oe=i.get(Y).__webglTexture;n.bindTexture(ie,oe),E(ie),n.unbindTexture()}}}let Rt=[],Nt=[];function Gt(T){if(T.samples>0){if(Ot(T)===!1){let x=T.textures,k=T.width,G=T.height,Y=t.COLOR_BUFFER_BIT,ie=T.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,oe=i.get(T),K=x.length>1;if(K)for(let ce=0;ce<x.length;ce++)n.bindFramebuffer(t.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ce,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,oe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+ce,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,oe.__webglMultisampledFramebuffer);let J=T.texture.mipmaps;J&&J.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,oe.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,oe.__webglFramebuffer);for(let ce=0;ce<x.length;ce++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(Y|=t.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(Y|=t.STENCIL_BUFFER_BIT)),K){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,oe.__webglColorRenderbuffer[ce]);let Te=i.get(x[ce]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Te,0)}t.blitFramebuffer(0,0,k,G,0,0,k,G,Y,t.NEAREST),l===!0&&(Rt.length=0,Nt.length=0,Rt.push(t.COLOR_ATTACHMENT0+ce),T.depthBuffer&&T.resolveDepthBuffer===!1&&(Rt.push(ie),Nt.push(ie),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,Nt)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,Rt))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),K)for(let ce=0;ce<x.length;ce++){n.bindFramebuffer(t.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ce,t.RENDERBUFFER,oe.__webglColorRenderbuffer[ce]);let Te=i.get(x[ce]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,oe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+ce,t.TEXTURE_2D,Te,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,oe.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){let x=T.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[x])}}}function It(T){return Math.min(s.maxSamples,T.samples)}function Ot(T){let x=i.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function D(T){let x=a.render.frame;u.get(T)!==x&&(u.set(T,x),T.update())}function wn(T,x){let k=T.colorSpace,G=T.format,Y=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||k!==tr&&k!==pi&&(je.getTransfer(k)===mt?(G!==Qn||Y!==Gn)&&Ue("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Be("WebGLTextures: Unsupported texture color space:",k)),x}function gt(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=W,this.resetTextureUnits=O,this.getTextureUnits=B,this.setTextureUnits=L,this.setTexture2D=$,this.setTexture2DArray=Z,this.setTexture3D=ee,this.setTextureCube=re,this.rebindTextures=at,this.setupRenderTarget=Je,this.updateRenderTargetMipmap=Lt,this.updateMultisampleRenderTarget=Gt,this.setupDepthRenderbuffer=pt,this.setupFrameBufferTexture=Ne,this.useMultisampledRTT=Ot,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function $M(t,e){function n(i,s=pi){let r,a=je.getTransfer(s);if(i===Gn)return t.UNSIGNED_BYTE;if(i===ic)return t.UNSIGNED_SHORT_4_4_4_4;if(i===sc)return t.UNSIGNED_SHORT_5_5_5_1;if(i===rd)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===ad)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===id)return t.BYTE;if(i===sd)return t.SHORT;if(i===jr)return t.UNSIGNED_SHORT;if(i===nc)return t.INT;if(i===di)return t.UNSIGNED_INT;if(i===fi)return t.FLOAT;if(i===Li)return t.HALF_FLOAT;if(i===od)return t.ALPHA;if(i===ld)return t.RGB;if(i===Qn)return t.RGBA;if(i===Ei)return t.DEPTH_COMPONENT;if(i===Ls)return t.DEPTH_STENCIL;if(i===cd)return t.RED;if(i===rc)return t.RED_INTEGER;if(i===Ns)return t.RG;if(i===ac)return t.RG_INTEGER;if(i===oc)return t.RGBA_INTEGER;if(i===io||i===so||i===ro||i===ao)if(a===mt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===io)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===so)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===ro)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===ao)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===io)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===so)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===ro)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===ao)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===lc||i===cc||i===hc||i===uc)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===lc)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===cc)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===hc)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===uc)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===dc||i===fc||i===pc||i===mc||i===gc||i===oo||i===xc)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(i===dc||i===fc)return a===mt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===pc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(i===mc)return r.COMPRESSED_R11_EAC;if(i===gc)return r.COMPRESSED_SIGNED_R11_EAC;if(i===oo)return r.COMPRESSED_RG11_EAC;if(i===xc)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===vc||i===_c||i===yc||i===bc||i===Mc||i===Sc||i===wc||i===Ec||i===Ac||i===Tc||i===Cc||i===Rc||i===Ic||i===Pc)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(i===vc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===_c)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===yc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===bc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Mc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Sc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===wc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Ec)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Ac)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Tc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Cc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Rc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Ic)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Pc)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Lc||i===Nc||i===Fc)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(i===Lc)return a===mt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Nc)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Fc)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Dc||i===Uc||i===lo||i===Oc)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(i===Dc)return r.COMPRESSED_RED_RGTC1_EXT;if(i===Uc)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===lo)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Oc)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Jr?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}var qM=`
void main() {
...
}`,Id=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n){if(this.texture===null){let i=new Ka(e.texture);(e.depthNear!==n.depthNear||e.depthFar!==n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){let n=e.cameras[0].viewport,i=new tn({vertexShader:qM,fragmentShader:YM,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new hn(new Ci(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Pd=class extends Ai{constructor(e,n){super();let i=this,s=null,r=1,a=null,o="local-floor",l=1,c=null,u=null,d=null,h=null,f=null,g=null,v=typeof XRWebGLBinding<"u",p=new Id,m={},E=n.getContextAttributes(),R=null,S=null,b=[],M=[],w=new Qe,_=null,A=new xn;A.viewport=new Ft;let I=new xn;I.viewport=new Ft;let C=[A,I],P=new Jl,O=null,B=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(q){let ne=b[q];return ne===void 0&&(ne=new qr,b[q]=ne),ne.getTargetRaySpace()},this.getControllerGrip=function(q){let ne=b[q];return ne===void 0&&(ne=new qr,b[q]=ne),ne.getGripSpace()},this.getHand=function(q){let ne=b[q];return ne===void 0&&(ne=new qr,b[q]=ne),ne.getHandSpace()};function L(q){let ne=M.indexOf(q.inputSource);if(ne===-1)return;let Q=b[ne];Q!==void 0&&(Q.update(q.inputSource,q.frame,c||a),Q.dispatchEvent({type:q.type,data:q.inputSource}))}function W(){s.removeEventListener("select",L),s.removeEventListener("selectstart",L),s.removeEventListener("selectend",L),s.removeEventListener("squeeze",L),s.removeEventListener("squeezestart",L),s.removeEventListener("squeezeend",L),s.removeEventListener("end",W),s.removeEventListener("inputsourceschange",z);for(let q=0;q<b.length;q++){let ne=M[q];ne!==null&&(M[q]=null,b[q].disconnect(ne))}O=null,B=null,p.reset();for(let q in m)delete m[q];e.setRenderTarget(R),f=null,h=null,d=null,s=null,S=null,$e.stop(),i.isPresenting=!1,e.setPixelRatio(_),e.setSize(w.width,w.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(q){r=q,i.isPresenting===!0&&Ue("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(q){o=q,i.isPresenting===!0&&Ue("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(q){c=q},this.getBaseLayer=function(){return h!==null?h:f},this.getBinding=function(){return d===null&&v&&(d=new XRWebGLBinding(s,n)),d},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(q){if(s=q,s!==null){if(R=e.getRenderTarget(),s.addEventListener("select",L),s.addEventListener("selectstart",L),s.addEventListener("selectend",L),s.addEventListener("squeeze",L),s.addEventListener("squeezestart",L),s.addEventListener("squeezeend",L),s.addEventListener("end",W),s.addEventListener("inputsourceschange",z),E.xrCompatible!==!0&&await n.makeXRCompatible(),_=e.getPixelRatio(),e.getSize(w),v&&"createProjectionLayer"in XRWebGLBinding.prototype){let Q=null,De=null,ke=null;E.depth&&(ke=E.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,Q=E.stencil?Ls:Ei,De=E.stencil?Jr:di);let Ne={colorFormat:n.RGBA8,depthFormat:ke,scaleFactor:r};d=this.getBinding(),h=d.createProjectionLayer(Ne),s.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),S=new zn(h.textureWidth,h.textureHeight,{format:Qn,type:Gn,depthTexture:new es(h.textureWidth,h.textureHeight,De,void 0,void 0,void 0,void 0,void 0,void 0,Q),stencilBuffer:E.stencil,colorSpace:e.outputColorSpace,samples:E.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{let Q={antialias:E.antialias,alpha:!0,depth:E.depth,stencil:E.stencil,framebufferScaleFactor:r};f=new XRWebGLLayer(s,n,Q),s.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),S=new zn(f.framebufferWidth,f.framebufferHeight,{format:Qn,type:Gn,colorSpace:e.outputColorSpace,stencilBuffer:E.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),$e.setContext(s),$e.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return p.getDepthTexture()};function z(q){for(let ne=0;ne<q.removed.length;ne++){let Q=q.removed[ne],De=M.indexOf(Q);De>=0&&(M[De]=null,b[De].disconnect(Q))}for(let ne=0;ne<q.added.length;ne++){let Q=q.added[ne],De=M.indexOf(Q);if(De===-1){for(let Ne=0;Ne<b.length;Ne++)if(Ne>=M.length){M.push(Q),De=Ne;break}else if(M[Ne]===null){M[Ne]=Q,De=Ne;break}if(De===-1)break}let ke=b[De];ke&&ke.connect(Q)}}let $=new F,Z=new F;function ee(q,ne,Q){$.setFromMatrixPosition(ne.matrixWorld),Z.setFromMatrixPosition(Q.matrixWorld);let De=$.distanceTo(Z),ke=ne.projectionMatrix.elements,Ne=Q.projectionMatrix.elements,bt=ke[14]/(ke[10]-1),Ge=ke[14]/(ke[10]+1),pt=(ke[9]+1)/ke[5],at=(ke[9]-1)/ke[5],Je=(ke[8]-1)/ke[0],Lt=(Ne[8]+1)/Ne[0],Rt=bt*Je,Nt=bt*Lt,Gt=De/(-Je+Lt),It=Gt*-Je;if(ne.matrixWorld.decompose(q.position,q.quaternion,q.scale),q.translateX(It),q.translateZ(Gt),q.matrixWorld.compose(q.position,q.quaternion,q.scale),q.matrixWorldInverse.copy(q.matrixWorld).invert(),ke[10]===-1)q.projectionMatrix.copy(ne.projectionMatrix),q.projectionMatrixInverse.copy(ne.projectionMatrixInverse);else{let Ot=bt+Gt,D=Ge+Gt,wn=Rt-It,gt=Nt+(De-It),T=pt*Ge/D*Ot,x=at*Ge/D*Ot;q.projectionMatrix.makePerspective(wn,gt,T,x,Ot,D),q.projectionMatrixInverse.copy(q.projectionMatrix).invert()}}function re(q,ne){ne===null?q.matrixWorld.copy(q.matrix):q.matrixWorld.multiplyMatrices(ne.matrixWorld,q.matrix),q.matrixWorldInverse.copy(q.matrixWorld).invert()}this.updateCamera=function(q){if(s===null)return;let ne=q.near,Q=q.far;p.texture!==null&&(p.depthNear>0&&(ne=p.depthNear),p.depthFar>0&&(Q=p.depthFar)),P.near=I.near=A.near=ne,P.far=I.far=A.far=Q,(O!==P.near||B!==P.far)&&(s.updateRenderState({depthNear:P.near,depthFar:P.far}),O=P.near,B=P.far),P.layers.mask=q.layers.mask|6,A.layers.mask=P.layers.mask&-5,I.layers.mask=P.layers.mask&-3;let De=q.parent,ke=P.cameras;re(P,De);for(let Ne=0;Ne<ke.length;Ne++)re(ke[Ne],De);ke.length===2?ee(P,A,I):P.projectionMatrix.copy(A.projectionMatrix),le(q,P,De)};function le(q,ne,Q){Q===null?q.matrix.copy(ne.matrixWorld):(q.matrix.copy(Q.matrixWorld),q.matrix.invert(),q.matrix.multiply(ne.matrixWorld)),q.matrix.decompose(q.position,q.quaternion,q.scale),q.updateMatrixWorld(!0),q.projectionMatrix.copy(ne.projectionMatrix),q.projectionMatrixInverse.copy(ne.projectionMatrixInverse),q.isPerspectiveCamera&&(q.fov=Cl*2*Math.atan(1/q.projectionMatrix.elements[5]),q.zoom=1)}this.getCamera=function(){return P},this.getFoveation=function(){if(!(h===null&&f===null))return l},this.setFoveation=function(q){l=q,h!==null&&(h.fixedFoveation=q),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=q)},this.hasDepthSensing=function(){return p.texture!==null},this.getDepthSensingMesh=function(){return p.getMesh(P)},this.getCameraTexture=function(q){return m[q]};let Ke=null;function tt(q,ne){if(u=ne.getViewerPose(c||a),g=ne,u!==null){let Q=u.views;f!==null&&(e.setRenderTargetFramebuffer(S,f.framebuffer),e.setRenderTarget(S));let De=!1;Q.length!==P.cameras.length&&(P.cameras.length=0,De=!0);for(let Ge=0;Ge<Q.length;Ge++){let pt=Q[Ge],at=null;if(f!==null)at=f.getViewport(pt);else{let Lt=d.getViewSubImage(h,pt);at=Lt.viewport,Ge===0&&(e.setRenderTargetTextures(S,Lt.colorTexture,Lt.depthStencilTexture),e.setRenderTarget(S))}let Je=C[Ge];Je===void 0&&(Je=new xn,Je.layers.enable(Ge),Je.viewport=new Ft,C[Ge]=Je),Je.matrix.fromArray(pt.transform.matrix),Je.matrix.decompose(Je.position,Je.quaternion,Je.scale),Je.projectionMatrix.fromArray(pt.projectionMatrix),Je.projectionMatrixInverse.copy(Je.projectionMatrix).invert(),Je.viewport.set(at.x,at.y,at.width,at.height),Ge===0&&(P.matrix.copy(Je.matrix),P.matrix.decompose(P.position,P.quaternion,P.scale)),De===!0&&P.cameras.push(Je)}let ke=s.enabledFeatures;if(ke&&ke.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&v){d=i.getBinding();let Ge=d.getDepthInformation(Q[0]);Ge&&Ge.isValid&&Ge.texture&&p.init(Ge,s.renderState)}if(ke&&ke.includes("camera-access")&&v){e.state.unbindTexture(),d=i.getBinding();for(let Ge=0;Ge<Q.length;Ge++){let pt=Q[Ge].camera;if(pt){let at=m[pt];at||(at=new Ka,m[pt]=at);let Je=d.getCameraImage(pt);at.sourceTexture=Je}}}}for(let Q=0;Q<b.length;Q++){let De=M[Q],ke=b[Q];De!==null&&ke!==void 0&&ke.update(De,ne,c||a)}Ke&&Ke(q,ne),ne.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:ne}),g=null}let $e=new dg;$e.setAnimationLoop(tt),this.setAnimationLoop=function(q){Ke=q},this.dispose=function(){}}},KM=new zt,vg=new ze;vg.set(-1,0,0,0,1,0,0,0,1);function ZM(t,e){function n(p,m){p.matrixAutoUpdate===!0&&p.updateMatrix(),m.value.copy(p.matrix)}function i(p,m){m.color.getRGB(p.fogColor.value,fd(t)),m.isFog?(p.fogNear.value=m.near,p.fogFar.value=m.far):m.isFogExp2&&(p.fogDensity.value=m.density)}function s(p,m,E,R,S){m.isNodeMaterial?m.uniformsNeedUpdate=!1:m.isMeshBasicMaterial?r(p,m):m.isMeshLambertMaterial?(r(p,m),m.envMap&&(p.envMapIntensity.value=m.envMapIntensity)):m.isMeshToonMaterial?(r(p,m),d(p,m)):m.isMeshPhongMaterial?(r(p,m),u(p,m),m.envMap&&(p.envMapIntensity.value=m.envMapIntensity)):m.isMeshStandardMaterial?(r(p,m),h(p,m),m.isMeshPhysicalMaterial&&f(p,m,S)):m.isMeshMatcapMaterial?(r(p,m),g(p,m)):m.isMeshDepthMaterial?r(p,m):m.isMeshDistanceMaterial?(r(p,m),v(p,m)):m.isMeshNormalMaterial?r(p,m):m.isLineBasicMaterial?(a(p,m),m.isLineDashedMaterial&&o(p,m)):m.isPointsMaterial?l(p,m,E,R):m.isSpriteMaterial?c(p,m):m.isShadowMaterial?(p.color.value.copy(m.color),p.opacity.value=m.opacity):m.isShaderMaterial&&(m.uniformsNeedUpdate=!1)}function r(p,m){p.opacity.value=m.opacity,m.color&&p.diffuse.value.copy(m.color),m.emissive&&p.emissive.value.copy(m.emissive).multiplyScalar(m.emissiveIntensity),m.map&&(p.map.value=m.map,n(m.map,p.mapTransform)),m.alphaMap&&(p.alphaMap.value=m.alphaMap,n(m.alphaMap,p.alphaMapTransform)),m.bumpMap&&(p.bumpMap.value=m.bumpMap,n(m.bumpMap,p.bumpMapTransform),p.bumpScale.value=m.bumpScale,m.side===bn&&(p.bumpScale.value*=-1)),m.normalMap&&(p.normalMap.value=m.normalMap,n(m.normalMap,p.normalMapTransform),p.normalScale.value.copy(m.normalScale),m.side===bn&&p.normalScale.value.negate()),m.displacementMap&&(p.displacementMap.value=m.displacementMap,n(m.displacementMap,p.displacementMapTransform),p.displacementScale.value=m.displacementScale,p.displacementBias.value=m.displacementBias),m.emissiveMap&&(p.emissiveMap.value=m.emissiveMap,n(m.emissiveMap,p.emissiveMapTransform)),m.specularMap&&(p.specularMap.value=m.specularMap,n(m.specularMap,p.specularMapTransform)),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest);let E=e.get(m),R=E.envMap,S=E.envMapRotation;R&&(p.envMap.value=R,p.envMapRotation.value.setFromMatrix4(KM.makeRotationFromEuler(S)).transpose(),R.isCubeTexture&&R.isRenderTargetTexture===!1&&p.envMapRotation.value.premultiply(vg),p.reflectivity.value=m.reflectivity,p.ior.value=m.ior,p.refractionRatio.value=m.refractionRatio),m.lightMap&&(p.lightMap.value=m.lightMap,p.lightMapIntensity.value=m.lightMapIntensity,n(m.lightMap,p.lightMapTransform)),m.aoMap&&(p.aoMap.value=m.aoMap,p.aoMapIntensity.value=m.aoMapIntensity,n(m.aoMap,p.aoMapTransform))}function a(p,m){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,m.map&&(p.map.value=m.map,n(m.map,p.mapTransform))}function o(p,m){p.dashSize.value=m.dashSize,p.totalSize.value=m.dashSize+m.gapSize,p.scale.value=m.scale}function l(p,m,E,R){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,p.size.value=m.size*E,p.scale.value=R*.5,m.map&&(p.map.value=m.map,n(m.map,p.uvTransform)),m.alphaMap&&(p.alphaMap.value=m.alphaMap,n(m.alphaMap,p.alphaMapTransform)),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest)}function c(p,m){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,p.rotation.value=m.rotation,m.map&&(p.map.value=m.map,n(m.map,p.mapTransform)),m.alphaMap&&(p.alphaMap.value=m.alphaMap,n(m.alphaMap,p.alphaMapTransform)),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest)}function u(p,m){p.specular.value.copy(m.specular),p.shininess.value=Math.max(m.shininess,1e-4)}function d(p,m){m.gradientMap&&(p.gradientMap.value=m.gradientMap)}function h(p,m){p.metalness.value=m.metalness,m.metalnessMap&&(p.metalnessMap.value=m.metalnessMap,n(m.metalnessMap,p.metalnessMapTransform)),p.roughness.value=m.roughness,m.roughnessMap&&(p.roughnessMap.value=m.roughnessMap,n(m.roughnessMap,p.roughnessMapTransform)),m.envMap&&(p.envMapIntensity.value=m.envMapIntensity)}function f(p,m,E){p.ior.value=m.ior,m.sheen>0&&(p.sheenColor.value.copy(m.sheenColor).multiplyScalar(m.sheen),p.sheenRoughness.value=m.sheenRoughness,m.sheenColorMap&&(p.sheenColorMap.value=m.sheenColorMap,n(m.sheenColorMap,p.sheenColorMapTransform)),m.sheenRoughnessMap&&(p.sheenRoughnessMap.value=m.sheenRoughnessMap,n(m.sheenRoughnessMap,p.sheenRoughnessMapTransform))),m.clearcoat>0&&(p.clearcoat.value=m.clearcoat,p.clearcoatRoughness.value=m.clearcoatRoughness,m.clearcoatMap&&(p.clearcoatMap.value=m.clearcoatMap,n(m.clearcoatMap,p.clearcoatMapTransform)),m.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=m.clearcoatRoughnessMap,n(m.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),m.clearcoatNormalMap&&(p.clearcoatNormalMap.value=m.clearcoatNormalMap,n(m.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(m.clearcoatNormalScale),m.side===bn&&p.clearcoatNormalScale.value.negate())),m.dispersion>0&&(p.dispersion.value=m.dispersion),m.iridescence>0&&(p.iridescence.value=m.iridescence,p.iridescenceIOR.value=m.iridescenceIOR,p.iridescenceThicknessMinimum.value=m.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=m.iridescenceThicknessRange[1],m.iridescenceMap&&(p.iridescenceMap.value=m.iridescenceMap,n(m.iridescenceMap,p.iridescenceMapTransform)),m.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=m.iridescenceThicknessMap,n(m.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),m.transmission>0&&(p.transmission.value=m.transmission,p.transmissionSamplerMap.value=E.texture,p.transmissionSamplerSize.value.set(E.width,E.height),m.transmissionMap&&(p.transmissionMap.value=m.transmissionMap,n(m.transmissionMap,p.transmissionMapTransform)),p.thickness.value=m.thickness,m.thicknessMap&&(p.thicknessMap.value=m.thicknessMap,n(m.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=m.attenuationDistance,p.attenuationColor.value.copy(m.attenuationColor)),m.anisotropy>0&&(p.anisotropyVector.value.set(m.anisotropy*Math.cos(m.anisotropyRotation),m.anisotropy*Math.sin(m.anisotropyRotation)),m.anisotropyMap&&(p.anisotropyMap.value=m.anisotropyMap,n(m.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=m.specularIntensity,p.specularColor.value.copy(m.specularColor),m.specularColorMap&&(p.specularColorMap.value=m.specularColorMap,n(m.specularColorMap,p.specularColorMapTransform)),m.specularIntensityMap&&(p.specularIntensityMap.value=m.specularIntensityMap,n(m.specularIntensityMap,p.specularIntensityMapTransform))}function g(p,m){m.matcap&&(p.matcap.value=m.matcap)}function v(p,m){let E=e.get(m).light;p.referencePosition.value.setFromMatrixPosition(E.matrixWorld),p.nearDistance.value=E.shadow.camera.near,p.farDistance.value=E.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function jM(t,e,n,i){let s={},r={},a=[],o=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(S,b){let M=b.program;i.uniformBlockBinding(S,M)}function c(S,b){let M=s[S.id];M===void 0&&(p(S),M=u(S),s[S.id]=M,S.addEventListener("dispose",E));let w=b.program;i.updateUBOMapping(S,w);let _=e.render.frame;r[S.id]!==_&&(h(S),r[S.id]=_)}function u(S){let b=d();S.__bindingPointIndex=b;let M=t.createBuffer(),w=S.__size,_=S.usage;return t.bindBuffer(t.UNIFORM_BUFFER,M),t.bufferData(t.UNIFORM_BUFFER,w,_),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,b,M),M}function d(){for(let S=0;S<o;S++)if(a.indexOf(S)===-1)return a.push(S),S;return Be("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(S){let b=s[S.id],M=S.uniforms,w=S.__cache;t.bindBuffer(t.UNIFORM_BUFFER,b);for(let _=0,A=M.length;_<A;_++){let I=M[_];if(Array.isArray(I))for(let C=0,P=I.length;C<P;C++)f(I[C],_,C,w);else f(I,_,0,w)}t.bindBuffer(t.UNIFORM_BUFFER,null)}function f(S,b,M,w){if(v(S,b,M,w)===!0){let _=S.__offset,A=S.value;if(Array.isArray(A)){let I=0;for(let C=0;C<A.length;C++){let P=A[C],O=m(P);g(P,S.__data,I),typeof P!="number"&&typeof P!="boolean"&&!P.isMatrix3&&!ArrayBuffer.isView(P)&&(I+=O.storage/Float32Array.BYTES_PER_ELEMENT)}}else g(A,S.__data,0);t.bufferSubData(t.UNIFORM_BUFFER,_,S.__data)}}function g(S,b,M){typeof S=="number"||typeof S=="boolean"?b[0]=S:S.isMatrix3?(b[0]=S.elements[0],b[1]=S.elements[1],b[2]=S.elements[2],b[3]=0,b[4]=S.elements[3],b[5]=S.elements[4],b[6]=S.elements[5],b[7]=0,b[8]=S.elements[6],b[9]=S.elements[7],b[10]=S.elements[8],b[11]=0):ArrayBuffer.isView(S)?b.set(new S.constructor(S.buffer,S.byteOffset,b.length)):S.toArray(b,M)}function v(S,b,M,w){let _=S.value,A=b+"_"+M;if(w[A]===void 0)return typeof _=="number"||typeof _=="boolean"?w[A]=_:ArrayBuffer.isView(_)?w[A]=_.slice():w[A]=_.clone(),!0;{let I=w[A];if(typeof _=="number"||typeof _=="boolean"){if(I!==_)return w[A]=_,!0}else{if(ArrayBuffer.isView(_))return!0;if(I.equals(_)===!1)return I.copy(_),!0}}return!1}function p(S){let b=S.uniforms,M=0,w=16;for(let A=0,I=b.length;A<I;A++){let C=Array.isArray(b[A])?b[A]:[b[A]];for(let P=0,O=C.length;P<O;P++){let B=C[P],L=Array.isArray(B.value)?B.value:[B.value];for(let W=0,z=L.length;W<z;W++){let $=L[W],Z=m($),ee=M%w,re=ee%Z.boundary,le=ee+re;M+=re,le!==0&&w-le<Z.storage&&(M+=w-le),B.__data=new Float32Array(Z.storage/Float32Array.BYTES_PER_ELEMENT),B.__offset=M,M+=Z.storage}}}let _=M%w;return _>0&&(M+=w-_),S.__size=M,S.__cache={},this}function m(S){let b={boundary:0,storage:0};return typeof S=="number"||typeof S=="boolean"?(b.boundary=4,b.storage=4):S.isVector2?(b.boundary=8,b.storage=8):S.isVector3||S.isColor?(b.boundary=16,b.storage=12):S.isVector4?(b.boundary=16,b.storage=16):S.isMatrix3?(b.boundary=48,b.storage=48):S.isMatrix4?(b.boundary=64,b.storage=64):S.isTexture?Ue("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(S)?(b.boundary=16,b.storage=S.byteLength):Ue("WebGLRenderer: Unsupported uniform value type.",S),b}function E(S){let b=S.target;b.removeEventListener("dispose",E);let M=a.indexOf(b.__bindingPointIndex);a.splice(M,1),t.deleteBuffer(s[b.id]),delete s[b.id],delete r[b.id]}function R(){for(let S in s)t.deleteBuffer(s[S]);a=[],s={},r={}}return{bind:l,update:c,dispose:R}}var JM=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Ni=null;function QM(){return Ni===null&&(Ni=new Ll(JM,16,16,Ns,Li),Ni.name="DFG_LUT",Ni.minFilter=en,Ni.magFilter=en,Ni.wrapS=wi,Ni.wrapT=wi,Ni.generateMipmaps=!1,Ni.needsUpdate=!0),Ni}var Wc=class{constructor(e={}){let{canvas:n=Om(),context:i=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:h=!1,outputBufferType:f=Gn}=e;this.isWebGLRenderer=!0;let g;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=i.getContextAttributes().alpha}else g=a;let v=f,p=new Set([oc,ac,rc]),m=new Set([Gn,di,jr,Jr,ic,sc]),E=new Uint32Array(4),R=new Int32Array(4),S=new F,b=null,M=null,w=[],_=[],A=null;this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=ui,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let I=this,C=!1,P=null,O=null,B=null,L=null;this._outputColorSpace=Bn;let W=0,z=0,$=null,Z=-1,ee=null,re=new Ft,le=new Ft,Ke=null,tt=new Ve(0),$e=0,q=n.width,ne=n.height,Q=1,De=null,ke=null,Ne=new Ft(0,0,q,ne),bt=new Ft(0,0,q,ne),Ge=!1,pt=new $a,at=!1,Je=!1,Lt=new zt,Rt=new F,Nt=new Ft,Gt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},It=!1;function Ot(){return $===null?Q:1}let D=i;function wn(y,U){return n.getContext(y,U)}try{let y={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:d};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${"185"}`),n.addEventListener("webglcontextlost",kt,!1),n.addEventListener("webglcontextrestored",Mt,!1),n.addEventListener("webglcontextcreationerror",_i,!1),D===null){let U="webgl2";if(D=wn(U,y),D===null)throw wn(U)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(y){throw Be("WebGLRenderer: "+y.message),y}let gt,T,x,k,G,Y,ie,oe,K,J,ce,Te,de,he,Fe,Oe,We,N,ae,j,ue,ge,te;function Ae(){gt=new a2(D),gt.init(),ue=new $M(D,gt),T=new Jb(D,gt,e,ue),x=new WM(D,gt),T.reversedDepthBuffer&&h&&x.buffers.depth.setReversed(!0),O=D.createFramebuffer(),B=D.createFramebuffer(),L=D.createFramebuffer(),k=new c2(D),G=new IM,Y=new XM(D,gt,x,G,T,ue,k),ie=new r2(I),oe=new f_(D),ge=new Zb(D,oe),K=new o2(D,oe,k,ge),J=new u2(D,K,oe,ge,k),N=new h2(D,T,Y),Fe=new Qb(G),ce=new RM(I,ie,gt,T,ge,Fe),Te=new ZM(I,G),de=new LM,he=new kM(gt),We=new Kb(I,ie,x,J,g,l),Oe=new GM(I,J,T),te=new jM(D,k,T,x),ae=new jb(D,gt,k),j=new l2(D,gt,k),k.programs=ce.programs,I.capabilities=T,I.extensions=gt,I.properties=G,I.renderLists=de,I.shadowMap=Oe,I.state=x,I.info=k}Ae(),v!==Gn&&(A=new f2(v,n.width,n.height,o,s,r));let Se=new Pd(I,D);this.xr=Se,this.getContext=function(){return D},this.getContextAttributes=function(){return D.getContextAttributes()},this.forceContextLoss=function(){let y=gt.get("WEBGL_lose_context");y&&y.loseContext()},this.forceContextRestore=function(){let y=gt.get("WEBGL_lose_context");y&&y.restoreContext()},this.getPixelRatio=function(){return Q},this.setPixelRatio=function(y){y!==void 0&&(Q=y,this.setSize(q,ne,!1))},this.getSize=function(y){return y.set(q,ne)},this.setSize=function(y,U,X=!0){if(Se.isPresenting){Ue("WebGLRenderer: Can't change size while VR device is presenting.");return}q=y,ne=U,n.width=Math.floor(y*Q),n.height=Math.floor(U*Q),X===!0&&(n.style.width=y+"px",n.style.height=U+"px"),A!==null&&A.setSize(n.width,n.height),this.setViewport(0,0,y,U)},this.getDrawingBufferSize=function(y){return y.set(q*Q,ne*Q).floor()},this.setDrawingBufferSize=function(y,U,X){q=y,ne=U,Q=X,n.width=Math.floor(y*X),n.height=Math.floor(U*X),this.setViewport(0,0,y,U)},this.setEffects=function(y){if(v===Gn){Be("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(y){for(let U=0;U<y.length;U++)if(y[U].isOutputPass===!0){Ue("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}A.setEffects(y||[])},this.getCurrentViewport=function(y){return y.copy(re)},this.getViewport=function(y){return y.copy(Ne)},this.setViewport=function(y,U,X,V){y.isVector4?Ne.set(y.x,y.y,y.z,y.w):Ne.set(y,U,X,V),x.viewport(re.copy(Ne).multiplyScalar(Q).round())},this.getScissor=function(y){return y.copy(bt)},this.setScissor=function(y,U,X,V){y.isVector4?bt.set(y.x,y.y,y.z,y.w):bt.set(y,U,X,V),x.scissor(le.copy(bt).multiplyScalar(Q).round())},this.getScissorTest=function(){return Ge},this.setScissorTest=function(y){x.setScissorTest(Ge=y)},this.setOpaqueSort=function(y){De=y},this.setTransparentSort=function(y){ke=y},this.getClearColor=function(y){return y.copy(We.getClearColor())},this.setClearColor=function(){We.setClearColor(...arguments)},this.getClearAlpha=function(){return We.getClearAlpha()},this.setClearAlpha=function(){We.setClearAlpha(...arguments)},this.clear=function(y=!0,U=!0,X=!0){let V=0;if(y){let H=!1;if($!==null){let me=$.texture.format;H=p.has(me)}if(H){let me=$.texture.type,ye=m.has(me),pe=We.getClearColor(),Ee=We.getClearAlpha(),Ce=pe.r,Xe=pe.g,Ze=pe.b;ye?(E[0]=Ce,E[1]=Xe,E[2]=Ze,E[3]=Ee,D.clearBufferuiv(D.COLOR,0,E)):(R[0]=Ce,R[1]=Xe,R[2]=Ze,R[3]=Ee,D.clearBufferiv(D.COLOR,0,R))}else V|=D.COLOR_BUFFER_BIT}U&&(V|=D.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),X&&(V|=D.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),V!==0&&D.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(y){y.setRenderer(this),P=y},this.dispose=function(){n.removeEventListener("webglcontextlost",kt,!1),n.removeEventListener("webglcontextrestored",Mt,!1),n.removeEventListener("webglcontextcreationerror",_i,!1),We.dispose(),de.dispose(),he.dispose(),G.dispose(),ie.dispose(),J.dispose(),ge.dispose(),te.dispose(),ce.dispose(),Se.dispose(),Se.removeEventListener("sessionstart",Cp),Se.removeEventListener("sessionend",Rp),$s.stop()};function kt(y){y.preventDefault(),dd("WebGLRenderer: Context Lost."),C=!0}function Mt(){dd("WebGLRenderer: Context Restored."),C=!1;let y=k.autoReset,U=Oe.enabled,X=Oe.autoUpdate,V=Oe.needsUpdate,H=Oe.type;Ae(),k.autoReset=y,Oe.enabled=U,Oe.autoUpdate=X,Oe.needsUpdate=V,Oe.type=H}function _i(y){Be("WebGLRenderer: A WebGL context could not be created. Reason: ",y.statusMessage)}function yi(y){let U=y.target;U.removeEventListener("dispose",yi),Av(U)}function Av(y){Tv(y),G.remove(y)}function Tv(y){let U=G.get(y).programs;U!==void 0&&(U.forEach(function(X){ce.releaseProgram(X)}),y.isShaderMaterial&&ce.releaseShaderCache(y))}this.renderBufferDirect=function(y,U,X,V,H,me){U===null&&(U=Gt);let ye=H.isMesh&&H.matrixWorld.determinantAffine()<0,pe=Iv(y,U,X,V,H);x.setMaterial(V,ye);let Ee=X.index,Ce=1;if(V.wireframe===!0){if(Ee=K.getWireframeAttribute(X),Ee===void 0)return;Ce=2}let Xe=X.drawRange,Ze=X.attributes.position,Ie=Xe.start*Ce,vt=(Xe.start+Xe.count)*Ce;me!==null&&(Ie=Math.max(Ie,me.start*Ce),vt=Math.min(vt,(me.start+me.count)*Ce)),Ee!==null?(Ie=Math.max(Ie,0),vt=Math.min(vt,Ee.count)):Ze!=null&&(Ie=Math.max(Ie,0),vt=Math.min(vt,Ze.count));let Wt=vt-Ie;if(Wt<0||Wt===1/0)return;ge.setup(H,V,pe,X,Ee);let Bt,_t=ae;if(Ee!==null&&(Bt=oe.get(Ee),_t=j,_t.setIndex(Bt)),H.isMesh)V.wireframe===!0?(x.setLineWidth(V.wireframeLinewidth*Ot()),_t.setMode(D.LINES)):_t.setMode(D.TRIANGLES);else if(H.isLine){let pn=V.linewidth;pn===void 0&&(pn=1),x.setLineWidth(pn*Ot()),H.isLineSegments?_t.setMode(D.LINES):H.isLineLoop?_t.setMode(D.LINE_LOOP):_t.setMode(D.LINE_STRIP)}else H.isPoints?_t.setMode(D.POINTS):H.isSprite&&_t.setMode(D.TRIANGLES);if(H.isBatchedMesh)if(gt.get("WEBGL_multi_draw"))_t.renderMultiDraw(H._multiDrawStarts,H._multiDrawCounts,H._multiDrawCount);else{let pn=H._multiDrawStarts,_e=H._multiDrawCounts,Un=H._multiDrawCount,ot=Ee?oe.get(Ee).bytesPerElement:1,Zn=G.get(V).currentProgram.getUniforms();for(let bi=0;bi<Un;bi++)Zn.setValue(D,"_gl_DrawID",bi),_t.render(pn[bi]/ot,_e[bi])}else if(H.isInstancedMesh)_t.renderInstances(Ie,Wt,H.count);else if(X.isInstancedBufferGeometry){let pn=X._maxInstanceCount!==void 0?X._maxInstanceCount:1/0,_e=Math.min(X.instanceCount,pn);_t.renderInstances(Ie,Wt,_e)}else _t.render(Ie,Wt)};function Tp(y,U,X){y.transparent===!0&&y.side===Ri&&y.forceSinglePass===!1?(y.side=bn,y.needsUpdate=!0,Xo(y,U,X),y.side=Qi,y.needsUpdate=!0,Xo(y,U,X),y.side=Ri):Xo(y,U,X)}this.compile=function(y,U,X=null){X===null&&(X=y),M=he.get(X),M.init(U),_.push(M),X.traverseVisible(function(H){H.isLight&&H.layers.test(U.layers)&&(M.pushLight(H),H.castShadow&&M.pushShadow(H))}),y!==X&&y.traverseVisible(function(H){H.isLight&&H.layers.test(U.layers)&&(M.pushLight(H),H.castShadow&&M.pushShadow(H))}),M.setupLights();let V=new Set;return y.traverse(function(H){if(!(H.isMesh||H.isPoints||H.isLine||H.isSprite))return;let me=H.material;if(me)if(Array.isArray(me))for(let ye=0;ye<me.length;ye++){let pe=me[ye];Tp(pe,X,H),V.add(pe)}else Tp(me,X,H),V.add(me)}),M=_.pop(),V},this.compileAsync=function(y,U,X=null){let V=this.compile(y,U,X);return new Promise(H=>{function me(){if(V.forEach(function(ye){G.get(ye).currentProgram.isReady()&&V.delete(ye)}),V.size===0){H(y);return}setTimeout(me,10)}gt.get("KHR_parallel_shader_compile")!==null?me():setTimeout(me,10)})};let hu=null;function Cv(y){hu&&hu(y)}function Cp(){$s.stop()}function Rp(){$s.start()}let $s=new dg;$s.setAnimationLoop(Cv),typeof self<"u"&&$s.setContext(self),this.setAnimationLoop=function(y){hu=y,Se.setAnimationLoop(y),y===null?$s.stop():$s.start()},Se.addEventListener("sessionstart",Cp),Se.addEventListener("sessionend",Rp),this.render=function(y,U){if(U!==void 0&&U.isCamera!==!0){Be("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(C===!0)return;P!==null&&P.renderStart(y,U);let X=Se.enabled===!0&&Se.isPresenting===!0,V=A!==null&&($===null||X)&&A.begin(I,$);if(y.matrixWorldAutoUpdate===!0&&y.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),Se.enabled===!0&&Se.isPresenting===!0&&(A===null||A.isCompositing()===!1)&&(Se.cameraAutoUpdate===!0&&Se.updateCamera(U),U=Se.getCamera()),y.isScene===!0&&y.onBeforeRender(I,y,U,$),M=he.get(y,_.length),M.init(U),M.state.textureUnits=Y.getTextureUnits(),_.push(M),Lt.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),pt.setFromProjectionMatrix(Lt,hi,U.reversedDepth),Je=this.localClippingEnabled,at=Fe.init(this.clippingPlanes,Je),b=de.get(y,w.length),b.init(),w.push(b),Se.enabled===!0&&Se.isPresenting===!0){let ye=I.xr.getDepthSensingMesh();ye!==null&&uu(ye,U,-1/0,I.sortObjects)}uu(y,U,0,I.sortObjects),b.finish(),I.sortObjects===!0&&b.sort(De,ke,U.reversedDepth),It=Se.enabled===!1||Se.isPresenting===!1||Se.hasDepthSensing()===!1,It&&We.addToRenderList(b,y),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),at===!0&&Fe.beginShadows();let H=M.state.shadowsArray;if(Oe.render(H,y,U),at===!0&&Fe.endShadows(),(V&&A.hasRenderPass())===!1){let ye=b.opaque,pe=b.transmissive;if(M.setupLights(),U.isArrayCamera){let Ee=U.cameras;if(pe.length>0)for(let Ce=0,Xe=Ee.length;Ce<Xe;Ce++){let Ze=Ee[Ce];Pp(ye,pe,y,Ze)}It&&We.render(y);for(let Ce=0,Xe=Ee.length;Ce<Xe;Ce++){let Ze=Ee[Ce];Ip(b,y,Ze,Ze.viewport)}}else pe.length>0&&Pp(ye,pe,y,U),It&&We.render(y),Ip(b,y,U)}$!==null&&z===0&&(Y.updateMultisampleRenderTarget($),Y.updateRenderTargetMipmap($)),V&&A.end(I),y.isScene===!0&&y.onAfterRender(I,y,U),ge.resetDefaultState(),Z=-1,ee=null,_.pop(),_.length>0?(M=_[_.length-1],Y.setTextureUnits(M.state.textureUnits),at===!0&&Fe.setGlobalState(I.clippingPlanes,M.state.camera)):M=null,w.pop(),w.length>0?b=w[w.length-1]:b=null,P!==null&&P.renderEnd()};function uu(y,U,X,V){if(y.visible===!1)return;if(y.layers.test(U.layers)){if(y.isGroup)X=y.renderOrder;else if(y.isLOD)y.autoUpdate===!0&&y.update(U);else if(y.isLightProbeGrid)M.pushLightProbeGrid(y);else if(y.isLight)M.pushLight(y),y.castShadow&&M.pushShadow(y);else if(y.isSprite){if(!y.frustumCulled||pt.intersectsSprite(y)){V&&Nt.setFromMatrixPosition(y.matrixWorld).applyMatrix4(Lt);let ye=J.update(y),pe=y.material;pe.visible&&b.push(y,ye,pe,X,Nt.z,null)}}else if((y.isMesh||y.isLine||y.isPoints)&&(!y.frustumCulled||pt.intersectsObject(y))){let ye=J.update(y),pe=y.material;if(V&&(y.boundingSphere!==void 0?(y.boundingSphere===null&&y.computeBoundingSphere(),Nt.copy(y.boundingSphere.center)):(ye.boundingSphere===null&&ye.computeBoundingSphere(),Nt.copy(ye.boundingSphere.center)),Nt.applyMatrix4(y.matrixWorld).applyMatrix4(Lt)),Array.isArray(pe)){let Ee=ye.groups;for(let Ce=0,Xe=Ee.length;Ce<Xe;Ce++){let Ze=Ee[Ce],Ie=pe[Ze.materialIndex];Ie&&Ie.visible&&b.push(y,ye,Ie,X,Nt.z,Ze)}}else pe.visible&&b.push(y,ye,pe,X,Nt.z,null)}}let me=y.children;for(let ye=0,pe=me.length;ye<pe;ye++)uu(me[ye],U,X,V)}function Ip(y,U,X,V){let{opaque:H,transmissive:me,transparent:ye}=y;M.setupLightsView(X),at===!0&&Fe.setGlobalState(I.clippingPlanes,X),V&&x.viewport(re.copy(V)),H.length>0&&Wo(H,U,X),me.length>0&&Wo(me,U,X),ye.length>0&&Wo(ye,U,X),x.buffers.depth.setTest(!0),x.buffers.depth.setMask(!0),x.buffers.color.setMask(!0),x.setPolygonOffset(!1)}function Pp(y,U,X,V){if((X.isScene===!0?X.overrideMaterial:null)!==null)return;if(M.state.transmissionRenderTarget[V.id]===void 0){let Ie=gt.has("EXT_color_buffer_half_float")||gt.has("EXT_color_buffer_float");M.state.transmissionRenderTarget[V.id]=new zn(1,1,{generateMipmaps:!0,type:Ie?Li:Gn,minFilter:Pi,samples:Math.max(4,T.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:je.workingColorSpace})}let me=M.state.transmissionRenderTarget[V.id],ye=V.viewport||re;me.setSize(ye.z*I.transmissionResolutionScale,ye.w*I.transmissionResolutionScale);let pe=I.getRenderTarget(),Ee=I.getActiveCubeFace(),Ce=I.getActiveMipmapLevel();I.setRenderTarget(me),I.getClearColor(tt),$e=I.getClearAlpha(),$e<1&&I.setClearColor(16777215,.5),I.clear(),It&&We.render(X);let Xe=I.toneMapping;I.toneMapping=ui;let Ze=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),M.setupLightsView(V),at===!0&&Fe.setGlobalState(I.clippingPlanes,V),Wo(y,X,V),Y.updateMultisampleRenderTarget(me),Y.updateRenderTargetMipmap(me),gt.has("WEBGL_multisampled_render_to_texture")===!1){let Ie=!1;for(let vt=0,Wt=U.length;vt<Wt;vt++){let Bt=U[vt],{object:_t,geometry:pn,material:_e,group:Un}=Bt;if(_e.side===Ri&&_t.layers.test(V.layers)){let ot=_e.side;_e.side=bn,_e.needsUpdate=!0,Lp(_t,X,V,pn,_e,Un),_e.side=ot,_e.needsUpdate=!0,Ie=!0}}Ie===!0&&(Y.updateMultisampleRenderTarget(me),Y.updateRenderTargetMipmap(me))}I.setRenderTarget(pe,Ee,Ce),I.setClearColor(tt,$e),Ze!==void 0&&(V.viewport=Ze),I.toneMapping=Xe}function Wo(y,U,X){let V=U.isScene===!0?U.overrideMaterial:null;for(let H=0,me=y.length;H<me;H++){let ye=y[H],{object:pe,geometry:Ee,group:Ce}=ye,Xe=ye.material;Xe.allowOverride===!0&&V!==null&&(Xe=V),pe.layers.test(X.layers)&&Lp(pe,U,X,Ee,Xe,Ce)}}function Lp(y,U,X,V,H,me){y.onBeforeRender(I,U,X,V,H,me),y.modelViewMatrix.multiplyMatrices(X.matrixWorldInverse,y.matrixWorld),y.normalMatrix.getNormalMatrix(y.modelViewMatrix),H.onBeforeRender(I,U,X,V,y,me),H.transparent===!0&&H.side===Ri&&H.forceSinglePass===!1?(H.side=bn,H.needsUpdate=!0,I.renderBufferDirect(X,U,V,H,y,me),H.side=Qi,H.needsUpdate=!0,I.renderBufferDirect(X,U,V,H,y,me),H.side=Ri):I.renderBufferDirect(X,U,V,H,y,me),y.onAfterRender(I,U,X,V,H,me)}function Xo(y,U,X){U.isScene!==!0&&(U=Gt);let V=G.get(y),H=M.state.lights,me=M.state.shadowsArray,ye=H.state.version,pe=ce.getParameters(y,H.state,me,U,X,M.state.lightProbeGridArray),Ee=ce.getProgramCacheKey(pe),Ce=V.programs;V.environment=y.isMeshStandardMaterial||y.isMeshLambertMaterial||y.isMeshPhongMaterial?U.environment:null,V.fog=U.fog;let Xe=y.isMeshStandardMaterial||y.isMeshLambertMaterial&&!y.envMap||y.isMeshPhongMaterial&&!y.envMap;V.envMap=ie.get(y.envMap||V.environment,Xe),V.envMapRotation=V.environment!==null&&y.envMap===null?U.environmentRotation:y.envMapRotation,Ce===void 0&&(y.addEventListener("dispose",yi),Ce=new Map,V.programs=Ce);let Ze=Ce.get(Ee);if(Ze!==void 0){if(V.currentProgram===Ze&&V.lightsStateVersion===ye)return Fp(y,pe),Ze}else pe.uniforms=ce.getUniforms(y),P!==null&&y.isNodeMaterial&&P.build(y,X,pe),y.onBeforeCompile(pe,I),Ze=ce.acquireProgram(pe,Ee),Ce.set(Ee,Ze),V.uniforms=pe.uniforms;let Ie=V.uniforms;return(!y.isShaderMaterial&&!y.isRawShaderMaterial||y.clipping===!0)&&(Ie.clippingPlanes=Fe.uniform),Fp(y,pe),V.needsLights=Lv(y),V.lightsStateVersion=ye,V.needsLights&&(Ie.ambientLightColor.value=H.state.ambient,Ie.lightProbe.value=H.state.probe,Ie.directionalLights.value=H.state.directional,Ie.directionalLightShadows.value=H.state.directionalShadow,Ie.spotLights.value=H.state.spot,Ie.spotLightShadows.value=H.state.spotShadow,Ie.rectAreaLights.value=H.state.rectArea,Ie.ltc_1.value=H.state.rectAreaLTC1,Ie.ltc_2.value=H.state.rectAreaLTC2,Ie.pointLights.value=H.state.point,Ie.pointLightShadows.value=H.state.pointShadow,Ie.hemisphereLights.value=H.state.hemi,Ie.directionalShadowMatrix.value=H.state.directionalShadowMatrix,Ie.spotLightMatrix.value=H.state.spotLightMatrix,Ie.spotLightMap.value=H.state.spotLightMap,Ie.pointShadowMatrix.value=H.state.pointShadowMatrix),V.lightProbeGrid=M.state.lightProbeGridArray.length>0,V.currentProgram=Ze,V.uniformsList=null,Ze}function Np(y){if(y.uniformsList===null){let U=y.currentProgram.getUniforms();y.uniformsList=ea.seqWithValue(U.seq,y.uniforms)}return y.uniformsList}function Fp(y,U){let X=G.get(y);X.outputColorSpace=U.outputColorSpace,X.batching=U.batching,X.batchingColor=U.batchingColor,X.instancing=U.instancing,X.instancingColor=U.instancingColor,X.instancingMorph=U.instancingMorph,X.skinning=U.skinning,X.morphTargets=U.morphTargets,X.morphNormals=U.morphNormals,X.morphColors=U.morphColors,X.morphTargetsCount=U.morphTargetsCount,X.numClippingPlanes=U.numClippingPlanes,X.numIntersection=U.numClipIntersection,X.vertexAlphas=U.vertexAlphas,X.vertexTangents=U.vertexTangents,X.toneMapping=U.toneMapping}function Rv(y,U){if(y.length===0)return null;if(y.length===1)return y[0].texture!==null?y[0]:null;S.setFromMatrixPosition(U.matrixWorld);for(let X=0,V=y.length;X<V;X++){let H=y[X];if(H.texture!==null&&H.boundingBox.containsPoint(S))return H}return null}function Iv(y,U,X,V,H){U.isScene!==!0&&(U=Gt),Y.resetTextureUnits();let me=U.fog,ye=V.isMeshStandardMaterial||V.isMeshLambertMaterial||V.isMeshPhongMaterial?U.environment:null,pe=$===null?I.outputColorSpace:$.isXRRenderTarget===!0?$.texture.colorSpace:je.workingColorSpace,Ee=V.isMeshStandardMaterial||V.isMeshLambertMaterial&&!V.envMap||V.isMeshPhongMaterial&&!V.envMap,Ce=ie.get(V.envMap||ye,Ee),Xe=V.vertexColors===!0&&!!X.attributes.color&&X.attributes.color.itemSize===4,Ze=!!X.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),Ie=!!X.morphAttributes.position,vt=!!X.morphAttributes.normal,Wt=!!X.morphAttributes.color,Bt=ui;V.toneMapped&&($===null||$.isXRRenderTarget===!0)&&(Bt=I.toneMapping);let _t=X.morphAttributes.position||X.morphAttributes.normal||X.morphAttributes.color,pn=_t!==void 0?_t.length:0,_e=G.get(V),Un=M.state.lights;if(at===!0&&(Je===!0||y!==ee)){let St=y===ee&&V.id===Z;Fe.setState(V,y,St)}let ot=!1;V.version===_e.__version?(_e.needsLights&&_e.lightsStateVersion!==Un.state.version||_e.outputColorSpace!==pe||H.isBatchedMesh&&_e.batching===!1||!H.isBatchedMesh&&_e.batching===!0||H.isBatchedMesh&&_e.batchingColor===!0&&H.colorTexture===null||H.isBatchedMesh&&_e.batchingColor===!1&&H.colorTexture!==null||H.isInstancedMesh&&_e.instancing===!1||!H.isInstancedMesh&&_e.instancing===!0||H.isSkinnedMesh&&_e.skinning===!1||!H.isSkinnedMesh&&_e.skinning===!0||H.isInstancedMesh&&_e.instancingColor===!0&&H.instanceColor===null||H.isInstancedMesh&&_e.instancingColor===!1&&H.instanceColor!==null||H.isInstancedMesh&&_e.instancingMorph===!0&&H.morphTexture===null||H.isInstancedMesh&&_e.instancingMorph===!1&&H.morphTexture!==null||_e.envMap!==Ce||V.fog===!0&&_e.fog!==me||_e.numClippingPlanes!==void 0&&(_e.numClippingPlanes!==Fe.numPlanes||_e.numIntersection!==Fe.numIntersection)||_e.vertexAlphas!==Xe||_e.vertexTangents!==Ze||_e.morphTargets!==Ie||_e.morphNormals!==vt||_e.morphColors!==Wt||_e.toneMapping!==Bt||_e.morphTargetsCount!==pn||!!_e.lightProbeGrid!=M.state.lightProbeGridArray.length>0)&&(ot=!0):(ot=!0,_e.__version=V.version);let Zn=_e.currentProgram;ot===!0&&(Zn=Xo(V,U,H),P&&V.isNodeMaterial&&P.onUpdateProgram(V,Zn,_e));let bi=!1,ps=!1,Cr=!1,yt=Zn.getUniforms(),Xt=_e.uniforms;if(x.useProgram(Zn.program)&&(bi=!0,ps=!0,Cr=!0),V.id!==Z&&(Z=V.id,ps=!0),_e.needsLights){let St=Rv(M.state.lightProbeGridArray,H);_e.lightProbeGrid!==St&&(_e.lightProbeGrid=St,ps=!0)}if(bi||ee!==y){x.buffers.depth.getReversed()&&y.reversedDepth!==!0&&(y._reversedDepth=!0,y.updateProjectionMatrix()),yt.setValue(D,"projectionMatrix",y.projectionMatrix),yt.setValue(D,"viewMatrix",y.matrixWorldInverse);let gs=yt.map.cameraPosition;gs!==void 0&&gs.setValue(D,Rt.setFromMatrixPosition(y.matrixWorld)),T.logarithmicDepthBuffer&&yt.setValue(D,"logDepthBufFC",2/(Math.log(y.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&yt.setValue(D,"isOrthographic",y.isOrthographicCamera===!0),ee!==y&&(ee=y,ps=!0,Cr=!0)}if(_e.needsLights&&(Un.state.directionalShadowMap.length>0&&yt.setValue(D,"directionalShadowMap",Un.state.directionalShadowMap,Y),Un.state.spotShadowMap.length>0&&yt.setValue(D,"spotShadowMap",Un.state.spotShadowMap,Y),Un.state.pointShadowMap.length>0&&yt.setValue(D,"pointShadowMap",Un.state.pointShadowMap,Y)),H.isSkinnedMesh){yt.setOptional(D,H,"bindMatrix"),yt.setOptional(D,H,"bindMatrixInverse");let St=H.skeleton;St&&(St.boneTexture===null&&St.computeBoneTexture(),yt.setValue(D,"boneTexture",St.boneTexture,Y))}H.isBatchedMesh&&(yt.setOptional(D,H,"batchingTexture"),yt.setValue(D,"batchingTexture",H._matricesTexture,Y),yt.setOptional(D,H,"batchingIdTexture"),yt.setValue(D,"batchingIdTexture",H._indirectTexture,Y),yt.setOptional(D,H,"batchingColorTexture"),H._colorsTexture!==null&&yt.setValue(D,"batchingColorTexture",H._colorsTexture,Y));let ms=X.morphAttributes;if((ms.position!==void 0||ms.normal!==void 0||ms.color!==void 0)&&N.update(H,X,Zn),(ps||_e.receiveShadow!==H.receiveShadow)&&(_e.receiveShadow=H.receiveShadow,yt.setValue(D,"receiveShadow",H.receiveShadow)),(V.isMeshStandardMaterial||V.isMeshLambertMaterial||V.isMeshPhongMaterial)&&V.envMap===null&&U.environment!==null&&(Xt.envMapIntensity.value=U.environmentIntensity),Xt.dfgLUT!==void 0&&(Xt.dfgLUT.value=QM()),ps){if(yt.setValue(D,"toneMappingExposure",I.toneMappingExposure),_e.needsLights&&Pv(Xt,Cr),me&&V.fog===!0&&Te.refreshFogUniforms(Xt,me),Te.refreshMaterialUniforms(Xt,V,Q,ne,M.state.transmissionRenderTarget[y.id]),_e.needsLights&&_e.lightProbeGrid){let St=_e.lightProbeGrid;Xt.probesSH.value=St.texture,Xt.probesMin.value.copy(St.boundingBox.min),Xt.probesMax.value.copy(St.boundingBox.max),Xt.probesResolution.value.copy(St.resolution)}ea.upload(D,Np(_e),Xt,Y)}if(V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(ea.upload(D,Np(_e),Xt,Y),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&yt.setValue(D,"center",H.center),yt.setValue(D,"modelViewMatrix",H.modelViewMatrix),yt.setValue(D,"normalMatrix",H.normalMatrix),yt.setValue(D,"modelMatrix",H.matrixWorld),V.uniformsGroups!==void 0){let St=V.uniformsGroups;for(let gs=0,Rr=St.length;gs<Rr;gs++){let Dp=St[gs];te.update(Dp,Zn),te.bind(Dp,Zn)}}return Zn}function Pv(y,U){y.ambientLightColor.needsUpdate=U,y.lightProbe.needsUpdate=U,y.directionalLights.needsUpdate=U,y.directionalLightShadows.needsUpdate=U,y.pointLights.needsUpdate=U,y.pointLightShadows.needsUpdate=U,y.spotLights.needsUpdate=U,y.spotLightShadows.needsUpdate=U,y.rectAreaLights.needsUpdate=U,y.hemisphereLights.needsUpdate=U}function Lv(y){return y.isMeshLambertMaterial||y.isMeshToonMaterial||y.isMeshPhongMaterial||y.isMeshStandardMaterial||y.isShadowMaterial||y.isShaderMaterial&&y.lights===!0}this.getActiveCubeFace=function(){return W},this.getActiveMipmapLevel=function(){return z},this.getRenderTarget=function(){return $},this.setRenderTargetTextures=function(y,U,X){let V=G.get(y);V.__autoAllocateDepthBuffer=y.resolveDepthBuffer===!1,V.__autoAllocateDepthBuffer===!1&&(V.__useRenderToTexture=!1),G.get(y.texture).__webglTexture=U,G.get(y.depthTexture).__webglTexture=V.__autoAllocateDepthBuffer?void 0:X,V.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(y,U){let X=G.get(y);X.__webglFramebuffer=U,X.__useDefaultFramebuffer=U===void 0},this.setRenderTarget=function(y,U=0,X=0){$=y,W=U,z=X;let V=null,H=!1,me=!1;if(y){let pe=G.get(y);if(pe.__useDefaultFramebuffer!==void 0){x.bindFramebuffer(D.FRAMEBUFFER,pe.__webglFramebuffer),re.copy(y.viewport),le.copy(y.scissor),Ke=y.scissorTest,x.viewport(re),x.scissor(le),x.setScissorTest(Ke),Z=-1;return}else if(pe.__webglFramebuffer===void 0)Y.setupRenderTarget(y);else if(pe.__hasExternalTextures)Y.rebindTextures(y,G.get(y.texture).__webglTexture,G.get(y.depthTexture).__webglTexture);else if(y.depthBuffer){let Xe=y.depthTexture;if(pe.__boundDepthTexture!==Xe){if(Xe!==null&&G.has(Xe)&&(y.width!==Xe.image.width||y.height!==Xe.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");Y.setupDepthRenderbuffer(y)}}let Ee=y.texture;(Ee.isData3DTexture||Ee.isDataArrayTexture||Ee.isCompressedArrayTexture)&&(me=!0);let Ce=G.get(y).__webglFramebuffer;y.isWebGLCubeRenderTarget?(Array.isArray(Ce[U])?V=Ce[U][X]:V=Ce[U],H=!0):y.samples>0&&Y.useMultisampledRTT(y)===!1?V=G.get(y).__webglMultisampledFramebuffer:Array.isArray(Ce)?V=Ce[X]:V=Ce,re.copy(y.viewport),le.copy(y.scissor),Ke=y.scissorTest}else re.copy(Ne).multiplyScalar(Q).floor(),le.copy(bt).multiplyScalar(Q).floor(),Ke=Ge;if(X!==0&&(V=O),x.bindFramebuffer(D.FRAMEBUFFER,V)&&x.drawBuffers(y,V),x.viewport(re),x.scissor(le),x.setScissorTest(Ke),H){let pe=G.get(y.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_CUBE_MAP_POSITIVE_X+U,pe.__webglTexture,X)}else if(me){let pe=U;for(let Ee=0;Ee<y.textures.length;Ee++){let Ce=G.get(y.textures[Ee]);D.framebufferTextureLayer(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0+Ee,Ce.__webglTexture,X,pe)}}else if(y!==null&&X!==0){let pe=G.get(y.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,pe.__webglTexture,X)}Z=-1},this.readRenderTargetPixels=function(y,U,X,V,H,me,ye,pe=0){if(!(y&&y.isWebGLRenderTarget)){Be("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ee=G.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&ye!==void 0&&(Ee=Ee[ye]),Ee){x.bindFramebuffer(D.FRAMEBUFFER,Ee);try{let Ce=y.textures[pe],Xe=Ce.format,Ze=Ce.type;if(y.textures.length>1&&D.readBuffer(D.COLOR_ATTACHMENT0+pe),!T.textureFormatReadable(Xe)){Be("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!T.textureTypeReadable(Ze)){Be("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=y.width-V&&X>=0&&X<=y.height-H&&D.readPixels(U,X,V,H,ue.convert(Xe),ue.convert(Ze),me)}finally{let Ce=$!==null?G.get($).__webglFramebuffer:null;x.bindFramebuffer(D.FRAMEBUFFER,Ce)}}},this.readRenderTargetPixelsAsync=async function(y,U,X,V,H,me,ye,pe=0){if(!(y&&y.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ee=G.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&ye!==void 0&&(Ee=Ee[ye]),Ee)if(U>=0&&U<=y.width-V&&X>=0&&X<=y.height-H){x.bindFramebuffer(D.FRAMEBUFFER,Ee);let Ce=y.textures[pe],Xe=Ce.format,Ze=Ce.type;if(y.textures.length>1&&D.readBuffer(D.COLOR_ATTACHMENT0+pe),!T.textureFormatReadable(Xe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!T.textureTypeReadable(Ze))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let Ie=D.createBuffer();D.bindBuffer(D.PIXEL_PACK_BUFFER,Ie),D.bufferData(D.PIXEL_PACK_BUFFER,me.byteLength,D.STREAM_READ),D.readPixels(U,X,V,H,ue.convert(Xe),ue.convert(Ze),0);let vt=$!==null?G.get($).__webglFramebuffer:null;x.bindFramebuffer(D.FRAMEBUFFER,vt);let Wt=D.fenceSync(D.SYNC_GPU_COMMANDS_COMPLETE,0);return D.flush(),await Bm(D,Wt,4),D.bindBuffer(D.PIXEL_PACK_BUFFER,Ie),D.getBufferSubData(D.PIXEL_PACK_BUFFER,0,me),D.deleteBuffer(Ie),D.deleteSync(Wt),me}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(y,U=null,X=0){let V=Math.pow(2,-X),H=Math.floor(y.image.width*V),me=Math.floor(y.image.height*V),ye=U!==null?U.x:0,pe=U!==null?U.y:0;Y.setTexture2D(y,0),D.copyTexSubImage2D(D.TEXTURE_2D,X,0,0,ye,pe,H,me),x.unbindTexture()},this.copyTextureToTexture=function(y,U,X=null,V=null,H=0,me=0){let ye,pe,Ee,Ce,Xe,Ze,Ie,vt,Wt,Bt=y.isCompressedTexture?y.mipmaps[me]:y.image;if(X!==null)ye=X.max.x-X.min.x,pe=X.max.y-X.min.y,Ee=X.isBox3?X.max.z-X.min.z:1,Ce=X.min.x,Xe=X.min.y,Ze=X.isBox3?X.min.z:0;else{let Xt=Math.pow(2,-H);ye=Math.floor(Bt.width*Xt),pe=Math.floor(Bt.height*Xt),y.isDataArrayTexture?Ee=Bt.depth:y.isData3DTexture?Ee=Math.floor(Bt.depth*Xt):Ee=1,Ce=0,Xe=0,Ze=0}V!==null?(Ie=V.x,vt=V.y,Wt=V.z):(Ie=0,vt=0,Wt=0);let _t=ue.convert(U.format),pn=ue.convert(U.type),_e;U.isData3DTexture?(Y.setTexture3D(U,0),_e=D.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(Y.setTexture2DArray(U,0),_e=D.TEXTURE_2D_ARRAY):(Y.setTexture2D(U,0),_e=D.TEXTURE_2D),x.activeTexture(D.TEXTURE0),x.pixelStorei(D.UNPACK_FLIP_Y_WEBGL,U.flipY),x.pixelStorei(D.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),x.pixelStorei(D.UNPACK_ALIGNMENT,U.unpackAlignment);let Un=x.getParameter(D.UNPACK_ROW_LENGTH),ot=x.getParameter(D.UNPACK_IMAGE_HEIGHT),Zn=x.getParameter(D.UNPACK_SKIP_PIXELS),bi=x.getParameter(D.UNPACK_SKIP_ROWS),ps=x.getParameter(D.UNPACK_SKIP_IMAGES);x.pixelStorei(D.UNPACK_ROW_LENGTH,Bt.width),x.pixelStorei(D.UNPACK_IMAGE_HEIGHT,Bt.height),x.pixelStorei(D.UNPACK_SKIP_PIXELS,Ce),x.pixelStorei(D.UNPACK_SKIP_ROWS,Xe),x.pixelStorei(D.UNPACK_SKIP_IMAGES,Ze);let Cr=y.isDataArrayTexture||y.isData3DTexture,yt=U.isDataArrayTexture||U.isData3DTexture;if(y.isDepthTexture){let Xt=G.get(y),ms=G.get(U),St=G.get(Xt.__renderTarget),gs=G.get(ms.__renderTarget);x.bindFramebuffer(D.READ_FRAMEBUFFER,St.__webglFramebuffer),x.bindFramebuffer(D.DRAW_FRAMEBUFFER,gs.__webglFramebuffer);for(let Rr=0;Rr<Ee;Rr++)Cr&&(D.framebufferTextureLayer(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,G.get(y).__webglTexture,H,Ze+Rr),D.framebufferTextureLayer(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,G.get(U).__webglTexture,me,Wt+Rr)),D.blitFramebuffer(Ce,Xe,ye,pe,Ie,vt,ye,pe,D.DEPTH_BUFFER_BIT,D.NEAREST);x.bindFramebuffer(D.READ_FRAMEBUFFER,null),x.bindFramebuffer(D.DRAW_FRAMEBUFFER,null)}else if(H!==0||y.isRenderTargetTexture||G.has(y)){let Xt=G.get(y),ms=G.get(U);x.bindFramebuffer(D.READ_FRAMEBUFFER,B),x.bindFramebuffer(D.DRAW_FRAMEBUFFER,L);for(let St=0;St<Ee;St++)Cr?D.framebufferTextureLayer(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,Xt.__webglTexture,H,Ze+St):D.framebufferTexture2D(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,Xt.__webglTexture,H),yt?D.framebufferTextureLayer(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,ms.__webglTexture,me,Wt+St):D.framebufferTexture2D(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,ms.__webglTexture,me),H!==0?D.blitFramebuffer(Ce,Xe,ye,pe,Ie,vt,ye,pe,D.COLOR_BUFFER_BIT,D.NEAREST):yt?D.copyTexSubImage3D(_e,me,Ie,vt,Wt+St,Ce,Xe,ye,pe):D.copyTexSubImage2D(_e,me,Ie,vt,Ce,Xe,ye,pe);x.bindFramebuffer(D.READ_FRAMEBUFFER,null),x.bindFramebuffer(D.DRAW_FRAMEBUFFER,null)}else yt?y.isDataTexture||y.isData3DTexture?D.texSubImage3D(_e,me,Ie,vt,Wt,ye,pe,Ee,_t,pn,Bt.data):U.isCompressedArrayTexture?D.compressedTexSubImage3D(_e,me,Ie,vt,Wt,ye,pe,Ee,_t,Bt.data):D.texSubImage3D(_e,me,Ie,vt,Wt,ye,pe,Ee,_t,pn,Bt):y.isDataTexture?D.texSubImage2D(D.TEXTURE_2D,me,Ie,vt,ye,pe,_t,pn,Bt.data):y.isCompressedTexture?D.compressedTexSubImage2D(D.TEXTURE_2D,me,Ie,vt,Bt.width,Bt.height,_t,Bt.data):D.texSubImage2D(D.TEXTURE_2D,me,Ie,vt,ye,pe,_t,pn,Bt);x.pixelStorei(D.UNPACK_ROW_LENGTH,Un),x.pixelStorei(D.UNPACK_IMAGE_HEIGHT,ot),x.pixelStorei(D.UNPACK_SKIP_PIXELS,Zn),x.pixelStorei(D.UNPACK_SKIP_ROWS,bi),x.pixelStorei(D.UNPACK_SKIP_IMAGES,ps),me===0&&U.generateMipmaps&&D.generateMipmap(_e),x.unbindTexture()},this.initRenderTarget=function(y){G.get(y).__webglFramebuffer===void 0&&Y.setupRenderTarget(y)},this.initTexture=function(y){y.isCubeTexture?Y.setTextureCube(y,0):y.isData3DTexture?Y.setTexture3D(y,0):y.isDataArrayTexture||y.isCompressedArrayTexture?Y.setTexture2DArray(y,0):Y.setTexture2D(y,0),x.unbindTexture()},this.resetState=function(){W=0,z=0,$=null,x.reset(),ge.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return hi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let n=this.getContext();n.drawingBufferColorSpace=je._getDrawingBufferColorSpace(e),n.unpackColorSpace=je._getUnpackColorSpace()}};var na={amber:"#FFB020",coral:"#FF6B4A",magenta:"#E85C9A",violet:"#9B7BFF",azure:"#4FA8FF",teal:"#2FD0C0",lime:"#9BD648",bone:"#E8DCC8"},Ld=Object.keys(na),_g=["text","label","color","pos","placed","createdAt","lastTouchedAt"];function bg(t,e,n){return{id:t,name:e,createdAt:n,lastOpenedAt:n,nodes:{},links:{},holding:{origin:[0,-14,0],radius:5.2},clocks:{},removedLinks:{}}}function Nd(t,e){let n=!1,i=(s,r,a)=>{let o=t.clocks[s];if(o===void 0||r>o)return t.clocks[s]=r,t.clocks[s+"#a"]=yg(a),!0;if(r===o){let l=yg(a);if(l>(t.clocks[s+"#a"]??-1))return t.clocks[s+"#a"]=l,!0}return!1};switch(e.t){case"node.set":{let s=t.nodes[e.id],r=s??{id:e.id,text:"",label:"",color:"bone",pos:[0,0,0],placed:!1,createdAt:e.ts,lastTouchedAt:e.ts};for(let a of _g)a in e.fields&&i(`n:${e.id}:${a}`,e.ts,e.actor)&&(r[a]=e.fields[a],n=!0);return s||(t.nodes[e.id]=r,n=!0),s===void 0&&t.clocks[`n:${e.id}:#del`]!==void 0&&delete t.clocks[`n:${e.id}:#del`],n}case"node.del":{if(_g.some(r=>(t.clocks[`n:${e.id}:${r}`]??-1)>e.ts))return!1;if(t.nodes[e.id]){delete t.nodes[e.id];for(let r of Object.keys(t.links))(t.links[r].a===e.id||t.links[r].b===e.id)&&(t.removedLinks[r]=e.ts,delete t.links[r]);t.clocks[`n:${e.id}:#del`]=e.ts,n=!0}return n}case"link.add":return t.removedLinks[e.id]!==void 0&&t.removedLinks[e.id]>=e.ts?!1:(t.links[e.id]||(t.links[e.id]={id:e.id,a:e.a,b:e.b,createdAt:e.ts},delete t.removedLinks[e.id],t.clocks[`l:${e.id}`]=e.ts,n=!0),n);case"link.del":return(t.clocks[`l:${e.id}`]??-1)>e.ts?!1:(t.links[e.id]&&(delete t.links[e.id],t.removedLinks[e.id]=e.ts,n=!0),n);case"map.set":{for(let s of Object.keys(e.fields))i(`m:${s}`,e.ts,e.actor)&&(t[s]=e.fields[s],n=!0);return n}}}function yg(t){let e=2166136261;for(let n=0;n<t.length;n++)e^=t.charCodeAt(n),e=Math.imul(e,16777619);return e>>>0}function Cn(t){return Object.values(t.nodes).sort((e,n)=>e.id<n.id?-1:e.id>n.id?1:0)}function Mg(t){return Object.values(t.links).sort((e,n)=>e.id<n.id?-1:e.id>n.id?1:0)}function lr(t){return Cn(t).filter(e=>!e.placed)}function Fd(t,e){let n=new Set;for(let i of Object.values(t.links))i.a===e?n.add(i.b):i.b===e&&n.add(i.a);return n}function qc(t,e){let n=1/0,i=-1/0;for(let s of Object.values(t.nodes))s.createdAt<n&&(n=s.createdAt),s.createdAt>i&&(i=s.createdAt);return!isFinite(n)||i<=n?1:(e.createdAt-n)/(i-n)}function Sg(t,e,n){let i=new Map,s=e?Fd(t,e):new Set;for(let r of Object.values(t.nodes))i.set(r.id,r.id===e?"selected":n.has(r.id)?"searchHit":r.placed?s.has(r.id)?"connected":"plain":"unplaced");return i}function wg(t,e){let n=e.trim().toLowerCase();return n?Cn(t).map(i=>{let s=i.text.toLowerCase(),r=i.label.toLowerCase(),a=-1;return s===n?a=0:s.startsWith(n)?a=1:r===n?a=2:s.includes(n)?a=3:r.includes(n)&&(a=4),{n:i,score:a}}).filter(i=>i.score>=0).sort((i,s)=>i.score-s.score||(i.n.id<s.n.id?-1:1)).map(i=>({n:i.n,field:i.score===2||i.score===4?"label":"text"})):[]}var Eg=0;function Dd(t){Eg++;let e=Math.floor(Math.random()*16777215).toString(36);return`${t}${Date.now().toString(36)}${Eg.toString(36)}${e}`}var Yc=class t{doc;actor;lastTs=0;listeners=[];transport=null;constructor(e,n){this.doc=e,this.actor=n}static blank(e,n,i){return new t(bg(e,n,Date.now()),i)}lastChange=null;describe(e){if(e.t==="node.set"){let n=e.fields;return"pos"in n&&n.placed===!0?"placed a node":"pos"in n?"moved a node":"text"in n?"edited text":"color"in n?"changed a colour":"label"in n?"set a label":"edited a node"}return e.t==="link.add"?"connected two nodes":e.t==="link.del"?"removed a filament":e.t==="node.del"?"deleted a node":e.t}attach(e){this.transport=e,e.onRemote(n=>{this.lastTs=Math.max(this.lastTs,n.ts),Nd(this.doc,n)&&(this.lastChange={actor:n.actor,remote:n.actor!==this.actor,what:this.describe(n),at:n.ts},this.emit(n))})}detach(){this.transport=null}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(n=>n!==e)}}emit(e){for(let n of this.listeners)n(this.doc,e)}ts(){let e=Date.now();return this.lastTs=e>this.lastTs?e:this.lastTs+1,this.lastTs}commit(e){let n=e(this.ts());return Nd(this.doc,n)&&(this.lastChange={actor:n.actor,remote:!1,what:this.describe(n),at:n.ts},this.emit(n)),this.transport?.send(n),n}replaceDoc(e){this.doc=e,this.emit(null)}quickAdd(e,n="bone"){let i=Dd("n"),s=lr(this.doc).length,r=this.doc.holding,a=s*2.39996%(Math.PI*2),o=r.radius*(.34+.42*(s%5/5)),l=[r.origin[0]+o*Math.cos(a),r.origin[1]+(s%3-1)*r.radius*.26,r.origin[2]+o*Math.sin(a)],c=Date.now();return this.commit(u=>({t:"node.set",id:i,actor:this.actor,ts:u,fields:{text:e,label:"holding",color:n,pos:l,placed:!1,createdAt:c,lastTouchedAt:c}})),i}place(e,n,i){let s=this.doc.nodes[e];if(!s)return;let r=i!==void 0?i:s.label==="holding"?"":s.label;this.commit(a=>({t:"node.set",id:e,actor:this.actor,ts:a,fields:{pos:n,placed:!0,lastTouchedAt:Date.now(),label:r}}))}move(e,n){this.doc.nodes[e]&&this.commit(i=>({t:"node.set",id:e,actor:this.actor,ts:i,fields:{pos:n,lastTouchedAt:Date.now()}}))}moveCluster(e,n){for(let i of e){let s=this.doc.nodes[i];if(!s)continue;let r=[s.pos[0]+n[0],s.pos[1]+n[1],s.pos[2]+n[2]];this.commit(a=>({t:"node.set",id:i,actor:this.actor,ts:a,fields:{pos:r,lastTouchedAt:Date.now()}}))}}setText(e,n){this.commit(i=>({t:"node.set",id:e,actor:this.actor,ts:i,fields:{text:n,lastTouchedAt:Date.now()}}))}setColor(e,n){this.commit(i=>({t:"node.set",id:e,actor:this.actor,ts:i,fields:{color:n,lastTouchedAt:Date.now()}}))}setLabel(e,n){this.commit(i=>({t:"node.set",id:e,actor:this.actor,ts:i,fields:{label:n,lastTouchedAt:Date.now()}}))}remove(e){this.commit(n=>({t:"node.del",id:e,actor:this.actor,ts:n}))}connect(e,n){if(e===n||!this.doc.nodes[e]||!this.doc.nodes[n])return null;let[i,s]=e<n?[e,n]:[n,e],r=`l${i}_${s}`;return this.doc.links[r]||this.commit(a=>({t:"link.add",id:r,a:i,b:s,actor:this.actor,ts:a})),r}disconnect(e,n){let[i,s]=e<n?[e,n]:[n,e],r=`l${i}_${s}`;this.doc.links[r]&&this.commit(a=>({t:"link.del",id:r,actor:this.actor,ts:a}))}rename(e){this.commit(n=>({t:"map.set",actor:this.actor,ts:n,fields:{name:e}}))}touchOpened(){this.commit(e=>({t:"map.set",actor:this.actor,ts:e,fields:{lastOpenedAt:Date.now()}}))}holdingCount(){return lr(this.doc).length}neighboursOf(e){return Fd(this.doc,e)}node(e){return this.doc.nodes[e]}};var Kc=class{constructor(e,n,i){this.url=e;this.actor=n;this.account=i}url;actor;ws=null;queue=[];remoteFns=[];snapFns=[];origin={from:"live"};connId=null;serverPid=null;mapsFns=[];statusFns=[];status="offline";detail="not connected";account;connect(e){this.setStatus("connecting",`connecting to ${this.url}`);let n=new WebSocket(`${this.url}?map=${encodeURIComponent(e)}&actor=${encodeURIComponent(this.actor)}&account=${encodeURIComponent(this.account)}`);this.ws=n,n.onopen=()=>{this.setStatus("live",`live \xB7 ${this.account}`);for(let i of this.queue.splice(0))n.send(JSON.stringify({t:"op",op:i}))},n.onclose=()=>{this.status!=="error"&&this.setStatus("offline","disconnected")},n.onerror=()=>this.setStatus("error","connection failed"),n.onmessage=i=>{let s=JSON.parse(i.data);if(s.t==="op")for(let r of this.remoteFns)r(s.op);else if(s.t==="snapshot"){this.origin=s.origin??{from:"live"},s.conn!==void 0&&(this.connId=s.conn),s.serverPid!==void 0&&(this.serverPid=s.serverPid);for(let r of this.snapFns)r(s.doc,this.origin)}else if(s.t==="maps")for(let r of this.mapsFns)r(s.maps);else s.t==="error"&&this.setStatus("error",s.message)}}close(){this.ws?.close(),this.ws=null}send(e){this.ws&&this.ws.readyState===WebSocket.OPEN?this.ws.send(JSON.stringify({t:"op",op:e})):this.queue.push(e)}request(e){this.ws&&this.ws.readyState===WebSocket.OPEN&&this.ws.send(JSON.stringify(e))}onRemote(e){this.remoteFns.push(e)}onSnapshot(e){this.snapFns.push(e)}onMaps(e){this.mapsFns.push(e)}onStatus(e){this.statusFns.push(e),e(this.status,this.detail)}setStatus(e,n){this.status=e,this.detail=n;for(let i of this.statusFns)i(e,n)}};var Ig="#120E0B",eS="#8A7F76",tS="#D8CCC0",Qc="#EFE6D8",nS={plain:0,connected:1,unplaced:2,searchHit:3,selected:4},mo={plain:.5,connected:.72,unplaced:.86,searchHit:.95,selected:1},Ag=new Map;function zd(t){let e=na[t]??t,n=Ag.get(e);return n||(n=new Ve(e),Ag.set(e,n)),n}var Tg=(t,e,n)=>.2126*t+.7152*e+.0722*n;var Ud=t=>t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4),Od=t=>t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055;function iS(t,e,n){let i=Ud(t),s=Ud(e),r=Ud(n),a=Math.cbrt(.4122214708*i+.5363325363*s+.0514459929*r),o=Math.cbrt(.2119034982*i+.6806995451*s+.1073969566*r),l=Math.cbrt(.0883024619*i+.2817188376*s+.6299787005*r);return[.2104542553*a+.793617785*o-.0040720468*l,1.9779984951*a-2.428592205*o+.4505937099*l,.0259040371*a+.7827717662*o-.808675766*l]}function kd(t,e,n){let i=(t+.3963377774*e+.2158037573*n)**3,s=(t-.1055613458*e-.0638541728*n)**3,r=(t-.0894841775*e-1.291485548*n)**3;return[Od(4.0767416621*i-3.3077115913*s+.2309699292*r),Od(-1.2684380046*i+2.6097574011*s-.3413193965*r),Od(-.0041960863*i-.7034186147*s+1.707614701*r)]}var Bd={plain:.26,connected:.37,unplaced:.48,searchHit:.59,selected:.7},sS=.35,rS=.1,Cg=["plain","connected","unplaced","searchHit","selected"],go=Cg.map((t,e)=>{let n=Bd[t],i=e===0?rS:Bd[Cg[e-1]];return(n-sS*(n-i))/n}),Rg=new Map;function Pg(t,e){let n=`${t}|${e}`,i=Rg.get(n);if(!i){let s=zd(t),r=Bd[e],[,a,o]=iS(s.r,s.g,s.b),l=h=>{let f=0,g=1.4;for(let v=0;v<28;v++){let p=(f+g)/2,E=kd(p,a*h,o*h).map(R=>Math.min(1,Math.max(0,R)));Tg(E[0],E[1],E[2])<r?f=p:g=p}return(f+g)/2},c=0,u=1,d=null;for(let h=0;h<22;h++){let f=(c+u)/2,g=kd(l(f),a*f,o*f);g.every(p=>p>=-.002&&p<=1.002)&&Math.abs(Tg(Math.min(1,Math.max(0,g[0])),Math.min(1,Math.max(0,g[1])),Math.min(1,Math.max(0,g[2])))-r)<.004?(d=g.map(p=>Math.min(1,Math.max(0,p))),c=f):u=f}d||(d=kd(l(0),0,0).map(f=>Math.min(1,Math.max(0,f)))),i=new Ve(d[0],d[1],d[2]),Rg.set(n,i)}return i}var aS=`
precision highp float;
attribute vec3  iPos;
...
MAP JSON:
${JSON.stringify(s)}`}function Fw(t){let n=[...[...t.matchAll(/```(?:json|JSON|js|javascript)?\s*([\s\S]*?)```/g)].map(i=>i[1].trim()).filter(Boolean)];for(let i of["{","["]){let s=i==="{"?"}":"]",r=0,a=-1,o=!1,l=!1,c="";for(let u=0;u<t.length;u++){let d=t[u];if(l){l=!1;continue}if(d==="\\"){l=!0;continue}if(d==='"'||d==="'"){o?o===d&&(o=!1):o=d;continue}if(!o){if(d===i)r===0&&(a=u),r++;else if(d===s&&(r--,r===0&&a>=0)){let h=t.slice(a,u+1);h.length>c.length&&(c=h)}}}c&&n.push(c)}return n.sort((i,s)=>s.length-i.length),n[0]??null}function Dw(t){let e=t;e=e.replace(/[\u201C\u201D\u201E\u2033]/g,'"').replace(/[\u2018\u2019\u2032]/g,"'"),e=e.replace(/\/\*[\s\S]*?\*\//g,""),e=e.replace(/(^|[^:"'\\])\/\/[^\n\r]*/g,"$1"),e=e.replace(/\bTrue\b/g,"true").replace(/\bFalse\b/g,"false").replace(/\bNone\b/g,"null").replace(/\bNaN\b/g,"null"),e=e.replace(/([{,]\s*)([A-Za-z_$][\w$]*)\s*:/g,'$1"$2":'),e=e.replace(/'((?:[^'\\]|\\.)*)'/g,(a,o)=>JSON.stringify(o.replace(/\\'/g,"'"))),e=e.replace(/,(\s*[}\]])/g,"$1");let n=0,i=0,s=!1,r=!1;for(let a=0;a<e.length;a++){let o=e[a];if(r){r=!1;continue}if(o==="\\"){r=!0;continue}if(o==='"'){s=!s;continue}s||(o==="{"?n++:o==="}"?n--:o==="["?i++:o==="]"&&i--)}for(s&&(e+='"'),e=e.replace(/,\s*$/,"");i-- >0;)e+="]";for(;n-- >0;)e+="}";return e}var Uw=0,Ep=()=>`s${++Uw}`;function bv(t,e){let n=[];if(!t||!t.trim())return{ok:!1,suggestions:[],dropped:n,error:"The reply was empty. Nothing was changed."};let i=Fw(t);if(!i)return{ok:!1,suggestions:[],dropped:n,error:"No JSON found in that reply. Nothing was changed."};let s=null;for(let v of[i,Dw(i)])try{s=JSON.parse(v);break}catch{}if(s===null||typeof s!="object")return{ok:!1,suggestions:[],dropped:n,error:"That reply is not valid JSON, even after repair. Nothing was changed."};let r=[],a=[],o=[],l=Array.isArray(s)?{list:s}:s;if(Array.isArray(l.list)||Array.isArray(l.suggestions))for(let v of l.list??l.suggestions){let p=String(v?.kind??v?.type??"").toLowerCase();p.startsWith("conn")?r.push(v):p.startsWith("group")?a.push(v):p.startsWith("plac")?o.push(v):v?.a&&v?.b?r.push(v):v?.nodes?a.push(v):v?.pos?o.push(v):n.push({what:JSON.stringify(v).slice(0,60),why:"unrecognised suggestion kind"})}let c=(...v)=>{for(let p of v)if(Array.isArray(l[p]))return l[p];return[]};r=r.concat(c("connections","connect","links")),a=a.concat(c("groupings","groups","clusters")),o=o.concat(c("placements","placement","positions"));let u=new Map,d=new Map;for(let v of Cn(e))u.set(v.id,v),d.set(v.text.trim().toLowerCase(),v);let h=v=>typeof v!="string"?null:u.get(v)??d.get(v.trim().toLowerCase())??null,f=new Set(Object.values(e.links).map(v=>v.a<v.b?`${v.a}|${v.b}`:`${v.b}|${v.a}`)),g=[];for(let v of r){let p=h(v?.a??v?.from??v?.source),m=h(v?.b??v?.to??v?.target);if(!p||!m){n.push({what:`connection ${v?.a} \u2194 ${v?.b}`,why:"unknown node"});continue}if(p.id===m.id){n.push({what:`connection on ${p.text}`,why:"a node cannot link to itself"});continue}let E=p.id<m.id?`${p.id}|${m.id}`:`${m.id}|${p.id}`;if(f.has(E)){n.push({what:`${p.text} \u2194 ${m.text}`,why:"already linked"});continue}g.push({kind:"connection",id:Ep(),a:p.id,b:m.id,why:String(v?.why??v?.reason??"").slice(0,160)})}for(let v of a){let m=(Array.isArray(v?.nodes)?v.nodes:Array.isArray(v?.members)?v.members:[]).map(h).filter(Boolean).map(R=>R.id),E=String(v?.name??v?.label??v?.title??"").trim();if(m.length<2||!E){n.push({what:`grouping "${E||"?"}"`,why:m.length<2?"fewer than two known nodes":"no group name"});continue}g.push({kind:"grouping",id:Ep(),nodes:m,name:E.slice(0,40),why:String(v?.why??v?.reason??"").slice(0,160)})}for(let v of o){let p=h(v?.node??v?.id??v?.target),m=Array.isArray(v?.pos)?v.pos:Array.isArray(v?.position)?v.position:null;if(!p){n.push({what:`placement of ${v?.node}`,why:"unknown node"});continue}if(p.placed){n.push({what:`placement of "${p.text}"`,why:"that node is already placed \u2014 placed positions are not the finder's to change"});continue}let E=(m??[]).map(R=>Number(R));if(E.length!==3||E.some(R=>!isFinite(R))){n.push({what:`placement of "${p.text}"`,why:"position is not three finite numbers"});continue}g.push({kind:"placement",id:Ep(),node:p.id,pos:[E[0],E[1],E[2]],why:String(v?.why??v?.reason??"").slice(0,160)})}return g.length?{ok:!0,suggestions:g,dropped:n}:{ok:!1,suggestions:[],dropped:n,error:n.length?`Nothing usable in that reply \u2014 ${n.length} entr${n.length===1?"y":"ies"} rejected. Nothing was changed.`:"That reply held no suggestions. Nothing was changed."}}function Mv(t,e){if(e.kind==="connection")t.connect(e.a,e.b);else if(e.kind==="grouping")for(let n of e.nodes)t.setLabel(n,e.name);else e.kind==="placement"&&t.place(e.node,e.pos,t.node(e.node)?.label||"")}function cu(t,e){let n=i=>e.nodes[i]?.text??i;return t.kind==="connection"?`Connect \u201C${n(t.a)}\u201D to \u201C${n(t.b)}\u201D`:t.kind==="grouping"?`Group ${t.nodes.length} nodes as \u201C${t.name}\u201D`:`Place \u201C${n(t.node)}\u201D at ${t.pos.map(i=>i.toFixed(1)).join(", ")}`}var Sv=`
:root{
...
`;var ve=(t,e=document)=>e.querySelector(t),Et=(t,e={},n="")=>{let i=document.createElement(t);for(let[s,r]of Object.entries(e))i.setAttribute(s,r);return n&&(i.innerHTML=n),i},dt=t=>t.replace(/[&<>"]/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[e]),Ow=t=>{let e=Math.max(0,Math.round((Date.now()-t)/6e4));if(e<1)return"just now";if(e<60)return`${e} min ago`;let n=Math.round(e/60);if(n<24)return`${n} h ago`;let i=Math.round(n/24);return i<30?`${i} d ago`:`${Math.round(i/30)} mo ago`},Ap=class{handVocab=fs;touchVocab=lu;surface;lens="canvas";scene;store;sync;controls;hands;maps=[];selected=null;hits=[];hitIndex=0;suggestions=[];sugIndex=0;lastParse=null;handsOn=!1;frozenClock=null;virtualNow=null;uiUntil={toast:0,gesture:0,turning:0};ready=!1;raf=0;lastGesture={id:"",detail:"",at:0};handGrab=null;lastHandOp=0;gyro=null;constructor(e){this.surface=e}lenses(){return this.surface==="windows"?["canvas","expansion"]:["canvas","ar"]}async boot(e){document.head.appendChild(Et("style",{},Sv)),document.body.appendChild(Et("canvas",{id:"world"})),this.buildChrome();let n=await(await fetch("./assets/font-sdf.json")).json(),i=await new Promise((r,a)=>new ja().load("./assets/font-sdf.png",r,void 0,a));this.scene=new th(ve("#world"),n,i);let s=await(await fetch(`./maps/${e.mapId}.json`)).json();this.store=new Yc(s,e.actor),this.sync=new Kc(e.wsUrl,e.actor,e.account),this.sync.onSnapshot((r,a)=>{this.store.replaceDoc(r),this.scene.setDoc(r),this.refresh(),this.frameAll(),this.showOrigin(a)}),this.sync.onMaps(r=>{this.maps=r,ve("#maps")&&this.renderMaps()}),this.sync.onStatus(()=>this.renderSyncStatus()),this.store.attach(this.sync),this.store.subscribe(()=>{this.scene.markDirty(),this.refresh()}),this.sync.connect(e.mapId),this.scene.setDoc(this.store.doc),this.controls=new nh(this.scene,this.store,{onSelect:r=>this.select(r),onQuickAdd:()=>this.quickAdd(""),onGestureFired:(r,a)=>this.showGesture(r,a),onDragEnd:()=>this.refresh()}),this.controls.now=()=>this.now(),this.hands=new ou("./assets/mp-wasm","./assets/hand_landmarker.task"),this.hands.onFrame=r=>this.onHand(r),this.setLens(this.lenses()[0]),this.resize(),window.addEventListener("resize",()=>this.resize()),this.attachInput(),this.frameAll(),this.refresh(),this.loop(),this.ready=!0}buildChrome(){let e=Et("div",{id:"top"});e.innerHTML=`
      ...
      <button data-t="open-settings" class="ghost">Settings</button>`,document.body.append(e,Et("div",{id:"lenstag","data-t":"lens-tag"}),Et("div",{id:"gesture","data-t":"gesture-hud"}),Et("div",{id:"argyro","data-t":"ar-gyro"}),Et("div",{id:"toast","data-t":"toast"}),Et("div",{id:"tools","data-t":"tools"})),ve("[data-t=capture]").addEventListener("click",()=>this.quickAdd(ve("#capture").value)),ve("#capture").addEventListener("keydown",r=>{r.key==="Enter"&&this.quickAdd(ve("#capture").value)}),ve("[data-t=open-states]").addEventListener("click",()=>this.toggleStates()),ve("[data-t=hands-chip]").addEventListener("click",()=>this.toggleHands(!this.handsOn)),ve("[data-t=open-maps]").addEventListener("click",()=>this.openMapsHome()),ve("[data-t=open-settings]").addEventListener("click",()=>this.openSettings()),ve("[data-t=open-finder]").addEventListener("click",()=>this.toggleFinder());let n=ve("#search");n.addEventListener("input",()=>this.search(n.value)),n.addEventListener("keydown",r=>{r.key==="Enter"&&this.flyToHit(r.shiftKey?-1:1)});let i=ve("[data-t=lens-tabs]");for(let r of this.lenses()){let a=Et("button",{"data-t":`lens-${r}`},r==="expansion"?"Mind expansion":r==="ar"?"AR":"Canvas");a.addEventListener("click",()=>this.setLens(r)),i.appendChild(a)}let s=ve("#tools");for(let r of fs){let a={fist:"Grab",spread:"Closer",gather:"Back",two:"Select"},o=Et("button",{"data-t":`tool-${r.id}`,title:`${r.name} \u2014 ${r.mouse}`},a[r.id]??r.name);o.addEventListener("click",()=>this.runHandOperation(r.id,!0)),s.appendChild(o)}}attachInput(){let e=ve("#world");this.surface==="windows"?this.controls.attachMouse(e):this.controls.attachTouch(e),window.addEventListener("keydown",n=>{let i=n.target?.tagName;i==="INPUT"||i==="TEXTAREA"||((n.key==="n"||n.key==="N")&&(n.preventDefault(),this.quickAdd("")),n.key==="Escape"&&(this.select(null),this.closeOverlays()))}),window.addEventListener("deviceorientation",n=>{if(this.lens!=="ar"||n.alpha===null)return;let i=this.gyro;this.gyro={alpha:n.alpha??0,beta:n.beta??90,gamma:n.gamma??0},i&&Math.abs(this.gyro.alpha-i.alpha)+Math.abs(this.gyro.beta-i.beta)>1.5&&(this.uiUntil.turning=this.now()+1400),this.controls.applyOrientation(this.gyro.alpha,this.gyro.beta,this.gyro.gamma),this.renderGyro()})}setLens(e){this.lens=e,this.scene.applyLens(e);for(let s of this.lenses())ve(`[data-t=lens-${s}]`).classList.toggle("on",s===e);ve("#tools").classList.toggle("show",e==="expansion"),document.body.classList.toggle("ar",e==="ar"),this.controls.gyroDriven=e==="ar",e==="ar"&&this.controls.resetGyroBase();let n=this.provenance(),i=n.isElectron?`${n.runtime} \xB7 ${n.platform}`:this.surface==="android"?`${n.runtime} \xB7 android device profile`:`${n.runtime} \xB7 ${n.platform}`;ve("#lenstag").innerHTML=`<b>${this.surface==="windows"?"Windows":"Android"}</b> \xB7 <b>${e==="expansion"?"mind expansion":e}</b> <span class="prov">${dt(i)}</span>`+(e==="ar"?' <span class="prov">real orientation + touch events \xB7 <b class="absent">no camera pass-through</b></span>':""),e==="expansion"&&this.frameAll(),this.renderGyro(),this.scene.markDirty()}renderPin(){let e=this.selected!==null&&(this.scene.labelRects.get(this.selected)?.alpha??0)<=.02,n=this.pinned??(e?this.selected:null),i=document.getElementById("pinmark");if(!n||!this.store.doc.nodes[n]){i?.remove();return}i||(i=Et("div",{id:"pinmark","data-t":"pin-mark"}),i.innerHTML='<div class="ring"></div><div class="tag" data-t="pin-name"></div>',document.body.appendChild(i));let s=this.scene.screenPositions().find(o=>o.id===n);if(!s){i.className="";return}let r=this.scene.renderer.domElement.width/Math.max(window.innerWidth,1),a=Math.max(14,s.r/r+9);i.className="on",i.style.left=`${Math.round(s.x/r-a)}px`,i.style.top=`${Math.round(s.y/r-a)}px`,i.style.width=i.style.height=`${Math.round(a*2)}px`,ve("[data-t=pin-name]",i).textContent=this.store.doc.nodes[n].text}togglePin(e){this.pinned=this.pinned===e?null:e,this.scene.setPinned(this.pinned),this.refresh()}pinned=null;renderReticle(){let e=document.getElementById("reticle");if(this.lens!=="ar"){e?.remove(),this.aimedAt&&(this.aimedAt=null,this.scene.setNamedByChrome([]));return}e||(e=Et("div",{id:"reticle","data-t":"ar-reticle"}),e.innerHTML='<div class="lead" data-t="reticle-lead"></div><div class="x"></div><div class="n" data-t="reticle-node"></div>',document.body.appendChild(e));let n=this.scene.renderer.domElement,i=n.width/2,s=n.height/2,r=null;for(let f of this.scene.screenPositions()){let g=Math.hypot(f.x-i,f.y-s);(!r||g<r.d)&&(r={id:f.id,d:g,x:f.x,y:f.y})}let a=n.width*.22,o=!!r&&r.d<a,l=o?this.store.doc.nodes[r.id]:null,c=o?r.id:null;c!==this.aimedAt&&(this.aimedAt=c,this.scene.setSelection(c??this.selected)),this.scene.setNamedByChrome(c?[c]:[]);let u=ve("[data-t=reticle-node]",e);e.classList.toggle("on",o),u.textContent=l?`${l.text}${l.placed?"":" \xB7 in holding"}`:"pointing at open space";let d=ve("[data-t=reticle-lead]",e),h=n.width/Math.max(window.innerWidth,1);if(o&&r){let f=(r.x-i)/h,g=(r.y-s)/h,v=Math.hypot(f,g),p=13;d.style.width=`${Math.max(v-p,0).toFixed(1)}px`,d.style.transform=`rotate(${(Math.atan2(g,f)*180/Math.PI).toFixed(2)}deg) translateX(${p}px)`,d.style.opacity=v>p+4?"":"0"}else d.style.width="0px"}renderGyro(){let e=document.getElementById("argyro");if(!e||(e.classList.toggle("show",this.lens==="ar"),this.lens!=="ar"))return;let n=this.gyro;e.classList.toggle("turning",this.now()<this.uiUntil.turning),e.innerHTML=n?`gyro live \xB7 heading <b>${n.alpha.toFixed(0)}\xB0</b> \xB7 tilt <b>${n.beta.toFixed(0)}\xB0</b> \xB7 roll <b>${n.gamma.toFixed(0)}\xB0</b>`:"gyro \xB7 waiting for orientation"}safeInsets(){let e=Math.max(window.innerHeight,1),n=Math.max(window.innerWidth,1),i=u=>{let d=document.querySelector(u);if(!d||!d.offsetParent&&getComputedStyle(d).position!=="fixed")return 0;let h=d.getBoundingClientRect();return h.width>0&&h.height>0?h.height:0},s=22,r=Math.max(i("#tools"),i("#lenstag"),i("#argyro"),i("#gesture"))+12,a=i("#top"),o=12,l=12;for(let u of["#finder","#states"]){let d=document.querySelector(u);d&&(o=Math.max(o,d.getBoundingClientRect().right+14))}let c=document.getElementById("editor");return c&&(l=Math.max(l,n-c.getBoundingClientRect().left+14)),{top:Math.min((a+s)/e,.22),bottom:Math.min((r+s)/e,.22),left:Math.min(o/n,.38),right:Math.min(l/n,.38)}}frameNodes(e,n=1.3){let i=this.store.doc,s=e.map(a=>i.nodes[a]).filter(Boolean);if(!s.length)return;let r=this.scene.fitAll(s,n,this.safeInsets(),!1);this.scene.pose.target.copy(r.target),this.scene.pose.dist=r.dist}frameAll(e=1.04){let n=this.scene.fitAll(Cn(this.store.doc),e,this.safeInsets());this.scene.pose.target.copy(n.target),this.scene.pose.dist=n.dist,this.controls.minDist=Math.max(n.dist*.22,4),this.controls.maxDist=n.dist*2.1}resize(){let e=Math.floor(window.innerWidth),n=Math.floor(window.innerHeight);this.scene.setSize(e,n);let i=ve("#world");i.style.width=e+"px",i.style.height=n+"px"}quickAdd(e){let n=(e||"").trim(),i=this.store.quickAdd(n||"New thought");return ve("#capture").value="",this.select(i),this.toast(`Captured into holding \u2014 ${this.store.holdingCount()} waiting. Drag it out to place it.`),i}select(e){let n=e!==null&&this.selected===null;this.selected=e,this.scene.setSelection(e),this.renderEditor(),n&&this.clearOfPanels(e)}clearOfPanels(e){let n=this.scene.renderer.domElement,i=n.width/Math.max(window.innerWidth,1),s=0,r=0;for(let h of["#finder","#states"]){let f=document.querySelector(h);f&&(s=Math.max(s,(f.getBoundingClientRect().right+16)*i))}let a=document.getElementById("editor");if(a&&(r=Math.max(r,(n.width/i-a.getBoundingClientRect().left+16)*i)),!s&&!r)return;let{lo:o,hi:l}=this.scene.contentBoundsX();if(!isFinite(o)||!isFinite(l))return;let c=s,u=n.width-r,d=0;if(l-o<=u-c)o<c?d=c-o:l>u&&(d=u-l);else{let h=e?this.scene.screenPositions().find(p=>p.id===e):void 0,f=e?this.scene.labelRects.get(e):void 0,g=Math.min(h?h.x-h.r:1/0,f?f.x0:1/0),v=Math.max(h?h.x+h.r:-1/0,f?f.x1:-1/0);!isFinite(g)||!isFinite(v)?d=(c+u)/2-(o+l)/2:g<c?d=c-g:v>u&&(d=u-v)}Math.abs(d)<4||this.controls.panTarget(d,0)}search(e){let n=wg(this.store.doc,e);this.hits=n.map(i=>i.n.id),this.hitLabelMatches=n.filter(i=>i.field==="label").map(i=>i.n.id),this.hitQuery=e.trim(),this.hitIndex=0,this.scene.setHits(this.hits),this.refresh()}hitLabelMatches=[];hitQuery="";renderHitBreakdown(){let e=document.getElementById("hitbreak");e||(e=Et("div",{id:"hitbreak","data-t":"search-breakdown"}),document.body.appendChild(e));let n=this.hits.length;if(!n||!this.hitQuery){e.className="",e.textContent="";return}let i=this.hitLabelMatches.length,s=n-i,r=[...new Set(this.hitLabelMatches.map(l=>this.store.doc.nodes[l]?.label).filter(Boolean))],a=[`${n} hit${n===1?"":"s"}`];s&&a.push(`${s} in the text`),i&&a.push(`${i} in the label ${r.map(l=>`\u201C${l}\u201D`).join(", ")}`),e.textContent=a.join(" \xB7 "),e.className="show";let o=document.getElementById("search")?.getBoundingClientRect();if(o){e.style.top=`${Math.round(o.bottom+8)}px`;let l=e.getBoundingClientRect().width,c=window.innerWidth-o.right;for(let u of["#editor","#finder","#states"]){let d=document.querySelector(u);if(!d)continue;let h=d.getBoundingClientRect();h.width>2&&h.height>2&&(c=Math.max(c,window.innerWidth-h.left+10))}e.style.right=`${Math.round(Math.min(c,Math.max(8,window.innerWidth-l-8)))}px`}}flyToHit(e=0){if(!this.hits.length)return;e&&(this.hitIndex=(this.hitIndex+e+this.hits.length)%this.hits.length);let n=this.hits[this.hitIndex];this.select(n),this.controls.flyTo(n,1300,this.lens==="expansion"?15:12)}async toggleHands(e){if(this.handsOn=e,this.renderHandPanel(),e){let n=document.getElementById("handvid");if(!n){this.handsOn=!1,this.toast("Hand tracking unavailable: no video surface",!0);return}try{await this.hands.start(n)}catch(i){this.handsOn=!1,this.toast(`Hand tracking unavailable: ${i.message}`,!0)}}else this.hands.stop();this.renderHandPanel()}onHand(e){if(this.drawLandmarks(e),this.renderHandPanel(),!e.present||e.pose==="none"){this.handGrab=null;return}this.runHandOperation(e.pose,!1,e)}runHandOperation(e,n,i){let s=fs.find(o=>o.id===e);this.showGesture(n?`mouse:${e}`:e,s.operation.split(" \u2014 ")[0]);let r=this.now(),a=!n&&r-this.lastHandOp<250;if(e==="spread"||e==="gather"){if(a)return;this.lastHandOp=r,this.controls.zoom(e==="spread"?n?1/1.12:.985:n?1.12:1.015)}else if(e==="two"){let o=this.scene.renderer.domElement,l=i?(1-i.x)*o.width:o.width/2,c=i?i.y*o.height:o.height/2;this.select(this.scene.pick(l,c,26))}else if(e==="fist"){let o=this.scene.renderer.domElement,l=i?(1-i.x)*o.width:o.width/2,c=i?i.y*o.height:o.height/2;if(!this.handGrab){let v=this.scene.pick(l,c,70);if(!v)return;this.handGrab={ids:this.controls.clusterOf(v),x:l,y:c};return}let u=this.store.node(this.handGrab.ids[0]);if(!u){this.handGrab=null;return}let d=new F(...u.pos),h=this.scene.screenToWorld(this.handGrab.x,this.handGrab.y,d),g=this.scene.screenToWorld(l,c,d).sub(h);g.length()>.02&&(this.store.moveCluster(this.handGrab.ids,[g.x,g.y,g.z]),this.handGrab.x=l,this.handGrab.y=c)}this.scene.markDirty()}drawLandmarks(e){let n=document.getElementById("handlm");if(!n)return;n.width!==288&&(n.width=288,n.height=216);let i=n.getContext("2d");if(i.clearRect(0,0,n.width,n.height),!e.present)return;let s=[[0,1],[1,2],[2,3],[3,4],[0,5],[5,6],[6,7],[7,8],[5,9],[9,10],[10,11],[11,12],[9,13],[13,14],[14,15],[15,16],[13,17],[17,18],[18,19],[19,20],[0,17]],r=o=>(1-o.x)*n.width,a=o=>o.y*n.height;i.strokeStyle="#FFB020",i.lineWidth=2;for(let[o,l]of s){let c=e.landmarks[o],u=e.landmarks[l];!c||!u||(i.beginPath(),i.moveTo(r(c),a(c)),i.lineTo(r(u),a(u)),i.stroke())}i.fillStyle="#EFE6D8";for(let o of e.landmarks)i.beginPath(),i.arc(r(o),a(o),2.6,0,7),i.fill()}now(){return this.virtualNow??performance.now()}renderFrame(){let e=this.now();this.controls.tickTimers(e),this.controls.tickFly(e),this.tickUi(e),this.scene.clock=this.frozenClock??e/1e3,this.scene.render(),this.renderReticle(),this.renderHidden(),this.renderClusterProof()}renderAt(e){this.virtualNow=e,this.renderFrame()}tickUi(e){this.uiUntil.toast&&e>=this.uiUntil.toast&&(ve("#toast").className="",this.uiUntil.toast=0),this.uiUntil.gesture&&e>=this.uiUntil.gesture&&(ve("#gesture").classList.remove("show"),this.uiUntil.gesture=0)}loop=()=>{this.renderFrame(),this.raf=requestAnimationFrame(this.loop)};stop(){cancelAnimationFrame(this.raf)}start(){cancelAnimationFrame(this.raf),this.raf=requestAnimationFrame(this.loop)}refresh(){ve("[data-t=map-name]").textContent=this.store.doc.name,ve("[data-t=holding-count]").textContent=String(this.store.holdingCount()),ve("[data-t=holding-chip]").classList.toggle("on",this.store.holdingCount()>0),this.renderEditor(),ve("#finder")&&this.renderFinder(),ve("#settings")&&this.renderSyncStatus()}panelOpen(){return!!document.querySelector("#finder, #states, .overlay")}reflowSessionChips(){let e=this.panelOpen();for(let n of["origin","activity"]){let i=document.getElementById(n);i&&(i.style.visibility=e?"hidden":"")}}showOrigin(e){let n=document.getElementById("origin");n||(n=Et("div",{id:"origin","data-t":"map-origin"}),document.body.appendChild(n)),n.className=e.from==="seed"?"seed":"",n.innerHTML=e.from==="seed"?`first launch \xB7 restored from the committed seed <b>${dt((e.file??"").replace("seeds/",""))}</b>`+(e.sha256?` <span class="mono">${dt(e.sha256.slice(0,12))}</span>`:""):"live state"}renderHidden(){let e=document.getElementById("hidden");e||(e=Et("div",{id:"hidden","data-t":"labels-hidden"}),document.body.appendChild(e));let n=this.scene.suppressed,i=this.scene.shortened;e.className=n>0||i>0?"show":"";let s=[];if(n>0&&s.push(`${n} label${n===1?"":"s"} hidden`),i>0&&s.push(`${i} shortened`),e.textContent=s.length?`${s.join(" \xB7 ")} at this zoom \u2014 move closer to read them`:"",e.className==="show"){e.style.top="",e.style.right="";let r=e.getBoundingClientRect(),a=12;for(let l of["#editor","#finder","#states","#hands"]){let c=document.querySelector(l);if(!c)continue;let u=c.getBoundingClientRect();u.width>2&&u.height>2&&u.top<r.bottom&&u.bottom>r.top&&(a=Math.max(a,window.innerWidth-u.left+8))}e.style.right=`${Math.round(a)}px`;let o=0;for(let l of["#origin","#hitbreak"]){let c=document.getElementById(l.slice(1));if(!c||getComputedStyle(c).display==="none"||!c.textContent)continue;let u=c.getBoundingClientRect(),d=e.getBoundingClientRect();u.right+8>d.left&&u.left<d.right&&(o=Math.max(o,u.bottom+8))}e.style.top=o?`${Math.round(o)}px`:""}this.renderUnlabelled(),this.renderLeaders(),this.renderHitBreakdown(),this.renderPin(),this.renderGrab()}renderGrab(){let e=document.getElementById("grabmark"),n=this.handGrab;if(!n||!n.ids.length){e?.remove();return}e||(e=Et("div",{id:"grabmark","data-t":"grab-mark"}),e.innerHTML='<div class="ring"></div><div class="tag" data-t="grab-name"></div>',document.body.appendChild(e));let i=this.scene.renderer.domElement.width/Math.max(window.innerWidth,1),s=new Set(n.ids),r=this.scene.screenPositions().filter(h=>s.has(h.id));if(!r.length){e.className="";return}let a=1/0,o=1/0,l=-1/0,c=-1/0;for(let h of r)a=Math.min(a,h.x-h.r),l=Math.max(l,h.x+h.r),o=Math.min(o,h.y-h.r),c=Math.max(c,h.y+h.r);let u=16;e.className="on",e.style.left=`${Math.round(a/i-u)}px`,e.style.top=`${Math.round(o/i-u)}px`,e.style.width=`${Math.round((l-a)/i+u*2)}px`,e.style.height=`${Math.round((c-o)/i+u*2)}px`;let d=this.store.doc.nodes[n.ids[0]]?.label??"";ve("[data-t=grab-name]",e).textContent=`holding ${n.ids.length} thought${n.ids.length===1?"":"s"}${d?` \xB7 ${d}`:""}`}renderLeaders(){let e=document.getElementById("leaders");e||(e=document.createElementNS("http://www.w3.org/2000/svg","svg"),e.setAttribute("id","leaders"),e.setAttribute("data-t","label-leaders"),document.body.appendChild(e));let i=this.scene.renderer.domElement.width/Math.max(window.innerWidth,1),s=this.scene.screenPositions(),r=[];this.leaderFor.clear();for(let a of s){if(!this.store.doc.nodes[a.id])continue;let l=this.scene.labelRects.get(a.id);if(!l||l.alpha<=.02)continue;let c=this.scene.labelNeedsLeader.has(a.id),u=w=>{let _=Math.min(Math.max(w.x,l.x0),l.x1),A=Math.min(Math.max(w.y,l.y0),l.y1);return Math.hypot(w.x-_,w.y-A)},d=u(a),h=1/0,f=a;for(let w of s){if(w.id===a.id)continue;let _=u(w);_<h&&(h=_,f=w)}let g=h>0?d/h:1,v=f.id!==a.id&&h<d?!0:g>.6;if(!c&&!v)continue;this.leaderFor.add(a.id);let p=a.x/i,m=a.y/i,E=Math.min(Math.max(p,l.x0/i),l.x1/i),R=Math.min(Math.max(m,l.y0/i),l.y1/i),S=Math.hypot(E-p,R-m)||1,b=Math.max(a.r/i,3)+2,M=Math.min(b/S,.9);r.push(`<line x1="${(p+(E-p)*M).toFixed(1)}" y1="${(m+(R-m)*M).toFixed(1)}" x2="${E.toFixed(1)}" y2="${R.toFixed(1)}"></line>`)}e.innerHTML=r.join(""),this.scene.setDrawnLeaders(this.leaderFor)}leaderFor=new Set;aimedAt=null;renderUnlabelled(){let e=document.getElementById("unlabelled");e||(e=Et("div",{id:"unlabelled","data-t":"unlabelled-list"}),document.body.appendChild(e));let n=this.scene.suppressedIds,i=(this.lens==="expansion"||this.lens==="canvas")&&n.length>0&&!this.panelOpen();if(e.className=i?"show":"",!i){e.innerHTML="",e.style.top="";return}{let h=document.getElementById("editor"),f=h?h.getBoundingClientRect():null;e.style.top=f&&f.height>2?`${Math.round(f.bottom+10)}px`:""}let s=n.map(h=>this.store.doc.nodes[h]).filter(Boolean).sort((h,f)=>h.createdAt-f.createdAt),r=h=>`<li>${dt(h.text)}</li>`,a=h=>`<h4>${h} thought${h===1?"":"s"} on screen without room for a label</h4>`,o=h=>{let f=new Map;for(let g of h){let v=g.label||"\u2014";(f.get(v)??f.set(v,[]).get(v)).push(g)}return[...f.entries()].sort((g,v)=>v[1].length-g[1].length||(g[0]<v[0]?-1:1))},l=(h,f,g)=>`<h5><i style="background:${f}"></i>${dt(h)} <b>${g}</b></h5>`,c=(h,f="")=>{let g=[a(s.length)];for(let[v,p]of o(h)){let m=na[p[0].color]??"#8A7C70";g.push(l(v,m,p.length)),g.push(p.map(r).join(""))}return g.join("")+f};e.innerHTML=c(s);let u=s.length,d=()=>{let h=e.lastElementChild;return!h||h.getBoundingClientRect().bottom<=e.getBoundingClientRect().bottom-2};if(!d())for(;u>1&&!d();)u--,e.innerHTML=c(s.slice(0,u),`<li class="more">\u2026and ${s.length-u} more</li>`)}renderClusterProof(){let e=document.getElementById("clusterproof"),n=this.controls?.lastClusterMove??null;if(!n){e?.remove();return}e||(e=Et("div",{id:"clusterproof","data-t":"cluster-proof"}),document.body.appendChild(e)),e.className=this.panelOpen()?"":"show",e.innerHTML=`cluster <b>${dt(n.label)}</b> \xB7 ${n.members} nodes moved together<br>travelled <b>${n.travelled.toFixed(2)}</b> \xB7 internal arrangement drift <b>${n.drift.toFixed(6)}</b>`;let i=document.getElementById("origin"),r=i&&getComputedStyle(i).display!=="none"?i.getBoundingClientRect():null;e.style.top=r&&r.height>1?`${Math.round(r.bottom+8)}px`:""}renderActivity(){let e=document.getElementById("activity");e||(e=Et("div",{id:"activity","data-t":"last-change"}),document.body.appendChild(e));let n=this.store.lastChange;if(!n){e.className="",e.textContent="";return}e.className="show"+(n.remote?" remote":""),e.innerHTML=n.remote?`last change arrived from <b>${dt(n.actor)}</b> \u2014 ${dt(n.what)}`:`last change made here \u2014 ${dt(n.what)}`}dismissToast(){let e=document.getElementById("toast");e&&(e.className="",e.textContent=""),this.uiUntil.toast=0}toast(e,n=!1){let i=ve("#toast");i.textContent=e,i.className="show"+(n?" bad":""),this.uiUntil.toast=this.now()+(n?9e3:4200)}showGesture(e,n){this.lastGesture={id:e,detail:n,at:performance.now()};let i=ve("#gesture"),s=lu.find(u=>u.id===e),r=fs.find(u=>u.id===e||`mouse:${u.id}`===e),a=_v[e],o=s?.name??r?.name??a?.name??(e==="gyro"?"Gyroscope":e),l=e.startsWith("mouse:")?r:a?.standsIn?fs.find(u=>u.id===a.standsIn):void 0,c=l?e.startsWith("mouse:")?`${l.mouse.split(", or ")[0]} \u2014 the ${l.name} equivalent`:`${o} \u2014 the ${l.name} equivalent`:o;i.innerHTML=`<span class="n">${dt(c)}</span> <span class="o">\u2014 ${dt(n)}</span>`,i.classList.add("show"),this.uiUntil.gesture=this.now()+2600}get lastGestureFired(){return this.lastGesture}renderEditor(){let e=document.getElementById("editor"),n=this.selected?this.store.node(this.selected):void 0;if(!n){e?.remove();return}let i=e??(()=>{let a=Et("div",{class:"panel",id:"editor","data-t":"editor"});return document.body.appendChild(a),a})(),s=this.controls.linkArmed===n.id;i.innerHTML=`
      ...
      <div class="row"><button data-t="states-close">Close</button></div>`,document.body.appendChild(i),this.clearOfPanels(this.selected??void 0),this.reflowSessionChips(),ve("[data-t=states-close]",i).addEventListener("click",()=>{i.remove(),this.reflowSessionChips()})}toggleFinder(){let e=document.getElementById("finder");if(e){e.remove(),this.reflowSessionChips();return}let n=Et("div",{class:"panel",id:"finder","data-t":"finder"});document.body.appendChild(n),this.renderFinder(),this.reflowSessionChips()}renderFinder(){let e=document.getElementById("finder");if(!e)return;let n=this.suggestions[this.sugIndex],i=ve("[data-t=finder-prompt]",e)?.value??"",s=ve("[data-t=finder-reply]",e)?.value??"";e.innerHTML=`
