...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ii,depthTest:!1,depthWrite:!1})}function Yb(t,e,n){let i=new Float32Array(ar),s=new L(0,1,0);return new jt({name:"SphericalGaussianBlur",defines:{n:ar,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${t}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Wc(),fragmentShader:`
...
`].filter(ho).join(`
`)),a=Sd(a),a=Jm(a,n),a=jm(a,n),o=Sd(o),o=Jm(o,n),o=jm(o,n),a=Qm(a),o=Qm(o),n.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
`)+`
`+p);let T=E+m+a,b=E+p+o,A=Ym(s,s.VERTEX_SHADER,T),S=Ym(s,s.FRAGMENT_SHADER,b);s.attachShader(x,A),s.attachShader(x,S),n.index0AttributeName!==void 0?s.bindAttribLocation(x,0,n.index0AttributeName):n.hasPositionAttribute===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function C(R){if(t.debug.checkShaderErrors){let U=s.getProgramInfoLog(x)||"",H=s.getShaderInfoLog(A)||"",q=s.getShaderInfoLog(S)||"",k=U.trim(),X=H.trim(),G=q.trim(),J=!0,Q=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(J=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(s,x,A,S);else{let ue=Zm(s,A,"vertex"),me=Zm(s,S,"fragment");Oe("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
}`,PM=[new L(1,0,0),new L(-1,0,0),new L(0,1,0),new L(0,-1,0),new L(0,0,1),new L(0,0,-1)],LM=[new L(0,-1,0),new L(0,-1,0),new L(0,0,1),new L(0,0,-1),new L(0,-1,0),new L(0,-1,0)],sg=new Dt,co=new L,xd=new L;function NM(t,e,n){let i=new Wa,s=new Ke,r=new Ke,a=new Tt,o=new Bl,l=new kl,c={},u=n.maxTextureSize,d={[Qi]:bn,[bn]:Qi,[Ri]:Ri},h=new jt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ke},radius:{value:4}},vertexShader:RM,fragmentShader:IM}),f=h.clone();f.defines.HORIZONTAL_PASS=1;let g=new Tn;g.setAttribute("position",new on(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let x=new hn(g,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ja;let p=this.type;this.render=function(S,C,v){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||S.length===0)return;this.type===em&&(De("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=ja);let w=t.getRenderTarget(),I=t.getActiveCubeFace(),R=t.getActiveMipmapLevel(),U=t.state;U.setBlending(Ii),U.buffers.depth.getReversed()===!0?U.buffers.color.setClear(0,0,0,0):U.buffers.color.setClear(1,1,1,1),U.buffers.depth.setTest(!0),U.setScissorTest(!1);let H=p!==this.type;H&&C.traverse(function(q){q.material&&(Array.isArray(q.material)?q.material.forEach(k=>k.needsUpdate=!0):q.material.needsUpdate=!0)});for(let q=0,k=S.length;q<k;q++){let X=S[q],G=X.shadow;if(G===void 0){De("WebGLShadowMap:",X,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;s.copy(G.mapSize);let J=G.getFrameExtents();s.multiply(J),r.copy(G.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/J.x),s.x=r.x*J.x,G.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/J.y),s.y=r.y*J.y,G.mapSize.y=r.y));let Q=t.state.buffers.depth.getReversed();if(G.camera._reversedDepth=Q,G.map===null||H===!0){if(G.map!==null&&(G.map.depthTexture!==null&&(G.map.depthTexture.dispose(),G.map.depthTexture=null),G.map.dispose()),this.type===Kr){if(X.isPointLight){De("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}G.map=new kn(s.x,s.y,{format:Ls,type:Li,minFilter:Jt,magFilter:Jt,generateMipmaps:!1}),G.map.texture.name=X.name+".shadowMap",G.map.depthTexture=new es(s.x,s.y,fi),G.map.depthTexture.name=X.name+".shadowMapDepth",G.map.depthTexture.format=wi,G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=ln,G.map.depthTexture.magFilter=ln}else X.isPointLight?(G.map=new Hc(s.x),G.map.depthTexture=new Ul(s.x,di)):(G.map=new kn(s.x,s.y),G.map.depthTexture=new es(s.x,s.y,di)),G.map.depthTexture.name=X.name+".shadowMap",G.map.depthTexture.format=wi,this.type===ja?(G.map.depthTexture.compareFunction=Q?Bc:Oc,G.map.depthTexture.minFilter=Jt,G.map.depthTexture.magFilter=Jt):(G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=ln,G.map.depthTexture.magFilter=ln);G.camera.updateProjectionMatrix()}let ue=G.map.isWebGLCubeRenderTarget?6:1;for(let me=0;me<ue;me++){if(G.map.isWebGLCubeRenderTarget)t.setRenderTarget(G.map,me),t.clear();else{me===0&&(t.setRenderTarget(G.map),t.clear());let be=G.getViewport(me);a.set(r.x*be.x,r.y*be.y,r.x*be.z,r.y*be.w),U.viewport(a)}if(X.isPointLight){let be=G.camera,lt=G.matrix,It=X.distance||be.far;It!==be.far&&(be.far=It,be.updateProjectionMatrix()),co.setFromMatrixPosition(X.matrixWorld),be.position.copy(co),xd.copy(be.position),xd.add(PM[me]),be.up.copy(LM[me]),be.lookAt(xd),be.updateMatrixWorld(),lt.makeTranslation(-co.x,-co.y,-co.z),sg.multiplyMatrices(be.projectionMatrix,be.matrixWorldInverse),G._frustum.setFromProjectionMatrix(sg,be.coordinateSystem,be.reversedDepth)}else G.updateMatrices(X);i=G.getFrustum(),b(C,v,G.camera,X,this.type)}G.isPointLightShadow!==!0&&this.type===Kr&&E(G,v),G.needsUpdate=!1}p=this.type,m.needsUpdate=!1,t.setRenderTarget(w,I,R)};function E(S,C){let v=e.update(x);h.defines.VSM_SAMPLES!==S.blurSamples&&(h.defines.VSM_SAMPLES=S.blurSamples,f.defines.VSM_SAMPLES=S.blurSamples,h.needsUpdate=!0,f.needsUpdate=!0),S.mapPass===null&&(S.mapPass=new kn(s.x,s.y,{format:Ls,type:Li})),h.uniforms.shadow_pass.value=S.map.depthTexture,h.uniforms.resolution.value=S.mapSize,h.uniforms.radius.value=S.radius,t.setRenderTarget(S.mapPass),t.clear(),t.renderBufferDirect(C,null,v,h,x,null),f.uniforms.shadow_pass.value=S.mapPass.texture,f.uniforms.resolution.value=S.mapSize,f.uniforms.radius.value=S.radius,t.setRenderTarget(S.map),t.clear(),t.renderBufferDirect(C,null,v,f,x,null)}function T(S,C,v,w){let I=null,R=v.isPointLight===!0?S.customDistanceMaterial:S.customDepthMaterial;if(R!==void 0)I=R;else if(I=v.isPointLight===!0?l:o,t.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){let U=I.uuid,H=C.uuid,q=c[U];q===void 0&&(q={},c[U]=q);let k=q[H];k===void 0&&(k=I.clone(),q[H]=k,C.addEventListener("dispose",A)),I=k}if(I.visible=C.visible,I.wireframe=C.wireframe,w===Kr?I.side=C.shadowSide!==null?C.shadowSide:C.side:I.side=C.shadowSide!==null?C.shadowSide:d[C.side],I.alphaMap=C.alphaMap,I.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,I.map=C.map,I.clipShadows=C.clipShadows,I.clippingPlanes=C.clippingPlanes,I.clipIntersection=C.clipIntersection,I.displacementMap=C.displacementMap,I.displacementScale=C.displacementScale,I.displacementBias=C.displacementBias,I.wireframeLinewidth=C.wireframeLinewidth,I.linewidth=C.linewidth,v.isPointLight===!0&&I.isMeshDistanceMaterial===!0){let U=t.properties.get(I);U.light=v}return I}function b(S,C,v,w,I){if(S.visible===!1)return;if(S.layers.test(C.layers)&&(S.isMesh||S.isLine||S.isPoints)&&(S.castShadow||S.receiveShadow&&I===Kr)&&(!S.frustumCulled||i.intersectsObject(S))){S.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,S.matrixWorld);let H=e.update(S),q=S.material;if(Array.isArray(q)){let k=H.groups;for(let X=0,G=k.length;X<G;X++){let J=k[X],Q=q[J.materialIndex];if(Q&&Q.visible){let ue=T(S,Q,w,I);S.onBeforeShadow(t,S,C,v,H,ue,J),t.renderBufferDirect(v,null,H,ue,S,J),S.onAfterShadow(t,S,C,v,H,ue,J)}}}else if(q.visible){let k=T(S,q,w,I);S.onBeforeShadow(t,S,C,v,H,k,null),t.renderBufferDirect(v,null,H,k,S,null),S.onAfterShadow(t,S,C,v,H,k,null)}}let U=S.children;for(let H=0,q=U.length;H<q;H++)b(U[H],C,v,w,I)}function A(S){S.target.removeEventListener("dispose",A);for(let v in c){let w=c[v],I=S.target.uuid;I in w&&(w[I].dispose(),delete w[I])}}}function DM(t,e){function n(){let P=!1,ie=new Tt,Y=null,le=new Tt(0,0,0,0);return{setMask:function(pe){Y!==pe&&!P&&(t.colorMask(pe,pe,pe,pe),Y=pe)},setLocked:function(pe){P=pe},setClear:function(pe,j,Ae,Se,Lt){Lt===!0&&(pe*=Se,j*=Se,Ae*=Se),ie.set(pe,j,Ae,Se),le.equals(ie)===!1&&(t.clearColor(pe,j,Ae,Se),le.copy(ie))},reset:function(){P=!1,Y=null,le.set(-1,0,0,0)}}}function i(){let P=!1,ie=!1,Y=null,le=null,pe=null;return{setReversed:function(j){if(ie!==j){let Ae=e.get("EXT_clip_control");j?Ae.clipControlEXT(Ae.LOWER_LEFT_EXT,Ae.ZERO_TO_ONE_EXT):Ae.clipControlEXT(Ae.LOWER_LEFT_EXT,Ae.NEGATIVE_ONE_TO_ONE_EXT),ie=j;let Se=pe;pe=null,this.setClear(Se)}},getReversed:function(){return ie},setTest:function(j){j?ee(t.DEPTH_TEST):Be(t.DEPTH_TEST)},setMask:function(j){Y!==j&&!P&&(t.depthMask(j),Y=j)},setFunc:function(j){if(ie&&(j=Nm[j]),le!==j){switch(j){case _l:t.depthFunc(t.NEVER);break;case xl:t.depthFunc(t.ALWAYS);break;case vl:t.depthFunc(t.LESS);break;case Qs:t.depthFunc(t.LEQUAL);break;case yl:t.depthFunc(t.EQUAL);break;case bl:t.depthFunc(t.GEQUAL);break;case Ml:t.depthFunc(t.GREATER);break;case Sl:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}le=j}},setLocked:function(j){P=j},setClear:function(j){pe!==j&&(pe=j,ie&&(j=1-j),t.clearDepth(j))},reset:function(){P=!1,Y=null,le=null,pe=null,ie=!1}}}function s(){let P=!1,ie=null,Y=null,le=null,pe=null,j=null,Ae=null,Se=null,Lt=null;return{setTest:function(vt){P||(vt?ee(t.STENCIL_TEST):Be(t.STENCIL_TEST))},setMask:function(vt){ie!==vt&&!P&&(t.stencilMask(vt),ie=vt)},setFunc:function(vt,vi,yi){(Y!==vt||le!==vi||pe!==yi)&&(t.stencilFunc(vt,vi,yi),Y=vt,le=vi,pe=yi)},setOp:function(vt,vi,yi){(j!==vt||Ae!==vi||Se!==yi)&&(t.stencilOp(vt,vi,yi),j=vt,Ae=vi,Se=yi)},setLocked:function(vt){P=vt},setClear:function(vt){Lt!==vt&&(t.clearStencil(vt),Lt=vt)},reset:function(){P=!1,ie=null,Y=null,le=null,pe=null,j=null,Ae=null,Se=null,Lt=null}}}let r=new n,a=new i,o=new s,l=new WeakMap,c=new WeakMap,u={},d={},h={},f=new WeakMap,g=[],x=null,m=!1,p=null,E=null,T=null,b=null,A=null,S=null,C=null,v=new ze(0,0,0),w=0,I=!1,R=null,U=null,H=null,q=null,k=null,X=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS),G=!1,J=0,Q=t.getParameter(t.VERSION);Q.indexOf("WebGL")!==-1?(J=parseFloat(/^WebGL (\d)/.exec(Q)[1]),G=J>=1):Q.indexOf("OpenGL ES")!==-1&&(J=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),G=J>=2);let ue=null,me={},be=t.getParameter(t.SCISSOR_BOX),lt=t.getParameter(t.VIEWPORT),It=new Tt().fromArray(be),ct=new Tt().fromArray(lt);function Z(P,ie,Y,le){let pe=new Uint8Array(4),j=t.createTexture();t.bindTexture(P,j),t.texParameteri(P,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(P,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Ae=0;Ae<Y;Ae++)P===t.TEXTURE_3D||P===t.TEXTURE_2D_ARRAY?t.texImage3D(ie,0,t.RGBA,1,1,le,0,t.RGBA,t.UNSIGNED_BYTE,pe):t.texImage2D(ie+Ae,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,pe);return j}let se={};se[t.TEXTURE_2D]=Z(t.TEXTURE_2D,t.TEXTURE_2D,1),se[t.TEXTURE_CUBE_MAP]=Z(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),se[t.TEXTURE_2D_ARRAY]=Z(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),se[t.TEXTURE_3D]=Z(t.TEXTURE_3D,t.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ee(t.DEPTH_TEST),a.setFunc(Qs),Wt(!1),Zt(zu),ee(t.CULL_FACE),ht(Ii);function ee(P){u[P]!==!0&&(t.enable(P),u[P]=!0)}function Be(P){u[P]!==!1&&(t.disable(P),u[P]=!1)}function He(P,ie){return h[P]!==ie?(t.bindFramebuffer(P,ie),h[P]=ie,P===t.DRAW_FRAMEBUFFER&&(h[t.FRAMEBUFFER]=ie),P===t.FRAMEBUFFER&&(h[t.DRAW_FRAMEBUFFER]=ie),!0):!1}function Fe(P,ie){let Y=g,le=!1;if(P){Y=f.get(ie),Y===void 0&&(Y=[],f.set(ie,Y));let pe=P.textures;if(Y.length!==pe.length||Y[0]!==t.COLOR_ATTACHMENT0){for(let j=0,Ae=pe.length;j<Ae;j++)Y[j]=t.COLOR_ATTACHMENT0+j;Y.length=pe.length,le=!0}}else Y[0]!==t.BACK&&(Y[0]=t.BACK,le=!0);le&&t.drawBuffers(Y)}function Ot(P){return x!==P?(t.useProgram(P),x=P,!0):!1}let Ze={[Ss]:t.FUNC_ADD,[nm]:t.FUNC_SUBTRACT,[im]:t.FUNC_REVERSE_SUBTRACT};Ze[sm]=t.MIN,Ze[rm]=t.MAX;let gt={[am]:t.ZERO,[om]:t.ONE,[lm]:t.SRC_COLOR,[ml]:t.SRC_ALPHA,[pm]:t.SRC_ALPHA_SATURATE,[dm]:t.DST_COLOR,[hm]:t.DST_ALPHA,[cm]:t.ONE_MINUS_SRC_COLOR,[gl]:t.ONE_MINUS_SRC_ALPHA,[fm]:t.ONE_MINUS_DST_COLOR,[um]:t.ONE_MINUS_DST_ALPHA,[mm]:t.CONSTANT_COLOR,[gm]:t.ONE_MINUS_CONSTANT_COLOR,[_m]:t.CONSTANT_ALPHA,[xm]:t.ONE_MINUS_CONSTANT_ALPHA};function ht(P,ie,Y,le,pe,j,Ae,Se,Lt,vt){if(P===Ii){m===!0&&(Be(t.BLEND),m=!1);return}if(m===!1&&(ee(t.BLEND),m=!0),P!==tm){if(P!==p||vt!==I){if((E!==Ss||A!==Ss)&&(t.blendEquation(t.FUNC_ADD),E=Ss,A=Ss),vt)switch(P){case jn:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Vu:t.blendFunc(t.ONE,t.ONE);break;case Hu:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Gu:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:Oe("WebGLState: Invalid blending: ",P);break}else switch(P){case jn:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Vu:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case Hu:Oe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Gu:Oe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Oe("WebGLState: Invalid blending: ",P);break}T=null,b=null,S=null,C=null,v.set(0,0,0),w=0,p=P,I=vt}return}pe=pe||ie,j=j||Y,Ae=Ae||le,(ie!==E||pe!==A)&&(t.blendEquationSeparate(Ze[ie],Ze[pe]),E=ie,A=pe),(Y!==T||le!==b||j!==S||Ae!==C)&&(t.blendFuncSeparate(gt[Y],gt[le],gt[j],gt[Ae]),T=Y,b=le,S=j,C=Ae),(Se.equals(v)===!1||Lt!==w)&&(t.blendColor(Se.r,Se.g,Se.b,Lt),v.copy(Se),w=Lt),p=P,I=!1}function nt(P,ie){P.side===Ri?Be(t.CULL_FACE):ee(t.CULL_FACE);let Y=P.side===bn;ie&&(Y=!Y),Wt(Y),P.blending===jn&&P.transparent===!1?ht(Ii):ht(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),a.setFunc(P.depthFunc),a.setTest(P.depthTest),a.setMask(P.depthWrite),r.setMask(P.colorWrite);let le=P.stencilWrite;o.setTest(le),le&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),cn(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?ee(t.SAMPLE_ALPHA_TO_COVERAGE):Be(t.SAMPLE_ALPHA_TO_COVERAGE)}function Wt(P){R!==P&&(P?t.frontFace(t.CW):t.frontFace(t.CCW),R=P)}function Zt(P){P!==jp?(ee(t.CULL_FACE),P!==U&&(P===zu?t.cullFace(t.BACK):P===Qp?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):Be(t.CULL_FACE),U=P}function rn(P){P!==H&&(G&&t.lineWidth(P),H=P)}function cn(P,ie,Y){P?(ee(t.POLYGON_OFFSET_FILL),(q!==ie||k!==Y)&&(q=ie,k=Y,a.getReversed()&&(ie=-ie),t.polygonOffset(ie,Y))):Be(t.POLYGON_OFFSET_FILL)}function Pt(P){P?ee(t.SCISSOR_TEST):Be(t.SCISSOR_TEST)}function Xt(P){P===void 0&&(P=t.TEXTURE0+X-1),ue!==P&&(t.activeTexture(P),ue=P)}function N(P,ie,Y){Y===void 0&&(ue===null?Y=t.TEXTURE0+X-1:Y=ue);let le=me[Y];le===void 0&&(le={type:void 0,texture:void 0},me[Y]=le),(le.type!==P||le.texture!==ie)&&(ue!==Y&&(t.activeTexture(Y),ue=Y),t.bindTexture(P,ie||se[P]),le.type=P,le.texture=ie)}function En(){let P=me[ue];P!==void 0&&P.type!==void 0&&(t.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function ft(){try{t.compressedTexImage2D(...arguments)}catch(P){Oe("WebGLState:",P)}}function M(){try{t.compressedTexImage3D(...arguments)}catch(P){Oe("WebGLState:",P)}}function _(){try{t.texSubImage2D(...arguments)}catch(P){Oe("WebGLState:",P)}}function F(){try{t.texSubImage3D(...arguments)}catch(P){Oe("WebGLState:",P)}}function z(){try{t.compressedTexSubImage2D(...arguments)}catch(P){Oe("WebGLState:",P)}}function W(){try{t.compressedTexSubImage3D(...arguments)}catch(P){Oe("WebGLState:",P)}}function te(){try{t.texStorage2D(...arguments)}catch(P){Oe("WebGLState:",P)}}function re(){try{t.texStorage3D(...arguments)}catch(P){Oe("WebGLState:",P)}}function $(){try{t.texImage2D(...arguments)}catch(P){Oe("WebGLState:",P)}}function K(){try{t.texImage3D(...arguments)}catch(P){Oe("WebGLState:",P)}}function ae(P){return d[P]!==void 0?d[P]:t.getParameter(P)}function Te(P,ie){d[P]!==ie&&(t.pixelStorei(P,ie),d[P]=ie)}function ce(P){It.equals(P)===!1&&(t.scissor(P.x,P.y,P.z,P.w),It.copy(P))}function oe(P){ct.equals(P)===!1&&(t.viewport(P.x,P.y,P.z,P.w),ct.copy(P))}function Ne(P,ie){let Y=c.get(ie);Y===void 0&&(Y=new WeakMap,c.set(ie,Y));let le=Y.get(P);le===void 0&&(le=t.getUniformBlockIndex(ie,P.name),Y.set(P,le))}function Ue(P,ie){let le=c.get(ie).get(P);l.get(ie)!==le&&(t.uniformBlockBinding(ie,le,P.__bindingPointIndex),l.set(ie,le))}function Ge(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),a.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),u={},d={},ue=null,me={},h={},f=new WeakMap,g=[],x=null,m=!1,p=null,E=null,T=null,b=null,A=null,S=null,C=null,v=new ze(0,0,0),w=0,I=!1,R=null,U=null,H=null,q=null,k=null,It.set(0,0,t.canvas.width,t.canvas.height),ct.set(0,0,t.canvas.width,t.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:ee,disable:Be,bindFramebuffer:He,drawBuffers:Fe,useProgram:Ot,setBlending:ht,setMaterial:nt,setFlipSided:Wt,setCullFace:Zt,setLineWidth:rn,setPolygonOffset:cn,setScissorTest:Pt,activeTexture:Xt,bindTexture:N,unbindTexture:En,compressedTexImage2D:ft,compressedTexImage3D:M,texImage2D:$,texImage3D:K,pixelStorei:Te,getParameter:ae,updateUBOMapping:Ne,uniformBlockBinding:Ue,texStorage2D:te,texStorage3D:re,texSubImage2D:_,texSubImage3D:F,compressedTexSubImage2D:z,compressedTexSubImage3D:W,scissor:ce,viewport:oe,reset:Ge}}function FM(t,e,n,i,s,r,a){let o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ke,u=new WeakMap,d=new Set,h,f=new WeakMap,g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(M,_){return g?new OffscreenCanvas(M,_):Gr("canvas")}function m(M,_,F){let z=1,W=ft(M);if((W.width>F||W.height>F)&&(z=F/Math.max(W.width,W.height)),z<1)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap||typeof VideoFrame<"u"&&M instanceof VideoFrame){let te=Math.floor(z*W.width),re=Math.floor(z*W.height);h===void 0&&(h=x(te,re));let $=_?x(te,re):h;return $.width=te,$.height=re,$.getContext("2d").drawImage(M,0,0,te,re),De("WebGLRenderer: Texture has been resized from ("+W.width+"x"+W.height+") to ("+te+"x"+re+")."),$}else return"data"in M&&De("WebGLRenderer: Image in DataTexture is too big ("+W.width+"x"+W.height+")."),M;return M}function p(M){return M.generateMipmaps}function E(M){t.generateMipmap(M)}function T(M){return M.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:M.isWebGL3DRenderTarget?t.TEXTURE_3D:M.isWebGLArrayRenderTarget||M.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function b(M,_,F,z,W,te=!1){if(M!==null){if(t[M]!==void 0)return t[M];De("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let re;z&&(re=e.get("EXT_texture_norm16"),re||De("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let $=_;if(_===t.RED&&(F===t.FLOAT&&($=t.R32F),F===t.HALF_FLOAT&&($=t.R16F),F===t.UNSIGNED_BYTE&&($=t.R8),F===t.UNSIGNED_SHORT&&re&&($=re.R16_EXT),F===t.SHORT&&re&&($=re.R16_SNORM_EXT)),_===t.RED_INTEGER&&(F===t.UNSIGNED_BYTE&&($=t.R8UI),F===t.UNSIGNED_SHORT&&($=t.R16UI),F===t.UNSIGNED_INT&&($=t.R32UI),F===t.BYTE&&($=t.R8I),F===t.SHORT&&($=t.R16I),F===t.INT&&($=t.R32I)),_===t.RG&&(F===t.FLOAT&&($=t.RG32F),F===t.HALF_FLOAT&&($=t.RG16F),F===t.UNSIGNED_BYTE&&($=t.RG8),F===t.UNSIGNED_SHORT&&re&&($=re.RG16_EXT),F===t.SHORT&&re&&($=re.RG16_SNORM_EXT)),_===t.RG_INTEGER&&(F===t.UNSIGNED_BYTE&&($=t.RG8UI),F===t.UNSIGNED_SHORT&&($=t.RG16UI),F===t.UNSIGNED_INT&&($=t.RG32UI),F===t.BYTE&&($=t.RG8I),F===t.SHORT&&($=t.RG16I),F===t.INT&&($=t.RG32I)),_===t.RGB_INTEGER&&(F===t.UNSIGNED_BYTE&&($=t.RGB8UI),F===t.UNSIGNED_SHORT&&($=t.RGB16UI),F===t.UNSIGNED_INT&&($=t.RGB32UI),F===t.BYTE&&($=t.RGB8I),F===t.SHORT&&($=t.RGB16I),F===t.INT&&($=t.RGB32I)),_===t.RGBA_INTEGER&&(F===t.UNSIGNED_BYTE&&($=t.RGBA8UI),F===t.UNSIGNED_SHORT&&($=t.RGBA16UI),F===t.UNSIGNED_INT&&($=t.RGBA32UI),F===t.BYTE&&($=t.RGBA8I),F===t.SHORT&&($=t.RGBA16I),F===t.INT&&($=t.RGBA32I)),_===t.RGB&&(F===t.UNSIGNED_SHORT&&re&&($=re.RGB16_EXT),F===t.SHORT&&re&&($=re.RGB16_SNORM_EXT),F===t.UNSIGNED_INT_5_9_9_9_REV&&($=t.RGB9_E5),F===t.UNSIGNED_INT_10F_11F_11F_REV&&($=t.R11F_G11F_B10F)),_===t.RGBA){let K=te?Fa:Ye.getTransfer(W);F===t.FLOAT&&($=t.RGBA32F),F===t.HALF_FLOAT&&($=t.RGBA16F),F===t.UNSIGNED_BYTE&&($=K===dt?t.SRGB8_ALPHA8:t.RGBA8),F===t.UNSIGNED_SHORT&&re&&($=re.RGBA16_EXT),F===t.SHORT&&re&&($=re.RGBA16_SNORM_EXT),F===t.UNSIGNED_SHORT_4_4_4_4&&($=t.RGBA4),F===t.UNSIGNED_SHORT_5_5_5_1&&($=t.RGB5_A1)}return($===t.R16F||$===t.R32F||$===t.RG16F||$===t.RG32F||$===t.RGBA16F||$===t.RGBA32F)&&e.get("EXT_color_buffer_float"),$}function A(M,_){let F;return M?_===null||_===di||_===Jr?F=t.DEPTH24_STENCIL8:_===fi?F=t.DEPTH32F_STENCIL8:_===Zr&&(F=t.DEPTH24_STENCIL8,De("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===di||_===Jr?F=t.DEPTH_COMPONENT24:_===fi?F=t.DEPTH_COMPONENT32F:_===Zr&&(F=t.DEPTH_COMPONENT16),F}function S(M,_){return p(M)===!0||M.isFramebufferTexture&&M.minFilter!==ln&&M.minFilter!==Jt?Math.log2(Math.max(_.width,_.height))+1:M.mipmaps!==void 0&&M.mipmaps.length>0?M.mipmaps.length:M.isCompressedTexture&&Array.isArray(M.image)?_.mipmaps.length:1}function C(M){let _=M.target;_.removeEventListener("dispose",C),w(_),_.isVideoTexture&&u.delete(_),_.isHTMLTexture&&d.delete(_)}function v(M){let _=M.target;_.removeEventListener("dispose",v),R(_)}function w(M){let _=i.get(M);if(_.__webglInit===void 0)return;let F=M.source,z=f.get(F);if(z){let W=z[_.__cacheKey];W.usedTimes--,W.usedTimes===0&&I(M),Object.keys(z).length===0&&f.delete(F)}i.remove(M)}function I(M){let _=i.get(M);t.deleteTexture(_.__webglTexture);let F=M.source,z=f.get(F);delete z[_.__cacheKey],a.memory.textures--}function R(M){let _=i.get(M);if(M.depthTexture&&(M.depthTexture.dispose(),i.remove(M.depthTexture)),M.isWebGLCubeRenderTarget)for(let z=0;z<6;z++){if(Array.isArray(_.__webglFramebuffer[z]))for(let W=0;W<_.__webglFramebuffer[z].length;W++)t.deleteFramebuffer(_.__webglFramebuffer[z][W]);else t.deleteFramebuffer(_.__webglFramebuffer[z]);_.__webglDepthbuffer&&t.deleteRenderbuffer(_.__webglDepthbuffer[z])}else{if(Array.isArray(_.__webglFramebuffer))for(let z=0;z<_.__webglFramebuffer.length;z++)t.deleteFramebuffer(_.__webglFramebuffer[z]);else t.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&t.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&t.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let z=0;z<_.__webglColorRenderbuffer.length;z++)_.__webglColorRenderbuffer[z]&&t.deleteRenderbuffer(_.__webglColorRenderbuffer[z]);_.__webglDepthRenderbuffer&&t.deleteRenderbuffer(_.__webglDepthRenderbuffer)}let F=M.textures;for(let z=0,W=F.length;z<W;z++){let te=i.get(F[z]);te.__webglTexture&&(t.deleteTexture(te.__webglTexture),a.memory.textures--),i.remove(F[z])}i.remove(M)}let U=0;function H(){U=0}function q(){return U}function k(M){U=M}function X(){let M=U;return M>=s.maxTextures&&De("WebGLTextures: Trying to use "+M+" texture units while this GPU supports only "+s.maxTextures),U+=1,M}function G(M){let _=[];return _.push(M.wrapS),_.push(M.wrapT),_.push(M.wrapR||0),_.push(M.magFilter),_.push(M.minFilter),_.push(M.anisotropy),_.push(M.internalFormat),_.push(M.format),_.push(M.type),_.push(M.generateMipmaps),_.push(M.premultiplyAlpha),_.push(M.flipY),_.push(M.unpackAlignment),_.push(M.colorSpace),_.join()}function J(M,_){let F=i.get(M);if(M.isVideoTexture&&N(M),M.isRenderTargetTexture===!1&&M.isExternalTexture!==!0&&M.version>0&&F.__version!==M.version){let z=M.image;if(z===null)De("WebGLRenderer: Texture marked for update but no image data found.");else if(z.complete===!1)De("WebGLRenderer: Texture marked for update but image is incomplete");else{Be(F,M,_);return}}else M.isExternalTexture&&(F.__webglTexture=M.sourceTexture?M.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,F.__webglTexture,t.TEXTURE0+_)}function Q(M,_){let F=i.get(M);if(M.isRenderTargetTexture===!1&&M.version>0&&F.__version!==M.version){Be(F,M,_);return}else M.isExternalTexture&&(F.__webglTexture=M.sourceTexture?M.sourceTexture:null);n.bindTexture(t.TEXTURE_2D_ARRAY,F.__webglTexture,t.TEXTURE0+_)}function ue(M,_){let F=i.get(M);if(M.isRenderTargetTexture===!1&&M.version>0&&F.__version!==M.version){Be(F,M,_);return}n.bindTexture(t.TEXTURE_3D,F.__webglTexture,t.TEXTURE0+_)}function me(M,_){let F=i.get(M);if(M.isCubeDepthTexture!==!0&&M.version>0&&F.__version!==M.version){He(F,M,_);return}n.bindTexture(t.TEXTURE_CUBE_MAP,F.__webglTexture,t.TEXTURE0+_)}let be={[El]:t.REPEAT,[Ei]:t.CLAMP_TO_EDGE,[wl]:t.MIRRORED_REPEAT},lt={[ln]:t.NEAREST,[bm]:t.NEAREST_MIPMAP_NEAREST,[eo]:t.NEAREST_MIPMAP_LINEAR,[Jt]:t.LINEAR,[ec]:t.LINEAR_MIPMAP_NEAREST,[Pi]:t.LINEAR_MIPMAP_LINEAR},It={[Em]:t.NEVER,[Rm]:t.ALWAYS,[wm]:t.LESS,[Oc]:t.LEQUAL,[Am]:t.EQUAL,[Bc]:t.GEQUAL,[Tm]:t.GREATER,[Cm]:t.NOTEQUAL};function ct(M,_){if(_.type===fi&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===Jt||_.magFilter===ec||_.magFilter===eo||_.magFilter===Pi||_.minFilter===Jt||_.minFilter===ec||_.minFilter===eo||_.minFilter===Pi)&&De("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(M,t.TEXTURE_WRAP_S,be[_.wrapS]),t.texParameteri(M,t.TEXTURE_WRAP_T,be[_.wrapT]),(M===t.TEXTURE_3D||M===t.TEXTURE_2D_ARRAY)&&t.texParameteri(M,t.TEXTURE_WRAP_R,be[_.wrapR]),t.texParameteri(M,t.TEXTURE_MAG_FILTER,lt[_.magFilter]),t.texParameteri(M,t.TEXTURE_MIN_FILTER,lt[_.minFilter]),_.compareFunction&&(t.texParameteri(M,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(M,t.TEXTURE_COMPARE_FUNC,It[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===ln||_.minFilter!==eo&&_.minFilter!==Pi||_.type===fi&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||i.get(_).__currentAnisotropy){let F=e.get("EXT_texture_filter_anisotropic");t.texParameterf(M,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),i.get(_).__currentAnisotropy=_.anisotropy}}}function Z(M,_){let F=!1;M.__webglInit===void 0&&(M.__webglInit=!0,_.addEventListener("dispose",C));let z=_.source,W=f.get(z);W===void 0&&(W={},f.set(z,W));let te=G(_);if(te!==M.__cacheKey){W[te]===void 0&&(W[te]={texture:t.createTexture(),usedTimes:0},a.memory.textures++,F=!0),W[te].usedTimes++;let re=W[M.__cacheKey];re!==void 0&&(W[M.__cacheKey].usedTimes--,re.usedTimes===0&&I(_)),M.__cacheKey=te,M.__webglTexture=W[te].texture}return F}function se(M,_,F){return Math.floor(Math.floor(M/F)/_)}function ee(M,_,F,z){let te=M.updateRanges;if(te.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,_.width,_.height,F,z,_.data);else{te.sort((Te,ce)=>Te.start-ce.start);let re=0;for(let Te=1;Te<te.length;Te++){let ce=te[re],oe=te[Te],Ne=ce.start+ce.count,Ue=se(oe.start,_.width,4),Ge=se(ce.start,_.width,4);oe.start<=Ne+1&&Ue===Ge&&se(oe.start+oe.count-1,_.width,4)===Ue?ce.count=Math.max(ce.count,oe.start+oe.count-ce.start):(++re,te[re]=oe)}te.length=re+1;let $=n.getParameter(t.UNPACK_ROW_LENGTH),K=n.getParameter(t.UNPACK_SKIP_PIXELS),ae=n.getParameter(t.UNPACK_SKIP_ROWS);n.pixelStorei(t.UNPACK_ROW_LENGTH,_.width);for(let Te=0,ce=te.length;Te<ce;Te++){let oe=te[Te],Ne=Math.floor(oe.start/4),Ue=Math.ceil(oe.count/4),Ge=Ne%_.width,P=Math.floor(Ne/_.width),ie=Ue,Y=1;n.pixelStorei(t.UNPACK_SKIP_PIXELS,Ge),n.pixelStorei(t.UNPACK_SKIP_ROWS,P),n.texSubImage2D(t.TEXTURE_2D,0,Ge,P,ie,Y,F,z,_.data)}M.clearUpdateRanges(),n.pixelStorei(t.UNPACK_ROW_LENGTH,$),n.pixelStorei(t.UNPACK_SKIP_PIXELS,K),n.pixelStorei(t.UNPACK_SKIP_ROWS,ae)}}function Be(M,_,F){let z=t.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(z=t.TEXTURE_2D_ARRAY),_.isData3DTexture&&(z=t.TEXTURE_3D);let W=Z(M,_),te=_.source;n.bindTexture(z,M.__webglTexture,t.TEXTURE0+F);let re=i.get(te);if(te.version!==re.__version||W===!0){if(n.activeTexture(t.TEXTURE0+F),(typeof ImageBitmap<"u"&&_.image instanceof ImageBitmap)===!1){let Y=Ye.getPrimaries(Ye.workingColorSpace),le=_.colorSpace===pi?null:Ye.getPrimaries(_.colorSpace),pe=_.colorSpace===pi||Y===le?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,_.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,pe)}n.pixelStorei(t.UNPACK_ALIGNMENT,_.unpackAlignment);let K=m(_.image,!1,s.maxTextureSize);K=En(_,K);let ae=r.convert(_.format,_.colorSpace),Te=r.convert(_.type),ce=b(_.internalFormat,ae,Te,_.normalized,_.colorSpace,_.isVideoTexture);ct(z,_);let oe,Ne=_.mipmaps,Ue=_.isVideoTexture!==!0,Ge=re.__version===void 0||W===!0,P=te.dataReady,ie=S(_,K);if(_.isDepthTexture)ce=A(_.format===Ps,_.type),Ge&&(Ue?n.texStorage2D(t.TEXTURE_2D,1,ce,K.width,K.height):n.texImage2D(t.TEXTURE_2D,0,ce,K.width,K.height,0,ae,Te,null));else if(_.isDataTexture)if(Ne.length>0){Ue&&Ge&&n.texStorage2D(t.TEXTURE_2D,ie,ce,Ne[0].width,Ne[0].height);for(let Y=0,le=Ne.length;Y<le;Y++)oe=Ne[Y],Ue?P&&n.texSubImage2D(t.TEXTURE_2D,Y,0,0,oe.width,oe.height,ae,Te,oe.data):n.texImage2D(t.TEXTURE_2D,Y,ce,oe.width,oe.height,0,ae,Te,oe.data);_.generateMipmaps=!1}else Ue?(Ge&&n.texStorage2D(t.TEXTURE_2D,ie,ce,K.width,K.height),P&&ee(_,K,ae,Te)):n.texImage2D(t.TEXTURE_2D,0,ce,K.width,K.height,0,ae,Te,K.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Ue&&Ge&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ie,ce,Ne[0].width,Ne[0].height,K.depth);for(let Y=0,le=Ne.length;Y<le;Y++)if(oe=Ne[Y],_.format!==Qn)if(ae!==null)if(Ue){if(P)if(_.layerUpdates.size>0){let pe=dd(oe.width,oe.height,_.format,_.type);for(let j of _.layerUpdates){let Ae=oe.data.subarray(j*pe/oe.data.BYTES_PER_ELEMENT,(j+1)*pe/oe.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,Y,0,0,j,oe.width,oe.height,1,ae,Ae)}_.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,Y,0,0,0,oe.width,oe.height,K.depth,ae,oe.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,Y,ce,oe.width,oe.height,K.depth,0,oe.data,0,0);else De("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ue?P&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,Y,0,0,0,oe.width,oe.height,K.depth,ae,Te,oe.data):n.texImage3D(t.TEXTURE_2D_ARRAY,Y,ce,oe.width,oe.height,K.depth,0,ae,Te,oe.data)}else{Ue&&Ge&&n.texStorage2D(t.TEXTURE_2D,ie,ce,Ne[0].width,Ne[0].height);for(let Y=0,le=Ne.length;Y<le;Y++)oe=Ne[Y],_.format!==Qn?ae!==null?Ue?P&&n.compressedTexSubImage2D(t.TEXTURE_2D,Y,0,0,oe.width,oe.height,ae,oe.data):n.compressedTexImage2D(t.TEXTURE_2D,Y,ce,oe.width,oe.height,0,oe.data):De("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ue?P&&n.texSubImage2D(t.TEXTURE_2D,Y,0,0,oe.width,oe.height,ae,Te,oe.data):n.texImage2D(t.TEXTURE_2D,Y,ce,oe.width,oe.height,0,ae,Te,oe.data)}else if(_.isDataArrayTexture)if(Ue){if(Ge&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ie,ce,K.width,K.height,K.depth),P)if(_.layerUpdates.size>0){let Y=dd(K.width,K.height,_.format,_.type);for(let le of _.layerUpdates){let pe=K.data.subarray(le*Y/K.data.BYTES_PER_ELEMENT,(le+1)*Y/K.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,le,K.width,K.height,1,ae,Te,pe)}_.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,K.width,K.height,K.depth,ae,Te,K.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,ce,K.width,K.height,K.depth,0,ae,Te,K.data);else if(_.isData3DTexture)Ue?(Ge&&n.texStorage3D(t.TEXTURE_3D,ie,ce,K.width,K.height,K.depth),P&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,K.width,K.height,K.depth,ae,Te,K.data)):n.texImage3D(t.TEXTURE_3D,0,ce,K.width,K.height,K.depth,0,ae,Te,K.data);else if(_.isFramebufferTexture){if(Ge)if(Ue)n.texStorage2D(t.TEXTURE_2D,ie,ce,K.width,K.height);else{let Y=K.width,le=K.height;for(let pe=0;pe<ie;pe++)n.texImage2D(t.TEXTURE_2D,pe,ce,Y,le,0,ae,Te,null),Y>>=1,le>>=1}}else if(_.isHTMLTexture){if("texElementImage2D"in t){let Y=t.canvas;if(Y.hasAttribute("layoutsubtree")||Y.setAttribute("layoutsubtree","true"),K.parentNode!==Y){Y.appendChild(K),d.add(_),Y.onpaint=le=>{let pe=le.changedElements;for(let j of d)pe.includes(j.image)&&(j.needsUpdate=!0)},Y.requestPaint();return}if(t.texElementImage2D.length===3)t.texElementImage2D(t.TEXTURE_2D,t.RGBA8,K);else{let pe=t.RGBA,j=t.RGBA,Ae=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,0,pe,j,Ae,K)}t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(Ne.length>0){if(Ue&&Ge){let Y=ft(Ne[0]);n.texStorage2D(t.TEXTURE_2D,ie,ce,Y.width,Y.height)}for(let Y=0,le=Ne.length;Y<le;Y++)oe=Ne[Y],Ue?P&&n.texSubImage2D(t.TEXTURE_2D,Y,0,0,ae,Te,oe):n.texImage2D(t.TEXTURE_2D,Y,ce,ae,Te,oe);_.generateMipmaps=!1}else if(Ue){if(Ge){let Y=ft(K);n.texStorage2D(t.TEXTURE_2D,ie,ce,Y.width,Y.height)}P&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,ae,Te,K)}else n.texImage2D(t.TEXTURE_2D,0,ce,ae,Te,K);p(_)&&E(z),re.__version=te.version,_.onUpdate&&_.onUpdate(_)}M.__version=_.version}function He(M,_,F){if(_.image.length!==6)return;let z=Z(M,_),W=_.source;n.bindTexture(t.TEXTURE_CUBE_MAP,M.__webglTexture,t.TEXTURE0+F);let te=i.get(W);if(W.version!==te.__version||z===!0){n.activeTexture(t.TEXTURE0+F);let re=Ye.getPrimaries(Ye.workingColorSpace),$=_.colorSpace===pi?null:Ye.getPrimaries(_.colorSpace),K=_.colorSpace===pi||re===$?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,_.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),n.pixelStorei(t.UNPACK_ALIGNMENT,_.unpackAlignment),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,K);let ae=_.isCompressedTexture||_.image[0].isCompressedTexture,Te=_.image[0]&&_.image[0].isDataTexture,ce=[];for(let j=0;j<6;j++)!ae&&!Te?ce[j]=m(_.image[j],!0,s.maxCubemapSize):ce[j]=Te?_.image[j].image:_.image[j],ce[j]=En(_,ce[j]);let oe=ce[0],Ne=r.convert(_.format,_.colorSpace),Ue=r.convert(_.type),Ge=b(_.internalFormat,Ne,Ue,_.normalized,_.colorSpace),P=_.isVideoTexture!==!0,ie=te.__version===void 0||z===!0,Y=W.dataReady,le=S(_,oe);ct(t.TEXTURE_CUBE_MAP,_);let pe;if(ae){P&&ie&&n.texStorage2D(t.TEXTURE_CUBE_MAP,le,Ge,oe.width,oe.height);for(let j=0;j<6;j++){pe=ce[j].mipmaps;for(let Ae=0;Ae<pe.length;Ae++){let Se=pe[Ae];_.format!==Qn?Ne!==null?P?Y&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,Ae,0,0,Se.width,Se.height,Ne,Se.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,Ae,Ge,Se.width,Se.height,0,Se.data):De("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):P?Y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,Ae,0,0,Se.width,Se.height,Ne,Ue,Se.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,Ae,Ge,Se.width,Se.height,0,Ne,Ue,Se.data)}}}else{if(pe=_.mipmaps,P&&ie){pe.length>0&&le++;let j=ft(ce[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,le,Ge,j.width,j.height)}for(let j=0;j<6;j++)if(Te){P?Y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,ce[j].width,ce[j].height,Ne,Ue,ce[j].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Ge,ce[j].width,ce[j].height,0,Ne,Ue,ce[j].data);for(let Ae=0;Ae<pe.length;Ae++){let Lt=pe[Ae].image[j].image;P?Y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,Ae+1,0,0,Lt.width,Lt.height,Ne,Ue,Lt.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,Ae+1,Ge,Lt.width,Lt.height,0,Ne,Ue,Lt.data)}}else{P?Y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,Ne,Ue,ce[j]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Ge,Ne,Ue,ce[j]);for(let Ae=0;Ae<pe.length;Ae++){let Se=pe[Ae];P?Y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,Ae+1,0,0,Ne,Ue,Se.image[j]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,Ae+1,Ge,Ne,Ue,Se.image[j])}}}p(_)&&E(t.TEXTURE_CUBE_MAP),te.__version=W.version,_.onUpdate&&_.onUpdate(_)}M.__version=_.version}function Fe(M,_,F,z,W,te){let re=r.convert(F.format,F.colorSpace),$=r.convert(F.type),K=b(F.internalFormat,re,$,F.normalized,F.colorSpace),ae=i.get(_),Te=i.get(F);if(Te.__renderTarget=_,!ae.__hasExternalTextures){let ce=Math.max(1,_.width>>te),oe=Math.max(1,_.height>>te);W===t.TEXTURE_3D||W===t.TEXTURE_2D_ARRAY?n.texImage3D(W,te,K,ce,oe,_.depth,0,re,$,null):n.texImage2D(W,te,K,ce,oe,0,re,$,null)}n.bindFramebuffer(t.FRAMEBUFFER,M),Xt(_)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,z,W,Te.__webglTexture,0,Pt(_)):(W===t.TEXTURE_2D||W>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&W<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,z,W,Te.__webglTexture,te),n.bindFramebuffer(t.FRAMEBUFFER,null)}function Ot(M,_,F){if(t.bindRenderbuffer(t.RENDERBUFFER,M),_.depthBuffer){let z=_.depthTexture,W=z&&z.isDepthTexture?z.type:null,te=A(_.stencilBuffer,W),re=_.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;Xt(_)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Pt(_),te,_.width,_.height):F?t.renderbufferStorageMultisample(t.RENDERBUFFER,Pt(_),te,_.width,_.height):t.renderbufferStorage(t.RENDERBUFFER,te,_.width,_.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,re,t.RENDERBUFFER,M)}else{let z=_.textures;for(let W=0;W<z.length;W++){let te=z[W],re=r.convert(te.format,te.colorSpace),$=r.convert(te.type),K=b(te.internalFormat,re,$,te.normalized,te.colorSpace);Xt(_)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Pt(_),K,_.width,_.height):F?t.renderbufferStorageMultisample(t.RENDERBUFFER,Pt(_),K,_.width,_.height):t.renderbufferStorage(t.RENDERBUFFER,K,_.width,_.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Ze(M,_,F){let z=_.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(t.FRAMEBUFFER,M),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let W=i.get(_.depthTexture);if(W.__renderTarget=_,(!W.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),z){if(W.__webglInit===void 0&&(W.__webglInit=!0,_.depthTexture.addEventListener("dispose",C)),W.__webglTexture===void 0){W.__webglTexture=t.createTexture(),n.bindTexture(t.TEXTURE_CUBE_MAP,W.__webglTexture),ct(t.TEXTURE_CUBE_MAP,_.depthTexture);let ae=r.convert(_.depthTexture.format),Te=r.convert(_.depthTexture.type),ce;_.depthTexture.format===wi?ce=t.DEPTH_COMPONENT24:_.depthTexture.format===Ps&&(ce=t.DEPTH24_STENCIL8);for(let oe=0;oe<6;oe++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,ce,_.width,_.height,0,ae,Te,null)}}else J(_.depthTexture,0);let te=W.__webglTexture,re=Pt(_),$=z?t.TEXTURE_CUBE_MAP_POSITIVE_X+F:t.TEXTURE_2D,K=_.depthTexture.format===Ps?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(_.depthTexture.format===wi)Xt(_)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,K,$,te,0,re):t.framebufferTexture2D(t.FRAMEBUFFER,K,$,te,0);else if(_.depthTexture.format===Ps)Xt(_)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,K,$,te,0,re):t.framebufferTexture2D(t.FRAMEBUFFER,K,$,te,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function gt(M){let _=i.get(M),F=M.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==M.depthTexture){let z=M.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),z){let W=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,z.removeEventListener("dispose",W)};z.addEventListener("dispose",W),_.__depthDisposeCallback=W}_.__boundDepthTexture=z}if(M.depthTexture&&!_.__autoAllocateDepthBuffer)if(F)for(let z=0;z<6;z++)Ze(_.__webglFramebuffer[z],M,z);else{let z=M.texture.mipmaps;z&&z.length>0?Ze(_.__webglFramebuffer[0],M,0):Ze(_.__webglFramebuffer,M,0)}else if(F){_.__webglDepthbuffer=[];for(let z=0;z<6;z++)if(n.bindFramebuffer(t.FRAMEBUFFER,_.__webglFramebuffer[z]),_.__webglDepthbuffer[z]===void 0)_.__webglDepthbuffer[z]=t.createRenderbuffer(),Ot(_.__webglDepthbuffer[z],M,!1);else{let W=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,te=_.__webglDepthbuffer[z];t.bindRenderbuffer(t.RENDERBUFFER,te),t.framebufferRenderbuffer(t.FRAMEBUFFER,W,t.RENDERBUFFER,te)}}else{let z=M.texture.mipmaps;if(z&&z.length>0?n.bindFramebuffer(t.FRAMEBUFFER,_.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=t.createRenderbuffer(),Ot(_.__webglDepthbuffer,M,!1);else{let W=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,te=_.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,te),t.framebufferRenderbuffer(t.FRAMEBUFFER,W,t.RENDERBUFFER,te)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function ht(M,_,F){let z=i.get(M);_!==void 0&&Fe(z.__webglFramebuffer,M,M.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),F!==void 0&&gt(M)}function nt(M){let _=M.texture,F=i.get(M),z=i.get(_);M.addEventListener("dispose",v);let W=M.textures,te=M.isWebGLCubeRenderTarget===!0,re=W.length>1;if(re||(z.__webglTexture===void 0&&(z.__webglTexture=t.createTexture()),z.__version=_.version,a.memory.textures++),te){F.__webglFramebuffer=[];for(let $=0;$<6;$++)if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer[$]=[];for(let K=0;K<_.mipmaps.length;K++)F.__webglFramebuffer[$][K]=t.createFramebuffer()}else F.__webglFramebuffer[$]=t.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer=[];for(let $=0;$<_.mipmaps.length;$++)F.__webglFramebuffer[$]=t.createFramebuffer()}else F.__webglFramebuffer=t.createFramebuffer();if(re)for(let $=0,K=W.length;$<K;$++){let ae=i.get(W[$]);ae.__webglTexture===void 0&&(ae.__webglTexture=t.createTexture(),a.memory.textures++)}if(M.samples>0&&Xt(M)===!1){F.__webglMultisampledFramebuffer=t.createFramebuffer(),F.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let $=0;$<W.length;$++){let K=W[$];F.__webglColorRenderbuffer[$]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,F.__webglColorRenderbuffer[$]);let ae=r.convert(K.format,K.colorSpace),Te=r.convert(K.type),ce=b(K.internalFormat,ae,Te,K.normalized,K.colorSpace,M.isXRRenderTarget===!0),oe=Pt(M);t.renderbufferStorageMultisample(t.RENDERBUFFER,oe,ce,M.width,M.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+$,t.RENDERBUFFER,F.__webglColorRenderbuffer[$])}t.bindRenderbuffer(t.RENDERBUFFER,null),M.depthBuffer&&(F.__webglDepthRenderbuffer=t.createRenderbuffer(),Ot(F.__webglDepthRenderbuffer,M,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(te){n.bindTexture(t.TEXTURE_CUBE_MAP,z.__webglTexture),ct(t.TEXTURE_CUBE_MAP,_);for(let $=0;$<6;$++)if(_.mipmaps&&_.mipmaps.length>0)for(let K=0;K<_.mipmaps.length;K++)Fe(F.__webglFramebuffer[$][K],M,_,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+$,K);else Fe(F.__webglFramebuffer[$],M,_,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+$,0);p(_)&&E(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(re){for(let $=0,K=W.length;$<K;$++){let ae=W[$],Te=i.get(ae),ce=t.TEXTURE_2D;(M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(ce=M.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(ce,Te.__webglTexture),ct(ce,ae),Fe(F.__webglFramebuffer,M,ae,t.COLOR_ATTACHMENT0+$,ce,0),p(ae)&&E(ce)}n.unbindTexture()}else{let $=t.TEXTURE_2D;if((M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&($=M.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture($,z.__webglTexture),ct($,_),_.mipmaps&&_.mipmaps.length>0)for(let K=0;K<_.mipmaps.length;K++)Fe(F.__webglFramebuffer[K],M,_,t.COLOR_ATTACHMENT0,$,K);else Fe(F.__webglFramebuffer,M,_,t.COLOR_ATTACHMENT0,$,0);p(_)&&E($),n.unbindTexture()}M.depthBuffer&&gt(M)}function Wt(M){let _=M.textures;for(let F=0,z=_.length;F<z;F++){let W=_[F];if(p(W)){let te=T(M),re=i.get(W).__webglTexture;n.bindTexture(te,re),E(te),n.unbindTexture()}}}let Zt=[],rn=[];function cn(M){if(M.samples>0){if(Xt(M)===!1){let _=M.textures,F=M.width,z=M.height,W=t.COLOR_BUFFER_BIT,te=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,re=i.get(M),$=_.length>1;if($)for(let ae=0;ae<_.length;ae++)n.bindFramebuffer(t.FRAMEBUFFER,re.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ae,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,re.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+ae,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,re.__webglMultisampledFramebuffer);let K=M.texture.mipmaps;K&&K.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,re.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,re.__webglFramebuffer);for(let ae=0;ae<_.length;ae++){if(M.resolveDepthBuffer&&(M.depthBuffer&&(W|=t.DEPTH_BUFFER_BIT),M.stencilBuffer&&M.resolveStencilBuffer&&(W|=t.STENCIL_BUFFER_BIT)),$){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,re.__webglColorRenderbuffer[ae]);let Te=i.get(_[ae]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Te,0)}t.blitFramebuffer(0,0,F,z,0,0,F,z,W,t.NEAREST),l===!0&&(Zt.length=0,rn.length=0,Zt.push(t.COLOR_ATTACHMENT0+ae),M.depthBuffer&&M.resolveDepthBuffer===!1&&(Zt.push(te),rn.push(te),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,rn)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,Zt))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),$)for(let ae=0;ae<_.length;ae++){n.bindFramebuffer(t.FRAMEBUFFER,re.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ae,t.RENDERBUFFER,re.__webglColorRenderbuffer[ae]);let Te=i.get(_[ae]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,re.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+ae,t.TEXTURE_2D,Te,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,re.__webglMultisampledFramebuffer)}else if(M.depthBuffer&&M.resolveDepthBuffer===!1&&l){let _=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[_])}}}function Pt(M){return Math.min(s.maxSamples,M.samples)}function Xt(M){let _=i.get(M);return M.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function N(M){let _=a.render.frame;u.get(M)!==_&&(u.set(M,_),M.update())}function En(M,_){let F=M.colorSpace,z=M.format,W=M.type;return M.isCompressedTexture===!0||M.isVideoTexture===!0||F!==er&&F!==pi&&(Ye.getTransfer(F)===dt?(z!==Qn||W!==Hn)&&De("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Oe("WebGLTextures: Unsupported texture color space:",F)),_}function ft(M){return typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement?(c.width=M.naturalWidth||M.width,c.height=M.naturalHeight||M.height):typeof VideoFrame<"u"&&M instanceof VideoFrame?(c.width=M.displayWidth,c.height=M.displayHeight):(c.width=M.width,c.height=M.height),c}this.allocateTextureUnit=X,this.resetTextureUnits=H,this.getTextureUnits=q,this.setTextureUnits=k,this.setTexture2D=J,this.setTexture2DArray=Q,this.setTexture3D=ue,this.setTextureCube=me,this.rebindTextures=ht,this.setupRenderTarget=nt,this.updateRenderTargetMipmap=Wt,this.updateMultisampleRenderTarget=cn,this.setupDepthRenderbuffer=gt,this.setupFrameBufferTexture=Fe,this.useMultisampledRTT=Xt,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function UM(t,e){function n(i,s=pi){let r,a=Ye.getTransfer(s);if(i===Hn)return t.UNSIGNED_BYTE;if(i===nc)return t.UNSIGNED_SHORT_4_4_4_4;if(i===ic)return t.UNSIGNED_SHORT_5_5_5_1;if(i===td)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===nd)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===Qu)return t.BYTE;if(i===ed)return t.SHORT;if(i===Zr)return t.UNSIGNED_SHORT;if(i===tc)return t.INT;if(i===di)return t.UNSIGNED_INT;if(i===fi)return t.FLOAT;if(i===Li)return t.HALF_FLOAT;if(i===id)return t.ALPHA;if(i===sd)return t.RGB;if(i===Qn)return t.RGBA;if(i===wi)return t.DEPTH_COMPONENT;if(i===Ps)return t.DEPTH_STENCIL;if(i===rd)return t.RED;if(i===sc)return t.RED_INTEGER;if(i===Ls)return t.RG;if(i===rc)return t.RG_INTEGER;if(i===ac)return t.RGBA_INTEGER;if(i===to||i===no||i===io||i===so)if(a===dt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===to)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===no)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===io)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===so)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===to)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===no)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===io)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===so)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===oc||i===lc||i===cc||i===hc)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===oc)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===lc)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===cc)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===hc)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===uc||i===dc||i===fc||i===pc||i===mc||i===ro||i===gc)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(i===uc||i===dc)return a===dt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===fc)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(i===pc)return r.COMPRESSED_R11_EAC;if(i===mc)return r.COMPRESSED_SIGNED_R11_EAC;if(i===ro)return r.COMPRESSED_RG11_EAC;if(i===gc)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===_c||i===xc||i===vc||i===yc||i===bc||i===Mc||i===Sc||i===Ec||i===wc||i===Ac||i===Tc||i===Cc||i===Rc||i===Ic)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(i===_c)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===xc)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===vc)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===yc)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===bc)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Mc)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Sc)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Ec)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===wc)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Ac)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Tc)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Cc)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Rc)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Ic)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Pc||i===Lc||i===Nc)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(i===Pc)return a===dt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Lc)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Nc)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Dc||i===Fc||i===ao||i===Uc)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(i===Dc)return r.COMPRESSED_RED_RGTC1_EXT;if(i===Fc)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===ao)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Uc)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Jr?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}var OM=`
void main() {
