...
}`,Ad=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n){if(this.texture===null){let i=new Ya(e.texture);(e.depthNear!==n.depthNear||e.depthFar!==n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){let n=e.cameras[0].viewport,i=new Qt({vertexShader:GM,fragmentShader:WM,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new hn(new Ci(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Td=class extends Ai{constructor(e,n){super();let i=this,s=null,r=1,a=null,o="local-floor",l=1,c=null,h=null,d=null,u=null,f=null,g=null,_=typeof XRWebGLBinding<"u",m=new Ad,p={},A=n.getContextAttributes(),T=null,b=null,S=[],M=[],C=new Ke,v=null,w=new xn;w.viewport=new Tt;let I=new xn;I.viewport=new Tt;let R=[w,I],D=new Jl,V=null,X=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let se=S[Z];return se===void 0&&(se=new $r,S[Z]=se),se.getTargetRaySpace()},this.getControllerGrip=function(Z){let se=S[Z];return se===void 0&&(se=new $r,S[Z]=se),se.getGripSpace()},this.getHand=function(Z){let se=S[Z];return se===void 0&&(se=new $r,S[Z]=se),se.getHandSpace()};function O(Z){let se=M.indexOf(Z.inputSource);if(se===-1)return;let ee=S[se];ee!==void 0&&(ee.update(Z.inputSource,Z.frame,c||a),ee.dispatchEvent({type:Z.type,data:Z.inputSource}))}function W(){s.removeEventListener("select",O),s.removeEventListener("selectstart",O),s.removeEventListener("selectend",O),s.removeEventListener("squeeze",O),s.removeEventListener("squeezestart",O),s.removeEventListener("squeezeend",O),s.removeEventListener("end",W),s.removeEventListener("inputsourceschange",G);for(let Z=0;Z<S.length;Z++){let se=M[Z];se!==null&&(M[Z]=null,S[Z].disconnect(se))}V=null,X=null,m.reset();for(let Z in p)delete p[Z];e.setRenderTarget(T),f=null,u=null,d=null,s=null,b=null,ct.stop(),i.isPresenting=!1,e.setPixelRatio(v),e.setSize(C.width,C.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){r=Z,i.isPresenting===!0&&De("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){o=Z,i.isPresenting===!0&&De("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(Z){c=Z},this.getBaseLayer=function(){return u!==null?u:f},this.getBinding=function(){return d===null&&_&&(d=new XRWebGLBinding(s,n)),d},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(Z){if(s=Z,s!==null){if(T=e.getRenderTarget(),s.addEventListener("select",O),s.addEventListener("selectstart",O),s.addEventListener("selectend",O),s.addEventListener("squeeze",O),s.addEventListener("squeezestart",O),s.addEventListener("squeezeend",O),s.addEventListener("end",W),s.addEventListener("inputsourceschange",G),A.xrCompatible!==!0&&await n.makeXRCompatible(),v=e.getPixelRatio(),e.getSize(C),_&&"createProjectionLayer"in XRWebGLBinding.prototype){let ee=null,Be=null,He=null;A.depth&&(He=A.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,ee=A.stencil?Ps:wi,Be=A.stencil?Jr:di);let Fe={colorFormat:n.RGBA8,depthFormat:He,scaleFactor:r};d=this.getBinding(),u=d.createProjectionLayer(Fe),s.updateRenderState({layers:[u]}),e.setPixelRatio(1),e.setSize(u.textureWidth,u.textureHeight,!1),b=new kn(u.textureWidth,u.textureHeight,{format:Qn,type:Hn,depthTexture:new es(u.textureWidth,u.textureHeight,Be,void 0,void 0,void 0,void 0,void 0,void 0,ee),stencilBuffer:A.stencil,colorSpace:e.outputColorSpace,samples:A.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{let ee={antialias:A.antialias,alpha:!0,depth:A.depth,stencil:A.stencil,framebufferScaleFactor:r};f=new XRWebGLLayer(s,n,ee),s.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),b=new kn(f.framebufferWidth,f.framebufferHeight,{format:Qn,type:Hn,colorSpace:e.outputColorSpace,stencilBuffer:A.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}b.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),ct.setContext(s),ct.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function G(Z){for(let se=0;se<Z.removed.length;se++){let ee=Z.removed[se],Be=M.indexOf(ee);Be>=0&&(M[Be]=null,S[Be].disconnect(ee))}for(let se=0;se<Z.added.length;se++){let ee=Z.added[se],Be=M.indexOf(ee);if(Be===-1){for(let Fe=0;Fe<S.length;Fe++)if(Fe>=M.length){M.push(ee),Be=Fe;break}else if(M[Fe]===null){M[Fe]=ee,Be=Fe;break}if(Be===-1)break}let He=S[Be];He&&He.connect(ee)}}let J=new L,Q=new L;function ue(Z,se,ee){J.setFromMatrixPosition(se.matrixWorld),Q.setFromMatrixPosition(ee.matrixWorld);let Be=J.distanceTo(Q),He=se.projectionMatrix.elements,Fe=ee.projectionMatrix.elements,Ot=He[14]/(He[10]-1),Ze=He[14]/(He[10]+1),gt=(He[9]+1)/He[5],ht=(He[9]-1)/He[5],nt=(He[8]-1)/He[0],Xt=(Fe[8]+1)/Fe[0],Jt=Ot*nt,rn=Ot*Xt,cn=Be/(-nt+Xt),Pt=cn*-nt;if(se.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(Pt),Z.translateZ(cn),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),He[10]===-1)Z.projectionMatrix.copy(se.projectionMatrix),Z.projectionMatrixInverse.copy(se.projectionMatrixInverse);else{let $t=Ot+cn,N=Ze+cn,En=Jt-Pt,ft=rn+(Be-Pt),E=gt*Ze/N*$t,x=ht*Ze/N*$t;Z.projectionMatrix.makePerspective(En,ft,E,x,$t,N),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function me(Z,se){se===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(se.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(s===null)return;let se=Z.near,ee=Z.far;m.texture!==null&&(m.depthNear>0&&(se=m.depthNear),m.depthFar>0&&(ee=m.depthFar)),D.near=I.near=w.near=se,D.far=I.far=w.far=ee,(V!==D.near||X!==D.far)&&(s.updateRenderState({depthNear:D.near,depthFar:D.far}),V=D.near,X=D.far),D.layers.mask=Z.layers.mask|6,w.layers.mask=D.layers.mask&-5,I.layers.mask=D.layers.mask&-3;let Be=Z.parent,He=D.cameras;me(D,Be);for(let Fe=0;Fe<He.length;Fe++)me(He[Fe],Be);He.length===2?ue(D,w,I):D.projectionMatrix.copy(w.projectionMatrix),be(Z,D,Be)};function be(Z,se,ee){ee===null?Z.matrix.copy(se.matrixWorld):(Z.matrix.copy(ee.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(se.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(se.projectionMatrix),Z.projectionMatrixInverse.copy(se.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=Tl*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return D},this.getFoveation=function(){if(!(u===null&&f===null))return l},this.setFoveation=function(Z){l=Z,u!==null&&(u.fixedFoveation=Z),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=Z)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(D)},this.getCameraTexture=function(Z){return p[Z]};let lt=null;function It(Z,se){if(h=se.getViewerPose(c||a),g=se,h!==null){let ee=h.views;f!==null&&(e.setRenderTargetFramebuffer(b,f.framebuffer),e.setRenderTarget(b));let Be=!1;ee.length!==D.cameras.length&&(D.cameras.length=0,Be=!0);for(let Ze=0;Ze<ee.length;Ze++){let gt=ee[Ze],ht=null;if(f!==null)ht=f.getViewport(gt);else{let Xt=d.getViewSubImage(u,gt);ht=Xt.viewport,Ze===0&&(e.setRenderTargetTextures(b,Xt.colorTexture,Xt.depthStencilTexture),e.setRenderTarget(b))}let nt=R[Ze];nt===void 0&&(nt=new xn,nt.layers.enable(Ze),nt.viewport=new Tt,R[Ze]=nt),nt.matrix.fromArray(gt.transform.matrix),nt.matrix.decompose(nt.position,nt.quaternion,nt.scale),nt.projectionMatrix.fromArray(gt.projectionMatrix),nt.projectionMatrixInverse.copy(nt.projectionMatrix).invert(),nt.viewport.set(ht.x,ht.y,ht.width,ht.height),Ze===0&&(D.matrix.copy(nt.matrix),D.matrix.decompose(D.position,D.quaternion,D.scale)),Be===!0&&D.cameras.push(nt)}let He=s.enabledFeatures;if(He&&He.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&_){d=i.getBinding();let Ze=d.getDepthInformation(ee[0]);Ze&&Ze.isValid&&Ze.texture&&m.init(Ze,s.renderState)}if(He&&He.includes("camera-access")&&_){e.state.unbindTexture(),d=i.getBinding();for(let Ze=0;Ze<ee.length;Ze++){let gt=ee[Ze].camera;if(gt){let ht=p[gt];ht||(ht=new Ya,p[gt]=ht);let nt=d.getCameraImage(gt);ht.sourceTexture=nt}}}}for(let ee=0;ee<S.length;ee++){let Be=M[ee],He=S[ee];Be!==null&&He!==void 0&&He.update(Be,se,c||a)}lt&&lt(Z,se),se.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:se}),g=null}let ct=new cg;ct.setAnimationLoop(It),this.setAnimationLoop=function(Z){lt=Z},this.dispose=function(){}}},XM=new Dt,mg=new ke;mg.set(-1,0,0,0,1,0,0,0,1);function $M(t,e){function n(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function i(m,p){p.color.getRGB(m.fogColor.value,cd(t)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function s(m,p,A,T,b){p.isNodeMaterial?p.uniformsNeedUpdate=!1:p.isMeshBasicMaterial?r(m,p):p.isMeshLambertMaterial?(r(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshToonMaterial?(r(m,p),d(m,p)):p.isMeshPhongMaterial?(r(m,p),h(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshStandardMaterial?(r(m,p),u(m,p),p.isMeshPhysicalMaterial&&f(m,p,b)):p.isMeshMatcapMaterial?(r(m,p),g(m,p)):p.isMeshDepthMaterial?r(m,p):p.isMeshDistanceMaterial?(r(m,p),_(m,p)):p.isMeshNormalMaterial?r(m,p):p.isLineBasicMaterial?(a(m,p),p.isLineDashedMaterial&&o(m,p)):p.isPointsMaterial?l(m,p,A,T):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function r(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,n(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,n(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,n(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===bn&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,n(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===bn&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,n(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,n(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,n(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);let A=e.get(p),T=A.envMap,b=A.envMapRotation;T&&(m.envMap.value=T,m.envMapRotation.value.setFromMatrix4(XM.makeRotationFromEuler(b)).transpose(),T.isCubeTexture&&T.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(mg),m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,n(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,n(p.aoMap,m.aoMapTransform))}function a(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,n(p.map,m.mapTransform))}function o(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,A,T){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*A,m.scale.value=T*.5,p.map&&(m.map.value=p.map,n(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,n(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,n(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,n(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function h(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function d(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function u(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,n(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,n(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function f(m,p,A){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,n(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,n(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,n(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,n(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,n(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===bn&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,n(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,n(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=A.texture,m.transmissionSamplerSize.value.set(A.width,A.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,n(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,n(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,n(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,n(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,n(p.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,p){p.matcap&&(m.matcap.value=p.matcap)}function _(m,p){let A=e.get(p).light;m.referencePosition.value.setFromMatrixPosition(A.matrixWorld),m.nearDistance.value=A.shadow.camera.near,m.farDistance.value=A.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function qM(t,e,n,i){let s={},r={},a=[],o=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(b,S){let M=S.program;i.uniformBlockBinding(b,M)}function c(b,S){let M=s[b.id];M===void 0&&(m(b),M=h(b),s[b.id]=M,b.addEventListener("dispose",A));let C=S.program;i.updateUBOMapping(b,C);let v=e.render.frame;r[b.id]!==v&&(u(b),r[b.id]=v)}function h(b){let S=d();b.__bindingPointIndex=S;let M=t.createBuffer(),C=b.__size,v=b.usage;return t.bindBuffer(t.UNIFORM_BUFFER,M),t.bufferData(t.UNIFORM_BUFFER,C,v),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,S,M),M}function d(){for(let b=0;b<o;b++)if(a.indexOf(b)===-1)return a.push(b),b;return Oe("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(b){let S=s[b.id],M=b.uniforms,C=b.__cache;t.bindBuffer(t.UNIFORM_BUFFER,S);for(let v=0,w=M.length;v<w;v++){let I=M[v];if(Array.isArray(I))for(let R=0,D=I.length;R<D;R++)f(I[R],v,R,C);else f(I,v,0,C)}t.bindBuffer(t.UNIFORM_BUFFER,null)}function f(b,S,M,C){if(_(b,S,M,C)===!0){let v=b.__offset,w=b.value;if(Array.isArray(w)){let I=0;for(let R=0;R<w.length;R++){let D=w[R],V=p(D);g(D,b.__data,I),typeof D!="number"&&typeof D!="boolean"&&!D.isMatrix3&&!ArrayBuffer.isView(D)&&(I+=V.storage/Float32Array.BYTES_PER_ELEMENT)}}else g(w,b.__data,0);t.bufferSubData(t.UNIFORM_BUFFER,v,b.__data)}}function g(b,S,M){typeof b=="number"||typeof b=="boolean"?S[0]=b:b.isMatrix3?(S[0]=b.elements[0],S[1]=b.elements[1],S[2]=b.elements[2],S[3]=0,S[4]=b.elements[3],S[5]=b.elements[4],S[6]=b.elements[5],S[7]=0,S[8]=b.elements[6],S[9]=b.elements[7],S[10]=b.elements[8],S[11]=0):ArrayBuffer.isView(b)?S.set(new b.constructor(b.buffer,b.byteOffset,S.length)):b.toArray(S,M)}function _(b,S,M,C){let v=b.value,w=S+"_"+M;if(C[w]===void 0)return typeof v=="number"||typeof v=="boolean"?C[w]=v:ArrayBuffer.isView(v)?C[w]=v.slice():C[w]=v.clone(),!0;{let I=C[w];if(typeof v=="number"||typeof v=="boolean"){if(I!==v)return C[w]=v,!0}else{if(ArrayBuffer.isView(v))return!0;if(I.equals(v)===!1)return I.copy(v),!0}}return!1}function m(b){let S=b.uniforms,M=0,C=16;for(let w=0,I=S.length;w<I;w++){let R=Array.isArray(S[w])?S[w]:[S[w]];for(let D=0,V=R.length;D<V;D++){let X=R[D],O=Array.isArray(X.value)?X.value:[X.value];for(let W=0,G=O.length;W<G;W++){let J=O[W],Q=p(J),ue=M%C,me=ue%Q.boundary,be=ue+me;M+=me,be!==0&&C-be<Q.storage&&(M+=C-be),X.__data=new Float32Array(Q.storage/Float32Array.BYTES_PER_ELEMENT),X.__offset=M,M+=Q.storage}}}let v=M%C;return v>0&&(M+=C-v),b.__size=M,b.__cache={},this}function p(b){let S={boundary:0,storage:0};return typeof b=="number"||typeof b=="boolean"?(S.boundary=4,S.storage=4):b.isVector2?(S.boundary=8,S.storage=8):b.isVector3||b.isColor?(S.boundary=16,S.storage=12):b.isVector4?(S.boundary=16,S.storage=16):b.isMatrix3?(S.boundary=48,S.storage=48):b.isMatrix4?(S.boundary=64,S.storage=64):b.isTexture?De("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(b)?(S.boundary=16,S.storage=b.byteLength):De("WebGLRenderer: Unsupported uniform value type.",b),S}function A(b){let S=b.target;S.removeEventListener("dispose",A);let M=a.indexOf(S.__bindingPointIndex);a.splice(M,1),t.deleteBuffer(s[S.id]),delete s[S.id],delete r[S.id]}function T(){for(let b in s)t.deleteBuffer(s[b]);a=[],s={},r={}}return{bind:l,update:c,dispose:T}}var YM=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Ni=null;function KM(){return Ni===null&&(Ni=new Pl(YM,16,16,Ls,Li),Ni.name="DFG_LUT",Ni.minFilter=jt,Ni.magFilter=jt,Ni.wrapS=Ei,Ni.wrapT=Ei,Ni.generateMipmaps=!1,Ni.needsUpdate=!0),Ni}var Gc=class{constructor(e={}){let{canvas:n=Dm(),context:i=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:u=!1,outputBufferType:f=Hn}=e;this.isWebGLRenderer=!0;let g;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=i.getContextAttributes().alpha}else g=a;let _=f,m=new Set([ac,rc,sc]),p=new Set([Hn,di,Zr,Jr,nc,ic]),A=new Uint32Array(4),T=new Int32Array(4),b=new L,S=null,M=null,C=[],v=[],w=null;this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=ui,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let I=this,R=!1,D=null,V=null,X=null,O=null;this._outputColorSpace=Bn;let W=0,G=0,J=null,Q=-1,ue=null,me=new Tt,be=new Tt,lt=null,It=new ze(0),ct=0,Z=n.width,se=n.height,ee=1,Be=null,He=null,Fe=new Tt(0,0,Z,se),Ot=new Tt(0,0,Z,se),Ze=!1,gt=new Xa,ht=!1,nt=!1,Xt=new Dt,Jt=new L,rn=new Tt,cn={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Pt=!1;function $t(){return J===null?ee:1}let N=i;function En(y,F){return n.getContext(y,F)}try{let y={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:d};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${"185"}`),n.addEventListener("webglcontextlost",Lt,!1),n.addEventListener("webglcontextrestored",vt,!1),n.addEventListener("webglcontextcreationerror",vi,!1),N===null){let F="webgl2";if(N=En(F,y),N===null)throw En(F)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(y){throw Oe("WebGLRenderer: "+y.message),y}let ft,E,x,U,z,$,te,re,q,K,ae,Te,ce,oe,Ne,Ue,Ge,P,ie,Y,le,pe,j;function Ae(){ft=new n2(N),ft.init(),le=new HM(N,ft),E=new Yb(N,ft,e,le),x=new zM(N,ft),E.reversedDepthBuffer&&u&&x.buffers.depth.setReversed(!0),V=N.createFramebuffer(),X=N.createFramebuffer(),O=N.createFramebuffer(),U=new r2(N),z=new AM,$=new VM(N,ft,x,z,E,le,U),te=new t2(I),re=new c1(N),pe=new $b(N,re),q=new i2(N,re,U,pe),K=new o2(N,q,re,pe,U),P=new a2(N,E,$),Ne=new Kb(z),ae=new wM(I,te,ft,E,pe,Ne),Te=new $M(I,z),ce=new CM,oe=new DM(ft),Ge=new Xb(I,te,x,K,g,l),Ue=new kM(I,K,E),j=new qM(N,U,E,x),ie=new qb(N,ft,U),Y=new s2(N,ft,U),U.programs=ae.programs,I.capabilities=E,I.extensions=ft,I.properties=z,I.renderLists=ce,I.shadowMap=Ue,I.state=x,I.info=U}Ae(),_!==Hn&&(w=new c2(_,n.width,n.height,o,s,r));let Se=new Td(I,N);this.xr=Se,this.getContext=function(){return N},this.getContextAttributes=function(){return N.getContextAttributes()},this.forceContextLoss=function(){let y=ft.get("WEBGL_lose_context");y&&y.loseContext()},this.forceContextRestore=function(){let y=ft.get("WEBGL_lose_context");y&&y.restoreContext()},this.getPixelRatio=function(){return ee},this.setPixelRatio=function(y){y!==void 0&&(ee=y,this.setSize(Z,se,!1))},this.getSize=function(y){return y.set(Z,se)},this.setSize=function(y,F,H=!0){if(Se.isPresenting){De("WebGLRenderer: Can't change size while VR device is presenting.");return}Z=y,se=F,n.width=Math.floor(y*ee),n.height=Math.floor(F*ee),H===!0&&(n.style.width=y+"px",n.style.height=F+"px"),w!==null&&w.setSize(n.width,n.height),this.setViewport(0,0,y,F)},this.getDrawingBufferSize=function(y){return y.set(Z*ee,se*ee).floor()},this.setDrawingBufferSize=function(y,F,H){Z=y,se=F,ee=H,n.width=Math.floor(y*H),n.height=Math.floor(F*H),this.setViewport(0,0,y,F)},this.setEffects=function(y){if(_===Hn){Oe("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(y){for(let F=0;F<y.length;F++)if(y[F].isOutputPass===!0){De("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}w.setEffects(y||[])},this.getCurrentViewport=function(y){return y.copy(me)},this.getViewport=function(y){return y.copy(Fe)},this.setViewport=function(y,F,H,B){y.isVector4?Fe.set(y.x,y.y,y.z,y.w):Fe.set(y,F,H,B),x.viewport(me.copy(Fe).multiplyScalar(ee).round())},this.getScissor=function(y){return y.copy(Ot)},this.setScissor=function(y,F,H,B){y.isVector4?Ot.set(y.x,y.y,y.z,y.w):Ot.set(y,F,H,B),x.scissor(be.copy(Ot).multiplyScalar(ee).round())},this.getScissorTest=function(){return Ze},this.setScissorTest=function(y){x.setScissorTest(Ze=y)},this.setOpaqueSort=function(y){Be=y},this.setTransparentSort=function(y){He=y},this.getClearColor=function(y){return y.copy(Ge.getClearColor())},this.setClearColor=function(){Ge.setClearColor(...arguments)},this.getClearAlpha=function(){return Ge.getClearAlpha()},this.setClearAlpha=function(){Ge.setClearAlpha(...arguments)},this.clear=function(y=!0,F=!0,H=!0){let B=0;if(y){let k=!1;if(J!==null){let fe=J.texture.format;k=m.has(fe)}if(k){let fe=J.texture.type,_e=p.has(fe),de=Ge.getClearColor(),we=Ge.getClearAlpha(),Ce=de.r,We=de.g,qe=de.b;_e?(A[0]=Ce,A[1]=We,A[2]=qe,A[3]=we,N.clearBufferuiv(N.COLOR,0,A)):(T[0]=Ce,T[1]=We,T[2]=qe,T[3]=we,N.clearBufferiv(N.COLOR,0,T))}else B|=N.COLOR_BUFFER_BIT}F&&(B|=N.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),H&&(B|=N.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),B!==0&&N.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(y){y.setRenderer(this),D=y},this.dispose=function(){n.removeEventListener("webglcontextlost",Lt,!1),n.removeEventListener("webglcontextrestored",vt,!1),n.removeEventListener("webglcontextcreationerror",vi,!1),Ge.dispose(),ce.dispose(),oe.dispose(),z.dispose(),te.dispose(),K.dispose(),pe.dispose(),j.dispose(),ae.dispose(),Se.dispose(),Se.removeEventListener("sessionstart",wp),Se.removeEventListener("sessionend",Ap),Xs.stop()};function Lt(y){y.preventDefault(),ld("WebGLRenderer: Context Lost."),R=!0}function vt(){ld("WebGLRenderer: Context Restored."),R=!1;let y=U.autoReset,F=Ue.enabled,H=Ue.autoUpdate,B=Ue.needsUpdate,k=Ue.type;Ae(),U.autoReset=y,Ue.enabled=F,Ue.autoUpdate=H,Ue.needsUpdate=B,Ue.type=k}function vi(y){Oe("WebGLRenderer: A WebGL context could not be created. Reason: ",y.statusMessage)}function yi(y){let F=y.target;F.removeEventListener("dispose",yi),Mv(F)}function Mv(y){Sv(y),z.remove(y)}function Sv(y){let F=z.get(y).programs;F!==void 0&&(F.forEach(function(H){ae.releaseProgram(H)}),y.isShaderMaterial&&ae.releaseShaderCache(y))}this.renderBufferDirect=function(y,F,H,B,k,fe){F===null&&(F=cn);let _e=k.isMesh&&k.matrixWorld.determinantAffine()<0,de=Av(y,F,H,B,k);x.setMaterial(B,_e);let we=H.index,Ce=1;if(B.wireframe===!0){if(we=q.getWireframeAttribute(H),we===void 0)return;Ce=2}let We=H.drawRange,qe=H.attributes.position,Ie=We.start*Ce,mt=(We.start+We.count)*Ce;fe!==null&&(Ie=Math.max(Ie,fe.start*Ce),mt=Math.min(mt,(fe.start+fe.count)*Ce)),we!==null?(Ie=Math.max(Ie,0),mt=Math.min(mt,we.count)):qe!=null&&(Ie=Math.max(Ie,0),mt=Math.min(mt,qe.count));let Bt=mt-Ie;if(Bt<0||Bt===1/0)return;pe.setup(k,B,de,H,we);let Nt,xt=ie;if(we!==null&&(Nt=re.get(we),xt=Y,xt.setIndex(Nt)),k.isMesh)B.wireframe===!0?(x.setLineWidth(B.wireframeLinewidth*$t()),xt.setMode(N.LINES)):xt.setMode(N.TRIANGLES);else if(k.isLine){let pn=B.linewidth;pn===void 0&&(pn=1),x.setLineWidth(pn*$t()),k.isLineSegments?xt.setMode(N.LINES):k.isLineLoop?xt.setMode(N.LINE_LOOP):xt.setMode(N.LINE_STRIP)}else k.isPoints?xt.setMode(N.POINTS):k.isSprite&&xt.setMode(N.TRIANGLES);if(k.isBatchedMesh)if(ft.get("WEBGL_multi_draw"))xt.renderMultiDraw(k._multiDrawStarts,k._multiDrawCounts,k._multiDrawCount);else{let pn=k._multiDrawStarts,xe=k._multiDrawCounts,Fn=k._multiDrawCount,it=we?re.get(we).bytesPerElement:1,Zn=z.get(B).currentProgram.getUniforms();for(let bi=0;bi<Fn;bi++)Zn.setValue(N,"_gl_DrawID",bi),xt.render(pn[bi]/it,xe[bi])}else if(k.isInstancedMesh)xt.renderInstances(Ie,Bt,k.count);else if(H.isInstancedBufferGeometry){let pn=H._maxInstanceCount!==void 0?H._maxInstanceCount:1/0,xe=Math.min(H.instanceCount,pn);xt.renderInstances(Ie,Bt,xe)}else xt.render(Ie,Bt)};function Ep(y,F,H){y.transparent===!0&&y.side===Ri&&y.forceSinglePass===!1?(y.side=bn,y.needsUpdate=!0,Wo(y,F,H),y.side=Qi,y.needsUpdate=!0,Wo(y,F,H),y.side=Ri):Wo(y,F,H)}this.compile=function(y,F,H=null){H===null&&(H=y),M=oe.get(H),M.init(F),v.push(M),H.traverseVisible(function(k){k.isLight&&k.layers.test(F.layers)&&(M.pushLight(k),k.castShadow&&M.pushShadow(k))}),y!==H&&y.traverseVisible(function(k){k.isLight&&k.layers.test(F.layers)&&(M.pushLight(k),k.castShadow&&M.pushShadow(k))}),M.setupLights();let B=new Set;return y.traverse(function(k){if(!(k.isMesh||k.isPoints||k.isLine||k.isSprite))return;let fe=k.material;if(fe)if(Array.isArray(fe))for(let _e=0;_e<fe.length;_e++){let de=fe[_e];Ep(de,H,k),B.add(de)}else Ep(fe,H,k),B.add(fe)}),M=v.pop(),B},this.compileAsync=function(y,F,H=null){let B=this.compile(y,F,H);return new Promise(k=>{function fe(){if(B.forEach(function(_e){z.get(_e).currentProgram.isReady()&&B.delete(_e)}),B.size===0){k(y);return}setTimeout(fe,10)}ft.get("KHR_parallel_shader_compile")!==null?fe():setTimeout(fe,10)})};let au=null;function Ev(y){au&&au(y)}function wp(){Xs.stop()}function Ap(){Xs.start()}let Xs=new cg;Xs.setAnimationLoop(Ev),typeof self<"u"&&Xs.setContext(self),this.setAnimationLoop=function(y){au=y,Se.setAnimationLoop(y),y===null?Xs.stop():Xs.start()},Se.addEventListener("sessionstart",wp),Se.addEventListener("sessionend",Ap),this.render=function(y,F){if(F!==void 0&&F.isCamera!==!0){Oe("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(R===!0)return;D!==null&&D.renderStart(y,F);let H=Se.enabled===!0&&Se.isPresenting===!0,B=w!==null&&(J===null||H)&&w.begin(I,J);if(y.matrixWorldAutoUpdate===!0&&y.updateMatrixWorld(),F.parent===null&&F.matrixWorldAutoUpdate===!0&&F.updateMatrixWorld(),Se.enabled===!0&&Se.isPresenting===!0&&(w===null||w.isCompositing()===!1)&&(Se.cameraAutoUpdate===!0&&Se.updateCamera(F),F=Se.getCamera()),y.isScene===!0&&y.onBeforeRender(I,y,F,J),M=oe.get(y,v.length),M.init(F),M.state.textureUnits=$.getTextureUnits(),v.push(M),Xt.multiplyMatrices(F.projectionMatrix,F.matrixWorldInverse),gt.setFromProjectionMatrix(Xt,hi,F.reversedDepth),nt=this.localClippingEnabled,ht=Ne.init(this.clippingPlanes,nt),S=ce.get(y,C.length),S.init(),C.push(S),Se.enabled===!0&&Se.isPresenting===!0){let _e=I.xr.getDepthSensingMesh();_e!==null&&ou(_e,F,-1/0,I.sortObjects)}ou(y,F,0,I.sortObjects),S.finish(),I.sortObjects===!0&&S.sort(Be,He,F.reversedDepth),Pt=Se.enabled===!1||Se.isPresenting===!1||Se.hasDepthSensing()===!1,Pt&&Ge.addToRenderList(S,y),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),ht===!0&&Ne.beginShadows();let k=M.state.shadowsArray;if(Ue.render(k,y,F),ht===!0&&Ne.endShadows(),(B&&w.hasRenderPass())===!1){let _e=S.opaque,de=S.transmissive;if(M.setupLights(),F.isArrayCamera){let we=F.cameras;if(de.length>0)for(let Ce=0,We=we.length;Ce<We;Ce++){let qe=we[Ce];Cp(_e,de,y,qe)}Pt&&Ge.render(y);for(let Ce=0,We=we.length;Ce<We;Ce++){let qe=we[Ce];Tp(S,y,qe,qe.viewport)}}else de.length>0&&Cp(_e,de,y,F),Pt&&Ge.render(y),Tp(S,y,F)}J!==null&&G===0&&($.updateMultisampleRenderTarget(J),$.updateRenderTargetMipmap(J)),B&&w.end(I),y.isScene===!0&&y.onAfterRender(I,y,F),pe.resetDefaultState(),Q=-1,ue=null,v.pop(),v.length>0?(M=v[v.length-1],$.setTextureUnits(M.state.textureUnits),ht===!0&&Ne.setGlobalState(I.clippingPlanes,M.state.camera)):M=null,C.pop(),C.length>0?S=C[C.length-1]:S=null,D!==null&&D.renderEnd()};function ou(y,F,H,B){if(y.visible===!1)return;if(y.layers.test(F.layers)){if(y.isGroup)H=y.renderOrder;else if(y.isLOD)y.autoUpdate===!0&&y.update(F);else if(y.isLightProbeGrid)M.pushLightProbeGrid(y);else if(y.isLight)M.pushLight(y),y.castShadow&&M.pushShadow(y);else if(y.isSprite){if(!y.frustumCulled||gt.intersectsSprite(y)){B&&rn.setFromMatrixPosition(y.matrixWorld).applyMatrix4(Xt);let _e=K.update(y),de=y.material;de.visible&&S.push(y,_e,de,H,rn.z,null)}}else if((y.isMesh||y.isLine||y.isPoints)&&(!y.frustumCulled||gt.intersectsObject(y))){let _e=K.update(y),de=y.material;if(B&&(y.boundingSphere!==void 0?(y.boundingSphere===null&&y.computeBoundingSphere(),rn.copy(y.boundingSphere.center)):(_e.boundingSphere===null&&_e.computeBoundingSphere(),rn.copy(_e.boundingSphere.center)),rn.applyMatrix4(y.matrixWorld).applyMatrix4(Xt)),Array.isArray(de)){let we=_e.groups;for(let Ce=0,We=we.length;Ce<We;Ce++){let qe=we[Ce],Ie=de[qe.materialIndex];Ie&&Ie.visible&&S.push(y,_e,Ie,H,rn.z,qe)}}else de.visible&&S.push(y,_e,de,H,rn.z,null)}}let fe=y.children;for(let _e=0,de=fe.length;_e<de;_e++)ou(fe[_e],F,H,B)}function Tp(y,F,H,B){let{opaque:k,transmissive:fe,transparent:_e}=y;M.setupLightsView(H),ht===!0&&Ne.setGlobalState(I.clippingPlanes,H),B&&x.viewport(me.copy(B)),k.length>0&&Go(k,F,H),fe.length>0&&Go(fe,F,H),_e.length>0&&Go(_e,F,H),x.buffers.depth.setTest(!0),x.buffers.depth.setMask(!0),x.buffers.color.setMask(!0),x.setPolygonOffset(!1)}function Cp(y,F,H,B){if((H.isScene===!0?H.overrideMaterial:null)!==null)return;if(M.state.transmissionRenderTarget[B.id]===void 0){let Ie=ft.has("EXT_color_buffer_half_float")||ft.has("EXT_color_buffer_float");M.state.transmissionRenderTarget[B.id]=new kn(1,1,{generateMipmaps:!0,type:Ie?Li:Hn,minFilter:Pi,samples:Math.max(4,E.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ye.workingColorSpace})}let fe=M.state.transmissionRenderTarget[B.id],_e=B.viewport||me;fe.setSize(_e.z*I.transmissionResolutionScale,_e.w*I.transmissionResolutionScale);let de=I.getRenderTarget(),we=I.getActiveCubeFace(),Ce=I.getActiveMipmapLevel();I.setRenderTarget(fe),I.getClearColor(It),ct=I.getClearAlpha(),ct<1&&I.setClearColor(16777215,.5),I.clear(),Pt&&Ge.render(H);let We=I.toneMapping;I.toneMapping=ui;let qe=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),M.setupLightsView(B),ht===!0&&Ne.setGlobalState(I.clippingPlanes,B),Go(y,H,B),$.updateMultisampleRenderTarget(fe),$.updateRenderTargetMipmap(fe),ft.has("WEBGL_multisampled_render_to_texture")===!1){let Ie=!1;for(let mt=0,Bt=F.length;mt<Bt;mt++){let Nt=F[mt],{object:xt,geometry:pn,material:xe,group:Fn}=Nt;if(xe.side===Ri&&xt.layers.test(B.layers)){let it=xe.side;xe.side=bn,xe.needsUpdate=!0,Rp(xt,H,B,pn,xe,Fn),xe.side=it,xe.needsUpdate=!0,Ie=!0}}Ie===!0&&($.updateMultisampleRenderTarget(fe),$.updateRenderTargetMipmap(fe))}I.setRenderTarget(de,we,Ce),I.setClearColor(It,ct),qe!==void 0&&(B.viewport=qe),I.toneMapping=We}function Go(y,F,H){let B=F.isScene===!0?F.overrideMaterial:null;for(let k=0,fe=y.length;k<fe;k++){let _e=y[k],{object:de,geometry:we,group:Ce}=_e,We=_e.material;We.allowOverride===!0&&B!==null&&(We=B),de.layers.test(H.layers)&&Rp(de,F,H,we,We,Ce)}}function Rp(y,F,H,B,k,fe){y.onBeforeRender(I,F,H,B,k,fe),y.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse,y.matrixWorld),y.normalMatrix.getNormalMatrix(y.modelViewMatrix),k.onBeforeRender(I,F,H,B,y,fe),k.transparent===!0&&k.side===Ri&&k.forceSinglePass===!1?(k.side=bn,k.needsUpdate=!0,I.renderBufferDirect(H,F,B,k,y,fe),k.side=Qi,k.needsUpdate=!0,I.renderBufferDirect(H,F,B,k,y,fe),k.side=Ri):I.renderBufferDirect(H,F,B,k,y,fe),y.onAfterRender(I,F,H,B,k,fe)}function Wo(y,F,H){F.isScene!==!0&&(F=cn);let B=z.get(y),k=M.state.lights,fe=M.state.shadowsArray,_e=k.state.version,de=ae.getParameters(y,k.state,fe,F,H,M.state.lightProbeGridArray),we=ae.getProgramCacheKey(de),Ce=B.programs;B.environment=y.isMeshStandardMaterial||y.isMeshLambertMaterial||y.isMeshPhongMaterial?F.environment:null,B.fog=F.fog;let We=y.isMeshStandardMaterial||y.isMeshLambertMaterial&&!y.envMap||y.isMeshPhongMaterial&&!y.envMap;B.envMap=te.get(y.envMap||B.environment,We),B.envMapRotation=B.environment!==null&&y.envMap===null?F.environmentRotation:y.envMapRotation,Ce===void 0&&(y.addEventListener("dispose",yi),Ce=new Map,B.programs=Ce);let qe=Ce.get(we);if(qe!==void 0){if(B.currentProgram===qe&&B.lightsStateVersion===_e)return Pp(y,de),qe}else de.uniforms=ae.getUniforms(y),D!==null&&y.isNodeMaterial&&D.build(y,H,de),y.onBeforeCompile(de,I),qe=ae.acquireProgram(de,we),Ce.set(we,qe),B.uniforms=de.uniforms;let Ie=B.uniforms;return(!y.isShaderMaterial&&!y.isRawShaderMaterial||y.clipping===!0)&&(Ie.clippingPlanes=Ne.uniform),Pp(y,de),B.needsLights=Cv(y),B.lightsStateVersion=_e,B.needsLights&&(Ie.ambientLightColor.value=k.state.ambient,Ie.lightProbe.value=k.state.probe,Ie.directionalLights.value=k.state.directional,Ie.directionalLightShadows.value=k.state.directionalShadow,Ie.spotLights.value=k.state.spot,Ie.spotLightShadows.value=k.state.spotShadow,Ie.rectAreaLights.value=k.state.rectArea,Ie.ltc_1.value=k.state.rectAreaLTC1,Ie.ltc_2.value=k.state.rectAreaLTC2,Ie.pointLights.value=k.state.point,Ie.pointLightShadows.value=k.state.pointShadow,Ie.hemisphereLights.value=k.state.hemi,Ie.directionalShadowMatrix.value=k.state.directionalShadowMatrix,Ie.spotLightMatrix.value=k.state.spotLightMatrix,Ie.spotLightMap.value=k.state.spotLightMap,Ie.pointShadowMatrix.value=k.state.pointShadowMatrix),B.lightProbeGrid=M.state.lightProbeGridArray.length>0,B.currentProgram=qe,B.uniformsList=null,qe}function Ip(y){if(y.uniformsList===null){let F=y.currentProgram.getUniforms();y.uniformsList=Qr.seqWithValue(F.seq,y.uniforms)}return y.uniformsList}function Pp(y,F){let H=z.get(y);H.outputColorSpace=F.outputColorSpace,H.batching=F.batching,H.batchingColor=F.batchingColor,H.instancing=F.instancing,H.instancingColor=F.instancingColor,H.instancingMorph=F.instancingMorph,H.skinning=F.skinning,H.morphTargets=F.morphTargets,H.morphNormals=F.morphNormals,H.morphColors=F.morphColors,H.morphTargetsCount=F.morphTargetsCount,H.numClippingPlanes=F.numClippingPlanes,H.numIntersection=F.numClipIntersection,H.vertexAlphas=F.vertexAlphas,H.vertexTangents=F.vertexTangents,H.toneMapping=F.toneMapping}function wv(y,F){if(y.length===0)return null;if(y.length===1)return y[0].texture!==null?y[0]:null;b.setFromMatrixPosition(F.matrixWorld);for(let H=0,B=y.length;H<B;H++){let k=y[H];if(k.texture!==null&&k.boundingBox.containsPoint(b))return k}return null}function Av(y,F,H,B,k){F.isScene!==!0&&(F=cn),$.resetTextureUnits();let fe=F.fog,_e=B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial?F.environment:null,de=J===null?I.outputColorSpace:J.isXRRenderTarget===!0?J.texture.colorSpace:Ye.workingColorSpace,we=B.isMeshStandardMaterial||B.isMeshLambertMaterial&&!B.envMap||B.isMeshPhongMaterial&&!B.envMap,Ce=te.get(B.envMap||_e,we),We=B.vertexColors===!0&&!!H.attributes.color&&H.attributes.color.itemSize===4,qe=!!H.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),Ie=!!H.morphAttributes.position,mt=!!H.morphAttributes.normal,Bt=!!H.morphAttributes.color,Nt=ui;B.toneMapped&&(J===null||J.isXRRenderTarget===!0)&&(Nt=I.toneMapping);let xt=H.morphAttributes.position||H.morphAttributes.normal||H.morphAttributes.color,pn=xt!==void 0?xt.length:0,xe=z.get(B),Fn=M.state.lights;if(ht===!0&&(nt===!0||y!==ue)){let yt=y===ue&&B.id===Q;Ne.setState(B,y,yt)}let it=!1;B.version===xe.__version?(xe.needsLights&&xe.lightsStateVersion!==Fn.state.version||xe.outputColorSpace!==de||k.isBatchedMesh&&xe.batching===!1||!k.isBatchedMesh&&xe.batching===!0||k.isBatchedMesh&&xe.batchingColor===!0&&k.colorTexture===null||k.isBatchedMesh&&xe.batchingColor===!1&&k.colorTexture!==null||k.isInstancedMesh&&xe.instancing===!1||!k.isInstancedMesh&&xe.instancing===!0||k.isSkinnedMesh&&xe.skinning===!1||!k.isSkinnedMesh&&xe.skinning===!0||k.isInstancedMesh&&xe.instancingColor===!0&&k.instanceColor===null||k.isInstancedMesh&&xe.instancingColor===!1&&k.instanceColor!==null||k.isInstancedMesh&&xe.instancingMorph===!0&&k.morphTexture===null||k.isInstancedMesh&&xe.instancingMorph===!1&&k.morphTexture!==null||xe.envMap!==Ce||B.fog===!0&&xe.fog!==fe||xe.numClippingPlanes!==void 0&&(xe.numClippingPlanes!==Ne.numPlanes||xe.numIntersection!==Ne.numIntersection)||xe.vertexAlphas!==We||xe.vertexTangents!==qe||xe.morphTargets!==Ie||xe.morphNormals!==mt||xe.morphColors!==Bt||xe.toneMapping!==Nt||xe.morphTargetsCount!==pn||!!xe.lightProbeGrid!=M.state.lightProbeGridArray.length>0)&&(it=!0):(it=!0,xe.__version=B.version);let Zn=xe.currentProgram;it===!0&&(Zn=Wo(B,F,k),D&&B.isNodeMaterial&&D.onUpdateProgram(B,Zn,xe));let bi=!1,fs=!1,Tr=!1,_t=Zn.getUniforms(),kt=xe.uniforms;if(x.useProgram(Zn.program)&&(bi=!0,fs=!0,Tr=!0),B.id!==Q&&(Q=B.id,fs=!0),xe.needsLights){let yt=wv(M.state.lightProbeGridArray,k);xe.lightProbeGrid!==yt&&(xe.lightProbeGrid=yt,fs=!0)}if(bi||ue!==y){x.buffers.depth.getReversed()&&y.reversedDepth!==!0&&(y._reversedDepth=!0,y.updateProjectionMatrix()),_t.setValue(N,"projectionMatrix",y.projectionMatrix),_t.setValue(N,"viewMatrix",y.matrixWorldInverse);let ms=_t.map.cameraPosition;ms!==void 0&&ms.setValue(N,Jt.setFromMatrixPosition(y.matrixWorld)),E.logarithmicDepthBuffer&&_t.setValue(N,"logDepthBufFC",2/(Math.log(y.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&_t.setValue(N,"isOrthographic",y.isOrthographicCamera===!0),ue!==y&&(ue=y,fs=!0,Tr=!0)}if(xe.needsLights&&(Fn.state.directionalShadowMap.length>0&&_t.setValue(N,"directionalShadowMap",Fn.state.directionalShadowMap,$),Fn.state.spotShadowMap.length>0&&_t.setValue(N,"spotShadowMap",Fn.state.spotShadowMap,$),Fn.state.pointShadowMap.length>0&&_t.setValue(N,"pointShadowMap",Fn.state.pointShadowMap,$)),k.isSkinnedMesh){_t.setOptional(N,k,"bindMatrix"),_t.setOptional(N,k,"bindMatrixInverse");let yt=k.skeleton;yt&&(yt.boneTexture===null&&yt.computeBoneTexture(),_t.setValue(N,"boneTexture",yt.boneTexture,$))}k.isBatchedMesh&&(_t.setOptional(N,k,"batchingTexture"),_t.setValue(N,"batchingTexture",k._matricesTexture,$),_t.setOptional(N,k,"batchingIdTexture"),_t.setValue(N,"batchingIdTexture",k._indirectTexture,$),_t.setOptional(N,k,"batchingColorTexture"),k._colorsTexture!==null&&_t.setValue(N,"batchingColorTexture",k._colorsTexture,$));let ps=H.morphAttributes;if((ps.position!==void 0||ps.normal!==void 0||ps.color!==void 0)&&P.update(k,H,Zn),(fs||xe.receiveShadow!==k.receiveShadow)&&(xe.receiveShadow=k.receiveShadow,_t.setValue(N,"receiveShadow",k.receiveShadow)),(B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial)&&B.envMap===null&&F.environment!==null&&(kt.envMapIntensity.value=F.environmentIntensity),kt.dfgLUT!==void 0&&(kt.dfgLUT.value=KM()),fs){if(_t.setValue(N,"toneMappingExposure",I.toneMappingExposure),xe.needsLights&&Tv(kt,Tr),fe&&B.fog===!0&&Te.refreshFogUniforms(kt,fe),Te.refreshMaterialUniforms(kt,B,ee,se,M.state.transmissionRenderTarget[y.id]),xe.needsLights&&xe.lightProbeGrid){let yt=xe.lightProbeGrid;kt.probesSH.value=yt.texture,kt.probesMin.value.copy(yt.boundingBox.min),kt.probesMax.value.copy(yt.boundingBox.max),kt.probesResolution.value.copy(yt.resolution)}Qr.upload(N,Ip(xe),kt,$)}if(B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(Qr.upload(N,Ip(xe),kt,$),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&_t.setValue(N,"center",k.center),_t.setValue(N,"modelViewMatrix",k.modelViewMatrix),_t.setValue(N,"normalMatrix",k.normalMatrix),_t.setValue(N,"modelMatrix",k.matrixWorld),B.uniformsGroups!==void 0){let yt=B.uniformsGroups;for(let ms=0,Cr=yt.length;ms<Cr;ms++){let Lp=yt[ms];j.update(Lp,Zn),j.bind(Lp,Zn)}}return Zn}function Tv(y,F){y.ambientLightColor.needsUpdate=F,y.lightProbe.needsUpdate=F,y.directionalLights.needsUpdate=F,y.directionalLightShadows.needsUpdate=F,y.pointLights.needsUpdate=F,y.pointLightShadows.needsUpdate=F,y.spotLights.needsUpdate=F,y.spotLightShadows.needsUpdate=F,y.rectAreaLights.needsUpdate=F,y.hemisphereLights.needsUpdate=F}function Cv(y){return y.isMeshLambertMaterial||y.isMeshToonMaterial||y.isMeshPhongMaterial||y.isMeshStandardMaterial||y.isShadowMaterial||y.isShaderMaterial&&y.lights===!0}this.getActiveCubeFace=function(){return W},this.getActiveMipmapLevel=function(){return G},this.getRenderTarget=function(){return J},this.setRenderTargetTextures=function(y,F,H){let B=z.get(y);B.__autoAllocateDepthBuffer=y.resolveDepthBuffer===!1,B.__autoAllocateDepthBuffer===!1&&(B.__useRenderToTexture=!1),z.get(y.texture).__webglTexture=F,z.get(y.depthTexture).__webglTexture=B.__autoAllocateDepthBuffer?void 0:H,B.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(y,F){let H=z.get(y);H.__webglFramebuffer=F,H.__useDefaultFramebuffer=F===void 0},this.setRenderTarget=function(y,F=0,H=0){J=y,W=F,G=H;let B=null,k=!1,fe=!1;if(y){let de=z.get(y);if(de.__useDefaultFramebuffer!==void 0){x.bindFramebuffer(N.FRAMEBUFFER,de.__webglFramebuffer),me.copy(y.viewport),be.copy(y.scissor),lt=y.scissorTest,x.viewport(me),x.scissor(be),x.setScissorTest(lt),Q=-1;return}else if(de.__webglFramebuffer===void 0)$.setupRenderTarget(y);else if(de.__hasExternalTextures)$.rebindTextures(y,z.get(y.texture).__webglTexture,z.get(y.depthTexture).__webglTexture);else if(y.depthBuffer){let We=y.depthTexture;if(de.__boundDepthTexture!==We){if(We!==null&&z.has(We)&&(y.width!==We.image.width||y.height!==We.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");$.setupDepthRenderbuffer(y)}}let we=y.texture;(we.isData3DTexture||we.isDataArrayTexture||we.isCompressedArrayTexture)&&(fe=!0);let Ce=z.get(y).__webglFramebuffer;y.isWebGLCubeRenderTarget?(Array.isArray(Ce[F])?B=Ce[F][H]:B=Ce[F],k=!0):y.samples>0&&$.useMultisampledRTT(y)===!1?B=z.get(y).__webglMultisampledFramebuffer:Array.isArray(Ce)?B=Ce[H]:B=Ce,me.copy(y.viewport),be.copy(y.scissor),lt=y.scissorTest}else me.copy(Fe).multiplyScalar(ee).floor(),be.copy(Ot).multiplyScalar(ee).floor(),lt=Ze;if(H!==0&&(B=V),x.bindFramebuffer(N.FRAMEBUFFER,B)&&x.drawBuffers(y,B),x.viewport(me),x.scissor(be),x.setScissorTest(lt),k){let de=z.get(y.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_CUBE_MAP_POSITIVE_X+F,de.__webglTexture,H)}else if(fe){let de=F;for(let we=0;we<y.textures.length;we++){let Ce=z.get(y.textures[we]);N.framebufferTextureLayer(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0+we,Ce.__webglTexture,H,de)}}else if(y!==null&&H!==0){let de=z.get(y.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,de.__webglTexture,H)}Q=-1},this.readRenderTargetPixels=function(y,F,H,B,k,fe,_e,de=0){if(!(y&&y.isWebGLRenderTarget)){Oe("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let we=z.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&_e!==void 0&&(we=we[_e]),we){x.bindFramebuffer(N.FRAMEBUFFER,we);try{let Ce=y.textures[de],We=Ce.format,qe=Ce.type;if(y.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+de),!E.textureFormatReadable(We)){Oe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!E.textureTypeReadable(qe)){Oe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}F>=0&&F<=y.width-B&&H>=0&&H<=y.height-k&&N.readPixels(F,H,B,k,le.convert(We),le.convert(qe),fe)}finally{let Ce=J!==null?z.get(J).__webglFramebuffer:null;x.bindFramebuffer(N.FRAMEBUFFER,Ce)}}},this.readRenderTargetPixelsAsync=async function(y,F,H,B,k,fe,_e,de=0){if(!(y&&y.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let we=z.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&_e!==void 0&&(we=we[_e]),we)if(F>=0&&F<=y.width-B&&H>=0&&H<=y.height-k){x.bindFramebuffer(N.FRAMEBUFFER,we);let Ce=y.textures[de],We=Ce.format,qe=Ce.type;if(y.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+de),!E.textureFormatReadable(We))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!E.textureTypeReadable(qe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let Ie=N.createBuffer();N.bindBuffer(N.PIXEL_PACK_BUFFER,Ie),N.bufferData(N.PIXEL_PACK_BUFFER,fe.byteLength,N.STREAM_READ),N.readPixels(F,H,B,k,le.convert(We),le.convert(qe),0);let mt=J!==null?z.get(J).__webglFramebuffer:null;x.bindFramebuffer(N.FRAMEBUFFER,mt);let Bt=N.fenceSync(N.SYNC_GPU_COMMANDS_COMPLETE,0);return N.flush(),await Um(N,Bt,4),N.bindBuffer(N.PIXEL_PACK_BUFFER,Ie),N.getBufferSubData(N.PIXEL_PACK_BUFFER,0,fe),N.deleteBuffer(Ie),N.deleteSync(Bt),fe}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(y,F=null,H=0){let B=Math.pow(2,-H),k=Math.floor(y.image.width*B),fe=Math.floor(y.image.height*B),_e=F!==null?F.x:0,de=F!==null?F.y:0;$.setTexture2D(y,0),N.copyTexSubImage2D(N.TEXTURE_2D,H,0,0,_e,de,k,fe),x.unbindTexture()},this.copyTextureToTexture=function(y,F,H=null,B=null,k=0,fe=0){let _e,de,we,Ce,We,qe,Ie,mt,Bt,Nt=y.isCompressedTexture?y.mipmaps[fe]:y.image;if(H!==null)_e=H.max.x-H.min.x,de=H.max.y-H.min.y,we=H.isBox3?H.max.z-H.min.z:1,Ce=H.min.x,We=H.min.y,qe=H.isBox3?H.min.z:0;else{let kt=Math.pow(2,-k);_e=Math.floor(Nt.width*kt),de=Math.floor(Nt.height*kt),y.isDataArrayTexture?we=Nt.depth:y.isData3DTexture?we=Math.floor(Nt.depth*kt):we=1,Ce=0,We=0,qe=0}B!==null?(Ie=B.x,mt=B.y,Bt=B.z):(Ie=0,mt=0,Bt=0);let xt=le.convert(F.format),pn=le.convert(F.type),xe;F.isData3DTexture?($.setTexture3D(F,0),xe=N.TEXTURE_3D):F.isDataArrayTexture||F.isCompressedArrayTexture?($.setTexture2DArray(F,0),xe=N.TEXTURE_2D_ARRAY):($.setTexture2D(F,0),xe=N.TEXTURE_2D),x.activeTexture(N.TEXTURE0),x.pixelStorei(N.UNPACK_FLIP_Y_WEBGL,F.flipY),x.pixelStorei(N.UNPACK_PREMULTIPLY_ALPHA_WEBGL,F.premultiplyAlpha),x.pixelStorei(N.UNPACK_ALIGNMENT,F.unpackAlignment);let Fn=x.getParameter(N.UNPACK_ROW_LENGTH),it=x.getParameter(N.UNPACK_IMAGE_HEIGHT),Zn=x.getParameter(N.UNPACK_SKIP_PIXELS),bi=x.getParameter(N.UNPACK_SKIP_ROWS),fs=x.getParameter(N.UNPACK_SKIP_IMAGES);x.pixelStorei(N.UNPACK_ROW_LENGTH,Nt.width),x.pixelStorei(N.UNPACK_IMAGE_HEIGHT,Nt.height),x.pixelStorei(N.UNPACK_SKIP_PIXELS,Ce),x.pixelStorei(N.UNPACK_SKIP_ROWS,We),x.pixelStorei(N.UNPACK_SKIP_IMAGES,qe);let Tr=y.isDataArrayTexture||y.isData3DTexture,_t=F.isDataArrayTexture||F.isData3DTexture;if(y.isDepthTexture){let kt=z.get(y),ps=z.get(F),yt=z.get(kt.__renderTarget),ms=z.get(ps.__renderTarget);x.bindFramebuffer(N.READ_FRAMEBUFFER,yt.__webglFramebuffer),x.bindFramebuffer(N.DRAW_FRAMEBUFFER,ms.__webglFramebuffer);for(let Cr=0;Cr<we;Cr++)Tr&&(N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,z.get(y).__webglTexture,k,qe+Cr),N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,z.get(F).__webglTexture,fe,Bt+Cr)),N.blitFramebuffer(Ce,We,_e,de,Ie,mt,_e,de,N.DEPTH_BUFFER_BIT,N.NEAREST);x.bindFramebuffer(N.READ_FRAMEBUFFER,null),x.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else if(k!==0||y.isRenderTargetTexture||z.has(y)){let kt=z.get(y),ps=z.get(F);x.bindFramebuffer(N.READ_FRAMEBUFFER,X),x.bindFramebuffer(N.DRAW_FRAMEBUFFER,O);for(let yt=0;yt<we;yt++)Tr?N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,kt.__webglTexture,k,qe+yt):N.framebufferTexture2D(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,kt.__webglTexture,k),_t?N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,ps.__webglTexture,fe,Bt+yt):N.framebufferTexture2D(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,ps.__webglTexture,fe),k!==0?N.blitFramebuffer(Ce,We,_e,de,Ie,mt,_e,de,N.COLOR_BUFFER_BIT,N.NEAREST):_t?N.copyTexSubImage3D(xe,fe,Ie,mt,Bt+yt,Ce,We,_e,de):N.copyTexSubImage2D(xe,fe,Ie,mt,Ce,We,_e,de);x.bindFramebuffer(N.READ_FRAMEBUFFER,null),x.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else _t?y.isDataTexture||y.isData3DTexture?N.texSubImage3D(xe,fe,Ie,mt,Bt,_e,de,we,xt,pn,Nt.data):F.isCompressedArrayTexture?N.compressedTexSubImage3D(xe,fe,Ie,mt,Bt,_e,de,we,xt,Nt.data):N.texSubImage3D(xe,fe,Ie,mt,Bt,_e,de,we,xt,pn,Nt):y.isDataTexture?N.texSubImage2D(N.TEXTURE_2D,fe,Ie,mt,_e,de,xt,pn,Nt.data):y.isCompressedTexture?N.compressedTexSubImage2D(N.TEXTURE_2D,fe,Ie,mt,Nt.width,Nt.height,xt,Nt.data):N.texSubImage2D(N.TEXTURE_2D,fe,Ie,mt,_e,de,xt,pn,Nt);x.pixelStorei(N.UNPACK_ROW_LENGTH,Fn),x.pixelStorei(N.UNPACK_IMAGE_HEIGHT,it),x.pixelStorei(N.UNPACK_SKIP_PIXELS,Zn),x.pixelStorei(N.UNPACK_SKIP_ROWS,bi),x.pixelStorei(N.UNPACK_SKIP_IMAGES,fs),fe===0&&F.generateMipmaps&&N.generateMipmap(xe),x.unbindTexture()},this.initRenderTarget=function(y){z.get(y).__webglFramebuffer===void 0&&$.setupRenderTarget(y)},this.initTexture=function(y){y.isCubeTexture?$.setTextureCube(y,0):y.isData3DTexture?$.setTexture3D(y,0):y.isDataArrayTexture||y.isCompressedArrayTexture?$.setTexture2DArray(y,0):$.setTexture2D(y,0),x.unbindTexture()},this.resetState=function(){W=0,G=0,J=null,x.reset(),pe.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return hi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let n=this.getContext();n.drawingBufferColorSpace=Ye._getDrawingBufferColorSpace(e),n.unpackColorSpace=Ye._getUnpackColorSpace()}};var po={amber:"#FFB020",coral:"#FF6B4A",magenta:"#E85C9A",violet:"#9B7BFF",azure:"#4FA8FF",teal:"#2FD0C0",lime:"#9BD648",bone:"#E8DCC8"},Cd=Object.keys(po),gg=["text","label","color","pos","placed","createdAt","lastTouchedAt"];function _g(t,e,n){return{id:t,name:e,createdAt:n,lastOpenedAt:n,nodes:{},links:{},holding:{origin:[0,-14,0],radius:5.2},clocks:{},removedLinks:{}}}function Rd(t,e){let n=!1,i=(s,r,a)=>{let o=t.clocks[s];if(o===void 0||r>o)return t.clocks[s]=r,t.clocks[s+"#a"]=xg(a),!0;if(r===o){let l=xg(a);if(l>(t.clocks[s+"#a"]??-1))return t.clocks[s+"#a"]=l,!0}return!1};switch(e.t){case"node.set":{let s=t.nodes[e.id],r=s??{id:e.id,text:"",label:"",color:"bone",pos:[0,0,0],placed:!1,createdAt:e.ts,lastTouchedAt:e.ts};for(let a of gg)a in e.fields&&i(`n:${e.id}:${a}`,e.ts,e.actor)&&(r[a]=e.fields[a],n=!0);return s||(t.nodes[e.id]=r,n=!0),s===void 0&&t.clocks[`n:${e.id}:#del`]!==void 0&&delete t.clocks[`n:${e.id}:#del`],n}case"node.del":{if(gg.some(r=>(t.clocks[`n:${e.id}:${r}`]??-1)>e.ts))return!1;if(t.nodes[e.id]){delete t.nodes[e.id];for(let r of Object.keys(t.links))(t.links[r].a===e.id||t.links[r].b===e.id)&&(t.removedLinks[r]=e.ts,delete t.links[r]);t.clocks[`n:${e.id}:#del`]=e.ts,n=!0}return n}case"link.add":return t.removedLinks[e.id]!==void 0&&t.removedLinks[e.id]>=e.ts?!1:(t.links[e.id]||(t.links[e.id]={id:e.id,a:e.a,b:e.b,createdAt:e.ts},delete t.removedLinks[e.id],t.clocks[`l:${e.id}`]=e.ts,n=!0),n);case"link.del":return(t.clocks[`l:${e.id}`]??-1)>e.ts?!1:(t.links[e.id]&&(delete t.links[e.id],t.removedLinks[e.id]=e.ts,n=!0),n);case"map.set":{for(let s of Object.keys(e.fields))i(`m:${s}`,e.ts,e.actor)&&(t[s]=e.fields[s],n=!0);return n}}}function xg(t){let e=2166136261;for(let n=0;n<t.length;n++)e^=t.charCodeAt(n),e=Math.imul(e,16777619);return e>>>0}function Gn(t){return Object.values(t.nodes).sort((e,n)=>e.id<n.id?-1:e.id>n.id?1:0)}function vg(t){return Object.values(t.links).sort((e,n)=>e.id<n.id?-1:e.id>n.id?1:0)}function or(t){return Gn(t).filter(e=>!e.placed)}function Id(t,e){let n=new Set;for(let i of Object.values(t.links))i.a===e?n.add(i.b):i.b===e&&n.add(i.a);return n}function yg(t,e){let n=1/0,i=-1/0;for(let s of Object.values(t.nodes))s.createdAt<n&&(n=s.createdAt),s.createdAt>i&&(i=s.createdAt);return!isFinite(n)||i<=n?1:(e.createdAt-n)/(i-n)}function bg(t,e,n){let i=new Map,s=e?Id(t,e):new Set;for(let r of Object.values(t.nodes))i.set(r.id,r.id===e?"selected":n.has(r.id)?"searchHit":r.placed?s.has(r.id)?"connected":"plain":"unplaced");return i}function Mg(t,e){let n=e.trim().toLowerCase();return n?Gn(t).map(i=>{let s=i.text.toLowerCase(),r=i.label.toLowerCase(),a=-1;return s===n?a=0:s.startsWith(n)?a=1:r===n?a=2:s.includes(n)?a=3:r.includes(n)&&(a=4),{n:i,score:a}}).filter(i=>i.score>=0).sort((i,s)=>i.score-s.score||(i.n.id<s.n.id?-1:1)).map(i=>i.n):[]}var Sg=0;function Pd(t){Sg++;let e=Math.floor(Math.random()*16777215).toString(36);return`${t}${Date.now().toString(36)}${Sg.toString(36)}${e}`}var $c=class t{doc;actor;lastTs=0;listeners=[];transport=null;constructor(e,n){this.doc=e,this.actor=n}static blank(e,n,i){return new t(_g(e,n,Date.now()),i)}lastChange=null;describe(e){if(e.t==="node.set"){let n=e.fields;return"pos"in n&&n.placed===!0?"placed a node":"pos"in n?"moved a node":"text"in n?"edited text":"color"in n?"changed a colour":"label"in n?"set a label":"edited a node"}return e.t==="link.add"?"connected two nodes":e.t==="link.del"?"removed a filament":e.t==="node.del"?"deleted a node":e.t}attach(e){this.transport=e,e.onRemote(n=>{this.lastTs=Math.max(this.lastTs,n.ts),Rd(this.doc,n)&&(this.lastChange={actor:n.actor,remote:n.actor!==this.actor,what:this.describe(n),at:n.ts},this.emit(n))})}detach(){this.transport=null}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(n=>n!==e)}}emit(e){for(let n of this.listeners)n(this.doc,e)}ts(){let e=Date.now();return this.lastTs=e>this.lastTs?e:this.lastTs+1,this.lastTs}commit(e){let n=e(this.ts());return Rd(this.doc,n)&&(this.lastChange={actor:n.actor,remote:!1,what:this.describe(n),at:n.ts},this.emit(n)),this.transport?.send(n),n}replaceDoc(e){this.doc=e,this.emit(null)}quickAdd(e,n="bone"){let i=Pd("n"),s=or(this.doc).length,r=this.doc.holding,a=s*2.39996%(Math.PI*2),o=r.radius*(.34+.42*(s%5/5)),l=[r.origin[0]+o*Math.cos(a),r.origin[1]+(s%3-1)*r.radius*.26,r.origin[2]+o*Math.sin(a)],c=Date.now();return this.commit(h=>({t:"node.set",id:i,actor:this.actor,ts:h,fields:{text:e,label:"holding",color:n,pos:l,placed:!1,createdAt:c,lastTouchedAt:c}})),i}place(e,n,i){let s=this.doc.nodes[e];if(!s)return;let r=i!==void 0?i:s.label==="holding"?"":s.label;this.commit(a=>({t:"node.set",id:e,actor:this.actor,ts:a,fields:{pos:n,placed:!0,lastTouchedAt:Date.now(),label:r}}))}move(e,n){this.doc.nodes[e]&&this.commit(i=>({t:"node.set",id:e,actor:this.actor,ts:i,fields:{pos:n,lastTouchedAt:Date.now()}}))}moveCluster(e,n){for(let i of e){let s=this.doc.nodes[i];if(!s)continue;let r=[s.pos[0]+n[0],s.pos[1]+n[1],s.pos[2]+n[2]];this.commit(a=>({t:"node.set",id:i,actor:this.actor,ts:a,fields:{pos:r,lastTouchedAt:Date.now()}}))}}setText(e,n){this.commit(i=>({t:"node.set",id:e,actor:this.actor,ts:i,fields:{text:n,lastTouchedAt:Date.now()}}))}setColor(e,n){this.commit(i=>({t:"node.set",id:e,actor:this.actor,ts:i,fields:{color:n,lastTouchedAt:Date.now()}}))}setLabel(e,n){this.commit(i=>({t:"node.set",id:e,actor:this.actor,ts:i,fields:{label:n,lastTouchedAt:Date.now()}}))}remove(e){this.commit(n=>({t:"node.del",id:e,actor:this.actor,ts:n}))}connect(e,n){if(e===n||!this.doc.nodes[e]||!this.doc.nodes[n])return null;let[i,s]=e<n?[e,n]:[n,e],r=`l${i}_${s}`;return this.doc.links[r]||this.commit(a=>({t:"link.add",id:r,a:i,b:s,actor:this.actor,ts:a})),r}disconnect(e,n){let[i,s]=e<n?[e,n]:[n,e],r=`l${i}_${s}`;this.doc.links[r]&&this.commit(a=>({t:"link.del",id:r,actor:this.actor,ts:a}))}rename(e){this.commit(n=>({t:"map.set",actor:this.actor,ts:n,fields:{name:e}}))}touchOpened(){this.commit(e=>({t:"map.set",actor:this.actor,ts:e,fields:{lastOpenedAt:Date.now()}}))}holdingCount(){return or(this.doc).length}neighboursOf(e){return Id(this.doc,e)}node(e){return this.doc.nodes[e]}};var qc=class{constructor(e,n,i){this.url=e;this.actor=n;this.account=i}url;actor;ws=null;queue=[];remoteFns=[];snapFns=[];origin={from:"live"};connId=null;serverPid=null;mapsFns=[];statusFns=[];status="offline";detail="not connected";account;connect(e){this.setStatus("connecting",`connecting to ${this.url}`);let n=new WebSocket(`${this.url}?map=${encodeURIComponent(e)}&actor=${encodeURIComponent(this.actor)}&account=${encodeURIComponent(this.account)}`);this.ws=n,n.onopen=()=>{this.setStatus("live",`live \xB7 ${this.account}`);for(let i of this.queue.splice(0))n.send(JSON.stringify({t:"op",op:i}))},n.onclose=()=>{this.status!=="error"&&this.setStatus("offline","disconnected")},n.onerror=()=>this.setStatus("error","connection failed"),n.onmessage=i=>{let s=JSON.parse(i.data);if(s.t==="op")for(let r of this.remoteFns)r(s.op);else if(s.t==="snapshot"){this.origin=s.origin??{from:"live"},s.conn!==void 0&&(this.connId=s.conn),s.serverPid!==void 0&&(this.serverPid=s.serverPid);for(let r of this.snapFns)r(s.doc,this.origin)}else if(s.t==="maps")for(let r of this.mapsFns)r(s.maps);else s.t==="error"&&this.setStatus("error",s.message)}}close(){this.ws?.close(),this.ws=null}send(e){this.ws&&this.ws.readyState===WebSocket.OPEN?this.ws.send(JSON.stringify({t:"op",op:e})):this.queue.push(e)}request(e){this.ws&&this.ws.readyState===WebSocket.OPEN&&this.ws.send(JSON.stringify(e))}onRemote(e){this.remoteFns.push(e)}onSnapshot(e){this.snapFns.push(e)}onMaps(e){this.mapsFns.push(e)}onStatus(e){this.statusFns.push(e),e(this.status,this.detail)}setStatus(e,n){this.status=e,this.detail=n;for(let i of this.statusFns)i(e,n)}};var Tg="#120E0B",ZM="#8A7F76",JM="#D8CCC0",Jc="#EFE6D8",jM={plain:0,connected:1,unplaced:2,searchHit:3,selected:4},mo={plain:.5,connected:.72,unplaced:.86,searchHit:.95,selected:1},Eg=new Map;function Fd(t){let e=po[t]??t,n=Eg.get(e);return n||(n=new ze(e),Eg.set(e,n)),n}var wg=(t,e,n)=>.299*t+.587*e+.114*n,Ld=t=>t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4),Nd=t=>t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055;function QM(t,e,n){let i=Ld(t),s=Ld(e),r=Ld(n),a=Math.cbrt(.4122214708*i+.5363325363*s+.0514459929*r),o=Math.cbrt(.2119034982*i+.6806995451*s+.1073969566*r),l=Math.cbrt(.0883024619*i+.2817188376*s+.6299787005*r);return[.2104542553*a+.793617785*o-.0040720468*l,1.9779984951*a-2.428592205*o+.4505937099*l,.0259040371*a+.7827717662*o-.808675766*l]}function Dd(t,e,n){let i=(t+.3963377774*e+.2158037573*n)**3,s=(t-.1055613458*e-.0638541728*n)**3,r=(t-.0894841775*e-1.291485548*n)**3;return[Nd(4.0767416621*i-3.3077115913*s+.2309699292*r),Nd(-1.2684380046*i+2.6097574011*s-.3413193965*r),Nd(-.0041960863*i-.7034186147*s+1.707614701*r)]}var eS={plain:.3,connected:.44,unplaced:.57,searchHit:.69,selected:.8},Ag=new Map;function Cg(t,e){let n=`${t}|${e}`,i=Ag.get(n);if(!i){let s=Fd(t),r=eS[e],[,a,o]=QM(s.r,s.g,s.b),l=u=>{let f=0,g=1.4;for(let _=0;_<28;_++){let m=(f+g)/2,A=Dd(m,a*u,o*u).map(T=>Math.min(1,Math.max(0,T)));wg(A[0],A[1],A[2])<r?f=m:g=m}return(f+g)/2},c=0,h=1,d=null;for(let u=0;u<22;u++){let f=(c+h)/2,g=Dd(l(f),a*f,o*f);g.every(m=>m>=-.002&&m<=1.002)&&Math.abs(wg(Math.min(1,Math.max(0,g[0])),Math.min(1,Math.max(0,g[1])),Math.min(1,Math.max(0,g[2])))-r)<.004?(d=g.map(m=>Math.min(1,Math.max(0,m))),c=f):h=f}d||(d=Dd(l(0),0,0).map(f=>Math.min(1,Math.max(0,f)))),i=new ze(d[0],d[1],d[2]),Ag.set(n,i)}return i}var tS=`
precision highp float;
attribute vec3  iPos;
...
`;var ve=(t,e=document)=>e.querySelector(t),Wt=(t,e={},n="")=>{let i=document.createElement(t);for(let[s,r]of Object.entries(e))i.setAttribute(s,r);return n&&(i.innerHTML=n),i},Mt=t=>t.replace(/[&<>"]/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[e]),LE=t=>{let e=Math.max(0,Math.round((Date.now()-t)/6e4));if(e<1)return"just now";if(e<60)return`${e} min ago`;let n=Math.round(e/60);if(n<24)return`${n} h ago`;let i=Math.round(n/24);return i<30?`${i} d ago`:`${Math.round(i/30)} mo ago`},Sp=class{surface;lens="canvas";scene;store;sync;controls;hands;maps=[];selected=null;hits=[];hitIndex=0;suggestions=[];sugIndex=0;lastParse=null;handsOn=!1;frozenClock=null;virtualNow=null;uiUntil={toast:0,gesture:0,turning:0};ready=!1;raf=0;lastGesture={id:"",detail:"",at:0};handGrab=null;lastHandOp=0;gyro=null;constructor(e){this.surface=e}lenses(){return this.surface==="windows"?["canvas","expansion"]:["canvas","ar"]}async boot(e){document.head.appendChild(Wt("style",{},vv)),document.body.appendChild(Wt("canvas",{id:"world"})),this.buildChrome();let n=await(await fetch("./assets/font-sdf.json")).json(),i=await new Promise((r,a)=>new Za().load("./assets/font-sdf.png",r,void 0,a));this.scene=new Qc(ve("#world"),n,i);let s=await(await fetch(`./maps/${e.mapId}.json`)).json();this.store=new $c(s,e.actor),this.sync=new qc(e.wsUrl,e.actor,e.account),this.sync.onSnapshot((r,a)=>{this.store.replaceDoc(r),this.scene.setDoc(r),this.refresh(),this.frameAll(),this.showOrigin(a)}),this.sync.onMaps(r=>{this.maps=r,ve("#maps")&&this.renderMaps()}),this.sync.onStatus(()=>this.renderSyncStatus()),this.store.attach(this.sync),this.store.subscribe(()=>{this.scene.markDirty(),this.refresh()}),this.sync.connect(e.mapId),this.scene.setDoc(this.store.doc),this.controls=new eh(this.scene,this.store,{onSelect:r=>this.select(r),onQuickAdd:()=>this.quickAdd(""),onGestureFired:(r,a)=>this.showGesture(r,a),onDragEnd:()=>this.refresh()}),this.controls.now=()=>this.now(),this.hands=new ru("./assets/mp-wasm","./assets/hand_landmarker.task"),this.hands.onFrame=r=>this.onHand(r),this.setLens(this.lenses()[0]),this.resize(),window.addEventListener("resize",()=>this.resize()),this.attachInput(),this.frameAll(),this.refresh(),this.loop(),this.ready=!0}buildChrome(){let e=Wt("div",{id:"top"});e.innerHTML=`
      ...
      ${yp.map(n=>`<tr><td><b>${Mt(n.name)}</b></td><td>${Mt(n.how)}</td><td>${Mt(n.operation)}</td><td class="num">${n.span}</td></tr>`).join("")}
      </tbody></table>
      ...
      ${this.suggestions.length?`
        ...
        ${n?`<div class="sug" data-t="finder-current">
          ...
          <div class="d">${Mt(Mp(n,this.store.doc))}</div>
