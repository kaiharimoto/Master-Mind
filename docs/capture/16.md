...
The small map on the Android surface.

## Vantage

Canvas lens, framed to fit; 34 s at 30 fps.

## What it proves

All six touch gestures performed in sequence with on-screen labels, each producing a different operation, spanning capture, placement, connection, selection and navigation.
